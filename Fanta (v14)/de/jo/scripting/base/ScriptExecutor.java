...
public class ScriptExecutor {
    ...
    public ScriptExecutor() {
        ...
        this.registerLine("var addSetting = function(module, setting) {module.settings.add(setting);}");
        this.registerLine("var registerModule = function(module) {modulemanager.modules.add(module);}");
        this.registerLine("var Setting = Java.type(\"de.fanta.setting.Setting\");");
        this.registerLine("var BaseSetting = Java.type(\"de.fanta.setting.settings.BaseSetting\");");
        this.registerLine("var CheckBox = Java.type(\"de.fanta.setting.settings.CheckBox\");");
        this.registerLine("var ColorValue = Java.type(\"de.fanta.setting.settings.ColorValue\");");
        this.registerLine("var DropdownBox = Java.type(\"de.fanta.setting.settings.DropdownBox\");");
        this.registerLine("var Slider = Java.type(\"de.fanta.setting.settings.Slider\");");
        this.registerLine("var TextField = Java.type(\"de.fanta.setting.settings.TextField\");");
    }
