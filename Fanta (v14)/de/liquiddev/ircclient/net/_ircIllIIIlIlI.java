...
public final class _ircIllIIIlIlI {
    ...
    private ArrayList _ircIllIllIIlI = new ArrayList();

    public _ircIllIIIlIlI() {
        this._ircIllIllIIlI.add(Irc00Login.class);
    ...
    public final Class _ircIllIllIIlI(int n) {
        if (n == 255) {
            return Irc00Login.class;
        }
        return (Class)this._ircIllIllIIlI.get(n);
    }

    public final int _ircIllIllIIlI(IrcPacket ircPacket) {
