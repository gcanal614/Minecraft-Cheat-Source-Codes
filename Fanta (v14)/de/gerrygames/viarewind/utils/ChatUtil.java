 ...
 *  com.viaversion.viaversion.protocols.protocol1_13to1_12_2.ChatRewriter
 */
...
public class ChatUtil {
    ...
    public static String jsonToLegacy(String json) {
        ...
        try {
            String legacy = LegacyComponentSerializer.legacySection().serialize(ChatRewriter.HOVER_GSON_SERIALIZER.deserialize((Object)json));
