 ...
 *  com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter
 */
...
public class ItemRewriter {
    ...
    public static Item toClient(Item item) {
        ...
        tag.put("ViaRewind1_8to1_9", (Tag)viaVersionTag);
        ...
        if (item.data() != 0 && tag.contains("Unbreakable") && (unbreakable = (ByteTag)tag.get("Unbreakable")).asByte() != 0) {
            ListTag loreTag;
            viaVersionTag.put("Unbreakable", (Tag)new ByteTag(unbreakable.asByte()));
        ...
        if (item.identifier() == 383 && item.data() == 0) {
            ...
            if (tag.contains("EntityTag") && (entityTag = (CompoundTag)tag.get("EntityTag")).contains("id")) {
                ...
                if (ENTTIY_NAME_TO_ID.containsKey(id.getValue())) {
                    ...
                    tag.put("display", (Tag)display);
                    viaVersionTag.put("noDisplay", (Tag)new ByteTag());
                    display.put("Name", (Tag)new StringTag("\u00a7rSpawn " + id.getValue()));
                }
            }
        ...
        if (item.identifier() == 373 || item.identifier() == 438 || item.identifier() == 441) {
            ...
            if (tag.contains("Potion")) {
                ...
                if ((display == null || !display.contains("Name")) && POTION_NAME_INDEX.containsKey(potionName)) {
                    ...
                    display.put("Name", (Tag)new StringTag(POTION_NAME_INDEX.get(potionName)));
                }
            }
    ...
    public static Item toServer(Item item) {
        ...
        if (item.identifier() == 383 && item.data() != 0) {
            ...
            if (!tag.contains("EntityTag") && ENTTIY_ID_TO_NAME.containsKey(item.data())) {
                ...
                entityTag.put("id", (Tag)new StringTag(ENTTIY_ID_TO_NAME.get(item.data())));
        ...
        if (!(item.identifier() != 373 || tag != null && tag.contains("Potion"))) {
            ...
            String name = item.data() == 8192 ? "water" : com.viaversion.viaversion.protocols.protocol1_9to1_8.ItemRewriter.potionNameFromDamage((short)item.data());
            tag.put("Potion", (Tag)new StringTag("minecraft:" + name));
            item.setData((short)0);
        }
        ...
        if (viaVersionTag.contains("lore")) {
            ...
            if ((lore = (ListTag)display.get("Lore")) == null) {
                display.put("Lore", (Tag)new ListTag((List)viaVersionTag.get("lore").getValue()));
            } else {
