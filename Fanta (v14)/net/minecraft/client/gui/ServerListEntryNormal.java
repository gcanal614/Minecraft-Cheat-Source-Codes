...
implements GuiListExtended.IGuiListEntry {
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected) {
        ...
        while (i < Math.min(list.size(), 2)) {
            this.mc.fontRendererObj.drawString((String)list.get(i), x + 32 + 3, y + 12 + this.mc.fontRendererObj.getFontHeight() * i, 0x808080);
            ++i;
        }
        ...
        if (flag2) {
            ...
            if (this.field_148301_e.pingToServer < 0L) {
                ...
                s1 = String.valueOf(this.field_148301_e.pingToServer) + "ms";
                s = this.field_148301_e.playerList;
            }
        } else {
            k = 1;
