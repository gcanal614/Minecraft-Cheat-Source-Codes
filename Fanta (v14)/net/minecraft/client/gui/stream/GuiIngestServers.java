...
extends GuiScreen {
    ...
    extends GuiSlot {
        public ServerList(Minecraft mcIn) {
            super(mcIn, width, height, 32, height - 35, (int)((double)mcIn.fontRendererObj.getFontHeight() * 3.5));
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s, p_180791_2_ + 2, p_180791_3_ + GuiIngestServers.this.fontRendererObj.getFontHeight() + 5 + 3, 0x303030);
            ...
            if (s2 != null) {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s2, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s2), p_180791_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.getFontHeight(), 0x808080);
            }
        }
