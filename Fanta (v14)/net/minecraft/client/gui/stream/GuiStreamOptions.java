...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_152315_t) {
            this.drawCenteredString(this.fontRendererObj, (Object)((Object)EnumChatFormatting.RED) + I18n.format("options.stream.changes", new Object[0]), width / 2, 20 + this.fontRendererObj.getFontHeight(), 0xFFFFFF);
        }
