    ...
    public void drawChat(int p_146230_1_) {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                ...
                int i1 = 0;
                while (i1 + this.scrollPos < this.field_146253_i.size() && i1 < i) {
                    int j1;
                    ChatLine chatline = this.field_146253_i.get(i1 + this.scrollPos);
                    if (chatline != null && ((j1 = p_146230_1_ - chatline.getUpdatedCounter()) < 200 || flag)) {
                        ...
                        if (l1 > 3) {
                            ...
                            if (!Client.INSTANCE.moduleManager.getModule("AntiChat").isState()) {
                                this.mc.fontRendererObj.drawStringWithShadow(s, i2, (float)(j2 - 8) - (float)(this.mc.fontRendererObj.getFontHeight() / 6), 0xFFFFFF + (l1 << 24));
                            }
