...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.networkManager == null) {
            Client.INSTANCE.unicodeBasicFontRenderer.drawCenteredString(I18n.format("connect.connecting", new Object[0]), width / 2, height / 2 - 50, 0xFFFFFF);
        } else {
            Client.INSTANCE.unicodeBasicFontRenderer.drawCenteredString(I18n.format("connect.authorizing", new Object[0]), width / 2, height / 2 - 50, 0xFFFFFF);
        }
