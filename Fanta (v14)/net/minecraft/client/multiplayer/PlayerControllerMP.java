...
public class PlayerControllerMP {
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face) {
        ...
        if (flag) {
            ...
            if (block1.getPlayerRelativeBlockHardness(this.mc.thePlayer, EntityPlayerSP.worldObj, loc) >= 1.0f) {
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing) {
        ...
        if (this.isHittingPosition(posBlock)) {
            ...
            EntityPlayerSP cfr_ignored_0 = this.mc.thePlayer;
            curBlockDamageMP += block.getPlayerRelativeBlockHardness(this.mc.thePlayer, EntityPlayerSP.worldObj, posBlock);
    ...
    public float getBlockReachDistance() {
        return this.currentGameType.isCreative() ? (Client.INSTANCE.moduleManager.getModule("Teleport").isState() ? 256.0f : 5.0f) : (Client.INSTANCE.moduleManager.getModule("Teleport").isState() ? 256.0f : 4.5f);
    }
