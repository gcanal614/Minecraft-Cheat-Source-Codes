...
IStream {
    ...
    public void func_176018_a(String p_176018_1_, ChatUserInfo[] p_176018_2_, ChatUserInfo[] p_176018_3_, ChatUserInfo[] p_176018_4_) {
        ChatUserInfo[] chatUserInfoArray = p_176018_3_;
        int n = p_176018_3_.length;
        int n2 = 0;
        while (n2 < n) {
            ChatUserInfo chatuserinfo = chatUserInfoArray[n2];
            this.field_152955_g.remove(chatuserinfo.displayName);
            ++n2;
        }
        chatUserInfoArray = p_176018_4_;
        n = p_176018_4_.length;
        n2 = 0;
        while (n2 < n) {
            ChatUserInfo chatuserinfo1 = chatUserInfoArray[n2];
            this.field_152955_g.put(chatuserinfo1.displayName, chatuserinfo1);
            ++n2;
        }
        chatUserInfoArray = p_176018_2_;
        n = p_176018_2_.length;
        n2 = 0;
        while (n2 < n) {
    ...
    public boolean func_152929_G() {
        boolean flag;
        boolean bl = flag = this.mc.gameSettings.streamMicToggleBehavior == 1;
