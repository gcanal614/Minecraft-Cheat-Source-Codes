            ...
            if (!Reflector.postForgeBusEvent((ReflectorConstructor)Reflector.RenderItemInFrameEvent_Constructor, (Object[])new Object[]{itemFrame, this})) {
                if (item instanceof ItemMap) {
                    ...
                    if (item == Items.compass) {
                        ...
                        if (Config.isShaders()) {
                            ShadersTex.bindTextureMapForUpdateAndRender((TextureManager)this.mc.getTextureManager(), (ResourceLocation)TextureMap.locationBlocksTexture);
                        } else {
                        ...
                        if (textureatlassprite instanceof TextureCompass) {
                            ...
                            texturecompass.updateCompass(EntityItemFrame.worldObj, itemFrame.posX, itemFrame.posZ, MathHelper.wrapAngleTo180_float(180 + itemFrame.facingDirection.getHorizontalIndex() * 90), false, true);
