    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        try {
            ...
            if (Reflector.MinecraftForgeClient_onRebuildChunk.exists()) {
                Reflector.call((ReflectorMethod)Reflector.MinecraftForgeClient_onRebuildChunk, (Object[])new Object[]{this.world, this.position, regionrendercache});
            }
        ...
        if (!regionrendercache.extendedLevelsInChunkCache()) {
            ...
            Iterator iterator = BlockPosM.getAllInBoxMutable((BlockPos)blockpos, (BlockPos)blockpos1).iterator();
            ...
            while (iterator.hasNext()) {
                ...
                if (ReflectorForge.blockHasTileEntity((IBlockState)iblockstate)) {
                ...
                int i = 0;
                while (i < aenumworldblocklayer.length) {
                    boolean flag4;
                    EnumWorldBlockLayer enumworldblocklayer = aenumworldblocklayer[i];
                    if (!flag2 || (flag4 = Reflector.callBoolean((Object)block, (ReflectorMethod)Reflector.ForgeBlock_canRenderInLayer, (Object[])new Object[]{enumworldblocklayer}))) {
                        if (flag3) {
                        ...
                        if (block.getRenderType() != -1) {
                            ...
                            int n = j;
                            aboolean[n] = aboolean[n] | blockrendererdispatcher.renderBlock(iblockstate, (BlockPos)blockposm, regionrendercache, worldrenderer);
                        }
                    }
                    ++i;
                }
            ...
            while (n2 < n) {
                ...
                if (compiledchunk.isLayerStarted(enumworldblocklayer1)) {
                    if (Config.isShaders()) {
                        SVertexBuilder.calcNormalChunkLayer((WorldRenderer)generator.getRegionRenderCacheBuilder().getWorldRendererByLayer(enumworldblocklayer1));
                    }
