...
implements IResourceManagerReloadListener {
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_) {
        ...
        if (p_78481_2_) {
            ...
            try {
                if (!Client.INSTANCE.moduleManager.getModule("NoFov").isState() && Config.isDynamicFov()) {
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            if (entitylivingbase.getHealth() <= 0.0f) {
                f = (float)entitylivingbase.deathTime + partialTicks;
            }
            if (f2 < 0.0f) {
                return;
            }
            ...
            f = entitylivingbase.attackedAtYaw;
        }
    }
    ...
    private void orientCamera(float partialTicks) {
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists()) {
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                Object object = Reflector.newInstance((ReflectorConstructor)Reflector.EntityViewRenderEvent_CameraSetup_Constructor, (Object[])new Object[]{this, entity, block1, Float.valueOf(partialTicks), Float.valueOf(f6), Float.valueOf(f7), Float.valueOf(f8)});
    ...
    private void updateLightmap(float partialTicks) {
        if (this.lightmapUpdateNeeded) {
            ...
            if (worldclient != null) {
                if (Config.isCustomColors() && CustomColors.updateLightmap((World)worldclient, (float)this.torchFlickerX, (int[])this.lightmapColors, (boolean)this.mc.thePlayer.isPotionActive(Potion.nightVision))) {
    ...
    public void func_181560_a(float p_181560_1_, long p_181560_2_) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    if (Reflector.ForgeHooksClient_drawScreen.exists()) {
                        Reflector.callVoid((ReflectorMethod)Reflector.ForgeHooksClient_drawScreen, (Object[])new Object[]{this.mc.currentScreen, j1, k1, Float.valueOf(p_181560_1_)});
                    } else {
            ...
            if (((DropdownBox)Client.INSTANCE.moduleManager.getModule((String)"GUI").getSetting((String)"Modes").getSetting()).curOption == "Skash") {
                Client.clickGui.drawMenu(j1, k1);
            }
        }
        this.frameFinish();
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        if (flag) {
            ShadersRender.setFrustrumPosition((Frustum)frustum, (double)d0, (double)d1, (double)d2);
        } else {
        ...
        if (flag) {
            ShadersRender.setupTerrain((RenderGlobal)renderglobal, (Entity)entity, (double)partialTicks, (ICamera)frustum, (int)this.frameCount++, (boolean)this.mc.thePlayer.isSpectator());
        } else {
        ...
        if (!this.debugView) {
            ...
            if (this.mc.objectMouseOver != null && entity.isInsideOfMaterial(Material.water) && flag1) {
                ...
                if (!(Reflector.ForgeHooksClient_onDrawBlockHighlight.exists() && Reflector.callBoolean((ReflectorMethod)Reflector.ForgeHooksClient_onDrawBlockHighlight, (Object[])new Object[]{renderglobal, entityplayer, this.mc.objectMouseOver, 0, entityplayer.getHeldItem(), Float.valueOf(partialTicks)}) || this.mc.gameSettings.hideGUI)) {
        ...
        if (flag1 && this.mc.objectMouseOver != null && !entity.isInsideOfMaterial(Material.water)) {
            ...
            GlStateManager.disableAlpha();
            this.mc.mcProfiler.endStartSection("outline");
            if (!(Reflector.ForgeHooksClient_onDrawBlockHighlight.exists() && Reflector.callBoolean((ReflectorMethod)Reflector.ForgeHooksClient_onDrawBlockHighlight, (Object[])new Object[]{renderglobal, entityplayer1, this.mc.objectMouseOver, 0, entityplayer1.getHeldItem(), Float.valueOf(partialTicks)}) || this.mc.gameSettings.hideGUI)) {
        ...
        if (Reflector.ForgeHooksClient_dispatchRenderLast.exists()) {
            ...
            Reflector.callVoid((ReflectorMethod)Reflector.ForgeHooksClient_dispatchRenderLast, (Object[])new Object[]{renderglobal, Float.valueOf(partialTicks)});
        }
        this.mc.mcProfiler.endStartSection("hand");
        boolean flag2 = ReflectorForge.renderFirstPersonHand((RenderGlobal)this.mc.renderGlobal, (float)partialTicks, (int)pass);
    ...
    protected void renderRainSnow(float partialTicks) {
        ...
        if (Reflector.ForgeWorldProvider_getWeatherRenderer.exists() && (object = Reflector.call((Object)(worldprovider = this.mc.theWorld.provider), (ReflectorMethod)Reflector.ForgeWorldProvider_getWeatherRenderer, (Object[])new Object[0])) != null) {
            Reflector.callVoid((Object)object, (ReflectorMethod)Reflector.IRenderHandler_render, (Object[])new Object[]{Float.valueOf(partialTicks), this.mc.theWorld, this.mc});
            return;
        }
    ...
    private void updateFogColor(float partialTicks) {
        ...
        vec3 = CustomColors.getWorldSkyColor((Vec3)vec3, (World)worldclient, (Entity)this.mc.getRenderViewEntity(), (float)partialTicks);
        float f1 = (float)vec3.xCoord;
        float f2 = (float)vec3.yCoord;
        float f3 = (float)vec3.zCoord;
        Vec3 vec31 = worldclient.getFogColor(partialTicks);
        vec31 = CustomColors.getWorldFogColor((Vec3)vec31, (WorldClient)worldclient, (Entity)this.mc.getRenderViewEntity(), (float)partialTicks);
        ...
        if (this.cloudFog) {
            ...
            Vec3 vec34 = CustomColors.getUnderwaterColor((IBlockAccess)this.mc.theWorld, (double)this.mc.getRenderViewEntity().posX, (double)(this.mc.getRenderViewEntity().posY + 1.0), (double)this.mc.getRenderViewEntity().posZ);
            if (vec34 != null) {
        ...
        if (Reflector.EntityViewRenderEvent_FogColors_Constructor.exists()) {
            Object object = Reflector.newInstance((ReflectorConstructor)Reflector.EntityViewRenderEvent_FogColors_Constructor, (Object[])new Object[]{this, entity, block, Float.valueOf(partialTicks), Float.valueOf(this.fogColorRed), Float.valueOf(this.fogColorGreen), Float.valueOf(this.fogColorBlue)});
            Reflector.postForgeBusEvent((Object)object);
    ...
    private void setupFog(int p_78468_1_, float partialTicks) {
        ...
        if (Reflector.ForgeHooksClient_getFogDensity.exists()) {
            f1 = Reflector.callFloat((ReflectorMethod)Reflector.ForgeHooksClient_getFogDensity, (Object[])new Object[]{this, entity, block, Float.valueOf(partialTicks), Float.valueOf(0.1f)});
        }
        if (f1 >= 0.0f) {
            ...
            if (Reflector.ForgeHooksClient_onFogRender.exists()) {
                Reflector.callVoid((ReflectorMethod)Reflector.ForgeHooksClient_onFogRender, (Object[])new Object[]{this, entity, block, Float.valueOf(partialTicks), p_78468_1_, Float.valueOf(f)});
            }
        }
    ...
    private void frameInit() {
        ...
        if (this.updatedWorld != world) {
            RandomMobs.worldChanged((World)this.updatedWorld, (World)world);
