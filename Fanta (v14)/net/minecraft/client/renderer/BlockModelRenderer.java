...
public class BlockModelRenderer {
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides) {
        ...
        try {
            ...
            if (Config.isTreesSmart() && blockStateIn.getBlock() instanceof BlockLeavesBase) {
                modelIn = SmartLeaves.getLeavesModel((IBakedModel)modelIn);
            }
    ...
    public boolean renderModelAmbientOcclusion(IBlockAccess p_renderModelAmbientOcclusion_1_, IBakedModel p_renderModelAmbientOcclusion_2_, Block p_renderModelAmbientOcclusion_3_, IBlockState p_renderModelAmbientOcclusion_4_, BlockPos p_renderModelAmbientOcclusion_5_, WorldRenderer p_renderModelAmbientOcclusion_6_, boolean p_renderModelAmbientOcclusion_7_) {
        ...
        while (n2 < n) {
            ...
            if (!list.isEmpty()) {
                ...
                if (!p_renderModelAmbientOcclusion_7_ || p_renderModelAmbientOcclusion_3_.shouldSideBeRendered(p_renderModelAmbientOcclusion_1_, blockpos, enumfacing)) {
                    if (renderenv == null) {
                        renderenv = RenderEnv.getInstance((IBlockAccess)p_renderModelAmbientOcclusion_1_, (IBlockState)p_renderModelAmbientOcclusion_4_, (BlockPos)p_renderModelAmbientOcclusion_5_);
                    }
                    if (!renderenv.isBreakingAnimation(list) && Config.isBetterGrass()) {
                        list = BetterGrass.getFaceQuads((IBlockAccess)p_renderModelAmbientOcclusion_1_, (Block)p_renderModelAmbientOcclusion_3_, (BlockPos)p_renderModelAmbientOcclusion_5_, (EnumFacing)enumfacing, list);
                    }
        ...
        if (renderenv != null && Config.isBetterSnow() && !renderenv.isBreakingAnimation() && BetterSnow.shouldRender((IBlockAccess)p_renderModelAmbientOcclusion_1_, (Block)p_renderModelAmbientOcclusion_3_, (IBlockState)p_renderModelAmbientOcclusion_4_, (BlockPos)p_renderModelAmbientOcclusion_5_)) {
    ...
    public boolean renderModelStandard(IBlockAccess p_renderModelStandard_1_, IBakedModel p_renderModelStandard_2_, Block p_renderModelStandard_3_, IBlockState p_renderModelStandard_4_, BlockPos p_renderModelStandard_5_, WorldRenderer p_renderModelStandard_6_, boolean p_renderModelStandard_7_) {
        ...
        while (n2 < n) {
            ...
            if (!list.isEmpty()) {
                ...
                if (!p_renderModelStandard_7_ || p_renderModelStandard_3_.shouldSideBeRendered(p_renderModelStandard_1_, blockpos, enumfacing)) {
                    if (renderenv == null) {
                        renderenv = RenderEnv.getInstance((IBlockAccess)p_renderModelStandard_1_, (IBlockState)p_renderModelStandard_4_, (BlockPos)p_renderModelStandard_5_);
                    }
                    if (!renderenv.isBreakingAnimation(list) && Config.isBetterGrass()) {
                        list = BetterGrass.getFaceQuads((IBlockAccess)p_renderModelStandard_1_, (Block)p_renderModelStandard_3_, (BlockPos)p_renderModelStandard_5_, (EnumFacing)enumfacing, list);
                    }
        ...
        if (renderenv != null && Config.isBetterSnow() && !renderenv.isBreakingAnimation() && BetterSnow.shouldRender((IBlockAccess)p_renderModelStandard_1_, (Block)p_renderModelStandard_3_, (IBlockState)p_renderModelStandard_4_, (BlockPos)p_renderModelStandard_5_) && BetterSnow.shouldRender((IBlockAccess)p_renderModelStandard_1_, (Block)p_renderModelStandard_3_, (IBlockState)p_renderModelStandard_4_, (BlockPos)p_renderModelStandard_5_)) {
            IBakedModel ibakedmodel = BetterSnow.getModelSnowLayer();
            IBlockState iblockstate = BetterSnow.getStateSnowLayer();
        ...
        for (Object bakedquad0 : p_renderModelAmbientOcclusionQuads_5_) {
            ...
            if (!p_renderModelAmbientOcclusionQuads_6_.isBreakingAnimation(bakedquad)) {
                ...
                if (Config.isConnectedTextures()) {
                    bakedquad = ConnectedTextures.getConnectedTexture((IBlockAccess)p_renderModelAmbientOcclusionQuads_1_, (IBlockState)iblockstate, (BlockPos)p_renderModelAmbientOcclusionQuads_3_, (BakedQuad)bakedquad, (RenderEnv)p_renderModelAmbientOcclusionQuads_6_);
                }
                if (bakedquad == bakedquad1 && Config.isNaturalTextures()) {
                    bakedquad = NaturalTextures.getNaturalTexture((BlockPos)p_renderModelAmbientOcclusionQuads_3_, (BakedQuad)bakedquad);
                }
            }
            ...
            int k = CustomColors.getColorMultiplier((BakedQuad)bakedquad, (Block)p_renderModelAmbientOcclusionQuads_2_, (IBlockAccess)p_renderModelAmbientOcclusionQuads_1_, (BlockPos)p_renderModelAmbientOcclusionQuads_3_, (RenderEnv)p_renderModelAmbientOcclusionQuads_6_);
    ...
    private void renderModelStandardQuads(IBlockAccess p_renderModelStandardQuads_1_, Block p_renderModelStandardQuads_2_, BlockPos p_renderModelStandardQuads_3_, EnumFacing p_renderModelStandardQuads_4_, int p_renderModelStandardQuads_5_, boolean p_renderModelStandardQuads_6_, WorldRenderer p_renderModelStandardQuads_7_, List p_renderModelStandardQuads_8_, RenderEnv p_renderModelStandardQuads_9_) {
        ...
        for (Object bakedquad0 : p_renderModelStandardQuads_8_) {
            ...
            if (!p_renderModelStandardQuads_9_.isBreakingAnimation(bakedquad)) {
                BakedQuad bakedquad1 = bakedquad;
                if (Config.isConnectedTextures()) {
                    bakedquad = ConnectedTextures.getConnectedTexture((IBlockAccess)p_renderModelStandardQuads_1_, (IBlockState)iblockstate, (BlockPos)p_renderModelStandardQuads_3_, (BakedQuad)bakedquad, (RenderEnv)p_renderModelStandardQuads_9_);
                }
                if (bakedquad == bakedquad1 && Config.isNaturalTextures()) {
                    bakedquad = NaturalTextures.getNaturalTexture((BlockPos)p_renderModelStandardQuads_3_, (BakedQuad)bakedquad);
                }
            }
            ...
            int i1 = CustomColors.getColorMultiplier((BakedQuad)bakedquad, (Block)p_renderModelStandardQuads_2_, (IBlockAccess)p_renderModelStandardQuads_1_, (BlockPos)p_renderModelStandardQuads_3_, (RenderEnv)p_renderModelStandardQuads_9_);
