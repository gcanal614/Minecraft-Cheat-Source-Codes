...
implements LayerRenderer<EntityLivingBase> {
    ...
    private void renderLayer(EntityLivingBase entitylivingbaseIn, float p_177182_2_, float p_177182_3_, float p_177182_4_, float p_177182_5_, float p_177182_6_, float p_177182_7_, float p_177182_8_, int armorSlot) {
        ...
        if (itemstack != null && itemstack.getItem() instanceof ItemArmor) {
            ...
            if (!Config.isCustomItems() || !CustomItems.bindCustomArmorTexture((ItemStack)itemstack, (int)(flag ? 2 : 1), null)) {
            ...
            if (Reflector.ForgeHooksClient_getArmorTexture.exists()) {
                ...
                if (j != -1) {
                    ...
                    if (!Config.isCustomItems() || !CustomItems.bindCustomArmorTexture((ItemStack)itemstack, (int)(flag ? 2 : 1), (String)"overlay")) {
                        this.renderer.bindTexture(this.getArmorResource(entitylivingbaseIn, itemstack, flag ? 2 : 1, "overlay"));
                    }
                }
                GlStateManager.color(this.colorR, this.colorG, this.colorB, this.alpha);
                modelbase.render(entitylivingbaseIn, p_177182_2_, p_177182_3_, p_177182_5_, p_177182_6_, p_177182_7_, p_177182_8_);
                if (!(this.field_177193_i || !itemstack.isItemEnchanted() || Config.isCustomItems() && CustomItems.renderCustomArmorEffect((EntityLivingBase)entitylivingbaseIn, (ItemStack)itemstack, (ModelBase)modelbase, (float)p_177182_2_, (float)p_177182_3_, (float)p_177182_4_, (float)p_177182_5_, (float)p_177182_6_, (float)p_177182_7_, (float)p_177182_8_))) {
    ...
    public ResourceLocation getArmorResource(Entity p_getArmorResource_1_, ItemStack p_getArmorResource_2_, int p_getArmorResource_3_, String p_getArmorResource_4_) {
        ...
        ResourceLocation resourcelocation = (ResourceLocation)ARMOR_TEXTURE_RES_MAP.get(s2 = Reflector.callString((ReflectorMethod)Reflector.ForgeHooksClient_getArmorTexture, (Object[])new Object[]{p_getArmorResource_1_, p_getArmorResource_2_, s2, p_getArmorResource_3_, p_getArmorResource_4_}));
        if (resourcelocation == null) {
