        ...
        if (!entitylivingbaseIn.getSheared() && !entitylivingbaseIn.isInvisible()) {
            ...
            if (entitylivingbaseIn.hasCustomName() && "jeb_".equals(entitylivingbaseIn.getCustomNameTag())) {
                ...
                if (Config.isCustomColors()) {
                    afloat1 = CustomColors.getSheepColors((EnumDyeColor)EnumDyeColor.byMetadata(k), (float[])afloat1);
                    afloat2 = CustomColors.getSheepColors((EnumDyeColor)EnumDyeColor.byMetadata(l), (float[])afloat2);
                }
