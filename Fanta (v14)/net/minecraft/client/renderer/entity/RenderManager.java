...
public class RenderManager {
    ...
    public RenderManager(TextureManager renderEngineIn, RenderItem itemRendererIn) {
        ...
        if (Reflector.RenderingRegistry_loadEntityRenderers.exists()) {
            Reflector.call((ReflectorMethod)Reflector.RenderingRegistry_loadEntityRenderers, (Object[])new Object[]{this.entityRenderMap});
        }
    }
    ...
    public void cacheActiveRenderInfo(World worldIn, BasicFontRenderer textRendererIn, Entity livingPlayerIn, Entity pointedEntityIn, GameSettings optionsIn, float partialTicks) {
        ...
        if (livingPlayerIn instanceof EntityLivingBase && ((EntityLivingBase)livingPlayerIn).isPlayerSleeping()) {
            ...
            if (Reflector.callBoolean((ReflectorMethod)Reflector.ForgeBlock_isBed, (Object[])new Object[]{worldIn, new BlockPos(livingPlayerIn), (EntityLivingBase)livingPlayerIn})) {
                EnumFacing enumfacing = (EnumFacing)Reflector.call((Object)block, (ReflectorMethod)Reflector.ForgeBlock_getBedDirection, (Object[])new Object[]{worldIn, new BlockPos(livingPlayerIn)});
