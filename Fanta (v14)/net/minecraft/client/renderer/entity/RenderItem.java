...
implements IResourceManagerReloadListener {
    ...
    public RenderItem(TextureManager textureManager, ModelManager modelManager) {
        ...
        this.itemModelMesher = Reflector.ItemModelMesherForge_Constructor.exists() ? (ItemModelMesher)Reflector.newInstance((ReflectorConstructor)Reflector.ItemModelMesherForge_Constructor, (Object[])new Object[]{modelManager}) : new ItemModelMesher(modelManager);
        this.registerItems();
    }
        ...
        if (stack != null) {
            ...
            if (model.isBuiltInRenderer()) {
                ...
                if (Config.isCustomItems()) {
                    model = CustomItems.getCustomItemModel((ItemStack)stack, (IBakedModel)model, (ModelResourceLocation)this.modelLocation);
                }
                GlStateManager.translate(-0.5f, -0.5f, -0.5f);
    ...
    private void renderEffect(IBakedModel model) {
        if (!(Config.isCustomItems() && !CustomItems.isUseGlint() || Config.isShaders() && Shaders.isShadowPass)) {
            ...
            this.renderModel(model, Client.INSTANCE.moduleManager.getModule("Glint").isState() ? ((ColorValue)Client.INSTANCE.moduleManager.getModule((String)"Glint").getSetting((String)"Color").getSetting()).color : -8372020);
            GlStateManager.popMatrix();
            GlStateManager.pushMatrix();
            GlStateManager.scale(8.0f, 8.0f, 8.0f);
    ...
    private void renderQuad(WorldRenderer renderer, BakedQuad quad, int color) {
        ...
        if (Reflector.IColoredBakedQuad.exists() && Reflector.IColoredBakedQuad.isInstance((Object)quad)) {
        ...
        if (stack != null && entityToRenderFor != null) {
            ...
            if (entityToRenderFor instanceof EntityPlayer) {
                ...
                if (item == Items.fishing_rod && entityplayer.fishEntity != null) {
                    ...
                    modelresourcelocation = (ModelResourceLocation)Reflector.call((Object)item, (ReflectorMethod)Reflector.ForgeItem_getModel, (Object[])new Object[]{stack, entityplayer, entityplayer.getItemInUseCount()});
                }
    ...
    protected void renderItemModelTransform(ItemStack stack, IBakedModel model, ItemCameraTransforms.TransformType cameraTransformType) {
        ...
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            model = (IBakedModel)Reflector.call((ReflectorMethod)Reflector.ForgeHooksClient_handleCameraTransforms, (Object[])new Object[]{model, cameraTransformType});
        } else {
    ...
    public void renderItemIntoGUI(ItemStack stack, int x, int y) {
        ...
        if (Reflector.ForgeHooksClient_handleCameraTransforms.exists()) {
            ibakedmodel = (IBakedModel)Reflector.call((ReflectorMethod)Reflector.ForgeHooksClient_handleCameraTransforms, (Object[])new Object[]{ibakedmodel, ItemCameraTransforms.TransformType.GUI});
        } else {
    ...
    public void renderItemOverlayIntoGUI(BasicFontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                GlStateManager.disableBlend();
                Client.INSTANCE.unicodeBasicFontRenderer.drawStringWithShadow(s, xPosition + 19 - 2 - Client.INSTANCE.unicodeBasicFontRenderer.getStringWidth(s), yPosition + 6, 0xFFFFFF);
                GlStateManager.enableLighting();
                GlStateManager.enableDepth();
            }
            boolean flag = stack.isItemDamaged();
            if (Reflector.ForgeItem_showDurabilityBar.exists()) {
                flag = Reflector.callBoolean((Object)stack.getItem(), (ReflectorMethod)Reflector.ForgeItem_showDurabilityBar, (Object[])new Object[]{stack});
            }
            if (flag) {
                ...
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    double d0 = Reflector.callDouble((Object)stack.getItem(), (ReflectorMethod)Reflector.ForgeItem_getDurabilityForDisplay, (Object[])new Object[]{stack});
