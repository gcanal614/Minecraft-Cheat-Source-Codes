 ...
 *  shadersmod.client.SVertexFormat
 */
...
public class DefaultVertexFormats {
    ...
    public static void updateVertexFormats() {
        ...
        if (Reflector.Attributes_DEFAULT_BAKED_FORMAT.exists()) {
            ...
            VertexFormat vertexformat1 = (VertexFormat)Reflector.getFieldValue((ReflectorField)Reflector.Attributes_DEFAULT_BAKED_FORMAT);
            vertexformat1.clear();
            int i = 0;
