...
public class TextureAtlasSprite {
    ...
    public void loadSprite(BufferedImage[] images, AnimationMetadataSection meta) throws IOException {
        ...
        if (!this.isShadersSprite) {
            ...
            int l1 = 0;
            while (l1 < this.framesTextureData.size()) {
        ...
        if (Shaders.configNormalMap) {
            ...
            if (Config.hasResource((ResourceLocation)resourcelocation)) {
                try {
                    ...
                    Config.warn((String)("Error loading normal texture: " + s));
                    Config.warn((String)(String.valueOf(ioexception1.getClass().getName()) + ": " + ioexception1.getMessage()));
                }
            }
        }
        if (Shaders.configSpecularMap) {
            ...
            if (Config.hasResource((ResourceLocation)resourcelocation1)) {
                try {
                    ...
                    Config.warn((String)("Error loading specular texture: " + s1));
                    Config.warn((String)(String.valueOf(ioexception.getClass().getName()) + ": " + ioexception.getMessage()));
                }
            }
        }
    }
    ...
    public void loadShaderSpriteFrames(ResourceLocation p_loadShaderSpriteFrames_1_, int p_loadShaderSpriteFrames_2_) throws IOException {
        IResource iresource = Config.getResource((ResourceLocation)p_loadShaderSpriteFrames_1_);
