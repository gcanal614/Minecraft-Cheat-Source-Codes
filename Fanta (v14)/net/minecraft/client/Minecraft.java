...
IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.standardGalacticBasicFontRenderer = new FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii_sga.png"), this.renderEngine, false);
        ...
        this.displayGuiScreen(new GuiLoginFlux(new GuiMainMenu()));
    ...
    private void updateDebugProfilerName(int keyCount) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            if (keyCount == 0) {
                ...
                this.debugProfilerName = String.valueOf(this.debugProfilerName) + ((Profiler.Result)list.get((int)keyCount)).field_76331_c;
            }
        }
    }
    ...
    public void clickMouse() {
        block21: {
            block20: {
                block22: {
                    if (ViaMCP.getInstance().getVersion() != 47) break block20;
                    if (this.leftClickCounter > 0) break block21;
                    try {
                        this.thePlayer.swingItem();
                    }
                    catch (Exception exception) {
                    ...
                    if (this.objectMouseOver != null) break block22;
    ...
    public void runTick() throws IOException {
        block107: {
            block108: {
                ...
                if (this.currentScreen != null && !this.currentScreen.allowUserInput) break block107;
                ...
                while (Keyboard.next()) {
                    ...
                    try {
                        Client.INSTANCE.onEvent(new EventKey(k, EventKey.PressType.HELT));
                    }
                    catch (Exception i1) {
                        // empty catch block
                    }
                    ...
                    if (Keyboard.getEventKeyState()) {
                        if (k == 54 && this.currentScreen == null) {
                            this.displayGuiScreen(Client.clickGui);
                            Client.clickGui.activ = true;
                        }
                        for (Module mod : Client.INSTANCE.moduleManager.modules) {
                            if (k != mod.getKeyBind()) continue;
                            mod.setState();
                        }
                        KeyBinding.onTick(k);
                    }
                    ...
                    if (this.currentScreen != null) {
                        ...
                        try {
                            Client.INSTANCE.onEvent(new EventKey(k, EventKey.PressType.PRESSED));
                        }
                        catch (Exception mod) {
                            // empty catch block
                        }
                ...
                eventCLickMouse = new EventClickMouse(this.thePlayer.inventory.currentItem);
                oldSlot = this.thePlayer.inventory.currentItem;
                Client.INSTANCE.onEvent(eventCLickMouse);
                this.thePlayer.inventory.currentItem = eventCLickMouse.getSlot();
                if (!this.thePlayer.isUsingItem()) ** GOTO lbl221
...
lbl222:
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            EntityPlayerSP.movementInput = new MovementInputFromOptions(this.gameSettings);
    ...
    public MusicTicker.MusicType getAmbientMusicType() {
        return this.thePlayer != null ? (EntityPlayerSP.worldObj.provider instanceof WorldProviderHell ? MusicTicker.MusicType.NETHER : (EntityPlayerSP.worldObj.provider instanceof WorldProviderEnd ? (BossStatus.bossName != null && BossStatus.statusBarTime > 0 ? MusicTicker.MusicType.END_BOSS : MusicTicker.MusicType.END) : (this.thePlayer.capabilities.isCreativeMode && this.thePlayer.capabilities.allowFlying ? MusicTicker.MusicType.CREATIVE : MusicTicker.MusicType.GAME))) : MusicTicker.MusicType.MENU;
    }
