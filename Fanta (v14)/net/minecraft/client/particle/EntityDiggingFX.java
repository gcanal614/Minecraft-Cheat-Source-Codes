...
extends EntityFX {
    ...
    public EntityDiggingFX func_174846_a(BlockPos pos) {
        ...
        int i = this.field_174847_a.getBlock().colorMultiplier(worldObj, pos);
    ...
    public int getBrightnessForRender(float partialTicks) {
        ...
        int j = 0;
        if (worldObj.isBlockLoaded(this.field_181019_az)) {
            j = worldObj.getCombinedLight(this.field_181019_az, 0);
        }
        return i == 0 ? j : i;
    }
