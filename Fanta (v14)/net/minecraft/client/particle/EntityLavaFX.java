...
extends EntityFX {
    ...
    protected EntityLavaFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn) {
        ...
        this.motionY = rand.nextFloat() * 0.4f + 0.05f;
    ...
    public void onUpdate() {
        ...
        if (rand.nextFloat() > f) {
            worldObj.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, this.posX, this.posY, this.posZ, this.motionX, this.motionY, this.motionZ, new int[0]);
        }
        this.motionY -= 0.03;
