...
public class EntityFirework {
    ...
    extends EntityFX {
        ...
        public SparkFX(World p_i46465_1_, double p_i46465_2_, double p_i46465_4_, double p_i46465_6_, double p_i46465_8_, double p_i46465_10_, double p_i46465_12_, EffectRenderer p_i46465_14_) {
            ...
            this.particleMaxAge = 48 + rand.nextInt(12);
            this.noClip = false;
        }
        ...
        public void onUpdate() {
            ...
            if (this.trail && this.particleAge < this.particleMaxAge / 2 && (this.particleAge + this.particleMaxAge) % 2 == 0) {
                SparkFX entityfirework$sparkfx = new SparkFX(worldObj, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0, this.field_92047_az);
                entityfirework$sparkfx.setAlphaF(0.99f);
    ...
    extends EntityFX {
        ...
        public void onUpdate() {
            if (this.fireworkAge == 0 && this.fireworkExplosions != null) {
                ...
                worldObj.playSound(this.posX, this.posY, this.posZ, s1, 20.0f, 0.95f + rand.nextFloat() * 0.1f, true);
            }
            if (this.fireworkAge % 2 == 0 && this.fireworkExplosions != null && this.fireworkAge / 2 < this.fireworkExplosions.tagCount()) {
                ...
                OverlayFX entityfirework$overlayfx = new OverlayFX(worldObj, this.posX, this.posY, this.posZ);
            ...
            if (this.fireworkAge > this.particleMaxAge) {
                if (this.twinkle) {
                    ...
                    worldObj.playSound(this.posX, this.posY, this.posZ, s, 20.0f, 0.9f + rand.nextFloat() * 0.15f, true);
                }
                this.setDead();
            }
        }
        ...
        private void createParticle(double p_92034_1_, double p_92034_3_, double p_92034_5_, double p_92034_7_, double p_92034_9_, double p_92034_11_, int[] p_92034_13_, int[] p_92034_14_, boolean p_92034_15_, boolean p_92034_16_) {
            SparkFX entityfirework$sparkfx = new SparkFX(worldObj, p_92034_1_, p_92034_3_, p_92034_5_, p_92034_7_, p_92034_9_, p_92034_11_, this.theEffectRenderer);
            entityfirework$sparkfx.setAlphaF(0.99f);
        ...
        private void createBall(double speed, int size, int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn) {
            ...
            while (i <= size) {
                ...
                while (j <= size) {
                    int k = -size;
                    while (k <= size) {
                        double d3 = (double)j + (rand.nextDouble() - rand.nextDouble()) * 0.5;
                        double d4 = (double)i + (rand.nextDouble() - rand.nextDouble()) * 0.5;
                        double d5 = (double)k + (rand.nextDouble() - rand.nextDouble()) * 0.5;
                        double d6 = (double)MathHelper.sqrt_double(d3 * d3 + d4 * d4 + d5 * d5) / speed + rand.nextGaussian() * 0.05;
        ...
        private void createBurst(int[] colours, int[] fadeColours, boolean trail, boolean twinkleIn) {
            ...
            double d1 = rand.nextGaussian() * 0.05;
            int i = 0;
            while (i < 70) {
                double d2 = this.motionX * 0.5 + rand.nextGaussian() * 0.15 + d0;
                double d3 = this.motionZ * 0.5 + rand.nextGaussian() * 0.15 + d1;
                double d4 = this.motionY * 0.5 + rand.nextDouble() * 0.5;
