...
extends EntityFX {
    ...
    protected EntityFlameFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
        ...
        this.posX += (double)((rand.nextFloat() - rand.nextFloat()) * 0.05f);
        this.posY += (double)((rand.nextFloat() - rand.nextFloat()) * 0.05f);
        this.posZ += (double)((rand.nextFloat() - rand.nextFloat()) * 0.05f);
