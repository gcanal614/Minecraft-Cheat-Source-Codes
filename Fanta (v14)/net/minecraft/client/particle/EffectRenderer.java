...
public class EffectRenderer {
        ...
        while (i < 3) {
            ...
            while (k < 2) {
                if (!this.fxLayers[j][k].isEmpty()) {
                    ...
                    int l = 0;
                    while (l < this.fxLayers[j][k].size()) {
    ...
    public void addBlockDestroyEffects(BlockPos pos, IBlockState state) {
        ...
        if (Reflector.ForgeBlock_addDestroyEffects.exists() && Reflector.ForgeBlock_isAir.exists()) {
            ...
            Reflector.callBoolean((Object)block, (ReflectorMethod)Reflector.ForgeBlock_isAir, (Object[])new Object[]{this.worldObj, pos});
    ...
    public void addBlockHitEffects(BlockPos p_addBlockHitEffects_1_, MovingObjectPosition p_addBlockHitEffects_2_) {
        ...
        boolean flag = Reflector.callBoolean((Object)block, (ReflectorMethod)Reflector.ForgeBlock_addHitEffects, (Object[])new Object[]{this.worldObj, p_addBlockHitEffects_2_, this});
        if (block != null && !flag) {
