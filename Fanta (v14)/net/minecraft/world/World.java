...
implements IBlockAccess {
        ...
        while (k1 < j) {
            ...
            while (l1 < l) {
                ...
                while (i2 < j1) {
                    ...
                    Block block = iblockstate.getBlock();
                    if (block.getMaterial() == materialIn && (double)l >= (d0 = (double)((float)(l1 + 1) - BlockLiquid.getLiquidHeightPercent(iblockstate.getValue(BlockLiquid.LEVEL))))) {
                        flag = true;
    ...
    public EntityPlayer getClosestPlayer(double x, double y, double z, double distance) {
        ...
        while (i < this.playerEntities.size()) {
            ...
            if (EntitySelectors.NOT_SPECTATING.apply((Object)entityplayer1)) {
