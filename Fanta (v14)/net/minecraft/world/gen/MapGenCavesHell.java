                        ...
                        while (i3 < k) {
                            ...
                            while (j3 < i1) {
                                ...
                                while (i2 > k2) {
                                    ...
                                    if (d9 > -0.7 && d10 * d10 + d9 * d9 + d8 * d8 < 1.0 && ((iblockstate1 = p_180704_5_.getBlockState(i3, i2, j3)).getBlock() == Blocks.netherrack || iblockstate1.getBlock() == Blocks.dirt || iblockstate1.getBlock() == Blocks.grass)) {
