...
public class ComponentScatteredFeaturePieces {
    ...
    extends Feature {
        ...
        public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
            ...
            int j2 = 0;
            while (j2 < this.scatteredFeatureSizeX) {
                int j = 0;
                while (j < this.scatteredFeatureSizeZ) {
                    int k = -5;
            ...
            int j3 = 0;
            while (j3 <= this.scatteredFeatureSizeX - 1) {
                ...
                j3 += this.scatteredFeatureSizeX - 1;
            }
            int k3 = 2;
            while (k3 <= this.scatteredFeatureSizeX - 3) {
                ...
                this.setBlockState(worldIn, Blocks.sandstone.getStateFromMeta(BlockSandStone.EnumType.SMOOTH.getMetadata()), k3 + 1, 8, 0, structureBoundingBoxIn);
                k3 += this.scatteredFeatureSizeX - 3 - 2;
            }
