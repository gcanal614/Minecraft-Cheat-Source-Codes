    ...
    extends StructureComponent {
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            while (k < this.boundingBox.getXSize()) {
                if ((k += rand.nextInt(this.boundingBox.getXSize())) + 3 > this.boundingBox.getXSize()) break;
            ...
            while (k < this.boundingBox.getZSize()) {
                if ((k += rand.nextInt(this.boundingBox.getZSize())) + 3 > this.boundingBox.getZSize()) break;
