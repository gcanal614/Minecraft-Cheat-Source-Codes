...
public class StructureOceanMonumentPieces {
    ...
    extends Piece {
        ...
        private List<RoomDefinition> func_175836_a(Random p_175836_1_) {
                ...
                while (j3 < 5) {
                    ...
                    while (i4 < 3) {
                        ...
                        if (astructureoceanmonumentpieces$roomdefinition[l4] != null) {
                            ...
                            while (n < n2) {
                                int l1;
                                EnumFacing enumfacing = objectArray[n];
            ...
            n2 = astructureoceanmonumentpieces$roomdefinition.length;
            n = 0;
            while (n < n2) {
                Object structureoceanmonumentpieces$roomdefinition4 = objectArray[n];
