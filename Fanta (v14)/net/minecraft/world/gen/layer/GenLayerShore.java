        ...
        while (i < areaHeight) {
            ...
            while (j < areaWidth) {
                ...
                if (k == BiomeGenBase.mushroomIsland.biomeID) {
                    ...
                    aint1[j + i * areaWidth] = j2 != BiomeGenBase.ocean.biomeID && i3 != BiomeGenBase.ocean.biomeID && l3 != BiomeGenBase.ocean.biomeID && k4 != BiomeGenBase.ocean.biomeID ? k : BiomeGenBase.mushroomIslandShore.biomeID;
                    ...
                    aint1[j + i * areaWidth] = this.func_151631_c(i2) && this.func_151631_c(l2) && this.func_151631_c(k3) && this.func_151631_c(j4) ? (!(GenLayerShore.isBiomeOceanic(i2) || GenLayerShore.isBiomeOceanic(l2) || GenLayerShore.isBiomeOceanic(k3) || GenLayerShore.isBiomeOceanic(j4)) ? k : BiomeGenBase.beach.biomeID) : BiomeGenBase.jungleEdge.biomeID;
                    ...
                    if (biomegenbase != null && biomegenbase.isSnowyBiome()) {
                        ...
                        if (k != BiomeGenBase.ocean.biomeID && k != BiomeGenBase.deepOcean.biomeID && k != BiomeGenBase.river.biomeID && k != BiomeGenBase.swampland.biomeID) {
                            ...
                            aint1[j + i * areaWidth] = !(GenLayerShore.isBiomeOceanic(l1) || GenLayerShore.isBiomeOceanic(k2) || GenLayerShore.isBiomeOceanic(j3) || GenLayerShore.isBiomeOceanic(i4)) ? k : BiomeGenBase.beach.biomeID;
                        } else {
                        ...
                        aint1[j + i * areaWidth] = !(GenLayerShore.isBiomeOceanic(l) || GenLayerShore.isBiomeOceanic(i1) || GenLayerShore.isBiomeOceanic(j1) || GenLayerShore.isBiomeOceanic(k1)) ? (this.func_151633_d(l) && this.func_151633_d(i1) && this.func_151633_d(j1) && this.func_151633_d(k1) ? k : BiomeGenBase.desert.biomeID) : k;
                    }
                } else {
