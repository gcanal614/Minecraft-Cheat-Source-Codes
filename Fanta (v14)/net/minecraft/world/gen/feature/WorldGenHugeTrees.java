...
extends WorldGenAbstractTree {
    ...
    protected void func_175925_a(World worldIn, BlockPos p_175925_2_, int p_175925_3_) {
        ...
        while (j <= p_175925_3_ + 1) {
            int k = -p_175925_3_;
            while (k <= p_175925_3_ + 1) {
                BlockPos blockpos;
                Material material;
                int l = j - 1;
                int i1 = k - 1;
                if (!(j * j + k * k > i && l * l + i1 * i1 > i && j * j + i1 * i1 > i && l * l + k * k > i || (material = worldIn.getBlockState(blockpos = p_175925_2_.add(j, 0, k)).getBlock().getMaterial()) != Material.air && material != Material.leaves)) {
    ...
    protected void func_175928_b(World worldIn, BlockPos p_175928_2_, int p_175928_3_) {
        ...
        while (j <= p_175928_3_) {
            ...
            while (k <= p_175928_3_) {
                BlockPos blockpos;
                Material material;
                if (j * j + k * k <= i && ((material = worldIn.getBlockState(blockpos = p_175928_2_.add(j, 0, k)).getBlock().getMaterial()) == Material.air || material == Material.leaves)) {
                    this.setBlockAndNotifyAdequately(worldIn, blockpos, this.leavesMetadata);
                }
                ++k;
            }
