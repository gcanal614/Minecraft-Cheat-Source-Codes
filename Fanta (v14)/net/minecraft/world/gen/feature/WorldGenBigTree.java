        ...
        while (k >= 0) {
            ...
            if (f >= 0.0f) {
                ...
                while (l < i) {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1 = blockpos.up(this.leafDistanceLimit)) == -1) {
    ...
    void func_181631_a(BlockPos p_181631_1_, float p_181631_2_, IBlockState p_181631_3_) {
        ...
        while (j <= i) {
            ...
            while (k <= i) {
                BlockPos blockpos;
                Material material;
                if (Math.pow((double)Math.abs(j) + 0.5, 2.0) + Math.pow((double)Math.abs(k) + 0.5, 2.0) <= (double)(p_181631_2_ * p_181631_2_) && ((material = this.world.getBlockState(blockpos = p_181631_1_.add(j, 0, k)).getBlock().getMaterial()) == Material.air || material == Material.leaves)) {
