...
extends WorldGenAbstractTree {
                ...
                while (i3 <= position.getY() + i) {
                    ...
                    while (k1 <= position.getX() + j1) {
                        ...
                        while (i2 <= position.getZ() + j1) {
                            ...
                            if ((Math.abs(l1) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) && ((block = worldIn.getBlockState(blockpos = new BlockPos(k1, i3, i2)).getBlock()).getMaterial() == Material.air || block.getMaterial() == Material.leaves || block.getMaterial() == Material.vine)) {
    ...
    private void func_181650_b(World p_181650_1_, BlockPos p_181650_2_, PropertyBool p_181650_3_) {
        ...
        while (p_181650_1_.getBlockState(p_181650_2_).getBlock().getMaterial() == Material.air && i > 0) {
            this.func_181651_a(p_181650_1_, p_181650_2_, p_181650_3_);
            p_181650_2_ = p_181650_2_.down();
            --i;
        }
