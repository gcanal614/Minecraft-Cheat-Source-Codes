...
public final class SpawnerAnimals {
    ...
    public int findChunksForSpawning(WorldServer p_77192_1_, boolean spawnHostileMobs, boolean spawnPeacefulMobs, boolean p_77192_4_) {
        ...
        int n = enumCreatureTypeArray.length;
        int n2 = 0;
        while (n2 < n) {
            int k4;
            int j4;
            EnumCreatureType enumcreaturetype = enumCreatureTypeArray[n2];
            if (!(enumcreaturetype.getPeacefulCreature() && !spawnPeacefulMobs || !enumcreaturetype.getPeacefulCreature() && !spawnHostileMobs || enumcreaturetype.getAnimal() && !p_77192_4_ || (j4 = p_77192_1_.countEntities(enumcreaturetype.getCreatureClass())) > (k4 = enumcreaturetype.getMaxNumberOfCreature() * i / MOB_COUNT_DIV))) {
                block6: for (ChunkCoordIntPair chunkcoordintpair1 : this.eligibleChunksForSpawning) {
                    ...
                    while (k2 < 3) {
                        ...
                        while (l3 < 4) {
                            ...
                            if (!p_77192_1_.isAnyPlayerWithinRangeAt(f, i3, f1, 24.0) && blockpos2.distanceSq(f, i3, f1) >= 576.0) {
                                if (biomegenbase$spawnlistentry == null && (biomegenbase$spawnlistentry = p_77192_1_.getSpawnListEntryForTypeAt(enumcreaturetype, blockpos1)) == null) break;
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EntityLiving.SpawnPlacementType p_180267_0_, World worldIn, BlockPos pos) {
        ...
        boolean bl = flag = block1 != Blocks.bedrock && block1 != Blocks.barrier;
