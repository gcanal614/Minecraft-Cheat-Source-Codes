...
extends Block {
    ...
    public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state) {
        if (Client.INSTANCE.moduleManager.getModule("Jesus").isState() && ((DropdownBox)Client.INSTANCE.moduleManager.getModule((String)"Jesus").getSetting((String)"Modes").getSetting()).curOption == "Solid") {
