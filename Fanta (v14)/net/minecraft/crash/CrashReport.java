...
public class CrashReport {
    ...
    private void populateEnvironment() {
        ...
        if (Reflector.FMLCommonHandler_enhanceCrashReport.exists()) {
            ...
            Reflector.callString((Object)object, (ReflectorMethod)Reflector.FMLCommonHandler_enhanceCrashReport, (Object[])new Object[]{this, this.theReportCategory});
        }
    }
    ...
    public String getCompleteReport() {
        if (!this.reported) {
            this.reported = true;
            CrashReporter.onCrashReport((CrashReport)this, (CrashReportCategory)this.theReportCategory);
        }
        StringBuilder stringbuilder = new StringBuilder();
        stringbuilder.append("---- Minecraft Crash Report ----\n");
        Reflector.call((ReflectorMethod)Reflector.BlamingTransformer_onCrash, (Object[])new Object[]{stringbuilder});
