    ...
    private Entity spawnNewEntity(Entity entityIn, boolean spawn) {
        if (this.getRandomEntity() != null) {
            ...
            while (nbttagcompound.hasKey("Riding", 10)) {
                ...
                Entity entity1 = EntityList.createEntityByName(nbttagcompound2.getString("id"), Entity.worldObj);
                if (entity1 != null) {
                    ...
                    if (Entity.worldObj != null && spawn) {
                        Entity.worldObj.spawnEntityInWorld(entity1);
                    }
        ...
        } else if (entityIn instanceof EntityLivingBase && Entity.worldObj != null && spawn) {
            if (entityIn instanceof EntityLiving) {
                ((EntityLiving)entityIn).onInitialSpawn(Entity.worldObj.getDifficultyForLocation(new BlockPos(entityIn)), null);
            }
            Entity.worldObj.spawnEntityInWorld(entityIn);
        }
        return entityIn;
