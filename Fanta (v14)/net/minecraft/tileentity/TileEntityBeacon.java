...
IInventory {
    ...
    private void updateSegmentColors() {
        ...
        tileentitybeacon$beamsegment = new BeamSegment(EntitySheep.func_175513_a(EnumDyeColor.WHITE));
        ...
        while (i1 < 256) {
            block15: {
                iblockstate = this.worldObj.getBlockState(blockpos$mutableblockpos.func_181079_c(j, i1, l));
        ...
        if (this.isComplete) {
            ...
            while (l1 <= 4) {
                ...
                while (j1 <= j + l1 && flag1) {
                    k1 = l - l1;
                    while (k1 <= l + l1) {
                        block = this.worldObj.getBlockState(new BlockPos(j1, i2, k1)).getBlock();
