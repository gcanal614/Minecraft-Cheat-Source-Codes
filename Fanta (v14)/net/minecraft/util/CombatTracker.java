...
public class CombatTracker {
    ...
    public void func_94545_a() {
        ...
        if (this.fighter.isOnLadder()) {
            Block block = EntityLivingBase.worldObj.getBlockState(new BlockPos(this.fighter.posX, this.fighter.getEntityBoundingBox().minY, this.fighter.posZ)).getBlock();
    ...
    private CombatEntry func_94544_f() {
        ...
        float f = 0.0f;
        int j = 0;
        while (j < this.combatEntries.size()) {
