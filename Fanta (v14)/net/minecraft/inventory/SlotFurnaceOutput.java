...
extends Slot {
    ...
    protected void onCrafting(ItemStack stack) {
        stack.onCrafting(EntityPlayer.worldObj, this.thePlayer, this.field_75228_b);
        if (!EntityPlayer.worldObj.isRemote) {
            ...
            while (i > 0) {
                ...
                i -= k;
                EntityPlayer.worldObj.spawnEntityInWorld(new EntityXPOrb(EntityPlayer.worldObj, this.thePlayer.posX, this.thePlayer.posY + 0.5, this.thePlayer.posZ + 0.5, k));
            }
        }
