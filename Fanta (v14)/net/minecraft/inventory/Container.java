    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer playerIn) {
        ...
        if (mode == 5) {
            ...
            if (!(itemstack4 == null || slot2 != null && slot2.getHasStack() && slot2.canTakeStack(playerIn))) {
                ...
                while (l2 < 2) {
                    int i3 = i1;
                    while (i3 >= 0 && i3 < this.inventorySlots.size() && itemstack4.stackSize < itemstack4.getMaxStackSize()) {
                        Slot slot8 = this.inventorySlots.get(i3);
                        if (slot8.getHasStack() && Container.canAddItemToSlot(slot8, itemstack4, true) && slot8.canTakeStack(playerIn) && this.canMergeSlot(itemstack4, slot8) && (l2 != 0 || slot8.getStack().stackSize != slot8.getStack().getMaxStackSize())) {
