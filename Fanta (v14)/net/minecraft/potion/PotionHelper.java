...
public class PotionHelper {
    ...
    public static int calcPotionLiquidColor(Collection p_77911_0_) {
        ...
        if (p_77911_0_ != null && !p_77911_0_.isEmpty()) {
            ...
            for (Object potioneffect0 : p_77911_0_) {
                ...
                if (Config.isCustomColors()) {
                    j = CustomColors.getPotionColor((int)potioneffect.getPotionID(), (int)j);
                }
                int k = 0;
        ...
        if (Config.isCustomColors()) {
            i = CustomColors.getPotionColor((int)0, (int)i);
        }
        return i;
    }
    ...
    public static List getPotionEffects(int p_77917_0_, boolean p_77917_1_) {
        ...
        while (n2 < n) {
            ...
            if (potion != null && (!potion.isUsable() || p_77917_1_) && (s = (String)potionRequirements.get(potion.getId())) != null && (i = PotionHelper.parsePotionEffects(s, 0, s.length(), p_77917_0_)) > 0) {
                int j = 0;
