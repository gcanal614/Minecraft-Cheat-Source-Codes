...
implements IAdminCommand {
    ...
    public void notifyOperators(ICommandSender sender, ICommand command, int flags, String msgFormat, Object ... msgParams) {
        ...
        boolean bl3 = minecraftserver.worldServers[0].getGameRules().getBoolean("sendCommandFeedback");
        if (sender instanceof CommandBlockLogic) {
            bl = ((CommandBlockLogic)sender).shouldTrackOutput();
        }
        if ((flags & 1) != 1 && bl || sender instanceof MinecraftServer) {
