...
implements IAnimals {
    ...
    public void onLivingUpdate() {
        ...
        if (this.inLove > 0) {
            ...
            if (this.inLove % 10 == 0) {
                ...
                worldObj.spawnParticle(EnumParticleTypes.HEART, this.posX + (double)(rand.nextFloat() * this.width * 2.0f) - (double)this.width, this.posY + 0.5 + (double)(rand.nextFloat() * this.height), this.posZ + (double)(rand.nextFloat() * this.width * 2.0f) - (double)this.width, d0, d1, d2, new int[0]);
            }
        }
    }
    ...
    public boolean getCanSpawnHere() {
        ...
        return worldObj.getBlockState(blockpos.down()).getBlock() == this.spawnableBlock && worldObj.getLight(blockpos) > 8 && super.getCanSpawnHere();
    }
    ...
    protected int getExperiencePoints(EntityPlayer player) {
        return 1 + EntityAnimal.worldObj.rand.nextInt(3);
    }
