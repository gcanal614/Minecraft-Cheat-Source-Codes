...
extends EntityAnimal {
    ...
    public void onLivingUpdate() {
        if (EntitySheep.worldObj.isRemote) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        this.setFleeceColor(EntitySheep.getRandomSheepColor(EntitySheep.worldObj.rand));
        return livingdata;
    }
    ...
    private EnumDyeColor getDyeColorMixFromParents(EntityAnimal father, EntityAnimal mother) {
        ...
        EntitySheep cfr_ignored_0 = (EntitySheep)father;
        ItemStack itemstack = CraftingManager.getInstance().findMatchingRecipe(this.inventoryCrafting, worldObj);
        int k = itemstack != null && itemstack.getItem() == Items.dye ? itemstack.getMetadata() : (EntitySheep.worldObj.rand.nextBoolean() ? i : j);
