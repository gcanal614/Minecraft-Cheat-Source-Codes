...
extends EntityTameable {
    ...
    protected String getLivingSound() {
        return this.isTamed() ? (this.isInLove() ? "mob.cat.purr" : (rand.nextInt(4) == 0 ? "mob.cat.purreow" : "mob.cat.meow")) : "";
    }
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (this.isTamed()) {
            if (this.isOwner(player) && !EntityOcelot.worldObj.isRemote && !this.isBreedingItem(itemstack)) {
            ...
            if (!EntityOcelot.worldObj.isRemote) {
                if (rand.nextInt(3) == 0) {
                    this.setTamed(true);
                    this.setTameSkin(1 + EntityOcelot.worldObj.rand.nextInt(3));
    ...
    public boolean getCanSpawnHere() {
        return EntityOcelot.worldObj.rand.nextInt(3) != 0;
    }

    @Override
    public boolean isNotColliding() {
        if (worldObj.checkNoEntityCollision(this.getEntityBoundingBox(), this) && worldObj.getCollidingBoundingBoxes(this, this.getEntityBoundingBox()).isEmpty() && !worldObj.isAnyLiquid(this.getEntityBoundingBox())) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (EntityOcelot.worldObj.rand.nextInt(7) == 0) {
            int i = 0;
            while (i < 2) {
                EntityOcelot entityocelot = new EntityOcelot(worldObj);
