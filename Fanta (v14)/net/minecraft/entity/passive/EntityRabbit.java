...
extends EntityAnimal {
    ...
    public void setJumping(boolean jump, EnumMoveType moveTypeIn) {
        ...
        if (!jump) {
            ...
            this.playSound(this.getJumpingSound(), this.getSoundVolume(), ((rand.nextFloat() - rand.nextFloat()) * 0.2f + 1.0f) * 0.8f);
        }
    ...
    public void updateAITasks() {
        ...
        if (this.carrotTicks > 0) {
            this.carrotTicks -= rand.nextInt(3);
            if (this.carrotTicks < 0) {
                this.carrotTicks = 0;
            }
        }
    ...
    public void onLivingUpdate() {
        ...
        if (this.field_175540_bm != this.field_175535_bn) {
            if (this.field_175540_bm == 0 && !EntityRabbit.worldObj.isRemote) {
    ...
    public EntityRabbit createChild(EntityAgeable ageable) {
        ...
        if (ageable instanceof EntityRabbit) {
            entityrabbit.setRabbitType(rand.nextBoolean() ? this.getRabbitType() : ((EntityRabbit)ageable).getRabbitType());
        }
        return entityrabbit;
    }
    ...
    protected void createEatingParticles() {
        worldObj.spawnParticle(EnumParticleTypes.BLOCK_DUST, this.posX + (double)(rand.nextFloat() * this.width * 2.0f) - (double)this.width, this.posY + 0.5 + (double)(rand.nextFloat() * this.height), this.posZ + (double)(rand.nextFloat() * this.width * 2.0f) - (double)this.width, 0.0, 0.0, 0.0, Block.getStateId(Blocks.carrots.getStateFromMeta(7)));
