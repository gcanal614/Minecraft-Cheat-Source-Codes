...
extends EntityWaterMob {
    ...
    public EntitySquid(World worldIn) {
        ...
        rand.setSeed(1 + this.getEntityId());
        this.rotationVelocity = 1.0f / (rand.nextFloat() + 1.0f) * 0.2f;
    ...
    public boolean isInWater() {
        return worldObj.handleMaterialAcceleration(this.getEntityBoundingBox().expand(0.0, -0.6f, 0.0), Material.water, this);
    }
    ...
    public void onLivingUpdate() {
        ...
        if ((double)this.squidRotation > Math.PI * 2) {
            if (EntitySquid.worldObj.isRemote) {
    ...
    public boolean getCanSpawnHere() {
        return this.posY > 45.0 && this.posY < (double)worldObj.func_181545_F() && super.getCanSpawnHere();
    }
