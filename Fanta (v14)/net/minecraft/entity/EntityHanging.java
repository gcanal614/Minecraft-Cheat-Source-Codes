...
extends Entity {
    ...
    public void onUpdate() {
        ...
        if (this.tickCounter1++ == 100 && !EntityHanging.worldObj.isRemote) {
            this.tickCounter1 = 0;
    ...
    public boolean onValidSurface() {
        ...
        for (Entity entity : worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox())) {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (!this.isDead && !EntityHanging.worldObj.isRemote) {
            this.setDead();
    ...
    public void moveEntity(double x, double y, double z) {
        if (!EntityHanging.worldObj.isRemote && !this.isDead && x * x + y * y + z * z > 0.0) {
            this.setDead();
            this.onBroken(null);
        }
    }
