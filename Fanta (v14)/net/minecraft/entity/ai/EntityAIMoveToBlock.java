...
extends EntityAIBase {
    ...
    public boolean continueExecuting() {
        return this.timeoutCounter >= -this.field_179490_f && this.timeoutCounter <= 1200 && this.shouldMoveTo(EntityCreature.worldObj, this.destinationBlock);
    }
    ...
    private boolean searchForDestination() {
        ...
        while (k <= 1) {
            ...
            while (l < i) {
                int i1 = 0;
                while (i1 <= l) {
                    int j1 = i1 < l && i1 > -l ? l : 0;
                    while (j1 <= l) {
                        BlockPos blockpos1 = blockpos.add(i1, k - 1, j1);
                        if (this.theEntity.isWithinHomeDistanceFromPosition(blockpos1) && this.shouldMoveTo(EntityCreature.worldObj, blockpos1)) {
                            this.destinationBlock = blockpos1;
                            return true;
                        }
                        int n = j1 = j1 > 0 ? -j1 : 1 - j1;
                    }
                    int n = i1 = i1 > 0 ? -i1 : 1 - i1;
                }
                ++l;
            }
            int n = k = k > 0 ? -k : 1 - k;
