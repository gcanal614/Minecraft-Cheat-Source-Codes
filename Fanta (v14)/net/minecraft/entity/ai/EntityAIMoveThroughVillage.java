...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        this.resizeDoorList();
        if (this.isNocturnal && EntityCreature.worldObj.isDaytime()) {
            return false;
        }
        Village village = EntityCreature.worldObj.getVillageCollection().getNearestVillage(new BlockPos(this.theEntity), 0);
        if (village == null) {
            return false;
        }
