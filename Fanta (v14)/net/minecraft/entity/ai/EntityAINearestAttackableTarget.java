...
extends EntityAITarget {
    ...
    public boolean shouldExecute() {
        ...
        List<T> list = EntityCreature.worldObj.getEntitiesWithinAABB(this.targetClass, this.taskOwner.getEntityBoundingBox().expand(d0, 4.0, d0), Predicates.and(this.targetEntitySelector, EntitySelectors.NOT_SPECTATING));
