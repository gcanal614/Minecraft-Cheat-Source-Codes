...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        List<Entity> list = EntityLiving.worldObj.getEntitiesWithinAABB(EntityPlayer.class, this.field_179434_b.getEntityBoundingBox().expand(d0, 4.0, d0), this.field_179435_c);
