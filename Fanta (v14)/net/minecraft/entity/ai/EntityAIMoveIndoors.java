...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if ((!EntityCreature.worldObj.isDaytime() || EntityCreature.worldObj.isRaining() && !EntityCreature.worldObj.getBiomeGenForCoords(blockpos).canSpawnLightningBolt()) && !EntityCreature.worldObj.provider.getHasNoSky()) {
            ...
            Village village = EntityCreature.worldObj.getVillageCollection().getNearestVillage(blockpos, 14);
            if (village == null) {
                return false;
            }
