            ...
            if (this.interactionDelay == 0) {
                ...
                while (i < inventorybasic.getSizeInventory()) {
                    ...
                    if (itemstack1 != null) {
                        ...
                        EntityItem entityitem = new EntityItem(EntityVillager.worldObj, this.villager.posX, d0, this.villager.posZ, itemstack1);
                        float f = 0.3f;
                        ...
                        EntityVillager.worldObj.spawnEntityInWorld(entityitem);
                        break;
                    }
                    ++i;
                }
