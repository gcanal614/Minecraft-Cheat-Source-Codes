...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        if (!EntityVillager.worldObj.isDaytime()) {
            return false;
        }
        List<EntityIronGolem> list = EntityVillager.worldObj.getEntitiesWithinAABB(EntityIronGolem.class, this.theVillager.getEntityBoundingBox().expand(6.0, 2.0, 6.0));
        if (list.isEmpty()) {
            return false;
        }
