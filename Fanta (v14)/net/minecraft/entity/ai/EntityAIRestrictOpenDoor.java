...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (EntityCreature.worldObj.isDaytime()) {
            return false;
        }
        BlockPos blockpos = new BlockPos(this.entityObj);
        Village village = EntityCreature.worldObj.getVillageCollection().getNearestVillage(blockpos, 16);
        if (village == null) {
            return false;
        }
    ...
    public boolean continueExecuting() {
        return EntityCreature.worldObj.isDaytime() ? false : !this.frontDoor.getIsDetachedFromVillageFlag() && this.frontDoor.func_179850_c(new BlockPos(this.entityObj));
    }
