...
extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        if (this.thisEntity.onGround) {
            f2 = EntityLiving.worldObj.getBlockState((BlockPos)new BlockPos((int)MathHelper.floor_float((float)((float)i)), (int)(MathHelper.floor_float((float)((float)j)) - 1), (int)MathHelper.floor_float((float)((float)k)))).getBlock().slipperiness * 0.91f;
        }
        ...
        if (i != l || k != i1) {
            boolean flag;
            Block block = EntityLiving.worldObj.getBlockState(new BlockPos(i, j, k)).getBlock();
            boolean bl = flag = !this.isStairOrSlab(block) && (block.getMaterial() != Material.air || !this.isStairOrSlab(EntityLiving.worldObj.getBlockState(new BlockPos(i, j - 1, k)).getBlock()));
            if (flag && WalkNodeProcessor.func_176170_a(EntityLiving.worldObj, this.thisEntity, l, j, i1, j1, k1, l1, false, false, true) == 0 && 1 == WalkNodeProcessor.func_176170_a(EntityLiving.worldObj, this.thisEntity, i, j + 1, k, j1, k1, l1, false, false, true) && 1 == WalkNodeProcessor.func_176170_a(EntityLiving.worldObj, this.thisEntity, l, j + 1, i1, j1, k1, l1, false, false, true)) {
