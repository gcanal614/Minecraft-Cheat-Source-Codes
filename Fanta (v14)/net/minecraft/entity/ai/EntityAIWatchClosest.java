...
extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        this.closestEntity = this.watchedClass == EntityPlayer.class ? EntityLiving.worldObj.getClosestPlayerToEntity(this.theWatcher, this.maxDistanceForPlayer) : EntityLiving.worldObj.findNearestEntityWithinAABB(this.watchedClass, this.theWatcher.getEntityBoundingBox().expand(this.maxDistanceForPlayer, 3.0, this.maxDistanceForPlayer), this.theWatcher);
