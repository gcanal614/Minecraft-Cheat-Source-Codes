...
extends EntityAITarget {
    ...
    public void startExecuting() {
        ...
        if (this.entityCallsForHelp) {
            ...
            for (EntityCreature entitycreature : EntityCreature.worldObj.getEntitiesWithinAABB(this.taskOwner.getClass(), new AxisAlignedBB(this.taskOwner.posX, this.taskOwner.posY, this.taskOwner.posZ, this.taskOwner.posX + 1.0, this.taskOwner.posY + 1.0, this.taskOwner.posZ + 1.0).expand(d0, 10.0, d0))) {
