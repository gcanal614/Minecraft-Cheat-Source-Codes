...
implements ICrafting {
    ...
    public void onUpdate() {
        ...
        if (!EntityPlayerMP.worldObj.isRemote && !this.openContainer.canInteractWith(this)) {
            this.closeScreen();
        ...
        if (!this.loadedChunks.isEmpty()) {
            ...
            while (iterator1.hasNext() && list.size() < 10) {
                ...
                if (chunkcoordintpair != null) {
                    Chunk chunk;
                    if (!worldObj.isBlockLoaded(new BlockPos(chunkcoordintpair.chunkXPos << 4, 0, chunkcoordintpair.chunkZPos << 4)) || !(chunk = worldObj.getChunkFromChunkCoords(chunkcoordintpair.chunkXPos, chunkcoordintpair.chunkZPos)).isPopulated()) continue;
                    list.add(chunk);
    ...
    public void onUpdateEntity() {
        try {
            ...
            while (i < this.inventory.getSizeInventory()) {
                ...
                if (itemstack != null && itemstack.getItem().isMap() && (packet = ((ItemMapBase)itemstack.getItem()).createMapDataPacket(itemstack, worldObj, this)) != null) {
    ...
    protected void updateBiomesExplored() {
        BiomeGenBase biomegenbase = worldObj.getBiomeGenForCoords(new BlockPos(MathHelper.floor_double(this.posX), 0, MathHelper.floor_double(this.posZ)));
    ...
    public void handleFalling(double p_71122_1_, boolean p_71122_3_) {
        ...
        if (block.getMaterial() == Material.air && ((block1 = worldObj.getBlockState(blockpos.down()).getBlock()) instanceof BlockFence || block1 instanceof BlockWall || block1 instanceof BlockFenceGate)) {
    ...
    public void displayVillagerTradeGui(IMerchant villager) {
        this.getNextWindowId();
        this.openContainer = new ContainerMerchant(this.inventory, villager, worldObj);
        this.openContainer.windowId = this.currentWindowId;
        this.openContainer.onCraftGuiOpened(this);
