...
implements IProjectile {
    ...
    public void onUpdate() {
        ...
        if (this.isInWater()) {
            ...
            while (i < 4) {
                float f4 = 0.25f;
                worldObj.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX - this.motionX * (double)f4, this.posY - this.motionY * (double)f4, this.posZ - this.motionZ * (double)f4, this.motionX, this.motionY, this.motionZ, new int[0]);
                ++i;
            }
            f2 = 0.8f;
        }
    ...
    public EntityLivingBase getThrower() {
        if (this.thrower == null && this.throwerName != null && this.throwerName.length() > 0) {
            this.thrower = worldObj.getPlayerEntityByName(this.throwerName);
            if (this.thrower == null && worldObj instanceof WorldServer) {
                try {
                    Entity entity = ((WorldServer)worldObj).getEntityFromUuid(UUID.fromString(this.throwerName));
