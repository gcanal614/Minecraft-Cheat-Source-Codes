...
extends EntityFireball {
    ...
    protected void onImpact(MovingObjectPosition movingObject) {
        if (!EntityWitherSkull.worldObj.isRemote) {
            ...
            worldObj.newExplosion(this, this.posX, this.posY, this.posZ, 1.0f, false, worldObj.getGameRules().getBoolean("mobGriefing"));
            this.setDead();
        }
    }
