...
extends EntityThrowable {
    ...
    protected void onImpact(MovingObjectPosition p_70184_1_) {
        if (!EntityPotion.worldObj.isRemote) {
            ...
            if (list != null && !list.isEmpty() && !(list1 = worldObj.getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb = this.getEntityBoundingBox().expand(4.0, 2.0, 4.0))).isEmpty()) {
            ...
            worldObj.playAuxSFX(2002, new BlockPos(this), this.getPotionDamage());
            this.setDead();
        }
    }
