...
extends EntityCreature {
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.spawn_egg) {
            ...
            if (!EntityAgeable.worldObj.isRemote && (oclass = EntityList.getClassFromID(itemstack.getMetadata())) != null && this.getClass() == oclass && (entityageable = this.createChild(this)) != null) {
    ...
    public int getGrowingAge() {
        return EntityAgeable.worldObj.isRemote ? (int)this.dataWatcher.getWatchableObjectByte(12) : this.growingAge;
    }
    ...
    public void onLivingUpdate() {
        ...
        if (EntityAgeable.worldObj.isRemote) {
            if (this.field_175503_c > 0) {
                if (this.field_175503_c % 4 == 0) {
                    worldObj.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, this.posX + (double)(rand.nextFloat() * this.width * 2.0f) - (double)this.width, this.posY + 0.5 + (double)(rand.nextFloat() * this.height), this.posZ + (double)(rand.nextFloat() * this.width * 2.0f) - (double)this.width, 0.0, 0.0, 0.0, new int[0]);
                }
                --this.field_175503_c;
            }
            this.setScaleForAge(this.isChild());
