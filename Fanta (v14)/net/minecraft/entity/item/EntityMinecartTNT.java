...
extends EntityMinecart {
    ...
    public void killMinecart(DamageSource p_94095_1_) {
        ...
        if (!p_94095_1_.isExplosion() && worldObj.getGameRules().getBoolean("doEntityDrops")) {
    ...
    protected void explodeCart(double p_94103_1_) {
        if (!EntityMinecartTNT.worldObj.isRemote) {
            double d0 = Math.sqrt(p_94103_1_);
            if (d0 > 5.0) {
                d0 = 5.0;
            }
            worldObj.createExplosion(this, this.posX, this.posY, this.posZ, (float)(4.0 + rand.nextDouble() * 1.5 * d0), true);
            this.setDead();
        }
    }
