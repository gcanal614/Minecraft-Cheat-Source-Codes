...
extends Entity {
    ...
    public void onUpdate() {
        ...
        if (this.xpTargetColor < this.xpColor - 20 + this.getEntityId() % 100) {
            if (this.closestPlayer == null || this.closestPlayer.getDistanceSqToEntity(this) > d0 * d0) {
                this.closestPlayer = worldObj.getClosestPlayerToEntity(this, d0);
            }
        ...
        float f = 0.98f;
        if (this.onGround) {
            f = EntityXPOrb.worldObj.getBlockState((BlockPos)new BlockPos((int)MathHelper.floor_double((double)this.posX), (int)(MathHelper.floor_double((double)this.getEntityBoundingBox().minY) - 1), (int)MathHelper.floor_double((double)this.posZ))).getBlock().slipperiness * 0.98f;
        }
    ...
    public boolean handleWaterMovement() {
        return worldObj.handleMaterialAcceleration(this.getEntityBoundingBox(), Material.water, this);
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!EntityXPOrb.worldObj.isRemote && this.delayBeforeCanPickup == 0 && entityIn.xpCooldown == 0) {
