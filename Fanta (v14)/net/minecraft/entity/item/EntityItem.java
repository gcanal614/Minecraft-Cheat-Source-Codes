...
extends Entity {
        ...
        if (this.getEntityItem() == null) {
            ...
            if (flag || this.ticksExisted % 25 == 0) {
                if (worldObj.getBlockState(new BlockPos(this)).getBlock().getMaterial() == Material.lava) {
                    ...
                    this.playSound("random.fizz", 0.4f, 2.0f + rand.nextFloat() * 0.4f);
                }
            ...
            float f = 0.98f;
            if (this.onGround) {
                f = EntityItem.worldObj.getBlockState((BlockPos)new BlockPos((int)MathHelper.floor_double((double)this.posX), (int)(MathHelper.floor_double((double)this.getEntityBoundingBox().minY) - 1), (int)MathHelper.floor_double((double)this.posZ))).getBlock().slipperiness * 0.98f;
            }
            ...
            if (!EntityItem.worldObj.isRemote && this.age >= 6000) {
                this.setDead();
            }
        }
    }
    ...
    private void searchForOtherItemsNearby() {
        for (EntityItem entityitem : worldObj.getEntitiesWithinAABB(EntityItem.class, this.getEntityBoundingBox().expand(0.5, 0.0, 0.5))) {
    ...
    public boolean handleWaterMovement() {
        if (worldObj.handleMaterialAcceleration(this.getEntityBoundingBox(), Material.water, this)) {
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!EntityItem.worldObj.isRemote) {
            ...
            if (this.delayBeforeCanPickup == 0 && (this.owner == null || 6000 - this.age <= 200 || this.owner.equals(entityIn.getName())) && entityIn.inventory.addItemStackToInventory(itemstack)) {
                ...
                if (itemstack.getItem() == Items.diamond && this.getThrower() != null && (entityplayer = worldObj.getPlayerEntityByName(this.getThrower())) != null && entityplayer != entityIn) {
