...
extends EntityHanging {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (!source.isExplosion() && this.getDisplayedItem() != null) {
            if (!EntityItemFrame.worldObj.isRemote) {
    ...
    public void dropItemOrSelf(Entity p_146065_1_, boolean p_146065_2_) {
        if (worldObj.getGameRules().getBoolean("doEntityDrops")) {
            ...
            if (itemstack != null && rand.nextFloat() < this.itemDropChance) {
    ...
    private void setDisplayedItemWithUpdate(ItemStack p_174864_1_, boolean p_174864_2_) {
        ...
        if (p_174864_2_ && this.hangingPosition != null) {
            worldObj.updateComparatorOutputLevel(this.hangingPosition, Blocks.air);
        }
    }
    ...
    public boolean interactFirst(EntityPlayer playerIn) {
        if (this.getDisplayedItem() == null) {
            ...
            if (itemstack != null && !EntityItemFrame.worldObj.isRemote) {
                this.setDisplayedItem(itemstack);
                if (!playerIn.capabilities.isCreativeMode && --itemstack.stackSize <= 0) {
                    playerIn.inventory.setInventorySlotContents(playerIn.inventory.currentItem, null);
                }
            }
        } else if (!EntityItemFrame.worldObj.isRemote) {
