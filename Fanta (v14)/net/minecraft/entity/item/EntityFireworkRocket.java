...
extends Entity {
    ...
    public EntityFireworkRocket(World worldIn, double x, double y, double z, ItemStack givenItem) {
        ...
        this.motionY = 0.05;
        this.lifetime = 10 * i + rand.nextInt(6) + rand.nextInt(7);
    }
    ...
    public void onUpdate() {
        ...
        ++this.fireworkAge;
        if (EntityFireworkRocket.worldObj.isRemote && this.fireworkAge % 2 < 2) {
            worldObj.spawnParticle(EnumParticleTypes.FIREWORKS_SPARK, this.posX, this.posY - 0.3, this.posZ, rand.nextGaussian() * 0.05, -this.motionY * 0.5, rand.nextGaussian() * 0.05, new int[0]);
        }
        if (!EntityFireworkRocket.worldObj.isRemote && this.fireworkAge > this.lifetime) {
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 17 && EntityFireworkRocket.worldObj.isRemote) {
            ...
            worldObj.makeFireworks(this.posX, this.posY, this.posZ, this.motionX, this.motionY, this.motionZ, nbttagcompound);
        }
