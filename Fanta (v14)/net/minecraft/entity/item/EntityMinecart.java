...
implements IWorldNameable {
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        if (!EntityMinecart.worldObj.isRemote && !this.isDead) {
            boolean flag;
    ...
    public void onUpdate() {
        ...
        if (!EntityMinecart.worldObj.isRemote && worldObj instanceof WorldServer) {
            EntityMinecart.worldObj.theProfiler.startSection("portal");
            ...
            if (this.inPortal) {
                if (minecraftserver.getAllowNether()) {
                    if (this.ridingEntity == null && this.portalCounter++ >= i) {
                        ...
                        int j = EntityMinecart.worldObj.provider.getDimensionId() == -1 ? 0 : -1;
            ...
            EntityMinecart.worldObj.theProfiler.endSection();
        }
        if (EntityMinecart.worldObj.isRemote) {
            ...
            if (BlockRailBase.isRailBlock(worldObj, new BlockPos(k, (l = MathHelper.floor_double(this.posY)) - 1, i1 = MathHelper.floor_double(this.posZ)))) {
                --l;
            }
            if (BlockRailBase.isRailBlock(iblockstate = worldObj.getBlockState(blockpos = new BlockPos(k, l, i1)))) {
            ...
            this.setRotation(this.rotationYaw, this.rotationPitch);
            for (Entity entity : worldObj.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox().expand(0.2f, 0.0, 0.2f))) {
    ...
    public Vec3 func_70495_a(double p_70495_1_, double p_70495_3_, double p_70495_5_, double p_70495_7_) {
        ...
        if (BlockRailBase.isRailBlock(worldObj, new BlockPos(i, (j = MathHelper.floor_double(p_70495_3_)) - 1, k = MathHelper.floor_double(p_70495_5_)))) {
            --j;
        }
        if (BlockRailBase.isRailBlock(iblockstate = worldObj.getBlockState(new BlockPos(i, j, k)))) {
    ...
    public Vec3 func_70489_a(double p_70489_1_, double p_70489_3_, double p_70489_5_) {
        ...
        if (BlockRailBase.isRailBlock(worldObj, new BlockPos(i, (j = MathHelper.floor_double(p_70489_3_)) - 1, k = MathHelper.floor_double(p_70489_5_)))) {
            --j;
        }
        if (BlockRailBase.isRailBlock(iblockstate = worldObj.getBlockState(new BlockPos(i, j, k)))) {
            BlockRailBase.EnumRailDirection blockrailbase$enumraildirection = iblockstate.getValue(((BlockRailBase)iblockstate.getBlock()).getShapeProperty());
    ...
    public void applyEntityCollision(Entity entityIn) {
        if (!(EntityMinecart.worldObj.isRemote || entityIn.noClip || this.noClip || entityIn == this.riddenByEntity)) {
            double d1;
            double d0;
            double d2;
