...
extends EntityMob {
    ...
    protected boolean interact(EntityPlayer player) {
        ...
        if (itemstack != null && itemstack.getItem() == Items.flint_and_steel) {
            worldObj.playSoundEffect(this.posX + 0.5, this.posY + 0.5, this.posZ + 0.5, "fire.ignite", 1.0f, rand.nextFloat() * 0.4f + 0.8f);
            player.swingItem();
            if (!EntityCreeper.worldObj.isRemote) {
                this.ignite();
    ...
    private void explode() {
        if (!EntityCreeper.worldObj.isRemote) {
            ...
            worldObj.createExplosion(this, this.posX, this.posY, this.posZ, (float)this.explosionRadius * f, flag);
            this.setDead();
        }
    }
    ...
    public boolean isAIEnabled() {
        return this.field_175494_bm < 1 && worldObj.getGameRules().getBoolean("doMobLoot");
    }
