...
implements IRangedAttackMob {
    ...
    public void onLivingUpdate() {
        if (worldObj.isDaytime() && !EntitySkeleton.worldObj.isRemote) {
        ...
        if (EntitySkeleton.worldObj.isRemote && this.getSkeletonType() == 1) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (EntitySkeleton.worldObj.provider instanceof WorldProviderHell && this.getRNG().nextInt(5) > 0) {
        ...
        this.setCanPickUpLoot(rand.nextFloat() < 0.55f * difficulty.getClampedAdditionalDifficulty());
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
        EntityArrow entityarrow = new EntityArrow(worldObj, this, p_82196_1_, 1.6f, 14 - worldObj.getDifficulty().getDifficultyId() * 4);
        int i = EnchantmentHelper.getEnchantmentLevel(Enchantment.power.effectId, this.getHeldItem());
        int j = EnchantmentHelper.getEnchantmentLevel(Enchantment.punch.effectId, this.getHeldItem());
        entityarrow.setDamage((double)(p_82196_2_ * 2.0f) + rand.nextGaussian() * 0.25 + (double)((float)worldObj.getDifficulty().getDifficultyId() * 0.11f));
        if (i > 0) {
    ...
    public void setCurrentItemOrArmor(int slotIn, ItemStack stack) {
        ...
        if (!EntitySkeleton.worldObj.isRemote && slotIn == 0) {
            this.setCombatTask();
        }
    }
