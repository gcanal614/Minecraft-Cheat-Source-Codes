...
implements IMob {
    ...
    public void onUpdate() {
        super.onUpdate();
        if (!EntityGhast.worldObj.isRemote && worldObj.getDifficulty() == EnumDifficulty.PEACEFUL) {
            this.setDead();
        }
    }
    ...
    extends EntityMoveHelper {
        ...
        private boolean isNotColliding(double p_179926_1_, double p_179926_3_, double p_179926_5_, double p_179926_7_) {
            ...
            while ((double)i < p_179926_7_) {
                if (!worldObj.getCollidingBoundingBoxes(this.parentEntity, axisalignedbb = axisalignedbb.offset(d0, d1, d2)).isEmpty()) {
                    return false;
                }
                ++i;
            }
