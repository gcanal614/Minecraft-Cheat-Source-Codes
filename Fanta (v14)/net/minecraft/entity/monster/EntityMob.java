...
implements IMob {
    ...
    public void onUpdate() {
        super.onUpdate();
        if (!EntityMob.worldObj.isRemote && worldObj.getDifficulty() == EnumDifficulty.PEACEFUL) {
            this.setDead();
        }
    }
    ...
    public boolean getCanSpawnHere() {
        return worldObj.getDifficulty() != EnumDifficulty.PEACEFUL && this.isValidLightLevel() && super.getCanSpawnHere();
    }
