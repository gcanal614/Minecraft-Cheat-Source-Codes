...
extends EntityMob {
    ...
    public void onUpdate() {
        super.onUpdate();
        if (!EntitySpider.worldObj.isRemote) {
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, IEntityLivingData livingdata) {
        ...
        if (EntitySpider.worldObj.rand.nextInt(100) == 0) {
        ...
        if (livingdata == null) {
            ...
            if (worldObj.getDifficulty() == EnumDifficulty.HARD && EntitySpider.worldObj.rand.nextFloat() < 0.1f * difficulty.getClampedAdditionalDifficulty()) {
                ((GroupData)livingdata).func_111104_a(EntitySpider.worldObj.rand);
            }
        }
