...
extends EntityZombie {
    ...
    protected void updateAITasks() {
        ...
        if (this.randomSoundDelay > 0 && --this.randomSoundDelay == 0) {
            this.playSound("mob.zombiepig.zpigangry", this.getSoundVolume() * 2.0f, ((rand.nextFloat() - rand.nextFloat()) * 0.2f + 1.0f) * 1.8f);
        }
        if (this.angerLevel > 0 && this.angerTargetUUID != null && this.getAITarget() == null) {
            EntityPlayer entityplayer = worldObj.getPlayerEntityByUUID(this.angerTargetUUID);
