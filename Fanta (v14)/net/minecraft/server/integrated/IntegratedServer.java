...
extends MinecraftServer {
    ...
    protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type, String p_71247_6_) {
        ...
        if (Reflector.DimensionManager.exists()) {
            Integer[] ainteger;
            WorldServer worldserver = this.isDemo() ? (WorldServer)new DemoWorldServer(this, isavehandler, worldinfo, 0, this.theProfiler).init() : (WorldServer)new WorldServerOF((MinecraftServer)this, isavehandler, worldinfo, 0, this.theProfiler).init();
            ...
            while (l < this.worldServers.length) {
                ...
                if (l == 0) {
                    this.worldServers[l] = this.isDemo() ? (WorldServer)new DemoWorldServer(this, isavehandler, worldinfo, b0, this.theProfiler).init() : (WorldServer)new WorldServerOF((MinecraftServer)this, isavehandler, worldinfo, b0, this.theProfiler).init();
