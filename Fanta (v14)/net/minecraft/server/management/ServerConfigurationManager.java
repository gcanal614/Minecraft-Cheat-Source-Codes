...
public abstract class ServerConfigurationManager {
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn) {
        ...
        playerIn.theItemInWorldManager.setWorld((WorldServer)EntityPlayerMP.worldObj);
        String s1 = "local";
    ...
    public void transferPlayerToDimension(EntityPlayerMP playerIn, int dimension) {
        ...
        playerIn.playerNetServerHandler.sendPacket(new S07PacketRespawn(playerIn.dimension, EntityPlayerMP.worldObj.getDifficulty(), EntityPlayerMP.worldObj.getWorldInfo().getTerrainType(), playerIn.theItemInWorldManager.getGameType()));
    ...
    public String func_181058_b(boolean p_181058_1_) {
        ...
        while (i < list.size()) {
            ...
            s = String.valueOf(s) + ((EntityPlayerMP)list.get(i)).getName();
            if (p_181058_1_) {
                s = String.valueOf(s) + " (" + ((EntityPlayerMP)list.get(i)).getUniqueID().toString() + ")";
            }
            ++i;
        }
        return s;
