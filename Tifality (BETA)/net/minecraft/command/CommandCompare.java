...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        BlockPos blockpos = CommandCompare.parseBlockPos(sender, args2, 0, false);
        BlockPos blockpos1 = CommandCompare.parseBlockPos(sender, args2, 3, false);
        BlockPos blockpos2 = CommandCompare.parseBlockPos(sender, args2, 6, false);
        ...
        boolean flag = false;
        if (args2.length > 9 && args2[9].equals("masked")) {
            flag = true;
        }
        i = 0;
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args2, BlockPos pos) {
        return args2.length > 0 && args2.length <= 3 ? CommandCompare.func_175771_a(args2, 0, pos) : (args2.length > 3 && args2.length <= 6 ? CommandCompare.func_175771_a(args2, 3, pos) : (args2.length > 6 && args2.length <= 9 ? CommandCompare.func_175771_a(args2, 6, pos) : (args2.length == 10 ? CommandCompare.getListOfStringsMatchingLastWord(args2, "masked", "all") : null)));
    }
}
