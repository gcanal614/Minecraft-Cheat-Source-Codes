...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        WorldSettings.GameType worldsettings$gametype = this.getGameModeFromCommand(sender, args2[0]);
        EntityPlayerMP entityplayer = args2.length >= 2 ? CommandGameMode.getPlayer(sender, args2[1]) : CommandGameMode.getCommandSenderAsPlayer(sender);
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args2, BlockPos pos) {
        return args2.length == 1 ? CommandGameMode.getListOfStringsMatchingLastWord(args2, "survival", "creative", "adventure", "spectator") : (args2.length == 2 ? CommandGameMode.getListOfStringsMatchingLastWord(args2, this.getListOfPlayerUsernames()) : null);
    }
