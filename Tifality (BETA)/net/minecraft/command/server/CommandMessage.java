...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        EntityPlayerMP entityplayer = CommandMessage.getPlayer(sender, args2[0]);
        if (entityplayer == sender) {
            throw new PlayerNotFoundException("commands.message.sameTarget", new Object[0]);
        }
        IChatComponent ichatcomponent = CommandMessage.getChatComponentFromNthArg(sender, args2, 1, !(sender instanceof EntityPlayer));
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args2, BlockPos pos) {
        return CommandMessage.getListOfStringsMatchingLastWord(args2, MinecraftServer.getServer().getAllUsernames());
    }
