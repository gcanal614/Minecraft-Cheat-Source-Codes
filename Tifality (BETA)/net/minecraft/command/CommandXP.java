...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        EntityPlayerMP entityPlayerMP = entityplayer = args2.length > 1 ? CommandXP.getPlayer(sender, args2[1]) : CommandXP.getCommandSenderAsPlayer(sender);
        if (flag) {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args2, BlockPos pos) {
        return args2.length == 2 ? CommandXP.getListOfStringsMatchingLastWord(args2, this.getAllUsernames()) : null;
    }
