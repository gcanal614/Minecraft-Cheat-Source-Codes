...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        EnumDifficulty enumdifficulty = this.getDifficultyFromCommand(args2[0]);
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args2, BlockPos pos) {
        return args2.length == 1 ? CommandDifficulty.getListOfStringsMatchingLastWord(args2, "peaceful", "easy", "normal", "hard") : null;
    }
}
