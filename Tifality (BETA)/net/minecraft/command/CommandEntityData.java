...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        Entity entity = CommandEntityData.func_175768_b(sender, args2[0]);
        ...
        try {
            nbttagcompound2 = JsonToNBT.getTagFromJson(CommandEntityData.getChatComponentFromNthArg(sender, args2, 1).getUnformattedText());
        }
