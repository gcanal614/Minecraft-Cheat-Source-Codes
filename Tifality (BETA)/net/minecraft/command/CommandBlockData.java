...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args2) throws CommandException {
        ...
        BlockPos blockpos = CommandBlockData.parseBlockPos(sender, args2, 0, false);
        ...
        try {
            nbttagcompound2 = JsonToNBT.getTagFromJson(CommandBlockData.getChatComponentFromNthArg(sender, args2, 3).getUnformattedText());
        }
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args2, BlockPos pos) {
        return args2.length > 0 && args2.length <= 3 ? CommandBlockData.func_175771_a(args2, 0, pos) : null;
    }
}
