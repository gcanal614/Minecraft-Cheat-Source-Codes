...
public class WorldRenderer {
    ...
    public WorldRenderer color(float p_color_1_, float p_color_2_, float p_color_3_, float p_color_4_) {
        return this.color((int)(p_color_1_ * 255.0f), (int)(p_color_2_ * 255.0f), (int)(p_color_3_ * 255.0f), (int)(p_color_4_ * 255.0f));
    }

    public WorldRenderer color(int p_color_1_, int p_color_2_, int p_color_3_, int p_color_4_) {
        if (this.needsUpdate) {
            return this;
        }
        int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.func_181720_d(this.field_181678_g);
        switch (this.field_181677_f.getType()) {
            ...
            case UINT: 
            case INT: {
                this.byteBuffer.putFloat(i, p_color_1_);
                this.byteBuffer.putFloat(i + 4, p_color_2_);
                this.byteBuffer.putFloat(i + 8, p_color_3_);
                this.byteBuffer.putFloat(i + 12, p_color_4_);
                break;
            }
            case USHORT: 
            case SHORT: {
    ...
    public WorldRenderer color4f(float p_181666_1_, float p_181666_2_, float p_181666_3_, float p_181666_4_) {
