        ...
        try {
            ...
            if (flag || flag1 || aboolean[0] || aboolean[1] || aboolean[2] || aboolean[3]) {
                ...
                if (flag) {
                    ...
                    float f25 = f4 * f1;
                    float f26 = f4 * f2;
                    worldRendererIn.pos(d0 + 0.0, d1 + (double)f7, d2 + 0.0).color4f(f24, f25, f26, 1.0f).tex(f13, f17).func_181671_a(l2, i3).endVertex();
                    worldRendererIn.pos(d0 + 0.0, d1 + (double)f8, d2 + 1.0).color4f(f24, f25, f26, 1.0f).tex(f14, f18).func_181671_a(l2, i3).endVertex();
                    worldRendererIn.pos(d0 + 1.0, d1 + (double)f9, d2 + 1.0).color4f(f24, f25, f26, 1.0f).tex(f15, f19).func_181671_a(l2, i3).endVertex();
                    worldRendererIn.pos(d0 + 1.0, d1 + (double)f10, d2 + 0.0).color4f(f24, f25, f26, 1.0f).tex(f16, f20).func_181671_a(l2, i3).endVertex();
                ...
                if (flag1) {
                    ...
                    worldRendererIn.pos(d0, d1, d2 + 1.0).color4f(f * f41, f1 * f41, f2 * f41, 1.0f).tex(f35, f38).func_181671_a(i2, j2).endVertex();
                    worldRendererIn.pos(d0, d1, d2).color4f(f * f41, f1 * f41, f2 * f41, 1.0f).tex(f35, f37).func_181671_a(i2, j2).endVertex();
                    worldRendererIn.pos(d0 + 1.0, d1, d2).color4f(f * f41, f1 * f41, f2 * f41, 1.0f).tex(f36, f37).func_181671_a(i2, j2).endVertex();
                    worldRendererIn.pos(d0 + 1.0, d1, d2 + 1.0).color4f(f * f41, f1 * f41, f2 * f41, 1.0f).tex(f36, f38).func_181671_a(i2, j2).endVertex();
                    flag22 = true;
                }
                for (int i1 = 0; i1 < 4; ++i1) {
                    ...
                    float f33 = f4 * f31 * f1;
                    float f34 = f4 * f31 * f2;
                    worldRendererIn.pos(d3, d1 + (double)f39, d4).color4f(f32, f33, f34, 1.0f).tex(f42, f28).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d5, d1 + (double)f40, d6).color4f(f32, f33, f34, 1.0f).tex(f27, f29).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d5, d1 + 0.0, d6).color4f(f32, f33, f34, 1.0f).tex(f27, f30).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d3, d1 + 0.0, d4).color4f(f32, f33, f34, 1.0f).tex(f42, f30).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d3, d1 + 0.0, d4).color4f(f32, f33, f34, 1.0f).tex(f42, f30).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d5, d1 + 0.0, d6).color4f(f32, f33, f34, 1.0f).tex(f27, f30).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d5, d1 + (double)f40, d6).color4f(f32, f33, f34, 1.0f).tex(f27, f29).func_181671_a(k, l).endVertex();
                    worldRendererIn.pos(d3, d1 + (double)f39, d4).color4f(f32, f33, f34, 1.0f).tex(f42, f28).func_181671_a(k, l).endVertex();
