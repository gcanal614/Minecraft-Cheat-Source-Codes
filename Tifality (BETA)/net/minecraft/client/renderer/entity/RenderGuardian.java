...
extends RenderLiving<EntityGuardian> {
    ...
    public void doRender(EntityGuardian entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (entitylivingbase != null) {
            ...
            worldrenderer.pos(d12, d0, d13).tex(0.4999, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d12, 0.0, d13).tex(0.4999, d22).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d14, 0.0, d15).tex(0.0, d22).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d14, d0, d15).tex(0.0, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d16, d0, d17).tex(0.4999, d23).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d16, 0.0, d17).tex(0.4999, d22).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d18, 0.0, d19).tex(0.0, d22).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d18, d0, d19).tex(0.0, d23).color4i(j, k, l, 255).endVertex();
            double d24 = 0.0;
            if (entity.ticksExisted % 2 == 0) {
                d24 = 0.5;
            }
            worldrenderer.pos(d4, d0, d5).tex(0.5, d24 + 0.5).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d6, d0, d7).tex(1.0, d24 + 0.5).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d10, d0, d11).tex(1.0, d24).color4i(j, k, l, 255).endVertex();
            worldrenderer.pos(d8, d0, d9).tex(0.5, d24).color4i(j, k, l, 255).endVertex();
            tessellator.draw();
            GL11.glPopMatrix();
        }
    }
