    ...
    public void renderTileEntityAt(TileEntityEndPortal te, double x, double y, double z, float partialTicks, int destroyStage) {
        if (!Config.isShaders() || !ShadersRender.renderEndPortal(te, x, y, z, partialTicks, destroyStage, 0.75f)) {
            ...
            for (int i = 0; i < 16; ++i) {
                ...
                worldrenderer.pos(x, y + (double)f3, z).color4f(f11, f12, f13, 1.0f).endVertex();
                worldrenderer.pos(x, y + (double)f3, z + 1.0).color4f(f11, f12, f13, 1.0f).endVertex();
                worldrenderer.pos(x + 1.0, y + (double)f3, z + 1.0).color4f(f11, f12, f13, 1.0f).endVertex();
                worldrenderer.pos(x + 1.0, y + (double)f3, z).color4f(f11, f12, f13, 1.0f).endVertex();
                tessellator.draw();
                GL11.glPopMatrix();
