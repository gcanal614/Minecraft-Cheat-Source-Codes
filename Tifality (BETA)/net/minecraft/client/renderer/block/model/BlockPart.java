...
public class BlockPart {
    ...
    implements JsonDeserializer<BlockPart> {
        ...
        public BlockPart deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
            ...
            Map<EnumFacing, BlockPartFace> map2 = this.parseFacesCheck(p_deserialize_3_, jsonobject);
            ...
            return new BlockPart(vector3f, vector3f1, map2, blockpartrotation, flag);
        }
        ...
        private Map<EnumFacing, BlockPartFace> parseFacesCheck(JsonDeserializationContext p_178250_1_, JsonObject p_178250_2_) {
            Map<EnumFacing, BlockPartFace> map2 = this.parseFaces(p_178250_1_, p_178250_2_);
            if (map2.isEmpty()) {
        ...
        private Map<EnumFacing, BlockPartFace> parseFaces(JsonDeserializationContext p_178253_1_, JsonObject p_178253_2_) {
            EnumMap<EnumFacing, BlockPartFace> map2 = Maps.newEnumMap(EnumFacing.class);
            ...
            for (Map.Entry<String, JsonElement> entry : jsonobject.entrySet()) {
                ...
                map2.put(enumfacing, (BlockPartFace)p_178253_1_.deserialize(entry.getValue(), (Type)((Object)BlockPartFace.class)));
            }
            return map2;
        }
