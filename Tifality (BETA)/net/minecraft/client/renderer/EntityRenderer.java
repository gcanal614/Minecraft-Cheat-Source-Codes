...
implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null) {
            ...
            boolean flag = false;
            float reach = Reach.isReachEnabled() ? Reach.getReachValue() : 3.0f;
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (double)reach) {
                this.pointedEntity = null;
    ...
    private void hurtCameraEffect(float partialTicks) {
        if (NoHurtCamera.isEnabledCached()) {
            return;
        }
    ...
    private void updateLightmap(float partialTicks) {
        ...
        if (this.lightmapUpdateNeeded && (worldClient = this.mc.theWorld) != null) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.currentScreen != null) {
                ...
                if (this.mc.thePlayer == null) {
                    Tifality.getInstance().getNotificationManager().render(scaledresolution, null, false, 2);
                }
            }
        }
    ...
    private void renderWorldPass(ScaledResolution scaledresolution, int pass, float partialTicks, long finishTimeNano) {
        ...
        Tifality.getInstance().getEventBus().post(new Render3DEvent(scaledresolution, partialTicks));
        this.getClass();
            ...
            for (int k1 = k - i1; k1 <= k + i1; ++k1) {
                for (int l1 = i - i1; l1 <= i + i1; ++l1) {
                    ...
                    if (world.getWorldChunkManager().getTemperatureAtHeight(f1, j2) >= 0.15f) {
                        ...
                        int k3 = j3 >> 16 & 0xFFFF;
                        int l3 = j3 & 0xFFFF;
                        worldrenderer.pos((double)l1 - d3 + 0.5, k2, (double)k1 - d4 + 0.5).tex(0.0, (double)k2 * 0.25 + d5).color4f(1.0f, 1.0f, 1.0f, f3).func_181671_a(k3, l3).endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5, k2, (double)k1 + d4 + 0.5).tex(1.0, (double)k2 * 0.25 + d5).color4f(1.0f, 1.0f, 1.0f, f3).func_181671_a(k3, l3).endVertex();
                        worldrenderer.pos((double)l1 + d3 + 0.5, l2, (double)k1 + d4 + 0.5).tex(1.0, (double)l2 * 0.25 + d5).color4f(1.0f, 1.0f, 1.0f, f3).func_181671_a(k3, l3).endVertex();
                        worldrenderer.pos((double)l1 - d3 + 0.5, l2, (double)k1 - d4 + 0.5).tex(0.0, (double)l2 * 0.25 + d5).color4f(1.0f, 1.0f, 1.0f, f3).func_181671_a(k3, l3).endVertex();
                        continue;
                    }
                    if (j1 != 1) {
                        if (j1 >= 0) {
                    ...
                    int j4 = i4 >> 16 & 0xFFFF;
                    int k4 = i4 & 0xFFFF;
                    worldrenderer.pos((double)l1 - d3 + 0.5, k2, (double)k1 - d4 + 0.5).tex(0.0 + d9, (double)k2 * 0.25 + d8 + d10).color4f(1.0f, 1.0f, 1.0f, f4).func_181671_a(j4, k4).endVertex();
                    worldrenderer.pos((double)l1 + d3 + 0.5, k2, (double)k1 + d4 + 0.5).tex(1.0 + d9, (double)k2 * 0.25 + d8 + d10).color4f(1.0f, 1.0f, 1.0f, f4).func_181671_a(j4, k4).endVertex();
                    worldrenderer.pos((double)l1 + d3 + 0.5, l2, (double)k1 + d4 + 0.5).tex(1.0 + d9, (double)l2 * 0.25 + d8 + d10).color4f(1.0f, 1.0f, 1.0f, f4).func_181671_a(j4, k4).endVertex();
                    worldrenderer.pos((double)l1 - d3 + 0.5, l2, (double)k1 - d4 + 0.5).tex(0.0 + d9, (double)l2 * 0.25 + d8 + d10).color4f(1.0f, 1.0f, 1.0f, f4).func_181671_a(j4, k4).endVertex();
                }
            }
            if (j1 >= 0) {
                tessellator.draw();
    ...
    private void frameFinish() {
        int i;
        if (this.mc.theWorld != null && Config.isShowGlErrors() && TimedEvent.isActive("CheckGlErrorFrameFinish", 10000L) && (i = GL11.glGetError()) != 0 && GlErrors.isEnabled(i)) {
