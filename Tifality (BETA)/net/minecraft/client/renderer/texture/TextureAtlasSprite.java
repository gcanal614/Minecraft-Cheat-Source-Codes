...
public class TextureAtlasSprite {
    ...
    private static int[][] getFrameTextureData(int[][] data2, int rows, int columns, int p_147962_3_) {
        int[][] aint = new int[data2.length][];
    ...
    public void bindSpriteTexture() {
        if (this.glSpriteTextureId < 0) {
            this.glSpriteTextureId = GL11.glGenTextures();
