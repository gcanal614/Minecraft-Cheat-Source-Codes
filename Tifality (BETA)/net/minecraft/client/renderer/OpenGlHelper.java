...
public class OpenGlHelper {
    ...
    public static void glUniform1(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform1ARB(location, values2);
        } else {
            GL20.glUniform1(location, values2);
        }
    }
    ...
    public static void glUniform2(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform2ARB(location, values2);
        } else {
            GL20.glUniform2(location, values2);
        }
    }
    ...
    public static void glUniform3(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform3ARB(location, values2);
        } else {
            GL20.glUniform3(location, values2);
        }
    }
    ...
    public static void glUniform4(int location, IntBuffer values2) {
        if (arbShaders) {
            ARBShaderObjects.glUniform4ARB(location, values2);
        } else {
            GL20.glUniform4(location, values2);
        }
    }
    ...
    public static void glBufferData(int target, ByteBuffer data2, int usage) {
        if (arbVbo) {
            ARBVertexBufferObject.glBufferDataARB(target, data2, usage);
        } else {
            GL15.glBufferData(target, data2, usage);
        }
    }
