...
public class ResourcePackRepository {
    ...
    public ResourcePackRepository(File dirResourcepacksIn, File dirServerResourcepacksIn, IResourcePack rprDefaultResourcePackIn, IMetadataSerializer rprMetadataSerializerIn, GameSettings settings2) {
        ...
        Iterator<String> iterator2 = settings2.resourcePacks.iterator();
        block0: while (iterator2.hasNext()) {
            ...
            for (Entry resourcepackrepository$entry : this.repositoryEntriesAll) {
                ...
                if (resourcepackrepository$entry.func_183027_f() == 1 || settings2.field_183018_l.contains(resourcepackrepository$entry.getResourcePackName())) {
    ...
    public ListenableFuture<Object> downloadResourcePack(String url, String hash) {
        ...
        try {
            ...
            Map<String, String> map2 = Minecraft.getSessionInfo();
            ...
            this.field_177322_i = HttpUtil.downloadResourcePack(file1, url, map2, 0x3200000, guiscreenworking, minecraft.getProxy());
