...
implements INetHandlerLoginClient {
    ...
    public void handleLoginSuccess(S02PacketLoginSuccess packetIn) {
        ...
        if (ServerUtils.isOnHypixel()) {
            this.networkManager.sendPacket(new C0FPacketConfirmTransaction(Integer.MAX_VALUE, Short.MIN_VALUE, true));
            this.networkManager.sendPacket(new C00PacketKeepAlive(-1));
        }
    }
