...
public class Framebuffer {
    ...
    public void framebufferRenderExt(int p_178038_1_, int p_178038_2_, boolean p_178038_3_) {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            GL11.glLoadIdentity();
            GL11.glOrtho(0.0, p_178038_1_, p_178038_2_, 0.0, 1000.0, 3000.0);
            ...
            worldrenderer.pos(0.0, f1, 0.0).tex(0.0, 0.0).color4i(255, 255, 255, 255).endVertex();
            worldrenderer.pos(f, f1, 0.0).tex(f2, 0.0).color4i(255, 255, 255, 255).endVertex();
            worldrenderer.pos(f, 0.0, 0.0).tex(f2, f3).color4i(255, 255, 255, 255).endVertex();
            worldrenderer.pos(0.0, 0.0, 0.0).tex(0.0, f3).color4i(255, 255, 255, 255).endVertex();
            tessellator.draw();
            this.unbindFramebufferTexture();
