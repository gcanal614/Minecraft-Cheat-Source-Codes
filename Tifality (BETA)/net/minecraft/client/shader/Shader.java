...
public class Shader {
    ...
    public void loadShader(float p_148042_1_) {
        ...
        worldrenderer.pos(0.0, f1, 500.0).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(f, f1, 500.0).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(f, 0.0, 500.0).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(0.0, 0.0, 500.0).color4i(255, 255, 255, 255).endVertex();
        tessellator.draw();
