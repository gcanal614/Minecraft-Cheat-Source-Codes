    ...
    private void displayString(String message) {
        ...
        if (!this.mc.running) {
            ...
            if (OpenGlHelper.isFramebufferEnabled()) {
                ...
                GL11.glOrtho(0.0, this.scaledResolution.getScaledWidth() * i, this.scaledResolution.getScaledHeight() * i, 0.0, 100.0, 300.0);
            } else {
            ...
            if (i - this.systemTime >= 100L) {
                ...
                if (flag) {
                    ...
                    if (customloadingscreen != null) {
                        ...
                        worldrenderer.pos(0.0, l, 0.0).tex(0.0, (float)l / f).color4i(64, 64, 64, 255).endVertex();
                        worldrenderer.pos(k, l, 0.0).tex((float)k / f, (float)l / f).color4i(64, 64, 64, 255).endVertex();
                        worldrenderer.pos(k, 0.0, 0.0).tex((float)k / f, 0.0).color4i(64, 64, 64, 255).endVertex();
                    ...
                    if (progress >= 0) {
                        ...
                        worldrenderer.pos(j1, k1, 0.0).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos(j1, k1 + i1, 0.0).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos(j1 + l1, k1 + i1, 0.0).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos(j1 + l1, k1, 0.0).color4i(128, 128, 128, 255).endVertex();
                        worldrenderer.pos(j1, k1, 0.0).color4i(128, 255, 128, 255).endVertex();
                        worldrenderer.pos(j1, k1 + i1, 0.0).color4i(128, 255, 128, 255).endVertex();
                        worldrenderer.pos(j1 + progress, k1 + i1, 0.0).color4i(128, 255, 128, 255).endVertex();
                        worldrenderer.pos(j1 + progress, k1, 0.0).color4i(128, 255, 128, 255).endVertex();
                        tessellator.draw();
