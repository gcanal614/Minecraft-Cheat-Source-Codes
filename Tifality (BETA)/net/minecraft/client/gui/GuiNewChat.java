...
extends Gui {
            ...
            if (k > 0) {
                ...
                if (flag) {
                    ...
                    if (l2 != i3) {
                        ...
                        GuiNewChat.drawRect(0.0f, -j3, 2.0f, -j3 - k1, l3 + (k3 << 24));
                        GuiNewChat.drawRect(2.0f, -j3, 1.0f, -j3 - k1, 0xCCCCCC + (k3 << 24));
                    }
                }
                GL11.glPopMatrix();
            }
    ...
    public IChatComponent getChatComponent(int p_146236_1_, int p_146236_2_) {
        ...
        if (j >= 0 && k >= 0) {
            ...
            if (j <= MathHelper.floor_float((float)this.getChatWidth() / this.getChatScale()) && k < this.mc.fontRendererObj.FONT_HEIGHT * l + l && (i1 = k / this.mc.fontRendererObj.FONT_HEIGHT + this.scrollPos) >= 0 && i1 < this.field_146253_i.size()) {
    ...
    public void deleteChatLine(int p_146242_1_) {
        Iterator<ChatLine> iterator2 = this.field_146253_i.iterator();
        while (iterator2.hasNext()) {
            ChatLine chatline = iterator2.next();
            if (chatline.getChatLineID() != p_146242_1_) continue;
            iterator2.remove();
        }
        iterator2 = this.chatLines.iterator();
        while (iterator2.hasNext()) {
            ChatLine chatline1 = iterator2.next();
