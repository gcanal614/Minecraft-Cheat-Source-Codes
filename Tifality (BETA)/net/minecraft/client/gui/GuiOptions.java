...
implements GuiYesNoCallback {
    ...
    public void initGui() {
        ...
        GameSettings.Options[] arrayOfOptions = field_146440_f;
        int j = field_146440_f.length;
        for (int b = 0; b < j; b = (int)((byte)(b + 1))) {
            GameSettings.Options gamesettings$options = arrayOfOptions[b];
    ...
    public void confirmClicked(boolean result2, int id) {
        ...
        if (id == 109 && result2 && this.mc.theWorld != null) {
