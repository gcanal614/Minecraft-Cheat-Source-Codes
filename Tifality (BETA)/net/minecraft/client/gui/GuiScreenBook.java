...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = (this.width - this.bookImageWidth) / 2;
        int j = 2;
        GuiScreenBook.drawTexturedModalRect(i, j, 0, 0, this.bookImageWidth, this.bookImageHeight);
        if (this.bookGettingSigned) {
            ...
            if (this.bookIsUnsigned) {
                s5 = this.updateCount / 6 % 2 == 0 ? s5 + "" + (Object)((Object)EnumChatFormatting.BLACK) + "_" : s5 + "" + (Object)((Object)EnumChatFormatting.GRAY) + "_";
    ...
    extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (this.visible) {
                ...
                NextPageButton.drawTexturedModalRect(this.xPosition, this.yPosition, i, j, 23, 13);
            }
        }
    }
}
