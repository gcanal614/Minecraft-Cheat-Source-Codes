...
extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        int i = (this.width - this.xSize) / 2;
        int j = (this.height - this.ySize) / 2;
        GuiEnchantment.drawTexturedModalRect(i, j, 0, 0, this.xSize, this.ySize);
        GL11.glPushMatrix();
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
            if (l1 == 0) {
                GuiEnchantment.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
                continue;
            }
            String s1 = "" + l1;
            ...
            if (!(k >= l + 1 && this.mc.thePlayer.experienceLevel >= l1 || this.mc.thePlayer.capabilities.isCreativeMode)) {
                GuiEnchantment.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 185, 108, 19);
                GuiEnchantment.drawTexturedModalRect(i1 + 1, j + 15 + 19 * l, 16 * l, 239, 16, 16);
                ...
                if (j2 >= 0 && k2 >= 0 && j2 < 108 && k2 < 19) {
                    GuiEnchantment.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 204, 108, 19);
                    i2 = 0xFFFF80;
                } else {
                    GuiEnchantment.drawTexturedModalRect(i1, j + 14 + 19 * l, 0, 166, 108, 19);
                }
                GuiEnchantment.drawTexturedModalRect(i1 + 1, j + 15 + 19 * l, 16 * l, 223, 16, 16);
