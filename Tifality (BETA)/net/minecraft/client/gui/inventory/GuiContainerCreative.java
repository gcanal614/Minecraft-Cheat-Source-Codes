...
extends InventoryEffectRenderer {
    ...
    private void updateCreativeSearch() {
        ...
        Enchantment[] arrayOfEnchantment = Enchantment.enchantmentsBookList;
        int i = Enchantment.enchantmentsBookList.length;
        ...
        Iterator<ItemStack> iterator2 = guicontainercreative$containercreative.itemList.iterator();
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ...
            CreativeTabs[] arrayOfCreativeTabs = CreativeTabs.creativeTabArray;
            int k = CreativeTabs.creativeTabArray.length;
            for (int b = 0; b < k; b = (int)((byte)(b + 1))) {
                CreativeTabs creativetabs = arrayOfCreativeTabs[b];
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        CreativeTabs[] arrayOfCreativeTabs = CreativeTabs.creativeTabArray;
        int m = CreativeTabs.creativeTabArray.length;
        for (int b = 0; b < m && !this.renderCreativeInventoryHoveringText(creativetabs = arrayOfCreativeTabs[b], mouseX, mouseY); b = (int)((byte)(b + 1))) {
        }
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.tabAllSearch.getTabIndex()) {
            ...
            if (creativetabs == null && stack.getItem() == Items.enchanted_book && (map2 = EnchantmentHelper.getEnchantments(stack)).size() == 1) {
                Enchantment enchantment = Enchantment.getEnchantmentById(map2.keySet().iterator().next());
                CreativeTabs[] arrayOfCreativeTabs = CreativeTabs.creativeTabArray;
                int j = CreativeTabs.creativeTabArray.length;
                for (int b = 0; b < j; b = (int)((byte)(b + 1))) {
                    CreativeTabs creativetabs1 = arrayOfCreativeTabs[b];
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        CreativeTabs[] arrayOfCreativeTabs = CreativeTabs.creativeTabArray;
        int m = CreativeTabs.creativeTabArray.length;
        for (int b = 0; b < m; b = (int)((byte)(b + 1))) {
            CreativeTabs creativetabs1 = arrayOfCreativeTabs[b];
