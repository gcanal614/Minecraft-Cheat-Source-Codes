...
extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        GuiScreenHorseInventory.drawTexturedModalRect(i, j, 0, 0, this.xSize, this.ySize);
        if (this.horseEntity.isChested()) {
            GuiScreenHorseInventory.drawTexturedModalRect(i + 79, j + 17, 0, this.ySize, 90, 54);
        }
        if (this.horseEntity.canWearArmor()) {
            GuiScreenHorseInventory.drawTexturedModalRect(i + 7, j + 35, 0, this.ySize + 54, 18, 18);
        }
