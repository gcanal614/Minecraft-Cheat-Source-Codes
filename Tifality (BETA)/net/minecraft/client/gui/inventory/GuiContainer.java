...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ItemStack itemstack;
        ChestStealer stealer = Tifality.getInstance().getModuleManager().getModule(ChestStealer.class);
        Minecraft mc = Minecraft.getMinecraft();
        GuiScreen guiScreen = mc.currentScreen;
        if (stealer.isEnabled() && stealer.modeValue.get() == ChestStealer.Mode.BACKGROUND && guiScreen instanceof GuiChest) {
            mc.setIngameFocus();
    ...
    private void drawSlot(Slot slotIn) {
        ...
        if (itemstack == null && (s1 = slotIn.getSlotTexture()) != null) {
            ...
            GuiContainer.drawTexturedModalRect(i, j, textureatlassprite, 16, 16);
            GlStateManager.enableLighting();
            flag1 = true;
        }
        if (!flag1) {
