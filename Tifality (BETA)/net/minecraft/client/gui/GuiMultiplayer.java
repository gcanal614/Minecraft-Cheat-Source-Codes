...
implements GuiYesNoCallback {
    ...
    public void createButtons() {
        ...
        this.buttonList.add(new GuiButton(727, this.width / 2 + 160, this.height - 52, 50, 20, "Alt Man"));
    ...
    public void confirmClicked(boolean result2, int id) {
        ...
        if (this.deletingServer) {
            ...
            if (result2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Gui.drawRect(0.0f, 0.0f, this.width, this.height, -14144460);
        ...
        this.drawCenteredString(this.fontRendererObj, "Current Alt: " + this.mc.getSession().getUsername(), this.width / 2, 2, 0xFFFFFF);
