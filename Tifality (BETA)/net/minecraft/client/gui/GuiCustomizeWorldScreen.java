...
GuiPageButtonList.GuiResponder {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            ...
            worldrenderer.pos(this.width / 2 - 90, 185.0, 0.0).tex(0.0, 2.65625).color4i(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2 + 90, 185.0, 0.0).tex(5.625, 2.65625).color4i(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2 + 90, 100.0, 0.0).tex(5.625, 0.0).color4i(64, 64, 64, 64).endVertex();
            worldrenderer.pos(this.width / 2 - 90, 100.0, 0.0).tex(0.0, 0.0).color4i(64, 64, 64, 64).endVertex();
            tessellator.draw();
