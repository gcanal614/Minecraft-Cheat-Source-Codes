...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int i = 22;
        String[] arrayOfString = this.field_146607_r;
        int j = this.field_146607_r.length;
    ...
    extends GuiSlot {
        public List() {
            super(GuiSnooper.this.mc, GuiSnooper.this.width, GuiSnooper.this.height, 80, GuiSnooper.this.height - 40, 10);
        }
