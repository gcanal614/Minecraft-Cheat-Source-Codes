...
implements IProgressMeter {
    ...
    extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(mcIn, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 36);
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + 1 + 9, i == 0 ? 0x606060 : 0x909090);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s3, p_180791_2_ + 2, p_180791_3_ + 1 + 18, j == 0 ? 0x606060 : 0x909090);
        }
    }
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                    ...
                    if (statbase != null || statbase2 != null) {
                        ...
                        if (l != (i1 = GuiStats.this.field_146546_t.readStat(statbase2))) {
    ...
    extends GuiSlot {
            ...
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
                ...
                if (i >= 0) {
                    ...
                    if (s.length() > 0) {
                        ...
                        int i2 = GuiStats.this.fontRendererObj.getStringWidth(s);
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            ...
            String s;
            String s2;
            if (p_148213_1_ != null && (s2 = I18n.format(String.valueOf(s = (itemstack = new ItemStack(item = p_148213_1_.func_150959_a())).getUnlocalizedName()) + ".name", new Object[0]).trim()).length() > 0) {
                int i = p_148213_2_ + 12;
                int j = p_148213_3_ - 12;
                int k = GuiStats.this.fontRendererObj.getStringWidth(s2);
                Gui.drawGradientRect(i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
                GuiStats.this.fontRendererObj.drawStringWithShadow(s2, i, j, -1);
            }
        }
