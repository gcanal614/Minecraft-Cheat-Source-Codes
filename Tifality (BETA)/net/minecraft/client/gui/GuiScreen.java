...
implements GuiYesNoCallback {
    ...
    public void drawWorldBackground(int tint) {
        if (this.mc.theWorld != null) {
            GuiScreen.drawGradientRect(0.0f, 0.0f, this.width, this.height, -1072689136, -804253680);
        } else {
    ...
    public void drawBackground(int tint) {
        ...
        worldrenderer.pos(0.0, this.height, 0.0).tex(0.0, (float)this.height / 32.0f + (float)tint).color4i(64, 64, 64, 255).endVertex();
        worldrenderer.pos(this.width, this.height, 0.0).tex((float)this.width / 32.0f, (float)this.height / 32.0f + (float)tint).color4i(64, 64, 64, 255).endVertex();
        worldrenderer.pos(this.width, 0.0, 0.0).tex((float)this.width / 32.0f, tint).color4i(64, 64, 64, 255).endVertex();
        worldrenderer.pos(0.0, 0.0, 0.0).tex(0.0, tint).color4i(64, 64, 64, 255).endVertex();
        tessellator.draw();
    }
