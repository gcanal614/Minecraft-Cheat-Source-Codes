...
extends GuiScreen {
    ...
    private void drawWinGameScreen(int p_146575_1_, int p_146575_2_, float p_146575_3_) {
        ...
        f3 *= f3;
        f3 = f3 * 96.0f / 255.0f;
        worldrenderer.pos(0.0, this.height, this.zLevel).tex(0.0, f * f2).color4f(f3, f3, f3, 1.0f).endVertex();
        worldrenderer.pos(i, this.height, this.zLevel).tex((float)i * f2, f * f2).color4f(f3, f3, f3, 1.0f).endVertex();
        worldrenderer.pos(i, 0.0, this.zLevel).tex((float)i * f2, f1 * f2).color4f(f3, f3, f3, 1.0f).endVertex();
        worldrenderer.pos(0.0, 0.0, this.zLevel).tex(0.0, f1 * f2).color4f(f3, f3, f3, 1.0f).endVertex();
        tessellator.draw();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiWinGame.drawTexturedModalRect(j, k, 0, 0, 155, 44);
        GuiWinGame.drawTexturedModalRect(j + 155, k, 0, 45, 155, 44);
        int l = k + 200;
        ...
        int k1 = this.height;
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        worldrenderer.pos(0.0, k1, this.zLevel).tex(0.0, 1.0).color4f(1.0f, 1.0f, 1.0f, 1.0f).endVertex();
        worldrenderer.pos(j1, k1, this.zLevel).tex(1.0, 1.0).color4f(1.0f, 1.0f, 1.0f, 1.0f).endVertex();
        worldrenderer.pos(j1, 0.0, this.zLevel).tex(1.0, 0.0).color4f(1.0f, 1.0f, 1.0f, 1.0f).endVertex();
        worldrenderer.pos(0.0, 0.0, this.zLevel).tex(0.0, 0.0).color4f(1.0f, 1.0f, 1.0f, 1.0f).endVertex();
        tessellator.draw();
