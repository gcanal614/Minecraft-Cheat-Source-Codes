...
public class EffectRenderer {
    ...
    private void updateEffectAlphaLayer(List<EntityFX> entitiesFX) {
        ...
        if (j > 0) {
            Iterator<EntityFX> iterator2 = entitiesFX.iterator();
            for (int l = j; iterator2.hasNext() && l > 0; --l) {
                EntityFX entityfx1 = iterator2.next();
                entityfx1.setDead();
                iterator2.remove();
            }
        }
    ...
    public void addBlockHitEffects(BlockPos p_addBlockHitEffects_1_, EnumFacing p_addBlockHitEffects_2_) {
        ...
        if (block.getRenderType() != -1) {
            ...
            this.addEffect(new EntityDiggingFX(this.worldObj, d0, d1, d2, 0.0, 0.0, 0.0, iblockstate).func_174846_a(p_addBlockHitEffects_1_).multiplyVelocity(0.2f).multipleParticleScaleBy(0.6f));
        }
    }
