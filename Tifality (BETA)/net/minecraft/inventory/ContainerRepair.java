...
extends Container {
    ...
    public void updateRepairOutput() {
        ...
        if (itemstack == null) {
            ...
            Map<Integer, Integer> map2 = EnchantmentHelper.getEnchantments(itemstack1);
            boolean flag = false;
            ...
            if (itemstack2 != null) {
                ...
                if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
                    ...
                    for (int i5 : map1.keySet()) {
                        ...
                        int k5 = map2.containsKey(i5) ? map2.get(i5) : 0;
                        int l3 = map1.get(i5);
    ...
    @Override
    public void updateProgressBar(int id, int data2) {
        if (id == 0) {
            this.maximumCost = data2;
        }
    }
