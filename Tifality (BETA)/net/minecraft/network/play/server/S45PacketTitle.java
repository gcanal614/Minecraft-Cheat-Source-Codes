...
implements Packet<INetHandlerPlayClient> {
    ...
    public S45PacketTitle(Type type2, IChatComponent message) {
        this(type2, message, -1, -1, -1);
    }
    ...
    public S45PacketTitle(Type type2, IChatComponent message, int fadeInTime, int displayTime, int fadeOutTime) {
        this.type = type2;
