...
public enum EnumConnectionState {
    ...
    protected EnumConnectionState registerPacket(EnumPacketDirection p_registerPacket_1_, Class<? extends Packet> p_registerPacket_2_) {
        BiMap<Integer, Class<? extends Packet>> lvt_3_1_ = this.directionMaps.get((Object)p_registerPacket_1_);
        if (lvt_3_1_ == null) {
            lvt_3_1_ = HashBiMap.create();
            this.directionMaps.put(p_registerPacket_1_, lvt_3_1_);
        }
        if (lvt_3_1_.containsValue(p_registerPacket_2_)) {
            String lvt_4_1_ = (Object)((Object)p_registerPacket_1_) + " packet " + p_registerPacket_2_ + " is already known to ID " + lvt_3_1_.inverse().get(p_registerPacket_2_);
            LogManager.getLogger().fatal(lvt_4_1_);
            throw new IllegalArgumentException(lvt_4_1_);
        }
        lvt_3_1_.put(lvt_3_1_.size(), p_registerPacket_2_);
        return this;
    }

    public Integer getPacketId(EnumPacketDirection p_getPacketId_1_, Packet p_getPacketId_2_) {
        return (Integer)this.directionMaps.get((Object)p_getPacketId_1_).inverse().get(p_getPacketId_2_.getClass());
    }

    public Packet getPacket(EnumPacketDirection p_getPacket_1_, int p_getPacket_2_) throws InstantiationException, IllegalAccessException {
        Class lvt_3_1_ = (Class)this.directionMaps.get((Object)p_getPacket_1_).get(p_getPacket_2_);
    ...
    public static EnumConnectionState getById(int p_getById_0_) {
        return p_getById_0_ >= field_181136_e && p_getById_0_ <= field_181137_f ? STATES_BY_ID[p_getById_0_ - field_181136_e] : null;
    }

    public static EnumConnectionState getFromPacket(Packet p_getFromPacket_0_) {
        return STATES_BY_CLASS.get(p_getFromPacket_0_.getClass());
    }
    ...
    static {
        ...
        for (EnumConnectionState lvt_3_1_ : EnumConnectionState.values()) {
            ...
            EnumConnectionState.STATES_BY_ID[lvt_4_1_ - EnumConnectionState.field_181136_e] = lvt_3_1_;
            for (EnumPacketDirection lvt_6_1_ : lvt_3_1_.directionMaps.keySet()) {
                for (Class<? extends Packet> lvt_8_1_ : lvt_3_1_.directionMaps.get((Object)lvt_6_1_).values()) {
                    if (STATES_BY_CLASS.containsKey(lvt_8_1_) && STATES_BY_CLASS.get(lvt_8_1_) != lvt_3_1_) {
                        throw new Error("Packet " + lvt_8_1_ + " is already assigned to protocol " + (Object)((Object)STATES_BY_CLASS.get(lvt_8_1_)) + " - can't reassign to " + (Object)((Object)lvt_3_1_));
                    }
                    try {
                    ...
                    STATES_BY_CLASS.put(lvt_8_1_, lvt_3_1_);
                }
            }
        }
    }
