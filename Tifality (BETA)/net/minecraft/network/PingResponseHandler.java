...
extends ChannelInboundHandlerAdapter {
    ...
    private void writeAndFlush(ChannelHandlerContext ctx, ByteBuf data2) {
        ctx.pipeline().firstContext().writeAndFlush(data2).addListener(ChannelFutureListener.CLOSE);
    }
