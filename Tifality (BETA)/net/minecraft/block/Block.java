...
public class Block {
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos) {
        ...
        if (playerIn.onGround && (criticals = Tifality.INSTANCE.getModuleManager().getModule(Criticals.class)).isEnabled() && criticals.criticalsModeProperty.get() == Criticals.CriticalsMode.GROUND) {
            f /= 5.0f;
        }
