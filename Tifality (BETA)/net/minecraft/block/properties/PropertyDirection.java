...
extends PropertyEnum<EnumFacing> {
    protected PropertyDirection(String name, Collection<EnumFacing> values2) {
        super(name, EnumFacing.class, values2);
    }
    ...
    public static PropertyDirection create(String name, Collection<EnumFacing> values2) {
        return new PropertyDirection(name, values2);
    }
}
