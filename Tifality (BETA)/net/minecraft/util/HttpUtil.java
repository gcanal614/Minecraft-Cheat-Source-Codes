...
public class HttpUtil {
    ...
    public static String buildPostString(Map<String, Object> data2) {
    ...
    public static String postMap(URL url, Map<String, Object> data2, boolean skipLoggingErrors) {
        return HttpUtil.post(url, HttpUtil.buildPostString(data2), skipLoggingErrors);
    }
