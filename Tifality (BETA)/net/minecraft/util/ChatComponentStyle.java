...
implements IChatComponent {
    ...
    public static Iterator<IChatComponent> createDeepCopyIterator(Iterable<IChatComponent> components) {
        Iterator<IChatComponent> iterator2 = Iterators.concat(Iterators.transform(components.iterator(), new Function<IChatComponent, Iterator<IChatComponent>>(){
        ...
        iterator2 = Iterators.transform(iterator2, new Function<IChatComponent, IChatComponent>(){
