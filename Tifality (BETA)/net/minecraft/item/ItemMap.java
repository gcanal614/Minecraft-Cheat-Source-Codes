...
extends ItemMapBase {
    ...
    public void updateMapData(World worldIn, Entity viewer, MapData data2) {
        if (worldIn.provider.getDimensionId() == data2.dimension && viewer instanceof EntityPlayer) {
            int i = 1 << data2.scale;
            int j = data2.xCenter;
            int k = data2.zCenter;
            ...
            MapData.MapInfo mapdata$mapinfo = data2.getMapInfo((EntityPlayer)viewer);
            ...
            for (int k1 = l - j1 + 1; k1 < l + j1; ++k1) {
                ...
                for (int l1 = i1 - j1 - 1; l1 < i1 + j1; ++l1) {
                    ...
                    d0 = d1;
                    if (l1 < 0 || i2 * i2 + j2 * j2 >= j1 * j1 || flag1 && (k1 + l1 & 1) == 0 || (b0 = data2.colors[k1 + l1 * 128]) == (b1 = (byte)(mapcolor.colorIndex * 4 + i5))) continue;
                    data2.colors[k1 + l1 * 128] = b1;
                    data2.updateMapData(k1, l1);
                    flag = true;
                }
            }
        }
