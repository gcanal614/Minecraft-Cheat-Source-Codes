...
public class CraftingManager {
    ...
    public ShapedRecipes addRecipe(ItemStack stack, Object ... recipeComponents) {
        ...
        HashMap<Character, ItemStack> map2 = Maps.newHashMap();
        while (i < recipeComponents.length) {
            ...
            map2.put(character, itemstack);
            i += 2;
        }
        ItemStack[] aitemstack = new ItemStack[j * k];
        for (int i1 = 0; i1 < j * k; ++i1) {
            char c0 = s.charAt(i1);
            aitemstack[i1] = map2.containsKey(Character.valueOf(c0)) ? ((ItemStack)map2.get(Character.valueOf(c0))).copy() : null;
        }
