...
public class Scoreboard {
    ...
    public boolean entityHasObjective(String name, ScoreObjective p_178819_2_) {
        ...
        Score score = map2.get(p_178819_2_);
        return score != null;
    }
    ...
    public Score getValueFromObjective(String name, ScoreObjective objective) {
        ...
        if (map2 == null) {
            ...
            this.entitiesScoreObjectives.put(name, map2);
        }
        if ((score = map2.get(objective)) == null) {
            score = new Score(this, objective, name);
            map2.put(objective, score);
        }
        return score;
    }
    ...
    public Collection<Score> getSortedScores(ScoreObjective objective) {
        ...
        for (Map<ScoreObjective, Score> map2 : this.entitiesScoreObjectives.values()) {
            Score score = map2.get(objective);
    ...
    public void removeObjectiveFromEntity(String name, ScoreObjective objective) {
        if (objective == null) {
            Map<ScoreObjective, Score> map2 = this.entitiesScoreObjectives.remove(name);
            if (map2 != null) {
    ...
    public Collection<Score> getScores() {
        ...
        ArrayList<Score> list = Lists.newArrayList();
        for (Map<ScoreObjective, Score> map2 : collection) {
