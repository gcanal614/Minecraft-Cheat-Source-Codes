...
extends MinecraftServer {
    ...
    public IntegratedServer(Minecraft mcIn, String folderName, String worldName, WorldSettings settings2) {
        ...
        this.canCreateBonusChest(settings2.isBonusChestEnabled());
        this.setBuildLimit(256);
        this.setConfigManager(new IntegratedPlayerList(this));
        this.mc = mcIn;
        this.theWorldSettings = this.isDemo() ? DemoWorldServer.demoWorldSettings : settings2;
    ...
    @Override
    protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type2, String p_71247_6_) {
        ...
        if (flag) {
            ...
            for (int j = 0; j < i; ++j) {
                int k = ainteger1[j];
                WorldServer worldserver1 = k == 0 ? worldserver : (WorldServer)new WorldServerMulti((MinecraftServer)this, isavehandler, k, worldserver).init();
            ...
            for (int l = 0; l < this.worldServers.length; ++l) {
                ...
                if (l == 0) {
                    this.worldServers[l] = this.isDemo() ? (WorldServer)new DemoWorldServer(this, isavehandler, worldinfo, i1).init() : (WorldServer)new WorldServer(this, isavehandler, worldinfo, i1).init();
                    this.worldServers[l].initialize(this.theWorldSettings);
                } else {
                    this.worldServers[l] = (WorldServer)new WorldServerMulti((MinecraftServer)this, isavehandler, i1, this.worldServers[0]).init();
                }
        ...
        if (this.isGamePaused) {
            ...
            if (this.mc.theWorld != null) {
                ...
                if (!worldinfo1.isDifficultyLocked() && worldinfo.getDifficulty() != worldinfo1.getDifficulty()) {
                    ...
                    WorldServer[] arrayOfWorldServer = this.worldServers;
                    int i = this.worldServers.length;
    ...
    @Override
    public void addServerTypeToSnooper(PlayerUsageSnooper paramPlayerUsageSnooper) {
    }
    ...
    @Override
    public String shareToLAN(WorldSettings.GameType type2, boolean allowCheats) {
        try {
            int i = -1;
            try {
            ...
            this.getConfigurationManager().setGameType(type2);
