...
IPlayerUsage {
    ...
    protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type2, String p_71247_6_) {
        ...
        for (int i = 0; i < this.worldServers.length; ++i) {
            ...
            if (i == 0) {
                this.worldServers[i] = this.isDemo() ? (WorldServer)new DemoWorldServer(this, isavehandler, worldinfo, j).init() : (WorldServer)new WorldServer(this, isavehandler, worldinfo, j).init();
    ...
    public CrashReport addServerInfoToCrashReport(CrashReport report) {
        if (this.serverConfigManager != null) {
            report.getCategory().addCrashSectionCallable("Player Count", () -> this.serverConfigManager.getCurrentPlayerCount() + " / " + this.serverConfigManager.getMaxPlayers() + "; " + this.serverConfigManager.func_181057_v());
        }
        return report;
    }
