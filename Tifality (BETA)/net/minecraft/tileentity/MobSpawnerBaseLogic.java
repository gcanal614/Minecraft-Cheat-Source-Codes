...
public abstract class MobSpawnerBaseLogic {
    ...
    extends WeightedRandom.Item {
        ...
        public WeightedRandomMinecart(NBTTagCompound tagCompound, String type2) {
            this(tagCompound, type2, 1);
        }

        private WeightedRandomMinecart(NBTTagCompound tagCompound, String type2, int weight) {
            super(weight);
            if (type2.equals("Minecart")) {
                type2 = tagCompound != null ? EntityMinecart.EnumMinecartType.byNetworkID(tagCompound.getInteger("Type")).getName() : "MinecartRideable";
            }
