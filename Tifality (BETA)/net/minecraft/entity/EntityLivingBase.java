...
extends Entity {
    ...
    protected void updatePotionEffects() {
        boolean flag1;
        Iterator<Integer> iterator2 = this.activePotionsMap.keySet().iterator();
    ...
    private int getArmSwingAnimationEnd() {
        int speed = (int)(6.0f * (Animations.getInstance().isEnabled() ? ((Double)Animations.getInstance().swingSpeed.getValue()).floatValue() : 1.0f));
    ...
    protected void collideWithNearbyEntities() {
        List<Entity> list = this.worldObj.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(0.2f, 0.0, 0.2f), Predicates.and(EntitySelectors.NOT_SPECTATING, Entity::canBePushed));
        if (!list.isEmpty()) {
