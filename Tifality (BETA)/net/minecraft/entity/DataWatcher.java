...
public class DataWatcher {
    ...
    public void addObjectByDataType(int id, int type2) {
        WatchableObject datawatcher$watchableobject = new WatchableObject(type2, id, null);
        this.lock.writeLock().lock();
        this.watchedObjects.put(id, datawatcher$watchableobject);
        this.lock.writeLock().unlock();
        this.isBlank = false;
    ...
    public void updateWatchedObjectsFromList(List<WatchableObject> watchableObjects) {
        ...
        for (WatchableObject watchableObject : watchableObjects) {
            ...
            WatchableObject datawatcher$watchableobject1 = this.watchedObjects.get(id);
    ...
    public static class WatchableObject {
        ...
        public WatchableObject(int type2, int id, Object object) {
            this.dataValueId = id;
