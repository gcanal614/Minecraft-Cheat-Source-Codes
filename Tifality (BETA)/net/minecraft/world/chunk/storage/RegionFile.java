...
public class RegionFile {
    ...
    protected synchronized void write(int x, int z, byte[] data2, int length) {
        try {
            int i = this.getOffset(x, z);
            int j = i >> 8;
            int k = i & 0xFF;
    ...
    private void write(int sectorNumber, byte[] data2, int length) throws IOException {
        this.dataFile.seek(sectorNumber * 4096);
        this.dataFile.writeInt(length + 1);
        this.dataFile.writeByte(2);
        this.dataFile.write(data2, 0, length);
    }
