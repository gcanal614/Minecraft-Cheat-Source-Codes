...
extends WorldSavedData {
    ...
    private void updatePlayersVisibleOnMap(int type2, World worldIn, String entityIdentifier, double worldX, double worldZ, double rotation) {
        byte b2;
        int i = 1 << this.scale;
        ...
        this.playersVisibleOnMap.put(entityIdentifier, new Vec4b((byte)type2, b0, b1, b2));
    }
