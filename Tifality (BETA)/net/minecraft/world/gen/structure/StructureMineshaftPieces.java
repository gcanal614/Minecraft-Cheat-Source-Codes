...
public class StructureMineshaftPieces {
    ...
    private static StructureComponent func_175892_a(List<StructureComponent> listIn, Random rand, int x, int y, int z, EnumFacing facing, int type2) {
        int i = rand.nextInt(100);
        if (i >= 80) {
            StructureBoundingBox structureboundingbox = Cross.func_175813_a(listIn, rand, x, y, z, facing);
            if (structureboundingbox != null) {
                return new Cross(type2, rand, structureboundingbox, facing);
            }
        } else if (i >= 70) {
            StructureBoundingBox structureboundingbox1 = Stairs.func_175812_a(listIn, rand, x, y, z, facing);
            if (structureboundingbox1 != null) {
                return new Stairs(type2, rand, structureboundingbox1, facing);
            }
        } else {
            StructureBoundingBox structureboundingbox2 = Corridor.func_175814_a(listIn, rand, x, y, z, facing);
            if (structureboundingbox2 != null) {
                return new Corridor(type2, rand, structureboundingbox2, facing);
            }
        }
        return null;
    }

    private static StructureComponent func_175890_b(StructureComponent componentIn, List<StructureComponent> listIn, Random rand, int x, int y, int z, EnumFacing facing, int type2) {
        if (type2 > 8) {
            return null;
        }
        if (Math.abs(x - componentIn.getBoundingBox().minX) <= 80 && Math.abs(z - componentIn.getBoundingBox().minZ) <= 80) {
            StructureComponent structurecomponent = StructureMineshaftPieces.func_175892_a(listIn, rand, x, y, z, facing, type2 + 1);
    ...
    extends StructureComponent {
        ...
        public Stairs(int type2, Random rand, StructureBoundingBox structurebb, EnumFacing facing) {
            super(type2);
    ...
    extends StructureComponent {
        ...
        public Room(int type2, Random rand, int x, int z) {
            super(type2);
    ...
    extends StructureComponent {
        ...
        public Cross(int type2, Random rand, StructureBoundingBox structurebb, EnumFacing facing) {
            super(type2);
    ...
    extends StructureComponent {
        ...
        public Corridor(int type2, Random rand, StructureBoundingBox structurebb, EnumFacing facing) {
            super(type2);
            this.coordBaseMode = facing;
            this.boundingBox = structurebb;
