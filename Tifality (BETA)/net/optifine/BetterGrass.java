...
public class BetterGrass {
    ...
    private static void loadProperties(TextureMap textureMap) {
        ...
        try {
            ...
            betterGrass = BetterGrass.getBoolean(properties2, "grass", true);
            betterMycelium = BetterGrass.getBoolean(properties2, "mycelium", true);
            betterPodzol = BetterGrass.getBoolean(properties2, "podzol", true);
            betterGrassSnow = BetterGrass.getBoolean(properties2, "grass.snow", true);
            betterMyceliumSnow = BetterGrass.getBoolean(properties2, "mycelium.snow", true);
            betterPodzolSnow = BetterGrass.getBoolean(properties2, "podzol.snow", true);
            grassMultilayer = BetterGrass.getBoolean(properties2, "grass.multilayer", false);
            spriteGrass = BetterGrass.registerSprite(properties2, "texture.grass", TEXTURE_GRASS_DEFAULT, textureMap);
            spriteGrassSide = BetterGrass.registerSprite(properties2, "texture.grass_side", TEXTURE_GRASS_SIDE_DEFAULT, textureMap);
            spriteMycelium = BetterGrass.registerSprite(properties2, "texture.mycelium", TEXTURE_MYCELIUM_DEFAULT, textureMap);
            spritePodzol = BetterGrass.registerSprite(properties2, "texture.podzol", TEXTURE_PODZOL_DEFAULT, textureMap);
            spriteSnow = BetterGrass.registerSprite(properties2, "texture.snow", TEXTURE_SNOW_DEFAULT, textureMap);
        }
