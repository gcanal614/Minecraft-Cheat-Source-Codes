...
public class ConnectedProperties {
    ...
    public static IProperty getProperty(String key, Collection properties2) {
        for (Object e : properties2) {
    ...
    public boolean matchesBlock(int blockId, int metadata2) {
        return !Matches.block(blockId, metadata2, this.matchBlocks) ? false : Matches.metadata(metadata2, this.metadatas);
    }
