...
public class CustomPanorama {
    ...
    public static void update() {
        ...
        if (astring.length > 1) {
            ...
            String s = astring[i];
            Properties properties2 = aproperties[i];
            if (properties2 == null) {
                properties2 = aproperties[0];
            }
            if (properties2 == null) {
                properties2 = new PropertiesOrdered();
            }
            customPanoramaProperties = custompanoramaproperties = new CustomPanoramaProperties(s, properties2);
        }
    }
    ...
    private static int[] getWeights(Properties[] propertiess) {
        ...
        for (int i = 0; i < aint.length; ++i) {
            Properties properties2 = propertiess[i];
            if (properties2 == null) {
                properties2 = propertiess[0];
            }
            if (properties2 == null) {
                aint[i] = 1;
                continue;
