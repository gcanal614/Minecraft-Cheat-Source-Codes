...
public class CustomLoadingScreen {
    ...
    public void drawBackground(int width, int height) {
        ...
        worldrenderer.pos(0.0, height, 0.0).tex(d3, d4 + d2).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(width, height, 0.0).tex(d3 + d1, d4 + d2).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(width, 0.0, 0.0).tex(d3 + d1, d4).color4i(255, 255, 255, 255).endVertex();
        worldrenderer.pos(0.0, 0.0, 0.0).tex(d3, d4).color4i(255, 255, 255, 255).endVertex();
        tessellator.draw();
    }
}
