...
public class CustomEntityModels {
    ...
    public static void update() {
        Map<Class, Render> map2 = CustomEntityModels.getEntityRenderMap();
        ...
        if (map2 == null) {
            ...
            map2.clear();
            map1.clear();
            map2.putAll(originalEntityRenderMap);
            ...
            if (Config.isCustomEntityModels()) {
                ...
                for (int i = 0; i < aresourcelocation.length; ++i) {
                    ...
                    if (ientityrenderer instanceof Render) {
                        map2.put(oclass, (Render)ientityrenderer);
    ...
    private static Map<Class, Render> getEntityRenderMap() {
        ...
        Map<Class, Render> map2 = rendermanager.getEntityRenderMap();
        if (map2 == null) {
            return null;
        }
        if (originalEntityRenderMap == null) {
            originalEntityRenderMap = new HashMap<Class, Render>(map2);
        }
        return map2;
    }

    private static Map<Class, TileEntitySpecialRenderer> getTileEntityRenderMap() {
        Map<Class, TileEntitySpecialRenderer> map2 = TileEntityRendererDispatcher.instance.mapSpecialRenderers;
        if (originalTileEntityRenderMap == null) {
            originalTileEntityRenderMap = new HashMap<Class, TileEntitySpecialRenderer>(map2);
        }
        return map2;
    }
    ...
    private static boolean modifyModel(ModelAdapter modelAdapter, ModelBase model, CustomModelRenderer customModelRenderer, ModelResolver modelResolver) {
        ...
        if (!customModelRenderer.isAttach()) {
            ...
            if (modelrenderer.childModels != null) {
                ...
                Iterator<ModelRenderer> iterator2 = list.iterator();
                while (iterator2.hasNext()) {
                    ModelRenderer modelrenderer1 = iterator2.next();
