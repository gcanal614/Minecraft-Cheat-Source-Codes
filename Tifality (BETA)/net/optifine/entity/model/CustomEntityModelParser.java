...
public class CustomEntityModelParser {
    ...
    public static CustomEntityRenderer parseEntityRender(JsonObject obj, String path) {
        ...
        for (int i = 0; i < jsonarray.size(); ++i) {
            ...
            CustomEntityModelParser.processBaseId(jsonobject, map2);
            CustomEntityModelParser.processExternalModel(jsonobject, map2, s1);
            CustomEntityModelParser.processId(jsonobject, map2);
