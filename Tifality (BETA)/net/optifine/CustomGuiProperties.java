...
public class CustomGuiProperties {
    ...
    private static Map<ResourceLocation, ResourceLocation> parseTextureLocations(Properties props, String property, EnumContainer container, String pathPrefix, String basePath) {
        HashMap<ResourceLocation, ResourceLocation> map2 = new HashMap<ResourceLocation, ResourceLocation>();
        ...
        if (s != null) {
            ...
            if (resourcelocation != null && resourcelocation1 != null) {
                map2.put(resourcelocation, resourcelocation1);
            }
        }
        String s5 = property + ".";
        for (Object e : props.keySet()) {
            ...
            map2.put(resourcelocation2, resourcelocation3);
        }
        return map2;
    }
