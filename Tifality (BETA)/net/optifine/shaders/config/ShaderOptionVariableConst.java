...
extends ShaderOptionVariable {
    ...
    public ShaderOptionVariableConst(String name, String type2, String description2, String value, String[] values2, String path) {
        super(name, description2, value, values2, path);
        this.type = type2;
    }
