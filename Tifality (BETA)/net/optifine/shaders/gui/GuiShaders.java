...
extends GuiScreen {
    ...
    public static String toStringValue(float val, float[] values2, String[] names) {
        int i = GuiShaders.getValueIndex(val, values2);
        return names[i];
    }

    public static int getValueIndex(float val, float[] values2) {
