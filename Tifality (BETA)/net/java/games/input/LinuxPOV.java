...
extends LinuxComponent {
    ...
    public float convertValue(float value, LinuxAxisDescriptor descriptor2) {
        if (descriptor2 == this.component_x.getDescriptor()) {
            this.last_x = value;
        }
        if (descriptor2 == this.component_y.getDescriptor()) {
            this.last_y = value;
        }
