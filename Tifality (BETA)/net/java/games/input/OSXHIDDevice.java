...
final class OSXHIDDevice {
    ...
    private final void addElements(List elements, Map properties2) {
        Object[] elements_properties = (Object[])properties2.get(kIOHIDElementKey);
    ...
    private static final long getLongFromProperties(Map properties2, String key, long default_value) {
        Long long_obj = (Long)properties2.get(key);
        if (long_obj == null) {
    ...
    private static final boolean getBooleanFromProperties(Map properties2, String key, boolean default_value) {
        return OSXHIDDevice.getLongFromProperties(properties2, key, default_value ? 1L : 0L) != 0L;
    }

    private static final int getIntFromProperties(Map properties2, String key) {
        return (int)OSXHIDDevice.getLongFromProperties(properties2, key);
    }

    private static final long getLongFromProperties(Map properties2, String key) {
        Long long_obj = (Long)properties2.get(key);
        return long_obj;
    }
    ...
    private static final void dumpMap(String prefix, Map map2) {
