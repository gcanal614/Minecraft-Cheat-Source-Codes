...
extends AbstractOptionSpec<V> {
    ...
    NonOptionArgumentSpec(String description2) {
        super(Arrays.asList(NAME), description2);
    }
    ...
    public NonOptionArgumentSpec<V> describedAs(String description2) {
    ...
    @Override
    void handleOption(OptionParser parser, ArgumentList arguments2, OptionSet detectedOptions, String detectedArgument) {
