...
extends AbstractOptionSpec<V> {
    ...
    ArgumentAcceptingOptionSpec(Collection<String> options, boolean argumentRequired, String description2) {
        super(options, description2);
        this.argumentRequired = argumentRequired;
    }
    ...
    public final ArgumentAcceptingOptionSpec<V> describedAs(String description2) {
        this.argumentDescription = description2;
        return this;
    }
    ...
    public ArgumentAcceptingOptionSpec<V> defaultsTo(V value, V ... values2) {
        this.addDefaultValue(value);
        this.defaultsTo(values2);
        return this;
    }

    public ArgumentAcceptingOptionSpec<V> defaultsTo(V[] values2) {
        for (V each : values2) {
    ...
    @Override
    final void handleOption(OptionParser parser, ArgumentList arguments2, OptionSet detectedOptions, String detectedArgument) {
        if (Strings.isNullOrEmpty(detectedArgument)) {
            this.detectOptionArgument(parser, arguments2, detectedOptions);
        } else {
