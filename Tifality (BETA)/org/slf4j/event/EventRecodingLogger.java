...
implements Logger {
    ...
    public void trace(String format, Object ... arguments2) {
        this.recordEvent(Level.TRACE, format, arguments2, null);
    }
    ...
    public void debug(String format, Object ... arguments2) {
        this.recordEvent(Level.DEBUG, format, arguments2, null);
    }
    ...
    public void debug(Marker marker, String format, Object ... arguments2) {
        this.recordEvent(Level.DEBUG, marker, format, arguments2, null);
    }
    ...
    public void info(String format, Object ... arguments2) {
        this.recordEvent(Level.INFO, format, arguments2, null);
    }
    ...
    public void info(Marker marker, String format, Object ... arguments2) {
        this.recordEvent(Level.INFO, marker, format, arguments2, null);
    }
    ...
    public void warn(String format, Object ... arguments2) {
        this.recordEvent(Level.WARN, format, arguments2, null);
    }
    ...
    public void warn(Marker marker, String format, Object ... arguments2) {
        this.recordEvent(Level.WARN, marker, format, arguments2, null);
    }
    ...
    public void error(String format, Object ... arguments2) {
        this.recordEvent(Level.ERROR, format, arguments2, null);
    }
    ...
    public void error(Marker marker, String format, Object ... arguments2) {
        this.recordEvent(Level.ERROR, marker, format, arguments2, null);
    }
