...
public class GLU {
    ...
    public static int gluBuild2DMipmaps(int target, int components, int width, int height, int format, int type2, ByteBuffer data2) {
        return MipMap.gluBuild2DMipmaps(target, components, width, height, format, type2, data2);
    }
