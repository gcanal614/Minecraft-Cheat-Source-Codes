...
public final class CL12 {
    ...
    public static int clCreateSubDevices(CLDevice in_device, LongBuffer properties2, PointerBuffer out_devices, IntBuffer num_devices_ret) {
        int __result;
        ...
        if ((__result = CL12.nclCreateSubDevices(in_device.getPointer(), MemoryUtil.getAddress(properties2), out_devices == null ? 0 : out_devices.remaining(), MemoryUtil.getAddressSafe(out_devices), MemoryUtil.getAddressSafe(num_devices_ret), function_pointer)) == 0 && out_devices != null) {
