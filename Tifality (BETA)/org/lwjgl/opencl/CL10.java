...
public final class CL10 {
     ...
     */
    public static CLContext clCreateContext(PointerBuffer properties2, PointerBuffer devices, CLContextCallback pfn_notify, IntBuffer errcode_ret) {
        long function_pointer = CLCapabilities.clCreateContext;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(properties2, 3);
        BufferChecks.checkNullTerminated(properties2);
        ...
        try {
            CLContext cLContext = __result = new CLContext(CL10.nclCreateContext(MemoryUtil.getAddress(properties2), devices.remaining(), MemoryUtil.getAddress(devices), pfn_notify == null ? 0L : pfn_notify.getPointer(), user_data, MemoryUtil.getAddressSafe(errcode_ret), function_pointer), APIUtil.getCLPlatform(properties2));
            return cLContext;
        }
        finally {
            if (__result != null) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static CLContext clCreateContext(PointerBuffer properties2, CLDevice device, CLContextCallback pfn_notify, IntBuffer errcode_ret) {
        long function_pointer = CLCapabilities.clCreateContext;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(properties2, 3);
        BufferChecks.checkNullTerminated(properties2);
        ...
        CLContext __result = null;
        try {
            CLContext cLContext = __result = new CLContext(CL10.nclCreateContext(MemoryUtil.getAddress(properties2), 1, APIUtil.getPointer(device), pfn_notify == null ? 0L : pfn_notify.getPointer(), user_data, MemoryUtil.getAddressSafe(errcode_ret), function_pointer), APIUtil.getCLPlatform(properties2));
            return cLContext;
        }
        finally {
            if (__result != null) {
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public static CLContext clCreateContextFromType(PointerBuffer properties2, long device_type, CLContextCallback pfn_notify, IntBuffer errcode_ret) {
        ...
        CLContext __result = null;
        try {
            CLContext cLContext = __result = new CLContext(CL10.nclCreateContextFromType(MemoryUtil.getAddress(properties2), device_type, pfn_notify == null ? 0L : pfn_notify.getPointer(), user_data, MemoryUtil.getAddressSafe(errcode_ret), function_pointer), APIUtil.getCLPlatform(properties2));
            return cLContext;
        }
        finally {
            if (__result != null) {
    ...
    public static CLCommandQueue clCreateCommandQueue(CLContext context, CLDevice device, long properties2, IntBuffer errcode_ret) {
        long function_pointer = CLCapabilities.clCreateCommandQueue;
        BufferChecks.checkFunctionAddress(function_pointer);
        if (errcode_ret != null) {
            BufferChecks.checkBuffer(errcode_ret, 1);
        }
        CLCommandQueue __result = new CLCommandQueue(CL10.nclCreateCommandQueue(context.getPointer(), device.getPointer(), properties2, MemoryUtil.getAddressSafe(errcode_ret), function_pointer), context, device);
        return __result;
    }
    ...
    public static int clEnqueueNativeKernel(CLCommandQueue command_queue, CLNativeKernel user_func, CLMem[] mem_list, long[] sizes, PointerBuffer event_wait_list, PointerBuffer event) {
        ...
        ByteBuffer args2 = APIUtil.getNativeKernelArgs(user_func_ref, mem_list, sizes);
        int __result = 0;
        try {
            __result = CL10.nclEnqueueNativeKernel(command_queue.getPointer(), user_func.getPointer(), MemoryUtil.getAddress0(args2), args2.remaining(), mem_list == null ? 0 : mem_list.length, mem_list, event_wait_list == null ? 0 : event_wait_list.remaining(), MemoryUtil.getAddressSafe(event_wait_list), MemoryUtil.getAddressSafe(event), function_pointer);
            if (__result == 0) {
                command_queue.registerCLEvent(event);
            }
            int n = __result;
