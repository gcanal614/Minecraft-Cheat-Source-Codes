...
public final class EXTDeviceFission {
    ...
    public static int clCreateSubDevicesEXT(CLDevice in_device, LongBuffer properties2, PointerBuffer out_devices, IntBuffer num_devices) {
        int __result;
        ...
        if ((__result = EXTDeviceFission.nclCreateSubDevicesEXT(in_device.getPointer(), MemoryUtil.getAddress(properties2), out_devices == null ? 0 : out_devices.remaining(), MemoryUtil.getAddressSafe(out_devices), MemoryUtil.getAddressSafe(num_devices), function_pointer)) == 0 && out_devices != null) {
