...
extends CLObjectChild<CLPlatform> {
    ...
    private boolean checkCallback(long callback, int result2) {
        if (result2 == 0 && (callback == 0L || this.isValid())) {
            return true;
        }
        if (callback != 0L) {
    ...
    void setPrintfCallback(long callback, int result2) {
        if (this.checkCallback(callback, result2)) {
