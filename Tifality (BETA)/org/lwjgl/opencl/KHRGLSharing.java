...
public final class KHRGLSharing {
    ...
    public static int clGetGLContextInfoKHR(PointerBuffer properties2, int param_name, ByteBuffer param_value, PointerBuffer param_value_size_ret) {
        int __result;
        long function_pointer = CLCapabilities.clGetGLContextInfoKHR;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(properties2);
        ...
        if ((__result = KHRGLSharing.nclGetGLContextInfoKHR(MemoryUtil.getAddress(properties2), param_name, param_value == null ? 0 : param_value.remaining(), MemoryUtil.getAddressSafe(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer)) == 0 && param_value != null && APIUtil.isDevicesParam(param_name)) {
            APIUtil.getCLPlatform(properties2).registerCLDevices(param_value, param_value_size_ret);
        }
        return __result;
    }
