...
public final class NVVertexBufferUnifiedMemory {
    ...
    public static void glGetIntegeruNV(int value, int index, LongBuffer result2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetIntegerui64i_vNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(result2, 1);
        NVVertexBufferUnifiedMemory.nglGetIntegerui64i_vNV(value, index, MemoryUtil.getAddress(result2), function_pointer);
    }
    ...
    public static long glGetIntegerui64NV(int value, int index) {
        ...
        long function_pointer = caps.glGetIntegerui64i_vNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        LongBuffer result2 = APIUtil.getBufferLong(caps);
        NVVertexBufferUnifiedMemory.nglGetIntegerui64i_vNV(value, index, MemoryUtil.getAddress(result2), function_pointer);
