...
public final class GL14 {
    ...
    public static void glFogCoordPointer(int stride, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).GL14_glFogCoordPointer_data = data2;
        }
        GL14.nglFogCoordPointer(5130, stride, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glFogCoordPointer(int stride, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glFogCoordPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        ...
        GL14.nglFogCoordPointer(5126, stride, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glSecondaryColorPointer(int size, int stride, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glSecondaryColorPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        BufferChecks.checkDirect(data2);
        GL14.nglSecondaryColorPointer(size, 5130, stride, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glSecondaryColorPointer(int size, int stride, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glSecondaryColorPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        BufferChecks.checkDirect(data2);
        GL14.nglSecondaryColorPointer(size, 5126, stride, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glSecondaryColorPointer(int size, boolean unsigned, int stride, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glSecondaryColorPointer;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        BufferChecks.checkDirect(data2);
        GL14.nglSecondaryColorPointer(size, unsigned ? 5121 : 5120, stride, MemoryUtil.getAddress(data2), function_pointer);
    }
