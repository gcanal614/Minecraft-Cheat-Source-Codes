...
public final class NVBindlessTexture {
    ...
    public static void glProgramUniformHandleuNV(int program, int location, LongBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glProgramUniformHandleui64vNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(values2);
        NVBindlessTexture.nglProgramUniformHandleui64vNV(program, location, values2.remaining(), MemoryUtil.getAddress(values2), function_pointer);
    }
