...
public final class EXTFogCoord {
    ...
    public static void glFogCoordPointerEXT(int stride, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        if (LWJGLUtil.CHECKS) {
            StateTracker.getReferences((ContextCapabilities)caps).EXT_fog_coord_glFogCoordPointerEXT_data = data2;
        }
        EXTFogCoord.nglFogCoordPointerEXT(5130, stride, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glFogCoordPointerEXT(int stride, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glFogCoordPointerEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureArrayVBOdisabled(caps);
        ...
        EXTFogCoord.nglFogCoordPointerEXT(5126, stride, MemoryUtil.getAddress(data2), function_pointer);
    }
