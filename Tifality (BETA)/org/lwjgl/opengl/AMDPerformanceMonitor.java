...
public final class AMDPerformanceMonitor {
    ...
    public static void glGetPerfMonitorGroupsAMD(IntBuffer numGroups, IntBuffer groups2) {
        ...
        BufferChecks.checkDirect(groups2);
        AMDPerformanceMonitor.nglGetPerfMonitorGroupsAMD(MemoryUtil.getAddressSafe(numGroups), groups2.remaining(), MemoryUtil.getAddress(groups2), function_pointer);
    }
    ...
    public static void glGetPerfMonitorCounterInfoAMD(int group, int counter, int pname, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPerfMonitorCounterInfoAMD;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 16);
        AMDPerformanceMonitor.nglGetPerfMonitorCounterInfoAMD(group, counter, pname, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetPerfMonitorCounterDataAMD(int monitor, int pname, IntBuffer data2, IntBuffer bytesWritten) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        AMDPerformanceMonitor.nglGetPerfMonitorCounterDataAMD(monitor, pname, data2.remaining(), MemoryUtil.getAddress(data2), MemoryUtil.getAddressSafe(bytesWritten), function_pointer);
    }
    ...
    public static int glGetPerfMonitorCounterDataAMD(int monitor, int pname) {
        ...
        long function_pointer = caps.glGetPerfMonitorCounterDataAMD;
        BufferChecks.checkFunctionAddress(function_pointer);
        IntBuffer data2 = APIUtil.getBufferInt(caps);
        AMDPerformanceMonitor.nglGetPerfMonitorCounterDataAMD(monitor, pname, 4, MemoryUtil.getAddress(data2), 0L, function_pointer);
        return data2.get(0);
    }
}
