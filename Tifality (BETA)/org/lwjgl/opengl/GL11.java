...
public final class GL11 {
    ...
    public static void glGetPixelMap(int map2, FloatBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPixelMapfv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkBuffer(values2, 256);
        GL11.nglGetPixelMapfv(map2, MemoryUtil.getAddress(values2), function_pointer);
    }

    static native void nglGetPixelMapfv(int var0, long var1, long var3);

    public static void glGetPixelMapfv(int map2, long values_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPixelMapfv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOenabled(caps);
        GL11.nglGetPixelMapfvBO(map2, values_buffer_offset, function_pointer);
    }

    static native void nglGetPixelMapfvBO(int var0, long var1, long var3);

    public static void glGetPixelMapu(int map2, IntBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPixelMapuiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkBuffer(values2, 256);
        GL11.nglGetPixelMapuiv(map2, MemoryUtil.getAddress(values2), function_pointer);
    }

    static native void nglGetPixelMapuiv(int var0, long var1, long var3);

    public static void glGetPixelMapuiv(int map2, long values_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPixelMapuiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOenabled(caps);
        GL11.nglGetPixelMapuivBO(map2, values_buffer_offset, function_pointer);
    }

    static native void nglGetPixelMapuivBO(int var0, long var1, long var3);

    public static void glGetPixelMapu(int map2, ShortBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPixelMapusv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOdisabled(caps);
        BufferChecks.checkBuffer(values2, 256);
        GL11.nglGetPixelMapusv(map2, MemoryUtil.getAddress(values2), function_pointer);
    }

    static native void nglGetPixelMapusv(int var0, long var1, long var3);

    public static void glGetPixelMapusv(int map2, long values_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetPixelMapusv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensurePackPBOenabled(caps);
        GL11.nglGetPixelMapusvBO(map2, values_buffer_offset, function_pointer);
    }
    ...
    public static void glPixelMap(int map2, FloatBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPixelMapfv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOdisabled(caps);
        BufferChecks.checkDirect(values2);
        GL11.nglPixelMapfv(map2, values2.remaining(), MemoryUtil.getAddress(values2), function_pointer);
    }

    static native void nglPixelMapfv(int var0, int var1, long var2, long var4);

    public static void glPixelMapfv(int map2, int values_mapsize, long values_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPixelMapfv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOenabled(caps);
        GL11.nglPixelMapfvBO(map2, values_mapsize, values_buffer_offset, function_pointer);
    }

    static native void nglPixelMapfvBO(int var0, int var1, long var2, long var4);

    public static void glPixelMapu(int map2, IntBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPixelMapuiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOdisabled(caps);
        BufferChecks.checkDirect(values2);
        GL11.nglPixelMapuiv(map2, values2.remaining(), MemoryUtil.getAddress(values2), function_pointer);
    }

    static native void nglPixelMapuiv(int var0, int var1, long var2, long var4);

    public static void glPixelMapuiv(int map2, int values_mapsize, long values_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPixelMapuiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOenabled(caps);
        GL11.nglPixelMapuivBO(map2, values_mapsize, values_buffer_offset, function_pointer);
    }

    static native void nglPixelMapuivBO(int var0, int var1, long var2, long var4);

    public static void glPixelMapu(int map2, ShortBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPixelMapusv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOdisabled(caps);
        BufferChecks.checkDirect(values2);
        GL11.nglPixelMapusv(map2, values2.remaining(), MemoryUtil.getAddress(values2), function_pointer);
    }

    static native void nglPixelMapusv(int var0, int var1, long var2, long var4);

    public static void glPixelMapusv(int map2, int values_mapsize, long values_buffer_offset) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPixelMapusv;
        BufferChecks.checkFunctionAddress(function_pointer);
        GLChecks.ensureUnpackPBOenabled(caps);
        GL11.nglPixelMapusvBO(map2, values_mapsize, values_buffer_offset, function_pointer);
    }
