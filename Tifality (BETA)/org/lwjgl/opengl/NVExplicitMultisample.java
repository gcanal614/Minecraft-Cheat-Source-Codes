...
public final class NVExplicitMultisample {
    ...
    public static void glGetBooleanIndexedEXT(int pname, int index, ByteBuffer data2) {
        EXTDrawBuffers2.glGetBooleanIndexedEXT(pname, index, data2);
    }
    ...
    public static void glGetIntegerIndexedEXT(int pname, int index, IntBuffer data2) {
        EXTDrawBuffers2.glGetIntegerIndexedEXT(pname, index, data2);
    }
