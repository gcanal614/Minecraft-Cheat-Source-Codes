...
public final class EXTDrawBuffers2 {
    ...
    public static void glColorMaskIndexedEXT(int buf, boolean r, boolean g, boolean b2, boolean a2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glColorMaskIndexedEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTDrawBuffers2.nglColorMaskIndexedEXT(buf, r, g, b2, a2, function_pointer);
    }

    static native void nglColorMaskIndexedEXT(int var0, boolean var1, boolean var2, boolean var3, boolean var4, long var5);

    public static void glGetBooleanIndexedEXT(int value, int index, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBooleanIndexedvEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 4);
        EXTDrawBuffers2.nglGetBooleanIndexedvEXT(value, index, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static boolean glGetBooleanIndexedEXT(int value, int index) {
        ...
        long function_pointer = caps.glGetBooleanIndexedvEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        ByteBuffer data2 = APIUtil.getBufferByte(caps, 1);
        EXTDrawBuffers2.nglGetBooleanIndexedvEXT(value, index, MemoryUtil.getAddress(data2), function_pointer);
        return data2.get(0) == 1;
    }

    public static void glGetIntegerIndexedEXT(int value, int index, IntBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetIntegerIndexedvEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 4);
        EXTDrawBuffers2.nglGetIntegerIndexedvEXT(value, index, MemoryUtil.getAddress(data2), function_pointer);
    }
