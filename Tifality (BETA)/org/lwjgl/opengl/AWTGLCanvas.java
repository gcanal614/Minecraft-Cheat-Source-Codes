...
HierarchyListener {
    ...
    public void initContext(float r, float g, float b2) {
        GL11.glClearColor(r, g, b2, 0.0f);
        GL11.glClear(16384);
    }
     ...
     * WARNING - Removed try catching itself - possible behaviour change.
     */
    public final void setCLSharingProperties(PointerBuffer properties2) throws LWJGLException {
        Object object = this.SYNC_LOCK;
        synchronized (object) {
            if (this.context == null) {
                throw new IllegalStateException("Canvas not yet displayable");
            }
            this.context.setCLSharingProperties(properties2);
        }
    }
