...
public final class GL45 {
    ...
    public static void glNamedBufferStorage(int buffer, ByteBuffer data2, int flags) {
        ...
        GL45.nglNamedBufferStorage(buffer, data2.remaining(), MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glNamedBufferStorage(int buffer, DoubleBuffer data2, int flags) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferStorage(buffer, data2.remaining() << 3, MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glNamedBufferStorage(int buffer, FloatBuffer data2, int flags) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferStorage(buffer, data2.remaining() << 2, MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glNamedBufferStorage(int buffer, ShortBuffer data2, int flags) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferStorage(buffer, data2.remaining() << 1, MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glNamedBufferData(int buffer, ByteBuffer data2, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferData(buffer, data2.remaining(), MemoryUtil.getAddress(data2), usage, function_pointer);
    }
    ...
    public static void glNamedBufferData(int buffer, DoubleBuffer data2, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferData(buffer, data2.remaining() << 3, MemoryUtil.getAddress(data2), usage, function_pointer);
    }
    ...
    public static void glNamedBufferData(int buffer, FloatBuffer data2, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferData(buffer, data2.remaining() << 2, MemoryUtil.getAddress(data2), usage, function_pointer);
    }
    ...
    public static void glNamedBufferData(int buffer, ShortBuffer data2, int usage) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferData(buffer, data2.remaining() << 1, MemoryUtil.getAddress(data2), usage, function_pointer);
    }
    ...
    public static void glNamedBufferSubData(int buffer, long offset, ByteBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferSubData(buffer, offset, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glNamedBufferSubData(int buffer, long offset, DoubleBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferSubData(buffer, offset, data2.remaining() << 3, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glNamedBufferSubData(int buffer, long offset, FloatBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferSubData(buffer, offset, data2.remaining() << 2, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glNamedBufferSubData(int buffer, long offset, ShortBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglNamedBufferSubData(buffer, offset, data2.remaining() << 1, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glClearNamedBufferData(int buffer, int internalformat, int format, int type2, ByteBuffer data2) {
        ...
        GL45.nglClearNamedBufferData(buffer, internalformat, format, type2, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glClearNamedBufferSubData(int buffer, int internalformat, long offset, long size, int format, int type2, ByteBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 1);
        GL45.nglClearNamedBufferSubData(buffer, internalformat, offset, size, format, type2, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetNamedBufferSubData(int buffer, long offset, ByteBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglGetNamedBufferSubData(buffer, offset, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetNamedBufferSubData(int buffer, long offset, DoubleBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglGetNamedBufferSubData(buffer, offset, data2.remaining() << 3, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetNamedBufferSubData(int buffer, long offset, FloatBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglGetNamedBufferSubData(buffer, offset, data2.remaining() << 2, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetNamedBufferSubData(int buffer, long offset, ShortBuffer data2) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL45.nglGetNamedBufferSubData(buffer, offset, data2.remaining() << 1, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glCompressedTextureSubImage1D(int texture, int level, int xoffset, int width, int format, ByteBuffer data2) {
        ...
        GLChecks.ensureUnpackPBOdisabled(caps);
        BufferChecks.checkDirect(data2);
        GL45.nglCompressedTextureSubImage1D(texture, level, xoffset, width, format, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glCompressedTextureSubImage2D(int texture, int level, int xoffset, int yoffset, int width, int height, int format, ByteBuffer data2) {
        ...
        GLChecks.ensureUnpackPBOdisabled(caps);
        BufferChecks.checkDirect(data2);
        GL45.nglCompressedTextureSubImage2D(texture, level, xoffset, yoffset, width, height, format, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glCompressedTextureSubImage3D(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int imageSize, ByteBuffer data2) {
        ...
        GLChecks.ensureUnpackPBOdisabled(caps);
        BufferChecks.checkDirect(data2);
        GL45.nglCompressedTextureSubImage3D(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, MemoryUtil.getAddress(data2), function_pointer);
    }
