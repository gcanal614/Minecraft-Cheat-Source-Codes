...
public final class GL30 {
    ...
    public static void glColorMaski(int buf, boolean r, boolean g, boolean b2, boolean a2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glColorMaski;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL30.nglColorMaski(buf, r, g, b2, a2, function_pointer);
    }

    static native void nglColorMaski(int var0, boolean var1, boolean var2, boolean var3, boolean var4, long var5);

    public static void glGetBoolean(int value, int index, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBooleani_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 4);
        GL30.nglGetBooleani_v(value, index, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetInteger(int value, int index, IntBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetIntegeri_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 4);
        GL30.nglGetIntegeri_v(value, index, MemoryUtil.getAddress(data2), function_pointer);
    }
