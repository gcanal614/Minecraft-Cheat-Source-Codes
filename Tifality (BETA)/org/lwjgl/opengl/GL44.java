...
public final class GL44 {
    ...
    public static void glBufferStorage(int target, ByteBuffer data2, int flags) {
        ...
        GL44.nglBufferStorage(target, data2.remaining(), MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glBufferStorage(int target, DoubleBuffer data2, int flags) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL44.nglBufferStorage(target, data2.remaining() << 3, MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glBufferStorage(int target, FloatBuffer data2, int flags) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL44.nglBufferStorage(target, data2.remaining() << 2, MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glBufferStorage(int target, ShortBuffer data2, int flags) {
        ...
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL44.nglBufferStorage(target, data2.remaining() << 1, MemoryUtil.getAddress(data2), flags, function_pointer);
    }
    ...
    public static void glClearTexImage(int texture, int level, int format, int type2, ByteBuffer data2) {
        ...
        GL44.nglClearTexImage(texture, level, format, type2, MemoryUtil.getAddressSafe(data2), function_pointer);
    }
    ...
    public static void glClearTexSubImage(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type2, ByteBuffer data2) {
        ...
        GL44.nglClearTexSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type2, MemoryUtil.getAddressSafe(data2), function_pointer);
    }
