...
public final class GL15 {
    ...
    public static void glBufferData(int target, ByteBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferData(target, data2.remaining(), MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    public static void glBufferData(int target, DoubleBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferData(target, data2.remaining() << 3, MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    public static void glBufferData(int target, FloatBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferData(target, data2.remaining() << 2, MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    public static void glBufferData(int target, IntBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
    ...
    public static void glBufferData(int target, ShortBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferData(target, data2.remaining() << 1, MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    static native void nglBufferData(int var0, long var1, long var3, int var5, long var6);

    public static void glBufferSubData(int target, long offset, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferSubData(target, offset, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glBufferSubData(int target, long offset, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferSubData(target, offset, data2.remaining() << 3, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glBufferSubData(int target, long offset, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferSubData(target, offset, data2.remaining() << 2, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glBufferSubData(int target, long offset, IntBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
    ...
    public static void glBufferSubData(int target, long offset, ShortBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglBufferSubData(target, offset, data2.remaining() << 1, MemoryUtil.getAddress(data2), function_pointer);
    }

    static native void nglBufferSubData(int var0, long var1, long var3, long var5, long var7);

    public static void glGetBufferSubData(int target, long offset, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglGetBufferSubData(target, offset, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glGetBufferSubData(int target, long offset, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglGetBufferSubData(target, offset, data2.remaining() << 3, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glGetBufferSubData(int target, long offset, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglGetBufferSubData(target, offset, data2.remaining() << 2, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glGetBufferSubData(int target, long offset, IntBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
    ...
    public static void glGetBufferSubData(int target, long offset, ShortBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubData;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL15.nglGetBufferSubData(target, offset, data2.remaining() << 1, MemoryUtil.getAddress(data2), function_pointer);
    }
