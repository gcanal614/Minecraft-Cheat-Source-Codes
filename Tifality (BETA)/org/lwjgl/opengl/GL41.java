...
public final class GL41 {
    ...
    public static void glDepthRangef(float n, float f2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDepthRangef;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL41.nglDepthRangef(n, f2, function_pointer);
    }
    ...
    public static void glDepthRangeIndexed(int index, double n, double f2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glDepthRangeIndexed;
        BufferChecks.checkFunctionAddress(function_pointer);
        GL41.nglDepthRangeIndexed(index, n, f2, function_pointer);
    }

    static native void nglDepthRangeIndexed(int var0, double var1, double var3, long var5);

    public static void glGetFloat(int target, int index, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetFloati_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL41.nglGetFloati_v(target, index, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static float glGetFloat(int target, int index) {
        ...
        long function_pointer = caps.glGetFloati_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        FloatBuffer data2 = APIUtil.getBufferFloat(caps);
        GL41.nglGetFloati_v(target, index, MemoryUtil.getAddress(data2), function_pointer);
        return data2.get(0);
    }

    public static void glGetDouble(int target, int index, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetDoublei_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        GL41.nglGetDoublei_v(target, index, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static double glGetDouble(int target, int index) {
        ...
        long function_pointer = caps.glGetDoublei_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        DoubleBuffer data2 = APIUtil.getBufferDouble(caps);
        GL41.nglGetDoublei_v(target, index, MemoryUtil.getAddress(data2), function_pointer);
        return data2.get(0);
    }
}
