...
implements Context {
     ...
     */
    public synchronized void setCLSharingProperties(PointerBuffer properties2) throws LWJGLException {
        ...
        try {
            switch (LWJGLUtil.getPlatform()) {
                case 3: {
                    ...
                    properties2.put(8200L).put(implWindows.getHGLRC(this.handle));
                    properties2.put(8203L).put(implWindows.getHDC(peer_handle));
                    return;
                }
                case 1: {
                    LinuxContextImplementation implLinux = (LinuxContextImplementation)implementation;
                    properties2.put(8200L).put(implLinux.getGLXContext(this.handle));
                    properties2.put(8202L).put(implLinux.getDisplay(peer_handle));
                    return;
                }
                case 2: {
                    ...
                    properties2.put(0x10000000L).put(CGLShareGroup);
                    return;
                }
                default: {
