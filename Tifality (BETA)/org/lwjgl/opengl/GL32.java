...
public final class GL32 {
    ...
    public static void glGetInteger64(int pname, LongBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetInteger64v;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 1);
        GL32.nglGetInteger64v(pname, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static long glGetInteger64(int pname) {
        ...
        long function_pointer = caps.glGetInteger64v;
        BufferChecks.checkFunctionAddress(function_pointer);
        LongBuffer data2 = APIUtil.getBufferLong(caps);
        GL32.nglGetInteger64v(pname, MemoryUtil.getAddress(data2), function_pointer);
        return data2.get(0);
    }

    public static void glGetInteger64(int value, int index, LongBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetInteger64i_v;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(data2, 4);
        GL32.nglGetInteger64i_v(value, index, MemoryUtil.getAddress(data2), function_pointer);
    }
    ...
    public static void glGetSync(GLSync sync, int pname, IntBuffer length, IntBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        ...
        GL32.nglGetSynciv(sync.getPointer(), pname, values2.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(values2), function_pointer);
    }
    ...
    public static int glGetSynci(GLSync sync, int pname) {
        ...
        long function_pointer = caps.glGetSynciv;
        BufferChecks.checkFunctionAddress(function_pointer);
        IntBuffer values2 = APIUtil.getBufferInt(caps);
        GL32.nglGetSynciv(sync.getPointer(), pname, 1, 0L, MemoryUtil.getAddress(values2), function_pointer);
