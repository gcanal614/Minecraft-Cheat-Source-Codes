...
public class ARBBufferObject {
    ...
    public static void glBufferDataARB(int target, ByteBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferDataARB(target, data2.remaining(), MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    public static void glBufferDataARB(int target, DoubleBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferDataARB(target, data2.remaining() << 3, MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    public static void glBufferDataARB(int target, FloatBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferDataARB(target, data2.remaining() << 2, MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    public static void glBufferDataARB(int target, IntBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
    ...
    public static void glBufferDataARB(int target, ShortBuffer data2, int usage) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferDataARB(target, data2.remaining() << 1, MemoryUtil.getAddress(data2), usage, function_pointer);
    }

    static native void nglBufferDataARB(int var0, long var1, long var3, int var5, long var6);

    public static void glBufferSubDataARB(int target, long offset, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glBufferSubDataARB(int target, long offset, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data2.remaining() << 3, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glBufferSubDataARB(int target, long offset, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data2.remaining() << 2, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glBufferSubDataARB(int target, long offset, IntBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
    ...
    public static void glBufferSubDataARB(int target, long offset, ShortBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglBufferSubDataARB(target, offset, data2.remaining() << 1, MemoryUtil.getAddress(data2), function_pointer);
    }

    static native void nglBufferSubDataARB(int var0, long var1, long var3, long var5, long var7);

    public static void glGetBufferSubDataARB(int target, long offset, ByteBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data2.remaining(), MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glGetBufferSubDataARB(int target, long offset, DoubleBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data2.remaining() << 3, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glGetBufferSubDataARB(int target, long offset, FloatBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data2.remaining() << 2, MemoryUtil.getAddress(data2), function_pointer);
    }

    public static void glGetBufferSubDataARB(int target, long offset, IntBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
    ...
    public static void glGetBufferSubDataARB(int target, long offset, ShortBuffer data2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetBufferSubDataARB;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkDirect(data2);
        ARBBufferObject.nglGetBufferSubDataARB(target, offset, data2.remaining() << 1, MemoryUtil.getAddress(data2), function_pointer);
    }
