...
public final class GL40 {
    ...
    public static void glGetActiveSubroutineUniform(int program, int shadertype, int index, int pname, IntBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetActiveSubroutineUniformiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(values2, 1);
        GL40.nglGetActiveSubroutineUniformiv(program, shadertype, index, pname, MemoryUtil.getAddress(values2), function_pointer);
    }
    ...
    public static void glGetProgramStage(int program, int shadertype, int pname, IntBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetProgramStageiv;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(values2, 1);
        GL40.nglGetProgramStageiv(program, shadertype, pname, MemoryUtil.getAddress(values2), function_pointer);
    }
    ...
    public static void glPatchParameter(int pname, FloatBuffer values2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glPatchParameterfv;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(values2, 4);
        GL40.nglPatchParameterfv(pname, MemoryUtil.getAddress(values2), function_pointer);
    }
