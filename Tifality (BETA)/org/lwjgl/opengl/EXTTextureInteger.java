...
public final class EXTTextureInteger {
    ...
    public static void glClearColorIiEXT(int r, int g, int b2, int a2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glClearColorIiEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglClearColorIiEXT(r, g, b2, a2, function_pointer);
    }

    static native void nglClearColorIiEXT(int var0, int var1, int var2, int var3, long var4);

    public static void glClearColorIuiEXT(int r, int g, int b2, int a2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glClearColorIuiEXT;
        BufferChecks.checkFunctionAddress(function_pointer);
        EXTTextureInteger.nglClearColorIuiEXT(r, g, b2, a2, function_pointer);
    }
