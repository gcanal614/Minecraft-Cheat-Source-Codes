...
public final class NVShaderBufferLoad {
    ...
    public static void glGetIntegeruNV(int value, LongBuffer result2) {
        ContextCapabilities caps = GLContext.getCapabilities();
        long function_pointer = caps.glGetIntegerui64vNV;
        BufferChecks.checkFunctionAddress(function_pointer);
        BufferChecks.checkBuffer(result2, 1);
        NVShaderBufferLoad.nglGetIntegerui64vNV(value, MemoryUtil.getAddress(result2), function_pointer);
    }
