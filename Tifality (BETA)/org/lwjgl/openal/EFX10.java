...
public final class EFX10 {
    ...
    public static void alAuxiliaryEffectSlot(int auxiliaryeffectslot, int param, IntBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        EFX10.nalAuxiliaryEffectSlotiv(auxiliaryeffectslot, param, MemoryUtil.getAddress(values2));
    }
    ...
    public static void alAuxiliaryEffectSlot(int auxiliaryeffectslot, int param, FloatBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        EFX10.nalAuxiliaryEffectSlotfv(auxiliaryeffectslot, param, MemoryUtil.getAddress(values2));
    }
    ...
    public static void alEffect(int effect, int param, IntBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        EFX10.nalEffectiv(effect, param, MemoryUtil.getAddress(values2));
    }
    ...
    public static void alEffect(int effect, int param, FloatBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        EFX10.nalEffectfv(effect, param, MemoryUtil.getAddress(values2));
    }
    ...
    public static void alFilter(int filter, int param, IntBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        EFX10.nalFilteriv(filter, param, MemoryUtil.getAddress(values2));
    }
    ...
    public static void alFilter(int filter, int param, FloatBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        EFX10.nalFilterfv(filter, param, MemoryUtil.getAddress(values2));
    }
