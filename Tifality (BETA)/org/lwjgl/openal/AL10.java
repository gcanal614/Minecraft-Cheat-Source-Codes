...
public final class AL10 {
    ...
    public static void alGetInteger(int pname, IntBuffer data2) {
        BufferChecks.checkBuffer(data2, 1);
        AL10.nalGetIntegerv(pname, MemoryUtil.getAddress(data2));
    }

    static native void nalGetIntegerv(int var0, long var1);

    public static void alGetFloat(int pname, FloatBuffer data2) {
        BufferChecks.checkBuffer(data2, 1);
        AL10.nalGetFloatv(pname, MemoryUtil.getAddress(data2));
    }

    static native void nalGetFloatv(int var0, long var1);

    public static void alGetDouble(int pname, DoubleBuffer data2) {
        BufferChecks.checkBuffer(data2, 1);
        AL10.nalGetDoublev(pname, MemoryUtil.getAddress(data2));
    }
    ...
    public static void alBufferData(int buffer, int format, ByteBuffer data2, int freq) {
        BufferChecks.checkDirect(data2);
        AL10.nalBufferData(buffer, format, MemoryUtil.getAddress(data2), data2.remaining(), freq);
    }

    public static void alBufferData(int buffer, int format, IntBuffer data2, int freq) {
        BufferChecks.checkDirect(data2);
        AL10.nalBufferData(buffer, format, MemoryUtil.getAddress(data2), data2.remaining() << 2, freq);
    }

    public static void alBufferData(int buffer, int format, ShortBuffer data2, int freq) {
        BufferChecks.checkDirect(data2);
        AL10.nalBufferData(buffer, format, MemoryUtil.getAddress(data2), data2.remaining() << 1, freq);
    }
