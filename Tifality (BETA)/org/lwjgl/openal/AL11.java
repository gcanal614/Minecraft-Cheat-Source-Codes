...
public final class AL11 {
    ...
    public static void alGetBuffer(int buffer, int pname, IntBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        AL11.nalGetBufferiv(buffer, pname, MemoryUtil.getAddress(values2));
    }
    ...
    public static void alGetBuffer(int buffer, int pname, FloatBuffer values2) {
        BufferChecks.checkBuffer(values2, 1);
        AL11.nalGetBufferfv(buffer, pname, MemoryUtil.getAddress(values2));
    }
