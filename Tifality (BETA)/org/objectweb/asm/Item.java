...
final class Item {
    ...
    void set(int type2, String strVal1, String strVal2, String strVal3) {
        this.type = type2;
        ...
        switch (type2) {
            ...
            case 16: 
            case 30: {
                this.hashCode = Integer.MAX_VALUE & type2 + strVal1.hashCode();
                return;
            }
            case 12: {
                this.hashCode = Integer.MAX_VALUE & type2 + strVal1.hashCode() * strVal2.hashCode();
                return;
            }
        }
        this.hashCode = Integer.MAX_VALUE & type2 + strVal1.hashCode() * strVal2.hashCode() * strVal3.hashCode();
    }
    ...
    void set(int position, int hashCode2) {
        this.type = 33;
