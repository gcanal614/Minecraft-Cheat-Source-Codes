...
extends Printer {
    ...
    public void visit(int version, int access, String name, String signature2, String superName, String[] interfaces) {
        ...
        if (n == -1) {
            ...
            simpleName2 = name.substring(n + 1);
        }
        this.text.add("import java.util.*;\n");
        this.text.add("import org.objectweb.asm.*;\n");
        this.text.add("public class " + simpleName2 + "Dump implements Opcodes {\n\n");
        ...
        this.buf.append(", ");
        this.appendConstant(signature2);
        this.buf.append(", ");
    ...
    public ASMifier visitField(int access, String name, String desc, String signature2, Object value) {
        this.buf.setLength(0);
        this.buf.append("{\n");
    ...
    public ASMifier visitMethod(int access, String name, String desc, String signature2, String[] exceptions) {
        this.buf.setLength(0);
        this.buf.append("{\n");
    ...
    public void visitLookupSwitchInsn(Label dflt, int[] keys2, Label[] labels) {
        ...
        for (i = 0; i < keys2.length; ++i) {
            this.buf.append(i == 0 ? " " : ", ").append(keys2[i]);
        }
        this.buf.append(" }, new Label[] {");
        for (i = 0; i < labels.length; ++i) {
            this.buf.append(i == 0 ? " " : ", ");
