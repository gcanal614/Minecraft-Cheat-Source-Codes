...
extends Printer {
    ...
    public Textifier visitField(int access, String name, String desc, String signature2, Object value) {
        this.buf.setLength(0);
        this.buf.append('\n');
        if ((access & 0x20000) != 0) {
    ...
    public Textifier visitMethod(int access, String name, String desc, String signature2, String[] exceptions) {
        this.buf.setLength(0);
        this.buf.append('\n');
        if ((access & 0x20000) != 0) {
            this.buf.append(this.tab).append("// DEPRECATED\n");
            ...
            for (int i = 0; i < bsmArgs.length; ++i) {
                ...
                if (cst instanceof String) {
                    ...
                    if (type2.getSort() == 11) {
                        ...
                        this.buf.append(type2.getDescriptor()).append(".class");
                    }
    ...
    protected void appendDescriptor(int type2, String desc) {
