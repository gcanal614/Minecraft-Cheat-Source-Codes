...
extends LocalVariablesSorter {
    ...
    public RemappingMethodAdapter(int access, String desc, MethodVisitor mv, Remapper remapper) {
        this(327680, access, desc, mv, remapper);
    }
    ...
    public void visitLocalVariable(String name, String desc, String signature2, Label start, Label end, int index) {
        super.visitLocalVariable(name, this.remapper.mapDesc(desc), this.remapper.mapSignature(signature2, true), start, end, index);
    }
