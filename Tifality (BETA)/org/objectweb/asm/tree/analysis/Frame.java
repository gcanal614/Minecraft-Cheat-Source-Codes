    ...
    public void execute(AbstractInsnNode insn, Interpreter<V> interpreter) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 185: {
                ...
                this.push(interpreter.naryOperation(insn, values2));
                return;
            }
            case 186: {
                ArrayList<V> values3 = new ArrayList<V>();
                String desc = ((InvokeDynamicInsnNode)insn).desc;
                for (int i = Type.getArgumentTypes(desc).length; i > 0; --i) {
                    values3.add(0, this.pop());
                }
                if (Type.getReturnType(desc) == Type.VOID_TYPE) {
                    interpreter.naryOperation(insn, values3);
                    return;
                }
                this.push(interpreter.naryOperation(insn, values3));
                return;
            }
            case 187: {
                this.push(interpreter.newOperation(insn));
            ...
            case 197: {
                ArrayList<V> values4 = new ArrayList<V>();
                for (int i = ((MultiANewArrayInsnNode)insn).dims; i > 0; --i) {
                    values4.add(0, this.pop());
                }
                this.push(interpreter.naryOperation(insn, values4));
                return;
            }
            case 198: 
            case 199: {
