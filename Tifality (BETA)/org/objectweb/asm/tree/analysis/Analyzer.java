        ...
        while (this.top > 0) {
            ...
            try {
                ...
                if (insnType == 8 || insnType == 15 || insnType == 14) {
                    ...
                    if (insnNode instanceof JumpInsnNode) {
                        ...
                        for (int i = 0; i < subroutine.callers.size(); ++i) {
                            ...
                            int call = this.insns.indexOf(caller2);
                ...
                for (int i = 0; i < insnHandlers.size(); ++i) {
                    ...
                    Type type2 = tcb.type == null ? Type.getObjectType("java/lang/Throwable") : Type.getObjectType(tcb.type);
                    int jump = this.insns.indexOf(tcb.handler);
                    if (!this.newControlFlowExceptionEdge(insn, tcb)) continue;
                    handler.init(f);
                    handler.clearStack();
                    handler.push(this.interpreter.newValue(type2));
