...
extends FieldVisitor {
    ...
    public FieldNode(int access, String name, String desc, String signature2, Object value) {
        this(327680, access, name, desc, signature2, value);
        if (this.getClass() != FieldNode.class) {
            throw new IllegalStateException();
        }
    }

    public FieldNode(int api, int access, String name, String desc, String signature2, Object value) {
        super(api);
        this.access = access;
        this.name = name;
        this.desc = desc;
