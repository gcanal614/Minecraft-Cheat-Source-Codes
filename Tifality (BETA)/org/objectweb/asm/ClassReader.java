...
public class ClassReader {
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attrs, int flags) {
        ...
        classVisitor.visit(this.readInt(this.items[1] - 7), access, name, signature2, superClass, interfaces);
    ...
    private int readField(ClassVisitor classVisitor, Context context, int u) {
        ...
        u += 2;
        FieldVisitor fv = classVisitor.visitField(access, name, desc, signature2, value);
        if (fv == null) {
            return u;
        }
        if (anns != 0) {
    ...
    private void readCode(MethodVisitor mv, Context context, int u) {
        ...
        for (int i3 = this.readUnsignedShort(u); i3 > 0; --i3) {
            ...
            mv.visitTryCatchBlock(start, end, handler, type2);
            u += 8;
        }
        u += 2;
        int[] tanns = null;
