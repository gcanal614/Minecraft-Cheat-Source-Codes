...
implements Message {
    ...
    static {
        Method[] methods2 = ThreadInfo.class.getMethods();
        boolean basic = true;
    ...
    implements ThreadInfoFactory {
        ...
        public Map<ThreadInformation, StackTraceElement[]> createThreadInfo() {
            ...
            HashMap<ThreadInformation, StackTraceElement[]> threads = new HashMap<ThreadInformation, StackTraceElement[]>(map2.size());
