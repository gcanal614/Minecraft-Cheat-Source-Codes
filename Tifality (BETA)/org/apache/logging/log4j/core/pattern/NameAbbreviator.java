...
public abstract class NameAbbreviator {
    ...
    public static NameAbbreviator getAbbreviator(String pattern) {
        if (pattern.length() > 0) {
            ...
            ArrayList<PatternAbbreviatorFragment> fragments2 = new ArrayList<PatternAbbreviatorFragment>(5);
            for (int pos = 0; pos < trimmed.length() && pos >= 0; ++pos) {
                ...
                fragments2.add(new PatternAbbreviatorFragment(charCount, ellipsis));
                pos = trimmed.indexOf(46, pos);
                if (pos == -1) break;
            }
            return new PatternAbbreviator(fragments2);
        }
        return DEFAULT;
    }
    ...
    extends NameAbbreviator {
        ...
        public PatternAbbreviator(List<PatternAbbreviatorFragment> fragments2) {
