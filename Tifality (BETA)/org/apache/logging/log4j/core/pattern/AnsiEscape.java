...
public enum AnsiEscape {
    ...
    public static Map<String, String> createMap(String values2, String[] dontEscapeKeys) {
        return AnsiEscape.createMap(values2.split(AnsiEscape.toRegexSeparator(",")), dontEscapeKeys);
    }
    ...
    public static Map<String, String> createMap(String[] values2, String[] dontEscapeKeys) {
        ...
        for (String string : values2) {
            ...
            map2.put(key, escape ? AnsiEscape.createSequence(value.split("\\s")) : value);
        }
        return map2;
    }
