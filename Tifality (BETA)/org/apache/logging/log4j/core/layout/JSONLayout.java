...
extends AbstractStringLayout {
    ...
    protected JSONLayout(boolean locationInfo, boolean properties2, boolean complete, boolean compact, Charset charset) {
        super(charset);
    ...
    @PluginFactory
    public static JSONLayout createLayout(@PluginAttribute(value="locationInfo") String locationInfo, @PluginAttribute(value="properties") String properties2, @PluginAttribute(value="complete") String completeStr, @PluginAttribute(value="compact") String compactStr, @PluginAttribute(value="charset") String charsetName) {
        Charset charset = Charsets.getSupportedCharset(charsetName, Charsets.UTF_8);
        boolean info = Boolean.parseBoolean(locationInfo);
        boolean props = Boolean.parseBoolean(properties2);
