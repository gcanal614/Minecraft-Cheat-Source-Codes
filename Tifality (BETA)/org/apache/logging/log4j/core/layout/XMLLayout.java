...
extends AbstractStringLayout {
    ...
    protected XMLLayout(boolean locationInfo, boolean properties2, boolean complete, boolean compact, String nsPrefix, Charset charset) {
        super(charset);
    ...
    public String toSerializable(LogEvent event) {
        ...
        buf.append("\" level=\"");
        buf.append(Transform.escapeHtmlTags(String.valueOf((Object)event.getLevel())));
        buf.append("\" thread=\"");
    ...
    public Map<String, String> getContentFormat() {
        ...
        result2.put("xsd", "log4j-events.xsd");
