...
public final class ThrowableFormatOptions {
    ...
    protected ThrowableFormatOptions(int lines, String separator, List<String> packages2) {
        this.lines = lines;
        this.separator = separator == null ? Constants.LINE_SEP : separator;
        this.packages = packages2;
    }

    protected ThrowableFormatOptions(List<String> packages2) {
        this(Integer.MAX_VALUE, null, packages2);
    }
    ...
    public static ThrowableFormatOptions newInstance(String[] options) {
        ...
        List<String> packages2 = ThrowableFormatOptions.DEFAULT.packages;
        for (String rawOption : options) {
            ...
            if (option.startsWith("filters(") && option.endsWith(")")) {
                ...
                packages2 = new ArrayList<String>(array.length);
        ...
        return new ThrowableFormatOptions(lines, separator, packages2);
    }
}
