...
implements Serializable {
    ...
    public ThrowableProxy(Throwable throwable) {
        ...
        HashMap<String, CacheEntry> map2 = new HashMap<String, CacheEntry>();
        Stack<Class<?>> stack = this.getCurrentStack();
        this.callerPackageData = this.resolvePackageData(stack, map2, null, throwable.getStackTrace());
        this.proxyCause = throwable.getCause() == null ? null : new ThrowableProxy(throwable, stack, map2, throwable.getCause());
        this.setSuppressed(throwable);
    }

    private ThrowableProxy(Throwable parent, Stack<Class<?>> stack, Map<String, CacheEntry> map2, Throwable cause) {
        this.throwable = cause;
        this.name = cause.getClass().getName();
        this.callerPackageData = this.resolvePackageData(stack, map2, parent.getStackTrace(), cause.getStackTrace());
        this.proxyCause = cause.getCause() == null ? null : new ThrowableProxy(parent, stack, map2, cause.getCause());
    ...
    public String getRootCauseStackTrace(List<String> packages2) {
        ...
        sb.append("\n");
        this.formatElements(sb, 0, this.throwable.getStackTrace(), this.callerPackageData, packages2);
        return sb.toString();
    }
    ...
    public void formatWrapper(StringBuilder sb, ThrowableProxy cause, List<String> packages2) {
        Throwable caused;
        ...
        this.formatElements(sb, cause.commonElementCount, cause.getThrowable().getStackTrace(), cause.callerPackageData, packages2);
    }
    ...
    public String getExtendedStackTrace(List<String> packages2) {
        ...
        this.formatElements(sb, 0, this.throwable.getStackTrace(), this.callerPackageData, packages2);
        if (this.proxyCause != null) {
            this.formatCause(sb, this.proxyCause, packages2);
        }
        return sb.toString();
    }
    ...
    private void formatCause(StringBuilder sb, ThrowableProxy cause, List<String> packages2) {
        sb.append("Caused by: ").append(cause).append("\n");
        this.formatElements(sb, cause.commonElementCount, cause.getThrowable().getStackTrace(), cause.callerPackageData, packages2);
        if (cause.getCause() != null) {
            this.formatCause(sb, cause.proxyCause, packages2);
        }
    }

    private void formatElements(StringBuilder sb, int commonCount, StackTraceElement[] causedTrace, StackTracePackageElement[] packageData, List<String> packages2) {
        if (packages2 == null || packages2.size() == 0) {
            ...
            int count = 0;
            for (int i = 0; i < packageData.length; ++i) {
                if (!this.isSuppressed(causedTrace[i], packages2)) {
                    if (count > 0) {
                        if (count == 1) {
                            sb.append("\t....\n");
                        } else {
    ...
    private boolean isSuppressed(StackTraceElement element, List<String> packages2) {
    ...
    StackTracePackageElement[] resolvePackageData(Stack<Class<?>> stack, Map<String, CacheEntry> map2, StackTraceElement[] rootTrace, StackTraceElement[] stackTrace) {
        int stackLength;
        if (rootTrace != null) {
            int stackIndex;
    ...
    static {
        ...
        for (Method method : methods2 = Throwable.class.getMethods()) {
