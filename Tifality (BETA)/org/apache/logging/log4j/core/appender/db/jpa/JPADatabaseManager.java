...
extends AbstractDatabaseManager {
    ...
    implements ManagerFactory<JPADatabaseManager, FactoryData> {
        ...
        @Override
        public JPADatabaseManager createManager(String name, FactoryData data2) {
            return new JPADatabaseManager(name, data2.getBufferSize(), data2.entityClass, data2.entityConstructor, data2.persistenceUnitName);
        }
    }
