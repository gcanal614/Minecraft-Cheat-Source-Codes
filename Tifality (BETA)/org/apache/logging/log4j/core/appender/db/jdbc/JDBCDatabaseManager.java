...
extends AbstractDatabaseManager {
    ...
    implements ManagerFactory<JDBCDatabaseManager, FactoryData> {
        ...
        @Override
        public JDBCDatabaseManager createManager(String name, FactoryData data2) {
            StringBuilder columnPart = new StringBuilder();
            StringBuilder valuePart = new StringBuilder();
            ArrayList<Column> columns = new ArrayList<Column>();
            int i = 0;
            for (ColumnConfig config : data2.columnConfigs) {
                if (i++ > 0) {
                    columnPart.append(',');
                    valuePart.append(',');
                }
            ...
            String sqlStatement = "INSERT INTO " + data2.tableName + " (" + columnPart + ") VALUES (" + valuePart + ")";
            return new JDBCDatabaseManager(name, data2.getBufferSize(), data2.connectionSource, sqlStatement, columns);
        }
    }
