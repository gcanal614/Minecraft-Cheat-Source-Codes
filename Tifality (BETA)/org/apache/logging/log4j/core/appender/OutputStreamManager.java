...
extends AbstractManager {
    ...
    public static <T> OutputStreamManager getManager(String name, T data2, ManagerFactory<? extends OutputStreamManager, T> factory) {
        return AbstractManager.getManager(name, factory, data2);
    }
