...
extends OutputStreamManager {
    ...
    public Map<String, String> getContentFormat() {
        ...
        result2.put("fileURI", this.advertiseURI);
        return result2;
    }
    ...
    implements ManagerFactory<RandomAccessFileManager, FactoryData> {
        ...
        @Override
        public RandomAccessFileManager createManager(String name, FactoryData data2) {
            ...
            try {
                ...
                return new RandomAccessFileManager(raf, name, os, data2.immediateFlush, data2.advertiseURI, data2.layout);
            }
            catch (Exception ex) {
