...
extends AbstractAppender {
    ...
    public void start() {
        ...
        int errors = 0;
        if (map2.containsKey(this.primaryRef)) {
            this.primary = new AppenderControl(map2.get(this.primaryRef), null, null);
        } else {
        ...
        for (String name : this.failovers) {
            if (map2.containsKey(name)) {
                this.failoverAppenders.add(new AppenderControl(map2.get(name), null, null));
                continue;
            }
