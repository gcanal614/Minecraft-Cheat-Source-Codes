...
extends RollingFileManager {
    ...
    public synchronized void close() {
        ...
        try {
            ...
            LOGGER.error("Unable to close RandomAccessFile " + this.getName() + ". " + ex);
        }
    }
    ...
    implements ManagerFactory<RollingRandomAccessFileManager, FactoryData> {
        ...
        @Override
        public RollingRandomAccessFileManager createManager(String name, FactoryData data2) {
            ...
            try {
                ...
                return new RollingRandomAccessFileManager(raf, name, data2.pattern, new DummyOutputStream(), data2.append, data2.immediateFlush, size, time, data2.policy, data2.strategy, data2.advertiseURI, data2.layout);
            }
            catch (IOException ex) {
