...
extends AbstractJMSManager {
    ...
    implements ManagerFactory<JMSTopicManager, FactoryData> {
        ...
        @Override
        public JMSTopicManager createManager(String name, FactoryData data2) {
            try {
                ...
                TopicInfo info = JMSTopicManager.connect(ctx, data2.factoryBindingName, data2.topicBindingName, data2.userName, data2.password, true);
                return new JMSTopicManager(name, ctx, data2.factoryBindingName, data2.topicBindingName, data2.userName, data2.password, info);
            }
            catch (NamingException ex) {
