...
extends AbstractSocketManager {
    ...
    implements ManagerFactory<TCPSocketManager, FactoryData> {
        ...
        @Override
        public TCPSocketManager createManager(String name, FactoryData data2) {
            InetAddress address;
            try {
            ...
            try {
                Socket socket = new Socket(data2.host, data2.port);
                OutputStream os = socket.getOutputStream();
                return new TCPSocketManager(name, os, socket, address, data2.host, data2.port, data2.delay, data2.immediateFail, data2.layout);
            }
            catch (IOException ex) {
                ...
                return new TCPSocketManager(name, os, null, address, data2.host, data2.port, data2.delay, data2.immediateFail, data2.layout);
            }
        }
    }
