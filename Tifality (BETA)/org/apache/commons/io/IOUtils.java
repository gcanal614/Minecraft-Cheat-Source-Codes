...
public class IOUtils {
    ...
    public static byte[] toByteArray(InputStream input, int size) throws IOException {
        ...
        for (offset = 0; offset < size && (readed = input.read(data2, offset, size - offset)) != -1; offset += readed) {
        }
        if (offset != size) {
    ...
    public static void write(byte[] data2, Writer output, Charset encoding) throws IOException {
        if (data2 != null) {
            output.write(new String(data2, Charsets.toCharset(encoding)));
        }
    }

    public static void write(byte[] data2, Writer output, String encoding) throws IOException {
        IOUtils.write(data2, output, Charsets.toCharset(encoding));
    }
    ...
    public static void write(char[] data2, OutputStream output, Charset encoding) throws IOException {
        if (data2 != null) {
            output.write(new String(data2).getBytes(Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void write(CharSequence data2, Writer output) throws IOException {
        if (data2 != null) {
            IOUtils.write(((Object)data2).toString(), output);
        }
    }
    ...
    public static void write(CharSequence data2, OutputStream output, Charset encoding) throws IOException {
        if (data2 != null) {
            IOUtils.write(((Object)data2).toString(), output, encoding);
        }
    }
    ...
    public static void write(String data2, OutputStream output, Charset encoding) throws IOException {
        if (data2 != null) {
            output.write(data2.getBytes(Charsets.toCharset(encoding)));
        }
    }
    ...
    public static void write(StringBuffer data2, OutputStream output, String encoding) throws IOException {
        if (data2 != null) {
            output.write(data2.toString().getBytes(Charsets.toCharset(encoding)));
        }
    }
