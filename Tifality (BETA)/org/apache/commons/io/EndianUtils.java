...
public class EndianUtils {
    ...
    public static void writeSwappedShort(byte[] data2, int offset, short value) {
        data2[offset + 0] = (byte)(value >> 0 & 0xFF);
        data2[offset + 1] = (byte)(value >> 8 & 0xFF);
    }
    ...
    public static void writeSwappedInteger(byte[] data2, int offset, int value) {
        data2[offset + 0] = (byte)(value >> 0 & 0xFF);
        data2[offset + 1] = (byte)(value >> 8 & 0xFF);
        data2[offset + 2] = (byte)(value >> 16 & 0xFF);
        data2[offset + 3] = (byte)(value >> 24 & 0xFF);
    }
    ...
    public static void writeSwappedLong(byte[] data2, int offset, long value) {
        data2[offset + 0] = (byte)(value >> 0 & 0xFFL);
        data2[offset + 1] = (byte)(value >> 8 & 0xFFL);
        data2[offset + 2] = (byte)(value >> 16 & 0xFFL);
        data2[offset + 3] = (byte)(value >> 24 & 0xFFL);
        data2[offset + 4] = (byte)(value >> 32 & 0xFFL);
        data2[offset + 5] = (byte)(value >> 40 & 0xFFL);
        data2[offset + 6] = (byte)(value >> 48 & 0xFFL);
        data2[offset + 7] = (byte)(value >> 56 & 0xFFL);
    }

    public static long readSwappedLong(byte[] data2, int offset) {
        long low = ((data2[offset + 0] & 0xFF) << 0) + ((data2[offset + 1] & 0xFF) << 8) + ((data2[offset + 2] & 0xFF) << 16) + ((data2[offset + 3] & 0xFF) << 24);
        long high = ((data2[offset + 4] & 0xFF) << 0) + ((data2[offset + 5] & 0xFF) << 8) + ((data2[offset + 6] & 0xFF) << 16) + ((data2[offset + 7] & 0xFF) << 24);
        return (high << 32) + (0xFFFFFFFFL & low);
    }

    public static void writeSwappedFloat(byte[] data2, int offset, float value) {
        EndianUtils.writeSwappedInteger(data2, offset, Float.floatToIntBits(value));
    }
    ...
    public static void writeSwappedDouble(byte[] data2, int offset, double value) {
        EndianUtils.writeSwappedLong(data2, offset, Double.doubleToLongBits(value));
    }
