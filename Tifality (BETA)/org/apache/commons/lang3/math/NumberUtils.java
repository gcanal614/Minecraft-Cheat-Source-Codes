...
public class NumberUtils {
    ...
    public static long min(long a2, long b2, long c) {
        if (b2 < a2) {
            a2 = b2;
        }
        if (c < a2) {
    ...
    public static int min(int a2, int b2, int c) {
        if (b2 < a2) {
            a2 = b2;
        }
        if (c < a2) {
    ...
    public static short min(short a2, short b2, short c) {
        if (b2 < a2) {
            a2 = b2;
        }
        if (c < a2) {
    ...
    public static byte min(byte a2, byte b2, byte c) {
        if (b2 < a2) {
            a2 = b2;
        }
        if (c < a2) {
    ...
    public static double min(double a2, double b2, double c) {
        return Math.min(Math.min(a2, b2), c);
    }
    ...
    public static long max(long a2, long b2, long c) {
        if (b2 > a2) {
            a2 = b2;
        }
        if (c > a2) {
    ...
    public static int max(int a2, int b2, int c) {
        if (b2 > a2) {
            a2 = b2;
        }
        if (c > a2) {
    ...
    public static short max(short a2, short b2, short c) {
        if (b2 > a2) {
            a2 = b2;
        }
        if (c > a2) {
    ...
    public static byte max(byte a2, byte b2, byte c) {
        if (b2 > a2) {
            a2 = b2;
        }
        if (c > a2) {
