...
public class Validate {
    ...
    public static <T extends Map<?, ?>> T notEmpty(T map2, String message, Object ... values2) {
        if (map2 == null) {
            throw new NullPointerException(String.format(message, values2));
        }
        if (map2.isEmpty()) {
    ...
    public static void isInstanceOf(Class<?> type2, Object obj, String message, Object ... values2) {
        if (!type2.isInstance(obj)) {
            throw new IllegalArgumentException(String.format(message, values2));
        }
    }
    ...
    public static void isAssignableFrom(Class<?> superType, Class<?> type2, String message, Object ... values2) {
        if (!superType.isAssignableFrom(type2)) {
            throw new IllegalArgumentException(String.format(message, values2));
        }
    }
