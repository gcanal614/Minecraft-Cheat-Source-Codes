...
implements Builder<Integer> {
    ...
    private static void reflectionAppend(Object lhs, Object rhs, Class<?> clazz, CompareToBuilder builder, boolean useTransients, String[] excludeFields) {
        AccessibleObject[] fields2 = clazz.getDeclaredFields();
        AccessibleObject.setAccessible(fields2, true);
        for (int i = 0; i < fields2.length && builder.comparison == 0; ++i) {
            AccessibleObject f2 = fields2[i];
            if (ArrayUtils.contains(excludeFields, ((Field)f2).getName()) || ((Field)f2).getName().indexOf(36) != -1 || !useTransients && Modifier.isTransient(((Field)f2).getModifiers()) || Modifier.isStatic(((Field)f2).getModifiers())) continue;
            try {
