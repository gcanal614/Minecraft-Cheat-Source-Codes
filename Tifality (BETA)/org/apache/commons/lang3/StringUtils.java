...
public class StringUtils {
    ...
    public static String join(Iterator<?> iterator2, char separator) {
        ...
        if (!iterator2.hasNext()) {
            String result2 = ObjectUtils.toString(first);
            return result2;
        }
    ...
    private static int commonPrefixLength(CharSequence first, CharSequence second) {
        int result2 = StringUtils.getCommonPrefix(first.toString(), second.toString()).length();
        return result2 > 4 ? 4 : result2;
    }
