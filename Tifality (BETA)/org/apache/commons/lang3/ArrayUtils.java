...
public class ArrayUtils {
    ...
    public static char[] toPrimitive(Character[] array) {
        ...
        char[] result2 = new char[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i].charValue();
        }
        return result2;
    }
    ...
    public static char[] toPrimitive(Character[] array, char valueForNull) {
        ...
        char[] result2 = new char[array.length];
        for (int i = 0; i < array.length; ++i) {
            Character b2 = array[i];
            result2[i] = b2 == null ? valueForNull : b2.charValue();
        }
        return result2;
    }
    ...
    public static Character[] toObject(char[] array) {
        ...
        Character[] result2 = new Character[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = Character.valueOf(array[i]);
        }
        return result2;
    }
    ...
    public static long[] toPrimitive(Long[] array) {
        ...
        long[] result2 = new long[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i];
        }
        return result2;
    ...
    public static long[] toPrimitive(Long[] array, long valueForNull) {
        ...
        for (int i = 0; i < array.length; ++i) {
            Long b2 = array[i];
            result2[i] = b2 == null ? valueForNull : b2;
        }
        return result2;
    }
    ...
    public static Integer[] toObject(int[] array) {
        ...
        Integer[] result2 = new Integer[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i];
        }
        return result2;
    ...
    public static short[] toPrimitive(Short[] array) {
        ...
        short[] result2 = new short[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i];
        }
        return result2;
    ...
    public static double[] toPrimitive(Double[] array) {
        ...
        double[] result2 = new double[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i];
        }
        return result2;
    ...
    public static float[] toPrimitive(Float[] array, float valueForNull) {
        ...
        for (int i = 0; i < array.length; ++i) {
            Float b2 = array[i];
            result2[i] = b2 == null ? valueForNull : b2.floatValue();
        }
        return result2;
    }
    ...
    public static Float[] toObject(float[] array) {
        ...
        Float[] result2 = new Float[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = Float.valueOf(array[i]);
        }
        return result2;
    }
    ...
    public static boolean[] toPrimitive(Boolean[] array) {
        ...
        boolean[] result2 = new boolean[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i];
        }
        return result2;
    ...
    public static Boolean[] toObject(boolean[] array) {
        ...
        Boolean[] result2 = new Boolean[array.length];
        for (int i = 0; i < array.length; ++i) {
            result2[i] = array[i] ? Boolean.TRUE : Boolean.FALSE;
        }
        return result2;
    }
    ...
    private static Object add(Object array, int index, Object element, Class<?> clss) {
        ...
        Array.set(result2, index, element);
        if (index < length) {
            System.arraycopy(array, index, result2, index + 1, length - index);
        }
        return result2;
    }
    ...
    private static Object remove(Object array, int index) {
        ...
        Object result2 = Array.newInstance(array.getClass().getComponentType(), length - 1);
        System.arraycopy(array, 0, result2, 0, index);
        if (index < length - 1) {
            System.arraycopy(array, index + 1, result2, index, length - index - 1);
        }
        return result2;
    }
    ...
    public static <T> T[] removeElements(T[] array, T ... values2) {
        ...
        Object[] result2 = (Object[])ArrayUtils.removeAll(array, toRemove);
        return result2;
    }
    ...
    static Object removeAll(Object array, int ... indices) {
        ...
        Object result2 = Array.newInstance(array.getClass().getComponentType(), length - diff);
        if (diff < length) {
            int end = length;
            ...
            for (int i = indices.length - 1; i >= 0; --i) {
                ...
                if (end - index > 1) {
                    int cp = end - index - 1;
                    System.arraycopy(array, index + 1, result2, dest -= cp, cp);
                }
                end = index;
            }
            if (end > 0) {
    ...
    static Object removeAll(Object array, BitSet indices) {
        ...
        Object result2 = Array.newInstance(array.getClass().getComponentType(), srcLength - removals);
        int srcIndex = 0;
        int destIndex = 0;
        while ((set = indices.nextSetBit(srcIndex)) != -1) {
            count = set - srcIndex;
            if (count > 0) {
                System.arraycopy(array, srcIndex, result2, destIndex, count);
                destIndex += count;
            }
