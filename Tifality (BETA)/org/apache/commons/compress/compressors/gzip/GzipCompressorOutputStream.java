...
extends CompressorOutputStream {
    ...
    public GzipCompressorOutputStream(OutputStream out, GzipParameters parameters2) throws IOException {
        this.out = out;
        this.deflater = new Deflater(parameters2.getCompressionLevel(), true);
        this.writeHeader(parameters2);
    }

    private void writeHeader(GzipParameters parameters2) throws IOException {
        String filename = parameters2.getFilename();
        String comment = parameters2.getComment();
        ByteBuffer buffer = ByteBuffer.allocate(10);
        buffer.order(ByteOrder.LITTLE_ENDIAN);
        buffer.putShort((short)-29921);
        buffer.put((byte)8);
        buffer.put((byte)((filename != null ? 8 : 0) | (comment != null ? 16 : 0)));
        buffer.putInt((int)(parameters2.getModificationTime() / 1000L));
        int compressionLevel = parameters2.getCompressionLevel();
        ...
        buffer.put((byte)parameters2.getOperatingSystem());
