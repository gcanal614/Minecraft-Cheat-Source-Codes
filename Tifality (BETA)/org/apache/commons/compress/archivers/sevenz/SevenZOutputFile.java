...
implements Closeable {
    ...
    public void setContentMethods(Iterable<? extends SevenZMethodConfiguration> methods2) {
        this.contentMethods = SevenZOutputFile.reverse(methods2);
    }
    ...
    private void writeSingleCodec(SevenZMethodConfiguration m, OutputStream bos) throws IOException {
        ...
        byte[] properties2 = Coders.findByMethod(m.getMethod()).getOptionsAsProperties(m.getOptions());
        ...
        bos.write(id);
        if (properties2.length > 0) {
            bos.write(properties2.length);
            bos.write(properties2);
        }
    }
