...
implements ArchiveEntry {
    ...
    public DumpArchiveEntry(String name, String simpleName2) {
        this.setName(name);
        this.simpleName = simpleName2;
    }

    protected DumpArchiveEntry(String name, String simpleName2, int ino, TYPE type2) {
        this.setType(type2);
        this.setName(name);
        this.simpleName = simpleName2;
        this.ino = ino;
    ...
    protected void setSimpleName(String simpleName2) {
        this.simpleName = simpleName2;
    }
