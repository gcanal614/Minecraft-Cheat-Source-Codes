...
extends ArchiveOutputStream {
    ...
    protected void writeCentralDirectoryEnd() throws IOException {
        ...
        ByteBuffer data2 = this.zipEncoding.encode(this.comment);
        this.writeOut(ZipShort.getBytes(data2.limit()));
        this.writeOut(data2.array(), data2.arrayOffset(), data2.limit() - data2.position());
    }
    ...
    protected final void writeOut(byte[] data2) throws IOException {
        this.writeOut(data2, 0, data2.length);
    }

    protected final void writeOut(byte[] data2, int offset, int length) throws IOException {
        if (this.raf != null) {
            this.raf.write(data2, offset, length);
        } else {
            this.out.write(data2, offset, length);
        }
    }
