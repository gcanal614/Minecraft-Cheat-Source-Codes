...
implements ArchiveEntry {
    ...
    public void setExtraFields(ZipExtraField[] fields2) {
        this.extraFields = new LinkedHashMap();
        for (ZipExtraField field : fields2) {
    ...
    public ZipExtraField[] getExtraFields(boolean includeUnparseable) {
        ...
        ArrayList<ZipExtraField> result2 = new ArrayList<ZipExtraField>(this.extraFields.values());
        if (includeUnparseable && this.unparseableExtra != null) {
            result2.add(this.unparseableExtra);
        }
        return result2.toArray(new ZipExtraField[0]);
    }
    ...
    public void addAsFirstExtraField(ZipExtraField ze) {
        if (ze instanceof UnparseableExtraFieldData) {
            ...
            LinkedHashMap<ZipShort, ZipExtraField> copy2 = this.extraFields;
            this.extraFields = new LinkedHashMap();
            this.extraFields.put(ze.getHeaderId(), ze);
            if (copy2 != null) {
                copy2.remove(ze.getHeaderId());
                this.extraFields.putAll(copy2);
            }
        }
        this.setExtra();
    }
