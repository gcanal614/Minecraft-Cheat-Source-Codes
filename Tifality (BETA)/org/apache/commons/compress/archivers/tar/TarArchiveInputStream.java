...
extends ArchiveInputStream {
    ...
    public static boolean matches(byte[] signature2, int length) {
        ...
        if (ArchiveUtils.matchAsciiBuffer("ustar\u0000", signature2, 257, 6) && ArchiveUtils.matchAsciiBuffer("00", signature2, 263, 2)) {
            return true;
        }
        if (ArchiveUtils.matchAsciiBuffer("ustar ", signature2, 257, 6) && (ArchiveUtils.matchAsciiBuffer(" \u0000", signature2, 263, 2) || ArchiveUtils.matchAsciiBuffer("0\u0000", signature2, 263, 2))) {
            return true;
        }
        return ArchiveUtils.matchAsciiBuffer("ustar\u0000", signature2, 257, 6) && ArchiveUtils.matchAsciiBuffer("\u0000\u0000", signature2, 263, 2);
    }
}
