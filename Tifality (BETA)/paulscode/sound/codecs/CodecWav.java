...
implements ICodec {
    ...
    public SoundBuffer read() {
        ...
        byte[] data2 = CodecWav.convertAudioBytes(streamBuffer, audioFormat.getSampleSizeInBits() == 16);
        SoundBuffer buffer = new SoundBuffer(data2, audioFormat);
        return buffer;
    }
    ...
    public SoundBuffer readAll() {
        ...
        byte[] data2 = CodecWav.convertAudioBytes(fullBuffer, myAudioFormat.getSampleSizeInBits() == 16);
        SoundBuffer soundBuffer = new SoundBuffer(data2, myAudioFormat);
        try {
