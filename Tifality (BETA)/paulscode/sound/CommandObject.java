...
public class CommandObject {
    ...
    public CommandObject(int cmd, String s, float f2) {
        this.Command = cmd;
        this.floatArgs = new float[1];
        this.stringArgs = new String[1];
        this.floatArgs[0] = f2;
    ...
    public CommandObject(int cmd, String s, boolean b2) {
        this.Command = cmd;
    ...
    public CommandObject(int cmd, Object o, boolean b2, String s, float f1, float f2, float f3, int i, float f4) {
        this.Command = cmd;
        this.intArgs = new int[1];
        this.floatArgs = new float[4];
        this.boolArgs = new boolean[1];
