...
public class SoundSystem {
    ...
    public void loadSound(byte[] data2, AudioFormat format, String identifier) {
        this.CommandQueue(new CommandObject(3, identifier, new SoundBuffer(data2, format)));
        this.commandThread.interrupt();
    }
    ...
    public boolean playing() {
        ...
        synchronized (object) {
            ...
            Set<String> keys2 = sourceMap.keySet();
            for (String sourcename : keys2) {
