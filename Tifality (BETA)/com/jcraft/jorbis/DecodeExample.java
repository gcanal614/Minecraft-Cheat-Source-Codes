...
class DecodeExample {
    ...
    public static void main(String[] arg) {
        ...
        while (true) {
            ...
            while (i < 2) {
                int result2;
                while (i < 2 && (result2 = oy.pageout(og)) != 0) {
                    if (result2 != 1) continue;
                    os.pagein(og);
                    while (i < 2 && (result2 = os.packetout(op)) != 0) {
                        if (result2 == -1) {
            ...
            while (!eos) {
                int result3;
                while (!eos && (result3 = oy.pageout(og)) != 0) {
                    if (result3 == -1) {
                        System.err.println("Corrupt or missing data in bitstream; continuing...");
                        continue;
                    }
                    os.pagein(og);
                    while ((result3 = os.packetout(op)) != 0) {
                        int samples;
                        if (result3 == -1) continue;
