...
extends StdCallLibrary {
    ...
    extends Structure {
        ...
        public String getString() {
            byte[] data2 = this.Buffer.getByteArray(0L, this.Length);
            if (data2.length < 2 || data2[data2.length - 1] != 0) {
                Memory newdata = new Memory(data2.length + 2);
                newdata.write(0L, data2, 0, data2.length);
