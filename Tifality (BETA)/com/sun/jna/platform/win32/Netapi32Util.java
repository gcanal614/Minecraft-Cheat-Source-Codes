...
public abstract class Netapi32Util {
    ...
    public static LocalGroup[] getLocalGroups(String serverName) {
        ...
        try {
            ...
            LMAccess.LOCALGROUP_INFO_1[] groups2 = (LMAccess.LOCALGROUP_INFO_1[])group.toArray(entriesRead.getValue());
            ArrayList<LocalGroup> result2 = new ArrayList<LocalGroup>();
            for (LMAccess.LOCALGROUP_INFO_1 lgpi : groups2) {
                LocalGroup lgp = new LocalGroup();
                lgp.name = lgpi.lgrui1_name.toString();
                lgp.comment = lgpi.lgrui1_comment.toString();
                result2.add(lgp);
            }
            LocalGroup[] localGroupArray = result2.toArray(new LocalGroup[0]);
    ...
    public static Group[] getGlobalGroups(String serverName) {
        ...
        try {
            ...
            LMAccess.GROUP_INFO_1[] groups2 = (LMAccess.GROUP_INFO_1[])group.toArray(entriesRead.getValue());
            ArrayList<LocalGroup> result2 = new ArrayList<LocalGroup>();
            for (LMAccess.GROUP_INFO_1 lgpi : groups2) {
                LocalGroup lgp = new LocalGroup();
                lgp.name = lgpi.grpi1_name.toString();
                lgp.comment = lgpi.grpi1_comment.toString();
                result2.add(lgp);
            }
            Group[] groupArray = result2.toArray(new LocalGroup[0]);
            return groupArray;
        }
        finally {
            int rc;
    ...
    public static User[] getUsers(String serverName) {
        ...
        try {
            ...
            ArrayList<User> result2 = new ArrayList<User>();
            for (LMAccess.USER_INFO_1 lu : users) {
                User auser = new User();
                auser.name = lu.usri1_name.toString();
                result2.add(auser);
            }
            User[] userArray = result2.toArray(new User[0]);
            return userArray;
        }
        finally {
            int rc;
    ...
    public static Group[] getUserLocalGroups(String userName, String serverName) {
        ...
        try {
            ...
            Group[] groupArray = result2.toArray(new Group[0]);
            return groupArray;
        }
        finally {
            int rc;
    ...
    public static Group[] getUserGroups(String userName, String serverName) {
        ...
        try {
            ...
            ArrayList<Group> result2 = new ArrayList<Group>();
