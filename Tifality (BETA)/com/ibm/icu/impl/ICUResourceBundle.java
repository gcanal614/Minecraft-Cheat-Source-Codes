...
extends UResourceBundle {
    ...
    public ICUResourceBundle getWithFallback(String path) throws MissingResourceException {
        ICUResourceBundle result2 = null;
        ICUResourceBundle actualBundle = this;
        result2 = ICUResourceBundle.findResourceWithFallback(path, actualBundle, null);
        if (result2 == null) {
        ...
        if (result2.getType() == 0 && result2.getString().equals(NO_INHERITANCE_MARKER)) {
    ...
    private String getAliasValue(int res) {
        String result2 = this.reader.getAlias(res);
