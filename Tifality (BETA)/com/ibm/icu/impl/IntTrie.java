...
extends Trie {
    ...
    public boolean equals(Object other) {
        boolean result2 = super.equals(other);
        if (result2 && other instanceof IntTrie) {
    ...
    IntTrie(char[] index, int[] data2, int initialvalue, int options, Trie.DataManipulate datamanipulate) {
