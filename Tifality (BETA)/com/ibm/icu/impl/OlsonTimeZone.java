...
extends BasicTimeZone {
    ...
    public void setRawOffset(int offsetMillis) {
        ...
        if ((double)current < this.finalStartMillis) {
            ...
            int[] fields2 = Grego.timeToFields(current, null);
            this.finalStartYear = fields2[0];
            this.finalStartMillis = Grego.fieldsToDay(fields2[0], 0, 1);
            if (bDst) {
    ...
    public boolean useDaylightTime() {
        ...
        int[] fields2 = Grego.timeToFields(current, null);
        long start = Grego.fieldsToDay(fields2[0], 0, 1) * 86400L;
        long limit = Grego.fieldsToDay(fields2[0] + 1, 0, 1) * 86400L;
