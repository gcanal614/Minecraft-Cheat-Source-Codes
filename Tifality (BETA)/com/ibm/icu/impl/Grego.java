...
public class Grego {
    ...
    public static int[] dayToFields(long day, int[] fields2) {
        int march1;
    ...
    public static int[] timeToFields(long time, int[] fields2) {
        if (fields2 == null || fields2.length < 6) {
            fields2 = new int[6];
        }
        long[] remainder = new long[1];
        long day = Grego.floorDivide(time, 86400000L, remainder);
        Grego.dayToFields(day, fields2);
        fields2[5] = (int)remainder[0];
        return fields2;
    }
