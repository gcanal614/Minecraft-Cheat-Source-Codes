    ...
    public void getOffset(long date, boolean local, int[] offsets) {
        ...
        synchronized (calendar) {
            if (local) {
                ...
                int hour = tmp / 60;
                this.javacal.clear();
                this.javacal.set(fields2[0], fields2[1], fields2[2], hour, min, sec);
                ...
                if (fields2[4] != doy1 || hour != hour1 || min != min1 || sec != sec1 || mil != mil1) {
                    int dayDelta = Math.abs(doy1 - fields2[4]) > 1 ? 1 : doy1 - fields2[4];
