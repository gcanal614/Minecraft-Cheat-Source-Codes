...
public final class ZoneMeta {
    ...
    public static TimeZone getCustomTimeZone(String id) {
        int[] fields2 = new int[4];
        if (ZoneMeta.parseCustomID(id, fields2)) {
            Integer key = fields2[0] * (fields2[1] | fields2[2] << 5 | fields2[3] << 11);
            return (TimeZone)CUSTOM_ZONE_CACHE.getInstance(key, fields2);
        }
        return null;
    }
    ...
    public static String getCustomID(String id) {
        int[] fields2 = new int[4];
        if (ZoneMeta.parseCustomID(id, fields2)) {
            return ZoneMeta.formatCustomID(fields2[1], fields2[2], fields2[3], fields2[0] < 0);
        }
        return null;
    }

    static boolean parseCustomID(String id, int[] fields2) {
    ...
    extends SoftCache<Integer, SimpleTimeZone, int[]> {
        ...
        protected SimpleTimeZone createInstance(Integer key, int[] data2) {
            ...
            String id = ZoneMeta.formatCustomID(data2[1], data2[2], data2[3], data2[0] < 0);
