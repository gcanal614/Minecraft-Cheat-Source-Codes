...
extends PeriodBuilderImpl {
    SingleUnitBuilder(BasicPeriodBuilderFactory.Settings settings2) {
        super(settings2);
    }

    public static SingleUnitBuilder get(BasicPeriodBuilderFactory.Settings settings2) {
        if (settings2 == null) {
            return null;
        }
        return new SingleUnitBuilder(settings2);
    }
