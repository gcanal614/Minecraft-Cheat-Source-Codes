...
implements PeriodFormatterFactory {
    ...
    static class Customizations {
        ...
        public Customizations copy() {
            Customizations result2 = new Customizations();
            result2.displayLimit = this.displayLimit;
            result2.displayDirection = this.displayDirection;
            result2.separatorVariant = this.separatorVariant;
            result2.unitVariant = this.unitVariant;
            result2.countVariant = this.countVariant;
            return result2;
        }
    }
}
