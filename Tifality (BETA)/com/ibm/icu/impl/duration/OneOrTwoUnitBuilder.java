...
extends PeriodBuilderImpl {
    OneOrTwoUnitBuilder(BasicPeriodBuilderFactory.Settings settings2) {
        super(settings2);
    }

    public static OneOrTwoUnitBuilder get(BasicPeriodBuilderFactory.Settings settings2) {
        if (settings2 == null) {
            return null;
        }
        return new OneOrTwoUnitBuilder(settings2);
    }
