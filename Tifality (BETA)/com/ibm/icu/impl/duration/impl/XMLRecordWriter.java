...
implements RecordWriter {
    ...
    public void boolArray(String name, boolean[] values2) {
        if (values2 != null) {
            String[] stringValues = new String[values2.length];
            for (int i = 0; i < values2.length; ++i) {
                stringValues[i] = String.valueOf(values2[i]);
            }
    ...
    public void characterArray(String name, char[] values2) {
        if (values2 != null) {
            String[] stringValues = new String[values2.length];
            for (int i = 0; i < values2.length; ++i) {
                char value = values2[i];
    ...
    public void namedIndexArray(String name, String[] names, byte[] values2) {
        if (values2 != null) {
            String[] stringValues = new String[values2.length];
            for (int i = 0; i < values2.length; ++i) {
    ...
    public void stringArray(String name, String[] values2) {
        if (values2 != null) {
            this.push(name + "List");
            for (int i = 0; i < values2.length; ++i) {
                String value = XMLRecordWriter.normalize(values2[i]);
                if (value == null) {
                    value = NULL_NAME;
                }
    ...
    public void stringTable(String name, String[][] values2) {
        if (values2 != null) {
            this.push(name + "Table");
            for (int i = 0; i < values2.length; ++i) {
                String[] rowValues = values2[i];
                if (rowValues == null) {
