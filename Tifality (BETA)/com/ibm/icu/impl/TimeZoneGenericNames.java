...
Freezable<TimeZoneGenericNames> {
    ...
    private synchronized String formatPattern(Pattern pat, String ... args2) {
        int idx;
        if (this._patternFormatters == null) {
            this._patternFormatters = new MessageFormat[Pattern.values().length];
        }
        ...
        return this._patternFormatters[idx].format(args2);
    }
    ...
    public TimeZoneGenericNames cloneAsThawed() {
        TimeZoneGenericNames copy2 = null;
        try {
            copy2 = (TimeZoneGenericNames)super.clone();
            copy2._frozen = false;
        }
    ...
    extends SoftCache<String, TimeZoneGenericNames, ULocale> {
        ...
        @Override
        protected TimeZoneGenericNames createInstance(String key, ULocale data2) {
            return new TimeZoneGenericNames(data2).freeze();
        }
    }
