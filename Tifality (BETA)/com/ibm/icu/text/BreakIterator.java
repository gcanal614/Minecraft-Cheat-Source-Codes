...
implements Cloneable {
    ...
    public static BreakIterator getBreakInstance(ULocale where, int kind) {
        ...
        BreakIterator result2 = BreakIterator.getShim().createBreakIterator(where, kind);
        BreakIteratorCache cache2 = new BreakIteratorCache(where, result2);
        BreakIterator.iterCache[kind] = new SoftReference<BreakIteratorCache>(cache2);
        if (result2 instanceof RuleBasedBreakIterator) {
            RuleBasedBreakIterator rbbi = (RuleBasedBreakIterator)result2;
