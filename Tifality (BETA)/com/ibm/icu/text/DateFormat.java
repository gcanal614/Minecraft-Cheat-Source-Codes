...
extends UFormat {
    ...
    public Date parse(String text) throws ParseException {
        ...
        Date result2 = this.parse(text, pos);
        if (pos.getIndex() == 0) {
    ...
    private static DateFormat get(int dateStyle, int timeStyle, ULocale loc) {
        ...
        try {
            ...
            DateFormat result2 = cal.getDateTimeFormat(dateStyle, timeStyle, loc);
            result2.setLocale(cal.getLocale(ULocale.VALID_LOCALE), cal.getLocale(ULocale.ACTUAL_LOCALE));
            return result2;
        }
