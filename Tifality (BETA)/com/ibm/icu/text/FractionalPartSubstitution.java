...
extends NFSubstitution {
    ...
    FractionalPartSubstitution(int pos, NFRuleSet ruleSet, RuleBasedNumberFormat formatter, String description2) {
        super(pos, ruleSet, formatter, description2);
        if (description2.equals(">>") || description2.equals(">>>") || ruleSet == this.ruleSet) {
            this.byDigits = true;
    ...
    public Number doParse(String text, ParsePosition parsePosition, double baseValue, double upperBound, boolean lenientParse) {
        ...
        result2 = dl.count == 0 ? 0.0 : dl.getDouble();
        result2 = this.composeRuleValue(result2, baseValue);
