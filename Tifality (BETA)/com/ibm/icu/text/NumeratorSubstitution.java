...
extends NFSubstitution {
    ...
    NumeratorSubstitution(int pos, double denominator, NFRuleSet ruleSet, RuleBasedNumberFormat formatter, String description2) {
        super(pos, ruleSet, formatter, NumeratorSubstitution.fixdesc(description2));
    ...
    public Number doParse(String text, ParsePosition parsePosition, double baseValue, double upperBound, boolean lenientParse) {
        ...
        Number result2 = super.doParse(text, parsePosition, this.withZeros ? 1.0 : baseValue, upperBound, false);
        if (this.withZeros) {
            long d;
            ...
            result2 = new Double((double)n / (double)d);
        }
        return result2;
    }
