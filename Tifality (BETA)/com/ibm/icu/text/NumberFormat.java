...
extends UFormat {
    ...
    public Number parse(String text) throws ParseException {
        ...
        Number result2 = this.parse(text, parsePosition);
    ...
    protected static String getPattern(ULocale forLocale, int choice) {
        ...
        String result2 = null;
        try {
            result2 = rb.getStringWithFallback("NumberElements/" + ns.getName() + "/patterns/" + numberPatternKeys[entry]);
        }
        catch (MissingResourceException ex) {
            result2 = rb.getStringWithFallback("NumberElements/latn/patterns/" + numberPatternKeys[entry]);
        }
        return result2;
    }
