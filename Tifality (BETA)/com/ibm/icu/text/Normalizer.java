...
implements Cloneable {
    ...
    public Object clone() {
        try {
            Normalizer copy2 = (Normalizer)super.clone();
            copy2.text = (UCharacterIterator)this.text.clone();
            copy2.mode = this.mode;
            copy2.options = this.options;
            copy2.norm2 = this.norm2;
            copy2.buffer = new StringBuilder(this.buffer);
            copy2.bufferPos = this.bufferPos;
            copy2.currentIndex = this.currentIndex;
            copy2.nextIndex = this.nextIndex;
            return copy2;
        }
        catch (CloneNotSupportedException e) {
