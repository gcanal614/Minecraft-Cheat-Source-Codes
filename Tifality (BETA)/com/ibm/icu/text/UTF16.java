...
public final class UTF16 {
    ...
    public static int findOffsetFromCodePoint(String source, int offset32) {
        ...
        for (count = offset32; result2 < size && count > 0; --count, ++result2) {
            char ch = source.charAt(result2);
            if (!UTF16.isLeadSurrogate(ch) || result2 + 1 >= size || !UTF16.isTrailSurrogate(source.charAt(result2 + 1))) continue;
            ++result2;
        }
        if (count != 0) {
            throw new StringIndexOutOfBoundsException(offset32);
    ...
    public static int findOffsetFromCodePoint(char[] source, int start, int limit, int offset32) {
        ...
        for (count = offset32; result2 < limit && count > 0; --count, ++result2) {
            char ch = source[result2];
            if (!UTF16.isLeadSurrogate(ch) || result2 + 1 >= limit || !UTF16.isTrailSurrogate(source[result2 + 1])) continue;
            ++result2;
        }
        if (count != 0) {
            throw new ArrayIndexOutOfBoundsException(offset32);
        }
        return result2 - start;
    }
    ...
    public static int moveCodePointOffset(String source, int offset16, int shift32) {
        ...
        if (shift32 > 0) {
            ...
            for (count = shift32; result2 < size && count > 0; --count, ++result2) {
                char ch = source.charAt(result2);
                if (!UTF16.isLeadSurrogate(ch) || result2 + 1 >= size || !UTF16.isTrailSurrogate(source.charAt(result2 + 1))) continue;
                ++result2;
            }
            ...
            for (count = -shift32; count > 0 && --result2 >= 0; --count) {
                char ch = source.charAt(result2);
                if (!UTF16.isTrailSurrogate(ch) || result2 <= 0 || !UTF16.isLeadSurrogate(source.charAt(result2 - 1))) continue;
                --result2;
            }
        }
        if (count != 0) {
    ...
    public static int moveCodePointOffset(char[] source, int start, int limit, int offset16, int shift32) {
        ...
        if (offset16 < 0 || result2 > limit) {
            throw new StringIndexOutOfBoundsException(offset16);
        }
        if (shift32 > 0) {
            if (shift32 + result2 > size) {
                throw new StringIndexOutOfBoundsException(result2);
            }
            for (count = shift32; result2 < limit && count > 0; --count, ++result2) {
                char ch = source[result2];
                if (!UTF16.isLeadSurrogate(ch) || result2 + 1 >= limit || !UTF16.isTrailSurrogate(source[result2 + 1])) continue;
                ++result2;
            }
        } else {
            if (result2 + shift32 < start) {
                throw new StringIndexOutOfBoundsException(result2);
            }
            for (count = -shift32; count > 0 && --result2 >= start; --count) {
                char ch = source[result2];
                if (!UTF16.isTrailSurrogate(ch) || result2 <= start || !UTF16.isLeadSurrogate(source[result2 - 1])) continue;
                --result2;
            }
        }
        if (count != 0) {
    ...
    public static int indexOf(String source, int char32) {
        ...
        if (char32 < 65536) {
            int result2 = source.indexOf((char)char32);
            if (result2 >= 0) {
                if (UTF16.isLeadSurrogate((char)char32) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(result2 + 1))) {
                    return UTF16.indexOf(source, char32, result2 + 1);
                }
                if (result2 > 0 && UTF16.isLeadSurrogate(source.charAt(result2 - 1))) {
                    return UTF16.indexOf(source, char32, result2 + 1);
                }
            }
            return result2;
    ...
    public static int indexOf(String source, String str) {
        ...
        int result2 = source.indexOf(str);
        int resultEnd = result2 + strLength;
        if (result2 >= 0) {
            if (UTF16.isLeadSurrogate(str.charAt(strLength - 1)) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(resultEnd + 1))) {
                return UTF16.indexOf(source, str, resultEnd + 1);
            }
            if (UTF16.isTrailSurrogate(str.charAt(0)) && result2 > 0 && UTF16.isLeadSurrogate(source.charAt(result2 - 1))) {
                return UTF16.indexOf(source, str, resultEnd + 1);
            }
        }
        return result2;
    ...
    public static int indexOf(String source, int char32, int fromIndex) {
        ...
        if (char32 < 65536) {
            int result2 = source.indexOf((char)char32, fromIndex);
            if (result2 >= 0) {
                if (UTF16.isLeadSurrogate((char)char32) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(result2 + 1))) {
                    return UTF16.indexOf(source, char32, result2 + 1);
                }
    ...
    public static int indexOf(String source, String str, int fromIndex) {
        ...
        int result2 = source.indexOf(str, fromIndex);
        int resultEnd = result2 + strLength;
        if (result2 >= 0) {
            if (UTF16.isLeadSurrogate(str.charAt(strLength - 1)) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(resultEnd))) {
                return UTF16.indexOf(source, str, resultEnd + 1);
            }
            if (UTF16.isTrailSurrogate(str.charAt(0)) && result2 > 0 && UTF16.isLeadSurrogate(source.charAt(result2 - 1))) {
                return UTF16.indexOf(source, str, resultEnd + 1);
    ...
    public static int lastIndexOf(String source, int char32) {
        ...
        if (char32 < 65536) {
            int result2 = source.lastIndexOf((char)char32);
            if (result2 >= 0) {
                if (UTF16.isLeadSurrogate((char)char32) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(result2 + 1))) {
                    return UTF16.lastIndexOf(source, char32, result2 - 1);
                }
                if (result2 > 0 && UTF16.isLeadSurrogate(source.charAt(result2 - 1))) {
                    return UTF16.lastIndexOf(source, char32, result2 - 1);
                }
    ...
    public static int lastIndexOf(String source, String str) {
        ...
        int result2 = source.lastIndexOf(str);
        if (result2 >= 0) {
            if (UTF16.isLeadSurrogate(str.charAt(strLength - 1)) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(result2 + strLength + 1))) {
                return UTF16.lastIndexOf(source, str, result2 - 1);
            }
            if (UTF16.isTrailSurrogate(str.charAt(0)) && result2 > 0 && UTF16.isLeadSurrogate(source.charAt(result2 - 1))) {
                return UTF16.lastIndexOf(source, str, result2 - 1);
            }
    ...
    public static int lastIndexOf(String source, int char32, int fromIndex) {
        ...
        if (char32 < 65536) {
            int result2 = source.lastIndexOf((char)char32, fromIndex);
            if (result2 >= 0) {
                if (UTF16.isLeadSurrogate((char)char32) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(result2 + 1))) {
                    return UTF16.lastIndexOf(source, char32, result2 - 1);
                }
    ...
    public static int lastIndexOf(String source, String str, int fromIndex) {
        ...
        int result2 = source.lastIndexOf(str, fromIndex);
        if (result2 >= 0) {
            if (UTF16.isLeadSurrogate(str.charAt(strLength - 1)) && result2 < source.length() - 1 && UTF16.isTrailSurrogate(source.charAt(result2 + strLength))) {
                return UTF16.lastIndexOf(source, str, result2 - 1);
            }
            if (UTF16.isTrailSurrogate(str.charAt(0)) && result2 > 0 && UTF16.isLeadSurrogate(source.charAt(result2 - 1))) {
                return UTF16.lastIndexOf(source, str, result2 - 1);
    ...
    public static String replace(String source, int oldChar32, int newChar32) {
        ...
        StringBuffer result2 = new StringBuffer(source);
        ...
        while (index != -1) {
            ...
            result2.replace(resultIndex, endResultIndex, newChar32Str);
    ...
    public static String replace(String source, String oldStr, String newStr) {
        ...
        while (index != -1) {
            ...
            result2.replace(resultIndex, endResultIndex, newStr);
    ...
    private static String toString(int ch) {
        ...
        result2.append(UTF16.getLeadSurrogate(ch));
        result2.append(UTF16.getTrailSurrogate(ch));
        return result2.toString();
    }
