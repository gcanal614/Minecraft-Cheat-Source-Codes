...
extends CECalendar {
    ...
    protected void handleComputeFields(int julianDay) {
        int year;
        int era;
        int[] fields2 = new int[3];
        EthiopicCalendar.jdToCE(julianDay, this.getJDEpochOffset(), fields2);
        if (this.isAmeteAlemEra()) {
            era = 0;
            year = fields2[0] + 5500;
        } else if (fields2[0] > 0) {
        ...
        this.internalSet(19, fields2[0]);
        this.internalSet(0, era);
        this.internalSet(1, year);
        this.internalSet(2, fields2[1]);
        this.internalSet(5, fields2[2]);
        this.internalSet(6, 30 * fields2[1] + fields2[2]);
    }
