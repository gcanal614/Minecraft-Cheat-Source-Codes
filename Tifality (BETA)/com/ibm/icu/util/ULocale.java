...
implements Serializable {
    ...
    public static ULocale forLocale(Locale loc) {
        ...
        ULocale result2 = CACHE.get(loc);
        if (result2 == null) {
            result2 = JDKLocaleHelper.toULocale(loc);
    ...
    static ULocale[] parseAcceptLanguage(String acceptLanguage, boolean isLenient) throws ParseException {
        ...
        TreeMap<ULocaleAcceptLanguageQ, ULocale> map2 = new TreeMap<ULocaleAcceptLanguageQ, ULocale>();
        ...
        for (n = 0; n < acceptLanguage.length(); ++n) {
            ...
            if (languageRangeBuf.charAt(0) != '*') {
                int serial = map2.size();
                ULocaleAcceptLanguageQ entry = new ULocaleAcceptLanguageQ(q, serial);
                map2.put(entry, new ULocale(ULocale.canonicalize(languageRangeBuf.toString())));
            }
        ...
        ULocale[] acceptList = map2.values().toArray(new ULocale[map2.size()]);
        return acceptList;
    }
    ...
    private static final class JDKLocaleHelper {
        ...
        static {
            ...
            try {
                ...
                for (Class<?> c : classes2 = Locale.class.getDeclaredClasses()) {
