...
implements Comparable<VersionInfo> {
    ...
    public static VersionInfo getInstance(int major, int minor, int milli, int micro) {
        ...
        Integer key = version;
        VersionInfo result2 = MAP_.get(key);
        if (result2 == null && (tmpvi = MAP_.putIfAbsent(key, result2 = new VersionInfo(version))) != null) {
            result2 = tmpvi;
        }
        return result2;
    }
    ...
    public String toString() {
        StringBuilder result2 = new StringBuilder(7);
        result2.append(this.getMajor());
        result2.append('.');
        result2.append(this.getMinor());
        result2.append('.');
        result2.append(this.getMilli());
        result2.append('.');
        result2.append(this.getMicro());
