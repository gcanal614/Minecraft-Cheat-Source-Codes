...
public abstract class StringTrieBuilder {
    ...
    extends ValueNode {
        ...
        public Node register(StringTrieBuilder builder) {
            ...
            ValueNode result2 = head = new BranchHeadNode(this.chars.length(), subNode);
            if (this.hasValue) {
                if (builder.matchNodesCanHaveValues()) {
                    head.setValue(this.value);
                } else {
                    result2 = new IntermediateValueNode(this.value, builder.registerNode(head));
                }
            }
            return builder.registerNode(result2);
        }
    ...
    extends ValueNode {
        ...
        public Node register(StringTrieBuilder builder) {
            ...
            if (this.hasValue && !builder.matchNodesCanHaveValues()) {
                ...
                this.hasValue = false;
                this.setHashCode();
                result2 = new IntermediateValueNode(intermediateValue, builder.registerNode(this));
            } else {
                this.setHashCode();
                result2 = this;
            }
