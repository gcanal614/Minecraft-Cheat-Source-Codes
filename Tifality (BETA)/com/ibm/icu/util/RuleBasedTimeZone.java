...
extends BasicTimeZone {
    ...
    public TimeZoneTransition getNextTransition(long base, boolean inclusive) {
        ...
        TimeZoneTransition result2 = null;
        ...
        TimeZoneRule from = result2.getFrom();
        TimeZoneRule to = result2.getTo();
        if (from.getRawOffset() != to.getRawOffset()) return result2;
        if (from.getDSTSavings() != to.getDSTSavings()) return result2;
        if (!isFinal) return this.getNextTransition(result2.getTime(), false);
        return null;
    }
    ...
    public TimeZoneTransition getPreviousTransition(long base, boolean inclusive) {
        ...
        if (result2 != null) {
            ...
            if (from.getRawOffset() == to.getRawOffset() && from.getDSTSavings() == to.getDSTSavings()) {
                result2 = this.getPreviousTransition(result2.getTime(), false);
            }
        }
        return result2;
    }
