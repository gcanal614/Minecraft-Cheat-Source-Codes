...
extends HttpMinecraftSessionService {
    ...
    public void joinServer(GameProfile profile, String authenticationToken, String serverId) throws AuthenticationException {
        ...
        arguments2.put("user", profile.getName());
        arguments2.put("sessionId", authenticationToken);
        arguments2.put("serverId", serverId);
        URL url = HttpAuthenticationService.concatenateURL(JOIN_URL, HttpAuthenticationService.buildQuery(arguments2));
        try {
    ...
    public GameProfile hasJoinedServer(GameProfile user, String serverId) throws AuthenticationUnavailableException {
        HashMap<String, Object> arguments2 = new HashMap<String, Object>();
        arguments2.put("user", user.getName());
        arguments2.put("serverId", serverId);
