...
extends HttpUserAuthentication {
    ...
    public void logIn() throws AuthenticationException {
        ...
        args2.put("user", this.getUsername());
        args2.put("password", this.getPassword());
        args2.put("version", 14);
        try {
            response = this.getAuthenticationService().performPostRequest(AUTHENTICATION_URL, HttpAuthenticationService.buildQuery(args2), "application/x-www-form-urlencoded").trim();
        }
        catch (IOException e) {
