...
extends RealmsScreen {
        ...
        if (!checkedMcoAvailability) {
            ...
            new Thread("MCO Availability Checker #1"){
                ...
                public void run() {
                    ...
                    for (int i = 0; i < 3; ++i) {
                        try {
                            Boolean result2 = client.mcoEnabled();
        ...
        if (!stageEnabled) {
            new Thread("MCO Stage Availability Checker #1"){
                ...
                public void run() {
                    RealmsClient client = RealmsClient.createRealmsClient();
                    try {
                        Boolean result2 = client.stageAvailable();
                        if (result2.booleanValue()) {
    ...
    @Override
    public void confirmResult(boolean result2, int id) {
        if (id == 2) {
            if (result2) {
    ...
    public void render(int xm, int ym, float a2) {
        ...
        this.serverSelectionList.render(xm, ym, a2);
