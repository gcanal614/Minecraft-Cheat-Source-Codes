...
public final class Futures {
    ...
    private static <X extends Exception> X newWithCause(Class<X> exceptionClass, Throwable cause) {
        List<Constructor<X>> constructors2 = Arrays.asList(exceptionClass.getConstructors());
        for (Constructor<X> constructor : Futures.preferringStrings(constructors2)) {
    ...
    private static <X extends Exception> List<Constructor<X>> preferringStrings(List<Constructor<X>> constructors2) {
        return WITH_STRING_PARAM_FIRST.sortedCopy(constructors2);
    }
        ...
        NonCancellationPropagatingFuture(final ListenableFuture<V> delegate) {
            ...
            Futures.addCallback(delegate, new FutureCallback<V>(){
                ...
                public void onSuccess(V result2) {
                    NonCancellationPropagatingFuture.this.set(result2);
                }
