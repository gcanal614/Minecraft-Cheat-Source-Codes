...
public abstract class BaseEncoding {
    ...
    public final String encode(byte[] bytes, int off, int len) {
        ...
        GwtWorkarounds.CharOutput result2 = GwtWorkarounds.stringBuilderOutput(this.maxEncodedSize(len));
        GwtWorkarounds.ByteOutput byteOutput = this.encodingStream(result2);
        try {
            for (int i = 0; i < len; ++i) {
