...
extends CharMatcher.FastMatcher {
    ...
    private SmallCharMatcher(char[] table, long filter, boolean containsZero, String description2) {
        super(description2);
        this.table = table;
        this.filter = filter;
    ...
    static CharMatcher from(BitSet chars, String description2) {
        ...
        return new SmallCharMatcher(table, filter, containsZero, description2);
    }
