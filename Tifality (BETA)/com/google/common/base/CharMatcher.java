...
implements Predicate<Character> {
    ...
    public static CharMatcher is(final char match) {
        String description2 = "CharMatcher.is('" + CharMatcher.showCharacter(match) + "')";
    ...
    public static CharMatcher isNot(final char match) {
        String description2 = "CharMatcher.isNot('" + CharMatcher.showCharacter(match) + "')";
        return new FastMatcher(description2){
    ...
    public static CharMatcher anyOf(CharSequence sequence) {
        ...
        for (char c : chars) {
            description2.append(CharMatcher.showCharacter(c));
        }
        description2.append("\")");
    ...
    private static CharMatcher isEither(final char match1, final char match2) {
        String description2 = "CharMatcher.anyOf(\"" + CharMatcher.showCharacter(match1) + CharMatcher.showCharacter(match2) + "\")";
        return new FastMatcher(description2){
    ...
    public static CharMatcher inRange(char startInclusive, char endInclusive) {
        ...
        String description2 = "CharMatcher.inRange('" + CharMatcher.showCharacter(startInclusive) + "', '" + CharMatcher.showCharacter(endInclusive) + "')";
        return CharMatcher.inRange(startInclusive, endInclusive, description2);
    }
    ...
    public static CharMatcher forPredicate(final Predicate<? super Character> predicate) {
        ...
        String description2 = "CharMatcher.forPredicate(" + predicate + ")";
        return new CharMatcher(description2){
    ...
    CharMatcher withToString(String description2) {
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description2) {
        ...
        return CharMatcher.isSmall(totalCharacters, table.length()) ? SmallCharMatcher.from(table, description2) : new BitSetMatcher(table, description2);
    }
    ...
    extends FastMatcher {
        ...
        private BitSetMatcher(BitSet table, String description2) {
            super(description2);
    ...
    extends NegatedMatcher {
        ...
        NegatedFastMatcher(String toString2, CharMatcher original) {
            super(toString2, original);
        }
        ...
        @Override
        CharMatcher withToString(String description2) {
            return new NegatedFastMatcher(description2, this.original);
        }
    }
    ...
    extends CharMatcher {
        ...
        FastMatcher(String description2) {
            super(description2);
        }
    ...
    extends CharMatcher {
        ...
        Or(CharMatcher a2, CharMatcher b2, String description2) {
            super(description2);
        ...
        @Override
        CharMatcher withToString(String description2) {
            return new Or(this.first, this.second, description2);
        }
    }
    ...
    extends CharMatcher {
        ...
        And(CharMatcher a2, CharMatcher b2, String description2) {
            super(description2);
            this.first = Preconditions.checkNotNull(a2);
            this.second = Preconditions.checkNotNull(b2);
        }
        ...
        @Override
        CharMatcher withToString(String description2) {
            return new And(this.first, this.second, description2);
        }
    }
    ...
    extends CharMatcher {
        ...
        NegatedMatcher(String toString2, CharMatcher original) {
            super(toString2);
        ...
        @Override
        CharMatcher withToString(String description2) {
            return new NegatedMatcher(description2, this.original);
        }
    }
    ...
    extends CharMatcher {
        ...
        RangesMatcher(String description2, char[] rangeStarts, char[] rangeEnds) {
            super(description2);
