...
public final class MediaType {
    ...
    private static MediaType createConstant(String type2, String subtype) {
        return MediaType.addKnownType(new MediaType(type2, subtype, ImmutableListMultimap.<String, String>of()));
    }
    ...
    private MediaType(String type2, String subtype, ImmutableListMultimap<String, String> parameters2) {
        this.type = type2;
    ...
    public MediaType withParameters(Multimap<String, String> parameters2) {
        return MediaType.create(this.type, this.subtype, parameters2);
    }
    ...
    public static MediaType create(String type2, String subtype) {
        return MediaType.create(type2, subtype, ImmutableListMultimap.<String, String>of());
    }
    ...
    private static MediaType create(String type2, String subtype, Multimap<String, String> parameters2) {
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            ImmutableListMultimap.Builder parameters2 = ImmutableListMultimap.builder();
            ...
            return MediaType.create(type2, subtype, parameters2.build());
        }
