...
implements Iterable<E> {
    ...
    public final <T> FluentIterable<T> filter(Class<T> type2) {
        return FluentIterable.from(Iterables.filter(this.iterable, type2));
    }
    ...
    public final Optional<E> first() {
        Iterator<E> iterator2 = this.iterable.iterator();
    ...
    public final E[] toArray(Class<E> type2) {
        return Iterables.toArray(this.iterable, type2);
    }
