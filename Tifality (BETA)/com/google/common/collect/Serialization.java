...
final class Serialization {
    ...
    static <K, V> void populateMap(Map<K, V> map2, ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        Serialization.populateMap(map2, stream, size);
    }

    static <K, V> void populateMap(Map<K, V> map2, ObjectInputStream stream, int size) throws IOException, ClassNotFoundException {
