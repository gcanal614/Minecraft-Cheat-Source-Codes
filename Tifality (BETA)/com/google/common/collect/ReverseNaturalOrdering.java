...
implements Serializable {
    ...
    @Override
    public <E extends Comparable> E min(E a2, E b2, E c, E ... rest) {
        return NaturalOrdering.INSTANCE.max(a2, b2, c, rest);
    }
    ...
    @Override
    public <E extends Comparable> E max(E a2, E b2, E c, E ... rest) {
        return NaturalOrdering.INSTANCE.min(a2, b2, c, rest);
    }
