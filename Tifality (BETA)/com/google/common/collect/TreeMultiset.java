...
implements Serializable {
    ...
    public int setCount(@Nullable E element, int count) {
        ...
        int[] result2 = new int[1];
        AvlNode<E> newRoot = root.setCount(this.comparator(), element, count, result2);
        this.rootReference.checkAndSet(root, newRoot);
        return result2[0];
    }
    ...
    extends Multisets.AbstractEntry<E> {
        ...
        AvlNode<E> add(Comparator<? super E> comparator, @Nullable E e, int count, int[] result2) {
            int cmp = comparator.compare(e, this.elem);
            if (cmp < 0) {
                ...
                this.left = initLeft.add(comparator, e, count, result2);
                if (result2[0] == 0) {
                    ++this.distinctElements;
                }
                this.totalCount += (long)count;
            ...
            if (cmp > 0) {
                ...
                this.right = initRight.add(comparator, e, count, result2);
                if (result2[0] == 0) {
                    ++this.distinctElements;
                }
                this.totalCount += (long)count;
        ...
        AvlNode<E> remove(Comparator<? super E> comparator, @Nullable E e, int count, int[] result2) {
            int cmp = comparator.compare(e, this.elem);
            if (cmp < 0) {
                AvlNode<E> initLeft = this.left;
                if (initLeft == null) {
                ...
                this.left = initLeft.remove(comparator, e, count, result2);
                if (result2[0] > 0) {
                    if (count >= result2[0]) {
                        --this.distinctElements;
            ...
            if (cmp > 0) {
                ...
                this.right = initRight.remove(comparator, e, count, result2);
                if (result2[0] > 0) {
                    if (count >= result2[0]) {
                        --this.distinctElements;
                        this.totalCount -= (long)result2[0];
        ...
        AvlNode<E> setCount(Comparator<? super E> comparator, @Nullable E e, int count, int[] result2) {
            int cmp = comparator.compare(e, this.elem);
            if (cmp < 0) {
                AvlNode<E> initLeft = this.left;
                if (initLeft == null) {
                ...
                this.left = initLeft.setCount(comparator, e, count, result2);
                if (count == 0 && result2[0] != 0) {
                    --this.distinctElements;
                } else if (count > 0 && result2[0] == 0) {
                    ++this.distinctElements;
                }
                this.totalCount += (long)(count - result2[0]);
            ...
            if (cmp > 0) {
                ...
                this.right = initRight.setCount(comparator, e, count, result2);
                if (count == 0 && result2[0] != 0) {
                    --this.distinctElements;
                } else if (count > 0 && result2[0] == 0) {
                    ++this.distinctElements;
