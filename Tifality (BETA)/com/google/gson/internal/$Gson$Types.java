...
public final class $Gson$Types {
    ...
    public static Type resolve(Type context, Class<?> contextRawType, Type toResolve) {
        ...
        if (toResolve instanceof ParameterizedType) {
            ...
            for (int t = 0; t < length; ++t) {
                Type resolvedTypeArgument = $Gson$Types.resolve(context, contextRawType, args2[t]);
            ...
            return changed ? $Gson$Types.newParameterizedTypeWithOwner(newOwnerType, original.getRawType(), args2) : original;
        }
    ...
    private static void checkNotPrimitive(Type type2) {
    ...
    Serializable {
        ...
        public WildcardTypeImpl(Type[] upperBounds2, Type[] lowerBounds) {
            ...
            $Gson$Preconditions.checkArgument(upperBounds2.length == 1);
            if (lowerBounds.length == 1) {
                $Gson$Preconditions.checkNotNull(lowerBounds[0]);
                $Gson$Types.checkNotPrimitive(lowerBounds[0]);
                $Gson$Preconditions.checkArgument(upperBounds2[0] == Object.class);
                this.lowerBound = $Gson$Types.canonicalize(lowerBounds[0]);
                this.upperBound = Object.class;
            } else {
                $Gson$Preconditions.checkNotNull(upperBounds2[0]);
                $Gson$Types.checkNotPrimitive(upperBounds2[0]);
                this.lowerBound = null;
                this.upperBound = $Gson$Types.canonicalize(upperBounds2[0]);
            }
        }
