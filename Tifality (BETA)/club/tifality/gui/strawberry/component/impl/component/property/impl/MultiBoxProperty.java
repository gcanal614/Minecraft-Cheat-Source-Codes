...
public final class MultiBoxProperty
extends ExpandableComponent
implements PropertyComponent {
    private final MultiSelectEnumProperty<?> property;

    public MultiBoxProperty(Component parent, MultiSelectEnumProperty<?> property, int x, int y, int width, int height) {
        super(parent, property.getLabel(), x, y, width, height);
        this.property = property;
    }

    public MultiSelectEnumProperty<?> getProperty() {
    ...
    private <T extends Enum<T>> void handleRender(int x, int y, int width) {
        MultiSelectEnumProperty<?> property = this.property;
