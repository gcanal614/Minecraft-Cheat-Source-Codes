...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) {
        try {
            switch (button.id) {
                ...
                case 2: {
                    String data2 = (String)Toolkit.getDefaultToolkit().getSystemClipboard().getData(DataFlavor.stringFlavor);
                    if (!data2.contains(":")) break;
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        GlStateManager.enableAlpha();
        GuiAltLogin.drawGradientRect(0.0f, 0.0f, this.width, this.height, -2130706433, 0xFFFFFF);
        GuiAltLogin.drawGradientRect(0.0f, 0.0f, this.width, this.height, 0, Integer.MIN_VALUE);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        GlStateManager.pushMatrix();
        ...
        this.drawCenteredString(this.mc.fontRendererObj, this.thread == null ? (Object)((Object)ChatFormatting.GRAY) + "Idle..." : this.thread.getStatus(), this.width / 2, 29, -1);
