...
extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(float $this$toByteExactOrNull) {
        float f2 = -128;
        float f3 = 127;
        float f4 = $this$toByteExactOrNull;
        return f4 >= f2 && f4 <= f3 ? Byte.valueOf((byte)$this$toByteExactOrNull) : null;
    }
    ...
    public static final Integer toIntExactOrNull(float $this$toIntExactOrNull) {
        ...
        float f4 = $this$toIntExactOrNull;
        return f4 >= f2 && f4 <= f3 ? Integer.valueOf((int)$this$toIntExactOrNull) : null;
    }
    ...
    public static final Long toLongExactOrNull(float $this$toLongExactOrNull) {
        ...
        float f4 = $this$toLongExactOrNull;
        return f4 >= f2 && f4 <= f3 ? Long.valueOf((long)$this$toLongExactOrNull) : null;
    }
    ...
    public static final Short toShortExactOrNull(float $this$toShortExactOrNull) {
        ...
        float f4 = $this$toShortExactOrNull;
        return f4 >= f2 && f4 <= f3 ? Short.valueOf((short)$this$toShortExactOrNull) : null;
    }
