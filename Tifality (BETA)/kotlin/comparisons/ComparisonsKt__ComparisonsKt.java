...
class ComparisonsKt__ComparisonsKt {
    ...
    private static final <T> Comparator<T> compareBy(Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator<T>(selector){
            ...
            public final int compare(T a2, T b2) {
                boolean bl = false;
                return ComparisonsKt.compareValues((Comparable)this.$selector.invoke(a2), (Comparable)this.$selector.invoke(b2));
            }
            {
    ...
    private static final <T, K> Comparator<T> compareBy(Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator<T>(comparator, selector){
            ...
            public final int compare(T a2, T b2) {
                ...
                boolean bl = false;
                return comparator.compare(this.$selector.invoke(a2), this.$selector.invoke(b2));
            }
            {
    ...
    private static final <T> Comparator<T> compareByDescending(Function1<? super T, ? extends Comparable<?>> selector) {
        ...
        return new Comparator<T>(selector){
            ...
            public final int compare(T a2, T b2) {
                boolean bl = false;
                return ComparisonsKt.compareValues((Comparable)this.$selector.invoke(b2), (Comparable)this.$selector.invoke(a2));
            }
            {
                this.$selector = function1;
            }
    ...
    private static final <T, K> Comparator<T> compareByDescending(Comparator<? super K> comparator, Function1<? super T, ? extends K> selector) {
        ...
        return new Comparator<T>(comparator, selector){
            ...
            public final int compare(T a2, T b2) {
                Comparator comparator = this.$comparator;
                boolean bl = false;
                return comparator.compare(this.$selector.invoke(b2), this.$selector.invoke(a2));
            }
            {
                this.$comparator = comparator;
                this.$selector = function1;
        ...
        return new Comparator<T>($this$thenBy, selector){
            ...
            public final int compare(T a2, T b2) {
                ...
                if (previousCompare != 0) {
                    ...
                    boolean bl = false;
                    n = ComparisonsKt.compareValues((Comparable)this.$selector.invoke(a2), (Comparable)this.$selector.invoke(b2));
                }
                return n;
            }
            {
        ...
        return new Comparator<T>($this$thenBy, comparator, selector){
            ...
            public final int compare(T a2, T b2) {
                ...
                if (previousCompare != 0) {
                    ...
                    Comparator comparator = this.$comparator;
                    boolean bl = false;
                    n = comparator.compare(this.$selector.invoke(a2), this.$selector.invoke(b2));
                }
                return n;
            }
            {
        ...
        return new Comparator<T>($this$thenByDescending, selector){
            ...
            public final int compare(T a2, T b2) {
                ...
                if (previousCompare != 0) {
                    ...
                    boolean bl = false;
                    n = ComparisonsKt.compareValues((Comparable)this.$selector.invoke(b2), (Comparable)this.$selector.invoke(a2));
                }
                return n;
            }
            {
        ...
        return new Comparator<T>($this$thenByDescending, comparator, selector){
            ...
            public final int compare(T a2, T b2) {
                ...
                if (previousCompare != 0) {
                    ...
                    Comparator comparator = this.$comparator;
                    boolean bl = false;
                    n = comparator.compare(this.$selector.invoke(b2), this.$selector.invoke(a2));
                }
                return n;
            }
            {
