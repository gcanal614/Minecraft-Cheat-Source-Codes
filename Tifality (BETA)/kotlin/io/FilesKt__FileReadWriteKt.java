...
extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(@NotNull File $this$readBytes) {
        ...
        try {
            ...
            while (remaining > 0 && (read2 = input.read(result2, offset, remaining)) >= 0) {
                remaining -= read2;
                offset += read2;
            }
            if (remaining > 0) {
                ...
                if (extraByte == -1) {
                    ...
                    byArray2 = ArraysKt.copyInto(byArray4, byArray6, result2.length, 0, extra.size());
                }
            }
            byArray = byArray2;
        }
    ...
    public static final List<String> readLines(@NotNull File $this$readLines, @NotNull Charset charset) {
        ...
        FilesKt.forEachLine($this$readLines, charset, (Function1<? super String, Unit>)new Function1<String, Unit>(result2){
