...
public final class UStringsKt {
    ...
    public static final UInt toUIntOrNull(@NotNull String $this$toUIntOrNull, int radix) {
        ...
        while (n2 < n3) {
            ...
            n4 = result2;
            n5 = 0;
            int beforeAdding = result2 = UInt.constructor-impl(n4 * uradix);
            n5 = result2;
            int n6 = digit;
            boolean bl = false;
            n6 = UInt.constructor-impl(n6);
            bl = false;
            n5 = result2 = UInt.constructor-impl(n5 + n6);
            n6 = 0;
    ...
    public static final ULong toULongOrNull(@NotNull String $this$toULongOrNull, int radix) {
        ...
        while (n2 < n3) {
            ...
            l = result2;
            bl2 = false;
            long beforeAdding = result2 = ULong.constructor-impl(l * uradix);
            long l2 = result2;
            int n4 = digit;
            boolean bl3 = false;
            ...
            boolean bl5 = false;
            l2 = result2 = ULong.constructor-impl(l3 + l4);
            n4 = 0;
