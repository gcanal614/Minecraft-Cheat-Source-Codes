...
public final class ProgressionUtilKt {
    ...
    private static final int differenceModulo(int a2, int b2, int c) {
        return ProgressionUtilKt.mod(ProgressionUtilKt.mod(a2, c) - ProgressionUtilKt.mod(b2, c), c);
    }

    private static final long differenceModulo(long a2, long b2, long c) {
        return ProgressionUtilKt.mod(ProgressionUtilKt.mod(a2, c) - ProgressionUtilKt.mod(b2, c), c);
    }
