...
public final class KTypeProjection {
    ...
    public KTypeProjection(@Nullable KVariance variance, @Nullable KType type2) {
    ...
    @NotNull
    public final KTypeProjection copy(@Nullable KVariance variance, @Nullable KType type2) {
        return new KTypeProjection(variance, type2);
    }
    ...
    @JvmStatic
    @NotNull
    public static final KTypeProjection invariant(@NotNull KType type2) {
        return Companion.invariant(type2);
    }

    @JvmStatic
    @NotNull
    public static final KTypeProjection contravariant(@NotNull KType type2) {
        return Companion.contravariant(type2);
    }

    @JvmStatic
    @NotNull
    public static final KTypeProjection covariant(@NotNull KType type2) {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final KTypeProjection invariant(@NotNull KType type2) {
        ...
        @JvmStatic
        @NotNull
        public final KTypeProjection contravariant(@NotNull KType type2) {
            Intrinsics.checkNotNullParameter(type2, "type");
            return new KTypeProjection(KVariance.IN, type2);
        }

        @JvmStatic
        @NotNull
        public final KTypeProjection covariant(@NotNull KType type2) {
            Intrinsics.checkNotNullParameter(type2, "type");
