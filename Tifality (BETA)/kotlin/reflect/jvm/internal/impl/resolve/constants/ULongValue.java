...
extends UnsignedValueConstant<Long> {
    ...
    public KotlinType getType(@NotNull ModuleDescriptor module) {
        ...
        if (annotated != null && (annotated = annotated.getDefaultType()) != null) {
            ...
            SimpleType simpleType2 = ErrorUtils.createErrorType("Unsigned type ULong not found");
            Intrinsics.checkNotNullExpressionValue(simpleType2, "ErrorUtils.createErrorTy\u2026ed type ULong not found\")");
