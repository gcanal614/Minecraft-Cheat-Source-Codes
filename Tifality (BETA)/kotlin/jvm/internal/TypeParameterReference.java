...
implements KTypeParameter {
    ...
    public final void setUpperBounds(@NotNull List<? extends KType> upperBounds2) {
        Intrinsics.checkNotNullParameter(upperBounds2, "upperBounds");
        if (this.bounds != null) {
            String string = "Upper bounds of type parameter '" + this + "' have already been initialized.";
            boolean bl = false;
            throw (Throwable)new IllegalStateException(string.toString());
        }
        this.bounds = upperBounds2;
    }
