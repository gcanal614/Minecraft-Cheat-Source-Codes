...
public class ReflectionFactory {
    ...
    public String renderLambdaToString(FunctionBase lambda2) {
        String result2 = lambda2.getClass().getGenericInterfaces()[0].toString();
        return result2.startsWith(KOTLIN_JVM_FUNCTIONS) ? result2.substring(KOTLIN_JVM_FUNCTIONS.length()) : result2;
    }
    ...
    public KType typeOf(KClassifier klass, List<KTypeProjection> arguments2, boolean isMarkedNullable) {
        return new TypeReference(klass, arguments2, isMarkedNullable);
    }
