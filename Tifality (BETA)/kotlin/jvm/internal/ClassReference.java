...
ClassBasedDeclarationContainer {
    ...
    static {
        ...
        while (item$iv$iv2.hasNext()) {
            ...
            bl5 = false;
            map2.put(((Pair)serializable).getFirst(), ((Pair)serializable).getSecond());
        }
        ...
        for (Object element$iv$iv$iv : $this$associateByTo$iv$iv$iv) {
            ...
            boolean bl9 = false;
            String fqName2 = (String)var15_32.getValue();
            String string = StringsKt.substringAfterLast$default(fqName2, '.', null, 2, null);
    ...
    public static final class Companion {
        ...
        public final boolean isInstance(@Nullable Object value, @NotNull Class<?> jClass) {
            ...
            Integer n = (Integer)map2.get(jClass);
            if (n != null) {
                object = n;
                bl = false;
                boolean bl2 = false;
