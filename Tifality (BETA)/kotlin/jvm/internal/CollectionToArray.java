...
public final class CollectionToArray {
        ...
        block9: {
            ...
            if (size$iv == 0) {
                ...
                if (!iter$iv.hasNext()) {
                    ...
                    int n = i$iv;
                    Object[] result2 = result$iv;
                    boolean bl2 = false;
                    Object[] objectArray2 = Arrays.copyOf(result2, (int)size);
            ...
            if (size$iv == 0) {
                ...
                if (!iter$iv.hasNext()) {
                    ...
                    if (result2 == a2) {
                        ...
                        void size2;
                        Object[] objectArray3 = Arrays.copyOf(result2, (int)size2);
    ...
    private static final Object[] toArrayImpl(Collection<?> collection, Function0<Object[]> empty, Function1<? super Integer, Object[]> alloc, Function2<? super Object[], ? super Integer, Object[]> trim) {
        ...
        Object[] result2 = alloc.invoke((Integer)size);
        int i = 0;
        while (true) {
            result2[i++] = iter.next();
            if (i >= result2.length) {
                ...
                Intrinsics.checkNotNullExpressionValue(Arrays.copyOf(result2, newSize), "Arrays.copyOf(result, newSize)");
                continue;
            }
            if (!iter.hasNext()) break;
        }
        return trim.invoke((Object[])result2, (Integer)i);
    }
}
