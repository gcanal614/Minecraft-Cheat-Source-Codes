...
class MapsKt__MapWithDefaultKt {
    ...
    public static final <K, V> Map<K, V> withDefault(@NotNull Map<K, ? extends V> $this$withDefault, @NotNull Function1<? super K, ? extends V> defaultValue) {
        ...
        Map<K, ? extends V> map2 = $this$withDefault;
        return map2 instanceof MapWithDefault ? MapsKt.withDefault(((MapWithDefault)$this$withDefault).getMap(), defaultValue) : (Map)new MapWithDefaultImpl<K, V>($this$withDefault, defaultValue);
    }
    ...
    public static final <K, V> Map<K, V> withDefaultMutable(@NotNull Map<K, V> $this$withDefault, @NotNull Function1<? super K, ? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter($this$withDefault, "$this$withDefault");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        Map<K, V> map2 = $this$withDefault;
        return map2 instanceof MutableMapWithDefault ? MapsKt.withDefaultMutable(((MutableMapWithDefault)$this$withDefault).getMap(), defaultValue) : (Map)new MutableMapWithDefaultImpl<K, V>($this$withDefault, defaultValue);
    }
}
