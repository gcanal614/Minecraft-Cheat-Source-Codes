...
class GroupingKt__GroupingJVMKt {
    ...
    @PublishedApi
    @InlineOnly
    private static final <K, V, R> Map<K, R> mapValuesInPlace(Map<K, V> $this$mapValuesInPlace, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> f2) {
        ...
        for (Object element$iv : $this$forEach$iv) {
            ...
            TypeIntrinsics.asMutableMapEntry(entry).setValue(f2.invoke(it));
        }
        Map<K, V> map2 = $this$mapValuesInPlace;
        if (map2 == null) {
