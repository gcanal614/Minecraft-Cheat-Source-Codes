...
extends MapsKt__MapsKt {
    ...
    public static final <K, V> List<Pair<K, V>> toList(@NotNull Map<? extends K, ? extends V> $this$toList) {
        ...
        ArrayList<Pair<K, V>> result2 = new ArrayList<Pair<K, V>>($this$toList.size());
        Map.Entry<K, V> entry = first;
        boolean bl = false;
        result2.add(new Pair<K, V>(entry.getKey(), entry.getValue()));
        do {
