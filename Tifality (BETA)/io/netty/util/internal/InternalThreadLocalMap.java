...
extends UnpaddedInternalThreadLocalMap {
    ...
    public static InternalThreadLocalMap getIfSet() {
        ...
        Object threadLocalMap = thread2 instanceof FastThreadLocalThread ? ((FastThreadLocalThread)thread2).threadLocalMap() : ((slowThreadLocalMap = UnpaddedInternalThreadLocalMap.slowThreadLocalMap) == null ? null : slowThreadLocalMap.get());
