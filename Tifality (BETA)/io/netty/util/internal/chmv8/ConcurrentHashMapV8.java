...
Serializable {
    ...
    public V get(Object key) {
        ...
        if (this.table != null && (n = tab.length) > 0 && (e = ConcurrentHashMapV8.tabAt(tab, n - 1 & h)) != null) {
            ...
            while ((e = e.next) != null) {
                if (e.hash != h || (ek2 = e.key) != key && (ek2 == null || !key.equals(ek2))) continue;
                return e.val;
            }
        }
        return null;
    ...
    final V putVal(K key, V value, boolean onlyIfAbsent) {
        ...
        block19: {
            ...
            while (true) {
                ...
                i = n - 1 & hash;
                Node<K, V> f2 = ConcurrentHashMapV8.tabAt(tab, i);
                if (f2 == null) {
                ...
                synchronized (node) {
                    block20: {
                        if (ConcurrentHashMapV8.tabAt(tab, i) == f2) {
                            if (fh >= 0) {
                                binCount = 1;
                                Node<K, V> e = f2;
                                while (true) {
                                    Object ek2;
                                    if (e.hash == hash && ((ek2 = e.key) == key || ek2 != null && key.equals(ek2))) {
                                        oldVal = e.val;
                                        if (!onlyIfAbsent) {
                                            e.val = value;
                                        }
                            ...
                            if (f2 instanceof TreeBin) {
                                binCount = 2;
                                TreeNode<K, V> p = ((TreeBin)f2).putTreeVal(hash, key, value);
                                if (p != null) {
                                    oldVal = p.val;
                                    if (!onlyIfAbsent) {
                                        p.val = value;
    ...
    final V replaceNode(Object key, V value, Object cv) {
        ...
        int hash = ConcurrentHashMapV8.spread(key.hashCode());
        Node<K, V>[] tab = this.table;
        while (tab != null && (n = tab.length) != 0 && (f2 = ConcurrentHashMapV8.tabAt(tab, i = n - 1 & hash)) != null) {
            int fh = f2.hash;
            if (fh == -1) {
                tab = this.helpTransfer(tab, f2);
                continue;
    ...
    public void clear() {
        ...
        while (tab != null && i < tab.length) {
            ...
            synchronized (node) {
                if (ConcurrentHashMapV8.tabAt(tab, i) == f2) {
                    Node<K, V> p;
                    Node<K, V> node2 = fh >= 0 ? f2 : (p = f2 instanceof TreeBin ? ((TreeBin)f2).first : null);
                    while (p != null) {
                        --delta;
                        p = p.next;
                    }
    ...
    public String toString() {
        Node<K, V>[] t = this.table;
        int f2 = this.table == null ? 0 : t.length;
        Traverser<K, V> it = new Traverser<K, V>(t, f2, 0, f2);
                    ...
                    block31: {
                        if (ConcurrentHashMapV8.tabAt(tab, i) == f2) {
                            if (fh >= 0) {
                                ...
                                while (true) {
                                    Object ek2;
                                    if (e.hash == h && ((ek2 = e.key) == key || ek2 != null && key.equals(ek2))) {
                                        val = e.val;
                                        break block31;
                                    }
                                    Node<K, V> pred = e;
    ...
    public Enumeration<K> keys() {
        Node<K, V>[] t = this.table;
        int f2 = this.table == null ? 0 : t.length;
        return new KeyIterator<K, V>(t, f2, 0, f2, this);
    }

    public Enumeration<V> elements() {
        Node<K, V>[] t = this.table;
        int f2 = this.table == null ? 0 : t.length;
        return new ValueIterator<K, V>(t, f2, 0, f2, this);
    }
    ...
    private final void addCount(long x, int check) {
        ...
        if (this.counterCells != null || !U.compareAndSwapLong(this, BASECOUNT, b2 = this.baseCount, s = b2 + x)) {
            long v;
            CounterCell a2;
            int m;
            ...
            if (hc == null || as == null || (m = as.length - 1) < 0 || (a2 = as[m & hc.value]) == null || !(uncontended = U.compareAndSwapLong(a2, CELLVALUE, v = a2.value, v + x))) {
    ...
    private final void transfer(Node<K, V>[] tab, Node<K, V>[] nextTab) {
        ...
        while (true) {
            ...
            TreeBin f2 = ConcurrentHashMapV8.tabAt(tab, i);
            if (f2 == null) {
    ...
    final int batchFor(long b2) {
        long n;
        if (b2 == Long.MAX_VALUE || (n = this.sumCount()) <= 1L || n < b2) {
            return 0;
        }
        int sp = ForkJoinPool.getCommonPoolParallelism() << 2;
        return b2 <= 0L || (n /= b2) >= (long)sp ? sp : (int)n;
    }
        ...
        while (true) {
            ...
            if (this.counterCells != null && (n = as.length) > 0) {
                ...
                if (a2 == null) {
                    ...
                    v = a2.value;
                    if (U.compareAndSwapLong(a2, CELLVALUE, v, v + x)) break;
    ...
    extends BulkTask<K, V, Integer> {
        ...
        MapReduceMappingsToIntTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceMappingsToIntTask<K, V> nextRight, ObjectByObjectToInt<? super K, ? super V> transformer, int basis, IntByIntToInt reducer) {
            super(p, b2, i, f2, t);
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceMappingsToIntTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
    ...
    extends BulkTask<K, V, Integer> {
        ...
        MapReduceEntriesToIntTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceEntriesToIntTask<K, V> nextRight, ObjectToInt<Map.Entry<K, V>> transformer, int basis, IntByIntToInt reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceEntriesToIntTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
    ...
    extends BulkTask<K, V, Integer> {
        ...
        MapReduceValuesToIntTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceValuesToIntTask<K, V> nextRight, ObjectToInt<? super V> transformer, int basis, IntByIntToInt reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceValuesToIntTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
    ...
    extends BulkTask<K, V, Integer> {
        ...
        MapReduceKeysToIntTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceKeysToIntTask<K, V> nextRight, ObjectToInt<? super K> transformer, int basis, IntByIntToInt reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceKeysToIntTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
    ...
    extends BulkTask<K, V, Long> {
        ...
        MapReduceMappingsToLongTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceMappingsToLongTask<K, V> nextRight, ObjectByObjectToLong<? super K, ? super V> transformer, long basis, LongByLongToLong reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceMappingsToLongTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p.key, p.val));
    ...
    extends BulkTask<K, V, Long> {
        ...
        MapReduceEntriesToLongTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceEntriesToLongTask<K, V> nextRight, ObjectToLong<Map.Entry<K, V>> transformer, long basis, LongByLongToLong reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceEntriesToLongTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p));
    ...
    extends BulkTask<K, V, Long> {
        ...
        MapReduceValuesToLongTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceValuesToLongTask<K, V> nextRight, ObjectToLong<? super V> transformer, long basis, LongByLongToLong reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceValuesToLongTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p.val));
    ...
    extends BulkTask<K, V, Long> {
        ...
        MapReduceKeysToLongTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceKeysToLongTask<K, V> nextRight, ObjectToLong<? super K> transformer, long basis, LongByLongToLong reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceKeysToLongTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p.key));
    ...
    extends BulkTask<K, V, Double> {
        ...
        MapReduceMappingsToDoubleTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceMappingsToDoubleTask<K, V> nextRight, ObjectByObjectToDouble<? super K, ? super V> transformer, double basis, DoubleByDoubleToDouble reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceMappingsToDoubleTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p.key, p.val));
    ...
    extends BulkTask<K, V, Double> {
        ...
        MapReduceEntriesToDoubleTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceEntriesToDoubleTask<K, V> nextRight, ObjectToDouble<Map.Entry<K, V>> transformer, double basis, DoubleByDoubleToDouble reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceEntriesToDoubleTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p));
    ...
    extends BulkTask<K, V, Double> {
        ...
        MapReduceValuesToDoubleTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceValuesToDoubleTask<K, V> nextRight, ObjectToDouble<? super V> transformer, double basis, DoubleByDoubleToDouble reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceValuesToDoubleTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p.val));
    ...
    extends BulkTask<K, V, Double> {
        ...
        MapReduceKeysToDoubleTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceKeysToDoubleTask<K, V> nextRight, ObjectToDouble<? super K> transformer, double basis, DoubleByDoubleToDouble reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.basis = basis;
        ...
        public final void compute() {
            ...
            if (transformer != null && (reducer = this.reducer) != null) {
                ...
                while (this.batch > 0 && (h = (f2 = this.baseLimit) + i >>> 1) > i) {
                    this.addToPendingCount(1);
                    this.baseLimit = h;
                    this.rights = new MapReduceKeysToDoubleTask<K, V>(this, this.batch >>>= 1, this.baseLimit, f2, this.tab, this.rights, transformer, r, reducer);
                    this.rights.fork();
                }
                while ((p = this.advance()) != null) {
                    r = reducer.apply(r, transformer.apply(p.key));
    ...
    extends BulkTask<K, V, U> {
        ...
        MapReduceMappingsTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceMappingsTask<K, V, U> nextRight, BiFun<? super K, ? super V, ? extends U> transformer, BiFun<? super U, ? super U, ? extends U> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.reducer = reducer;
    ...
    extends BulkTask<K, V, U> {
        ...
        MapReduceEntriesTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceEntriesTask<K, V, U> nextRight, Fun<Map.Entry<K, V>, ? extends U> transformer, BiFun<? super U, ? super U, ? extends U> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.reducer = reducer;
    ...
    extends BulkTask<K, V, U> {
        ...
        MapReduceValuesTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceValuesTask<K, V, U> nextRight, Fun<? super V, ? extends U> transformer, BiFun<? super U, ? super U, ? extends U> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.reducer = reducer;
    ...
    extends BulkTask<K, V, U> {
        ...
        MapReduceKeysTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, MapReduceKeysTask<K, V, U> nextRight, Fun<? super K, ? extends U> transformer, BiFun<? super U, ? super U, ? extends U> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.transformer = transformer;
            this.reducer = reducer;
    ...
    extends BulkTask<K, V, Map.Entry<K, V>> {
        ...
        ReduceEntriesTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, ReduceEntriesTask<K, V> nextRight, BiFun<Map.Entry<K, V>, Map.Entry<K, V>, ? extends Map.Entry<K, V>> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.reducer = reducer;
        }
    ...
    extends BulkTask<K, V, V> {
        ...
        ReduceValuesTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, ReduceValuesTask<K, V> nextRight, BiFun<? super V, ? super V, ? extends V> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.reducer = reducer;
        }
    ...
    extends BulkTask<K, V, K> {
        ...
        ReduceKeysTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, ReduceKeysTask<K, V> nextRight, BiFun<? super K, ? super K, ? extends K> reducer) {
            super(p, b2, i, f2, t);
            this.nextRight = nextRight;
            this.reducer = reducer;
        }
    ...
    extends BulkTask<K, V, U> {
        ...
        SearchMappingsTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, BiFun<? super K, ? super V, ? extends U> searchFunction, AtomicReference<U> result2) {
            super(p, b2, i, f2, t);
    ...
    extends BulkTask<K, V, U> {
        ...
        SearchEntriesTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Fun<Map.Entry<K, V>, ? extends U> searchFunction, AtomicReference<U> result2) {
            super(p, b2, i, f2, t);
            this.searchFunction = searchFunction;
            this.result = result2;
        }
    ...
    extends BulkTask<K, V, U> {
        ...
        SearchValuesTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Fun<? super V, ? extends U> searchFunction, AtomicReference<U> result2) {
            super(p, b2, i, f2, t);
            this.searchFunction = searchFunction;
            this.result = result2;
        }
    ...
    extends BulkTask<K, V, U> {
        ...
        SearchKeysTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Fun<? super K, ? extends U> searchFunction, AtomicReference<U> result2) {
            super(p, b2, i, f2, t);
            this.searchFunction = searchFunction;
            this.result = result2;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedMappingTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, BiFun<? super K, ? super V, ? extends U> transformer, Action<? super U> action) {
            super(p, b2, i, f2, t);
            this.transformer = transformer;
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedEntryTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Fun<Map.Entry<K, V>, ? extends U> transformer, Action<? super U> action) {
            super(p, b2, i, f2, t);
            this.transformer = transformer;
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedValueTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Fun<? super V, ? extends U> transformer, Action<? super U> action) {
            super(p, b2, i, f2, t);
            this.transformer = transformer;
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachTransformedKeyTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Fun<? super K, ? extends U> transformer, Action<? super U> action) {
            super(p, b2, i, f2, t);
            this.transformer = transformer;
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachMappingTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, BiAction<? super K, ? super V> action) {
            super(p, b2, i, f2, t);
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachEntryTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Action<? super Map.Entry<K, V>> action) {
            super(p, b2, i, f2, t);
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachValueTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Action<? super V> action) {
            super(p, b2, i, f2, t);
            this.action = action;
        }
    ...
    extends BulkTask<K, V, Void> {
        ...
        ForEachKeyTask(BulkTask<K, V, ?> p, int b2, int i, int f2, Node<K, V>[] t, Action<? super K> action) {
            super(p, b2, i, f2, t);
            this.action = action;
        }
    ...
    extends CountedCompleter<R> {
        ...
        BulkTask(BulkTask<K, V, ?> par, int b2, int i, int f2, Node<K, V>[] t) {
            super(par);
            this.batch = b2;
    ...
    Serializable {
        ...
        EntrySetView(ConcurrentHashMapV8<K, V> map2) {
            super(map2);
        }
        ...
        public Iterator<Map.Entry<K, V>> iterator() {
            ...
            Node<K, V>[] t = m.table;
            int f2 = m.table == null ? 0 : t.length;
            return new EntryIterator(t, f2, 0, f2, m);
        }
        ...
        public ConcurrentHashMapSpliterator<Map.Entry<K, V>> spliterator166() {
            ...
            Node<K, V>[] t = m.table;
            int f2 = m.table == null ? 0 : t.length;
            return new EntrySpliterator(t, f2, 0, f2, n < 0L ? 0L : n, m);
        }
    ...
    Serializable {
        ...
        ValuesView(ConcurrentHashMapV8<K, V> map2) {
            super(map2);
        }
        ...
        public final Iterator<V> iterator() {
            ...
            Node<K, V>[] t = m.table;
            int f2 = m.table == null ? 0 : t.length;
            return new ValueIterator(t, f2, 0, f2, m);
        }
        ...
        public ConcurrentHashMapSpliterator<V> spliterator166() {
            ...
            Node<K, V>[] t = m.table;
            int f2 = m.table == null ? 0 : t.length;
            return new ValueSpliterator(t, f2, 0, f2, n < 0L ? 0L : n);
        }
    ...
    Serializable {
        ...
        KeySetView(ConcurrentHashMapV8<K, V> map2, V value) {
            super(map2);
            this.value = value;
        }
        ...
        public Iterator<K> iterator() {
            ...
            Node<K, V>[] t = m.table;
            int f2 = m.table == null ? 0 : t.length;
            return new KeyIterator(t, f2, 0, f2, m);
        }
        ...
        public ConcurrentHashMapSpliterator<K> spliterator166() {
            ...
            Node<K, V>[] t = m.table;
            int f2 = m.table == null ? 0 : t.length;
            return new KeySpliterator(t, f2, 0, f2, n < 0L ? 0L : n);
        }
    ...
    Serializable {
        ...
        CollectionView(ConcurrentHashMapV8<K, V> map2) {
            this.map = map2;
        }
    ...
    implements ConcurrentHashMapSpliterator<Map.Entry<K, V>> {
        ...
        EntrySpliterator(Node<K, V>[] tab, int size, int index, int limit, long est, ConcurrentHashMapV8<K, V> map2) {
    ...
    implements Map.Entry<K, V> {
        ...
        MapEntry(K key, V val, ConcurrentHashMapV8<K, V> map2) {
            this.key = key;
            this.val = val;
            this.map = map2;
        }
    ...
    implements Iterator<Map.Entry<K, V>> {
        EntryIterator(Node<K, V>[] tab, int index, int size, int limit, ConcurrentHashMapV8<K, V> map2) {
    ...
    Enumeration<V> {
        ValueIterator(Node<K, V>[] tab, int index, int size, int limit, ConcurrentHashMapV8<K, V> map2) {
            super(tab, index, size, limit, map2);
        }
    ...
    Enumeration<K> {
        KeyIterator(Node<K, V>[] tab, int index, int size, int limit, ConcurrentHashMapV8<K, V> map2) {
            super(tab, index, size, limit, map2);
        }
    ...
    extends Traverser<K, V> {
        ...
        BaseIterator(Node<K, V>[] tab, int size, int index, int limit, ConcurrentHashMapV8<K, V> map2) {
            super(tab, size, index, limit);
            this.map = map2;
            this.advance();
        }
    ...
    extends Node<K, V> {
        ...
        final Node<K, V> find(int h, Object k) {
            if (k != null) {
                ...
                while (e != null) {
                    ...
                    if ((s & 3) != 0) {
                        Object ek2;
                        if (e.hash == h && ((ek2 = e.key) == k || ek2 != null && k.equals(ek2))) {
                            return e;
                        }
        ...
        final TreeNode<K, V> putTreeVal(int h, K k, V v) {
            block21: {
                ...
                TreeNode<K, V> x = new TreeNode<K, V>(h, k, v, f2, xp);
                this.first = x;
                if (f2 != null) {
                    f2.prev = x;
                }
        ...
        Node<K, V> find(int h, Object k) {
            ...
            block0: while (true) {
                ...
                do {
                    Object ek2;
                    int eh;
                    if ((eh = e.hash) == h && ((ek2 = e.key) == k || ek2 != null && k.equals(ek2))) {
                        return e;
                    }
                    if (eh >= 0) continue;
                    if (e instanceof ForwardingNode) {
    ...
    implements Map.Entry<K, V> {
        ...
        Node<K, V> find(int h, Object k) {
            ...
            if (k != null) {
                do {
                    K ek2;
                    if (e.hash != h || (ek2 = e.key) != k && (ek2 == null || !k.equals(ek2))) continue;
                    return e;
                } while ((e = e.next) != null);
            }
            return null;
