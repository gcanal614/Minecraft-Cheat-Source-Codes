...
public abstract class Recycler<T> {
    ...
    static final class Stack<T> {
        ...
        Stack(Recycler<T> parent, Thread thread2, int maxCapacity) {
            this.parent = parent;
            this.thread = thread2;
    ...
    private static final class WeakOrderQueue {
         ...
         */
        WeakOrderQueue(Stack<?> stack, Thread thread2) {
    ...
    implements Handle {
        ...
        public void recycle() {
            ...
            if (queue == null) {
                queue = new WeakOrderQueue(this.stack, thread2);
