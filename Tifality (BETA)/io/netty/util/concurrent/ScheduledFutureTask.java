...
implements ScheduledFuture<V> {
    ...
    ScheduledFutureTask(EventExecutor executor, Queue<ScheduledFutureTask<?>> delayedTaskQueue, Runnable runnable, V result2, long nanoTime) {
        this(executor, delayedTaskQueue, ScheduledFutureTask.toCallable(runnable, result2), nanoTime);
    }
