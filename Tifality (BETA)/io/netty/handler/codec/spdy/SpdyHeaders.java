...
implements Iterable<Map.Entry<String, String>> {
    public static final SpdyHeaders EMPTY_HEADERS = new SpdyHeaders(){
        ...
        @Override
        public SpdyHeaders add(String name, Iterable<?> values2) {
            throw new UnsupportedOperationException("read only");
        }
        ...
        @Override
        public SpdyHeaders set(String name, Iterable<?> values2) {
            throw new UnsupportedOperationException("read only");
        }
    ...
    public static void setHeader(SpdyHeadersFrame frame, String name, Iterable<?> values2) {
        frame.headers().set(name, values2);
    }
