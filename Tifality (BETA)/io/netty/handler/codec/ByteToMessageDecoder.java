...
extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        block15: {
            ...
            try {
                ByteBuf data2 = (ByteBuf)msg;
                boolean bl = this.first = this.cumulation == null;
                if (this.first) {
                    this.cumulation = data2;
                } else {
                    if (this.cumulation.writerIndex() > this.cumulation.maxCapacity() - data2.readableBytes() || this.cumulation.refCnt() > 1) {
                        this.expandCumulation(ctx, data2.readableBytes());
                    }
                    this.cumulation.writeBytes(data2);
                    data2.release();
                }
