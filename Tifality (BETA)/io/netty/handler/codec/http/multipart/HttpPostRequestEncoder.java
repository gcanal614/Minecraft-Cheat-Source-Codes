...
implements ChunkedInput<HttpContent> {
    ...
    public void setBodyHttpDatas(List<InterfaceHttpData> datas) throws ErrorDataEncoderException {
        ...
        for (InterfaceHttpData data2 : datas) {
            this.addBodyHttpData(data2);
        }
    }
    ...
    public void addBodyAttribute(String name, String value) throws ErrorDataEncoderException {
        ...
        Attribute data2 = this.factory.createAttribute(this.request, name, svalue);
        this.addBodyHttpData(data2);
    }
    ...
    public void addBodyHttpData(InterfaceHttpData data2) throws ErrorDataEncoderException {
        ...
        this.bodyListDatas.add(data2);
        if (!this.isMultipart) {
            if (data2 instanceof Attribute) {
            ...
            } else if (data2 instanceof FileUpload) {
        ...
        if (data2 instanceof Attribute) {
            ...
            internal.addValue("\r\n");
            this.multipartHttpDatas.add(internal);
            this.multipartHttpDatas.add(data2);
    ...
    implements FullHttpRequest {
        ...
        public FullHttpRequest copy() {
            DefaultFullHttpRequest copy2 = new DefaultFullHttpRequest(this.getProtocolVersion(), this.getMethod(), this.getUri(), this.content().copy());
            copy2.headers().set(this.headers());
            copy2.trailingHeaders().set(this.trailingHeaders());
            return copy2;
        }
