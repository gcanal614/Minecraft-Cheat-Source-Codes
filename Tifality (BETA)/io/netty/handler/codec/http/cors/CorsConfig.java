...
public final class CorsConfig {
    ...
    public static class Builder {
        ...
        public Builder allowedRequestMethods(HttpMethod ... methods2) {
            this.requestMethods.addAll(Arrays.asList(methods2));
            return this;
        }
        ...
        public Builder preflightResponseHeader(CharSequence name, Object ... values2) {
            if (values2.length == 1) {
                this.preflightHeaders.put(name, new ConstantValueGenerator(values2[0]));
            } else {
                this.preflightResponseHeader(name, Arrays.asList(values2));
            }
            return this;
        }
