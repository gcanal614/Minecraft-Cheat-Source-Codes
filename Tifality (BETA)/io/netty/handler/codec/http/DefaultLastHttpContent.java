...
implements LastHttpContent {
    ...
    public LastHttpContent copy() {
        DefaultLastHttpContent copy2 = new DefaultLastHttpContent(this.content().copy(), this.validateHeaders);
    ...
    public LastHttpContent duplicate() {
        DefaultLastHttpContent copy2 = new DefaultLastHttpContent(this.content().duplicate(), this.validateHeaders);
        copy2.trailingHeaders().set(this.trailingHeaders());
        return copy2;
    }
