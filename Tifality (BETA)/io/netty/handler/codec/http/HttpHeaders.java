...
implements Iterable<Map.Entry<String, String>> {
    ...
    public static final HttpHeaders EMPTY_HEADERS = new HttpHeaders(){
        ...
        @Override
        public HttpHeaders add(String name, Iterable<?> values2) {
            throw new UnsupportedOperationException("read only");
        }
        ...
        @Override
        public HttpHeaders set(String name, Iterable<?> values2) {
            throw new UnsupportedOperationException("read only");
        }
    ...
    public static void setHeader(HttpMessage message, String name, Iterable<?> values2) {
        message.headers().set(name, values2);
    }

    public static void setHeader(HttpMessage message, CharSequence name, Iterable<?> values2) {
        message.headers().set(name, values2);
    }
    ...
    public static void setIntHeader(HttpMessage message, String name, Iterable<Integer> values2) {
        message.headers().set(name, values2);
    }

    public static void setIntHeader(HttpMessage message, CharSequence name, Iterable<Integer> values2) {
        message.headers().set(name, values2);
    }
    ...
    public static void setDateHeader(HttpMessage message, String name, Iterable<Date> values2) {
        message.headers().set(name, values2);
    }

    public static void setDateHeader(HttpMessage message, CharSequence name, Iterable<Date> values2) {
        message.headers().set(name, values2);
    }
    ...
    public static void removeTransferEncodingChunked(HttpMessage m) {
        List<String> values2 = m.headers().getAll(TRANSFER_ENCODING_ENTITY);
        if (values2.isEmpty()) {
            return;
        }
        ...
        if (values2.isEmpty()) {
            ...
            m.headers().set(TRANSFER_ENCODING_ENTITY, values2);
        }
    }
    ...
    public HttpHeaders add(CharSequence name, Iterable<?> values2) {
        return this.add(name.toString(), values2);
    }
    ...
    public HttpHeaders set(CharSequence name, Iterable<?> values2) {
        return this.set(name.toString(), values2);
    }
    ...
    public boolean contains(String name, String value, boolean ignoreCaseValue) {
        List<String> values2 = this.getAll(name);
        if (values2.isEmpty()) {
            return false;
        }
