...
implements DatagramChannel {
    ...
    protected int doReadMessages(List<Object> buf) throws Exception {
        ...
        ByteBuf data2 = config.getAllocator().heapBuffer(allocHandle.guess());
        boolean free = true;
        try {
            this.tmpPacket.setData(data2.array(), data2.arrayOffset(), data2.capacity());
            ...
            buf.add(new DatagramPacket(data2.writerIndex(readBytes), this.localAddress(), remoteAddr));
            free = false;
            int n = 1;
            return n;
        }
    ...
    protected void doWrite(ChannelOutboundBuffer in) throws Exception {
        ...
        while ((o = in.current()) != null) {
            ...
            if (data2.hasArray()) {
                this.tmpPacket.setData(data2.array(), data2.arrayOffset() + data2.readerIndex(), length);
            } else {
                byte[] tmp = new byte[length];
                data2.getBytes(data2.readerIndex(), tmp);
