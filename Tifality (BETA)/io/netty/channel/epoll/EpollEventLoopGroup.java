...
extends MultithreadEventLoopGroup {
    ...
    @Override
    protected EventExecutor newChild(ThreadFactory threadFactory, Object ... args2) throws Exception {
        return new EpollEventLoop((EventLoopGroup)this, threadFactory, (Integer)args2[0]);
    }
}
