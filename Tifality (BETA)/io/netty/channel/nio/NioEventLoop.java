...
extends SingleThreadEventLoop {
    ...
    private void processSelectedKeysPlain(Set<SelectionKey> selectedKeys) {
        ...
        while (true) {
            ...
            Object a2 = k.attachment();
            i.remove();
            if (a2 instanceof AbstractNioChannel) {
                NioEventLoop.processSelectedKey(k, (AbstractNioChannel)a2);
            } else {
                NioTask task = (NioTask)a2;
    ...
    private void closeAll() {
        ...
        ArrayList<AbstractNioChannel> channels = new ArrayList<AbstractNioChannel>(keys2.size());
