...
public final class Unpooled {
    ...
    public static ByteBuf copiedBuffer(ByteBuffer buffer) {
        ...
        return Unpooled.wrappedBuffer(copy2).order(buffer.order());
    }
    ...
    public static ByteBuf copyInt(int ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 4);
        for (int v : values2) {
            buffer.writeInt(v);
        }
        return buffer;
    ...
    public static ByteBuf copyShort(short ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 2);
        for (short v : values2) {
            buffer.writeShort(v);
        }
        return buffer;
    ...
    public static ByteBuf copyShort(int ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 2);
    ...
    public static ByteBuf copyMedium(int ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 3);
        for (int v : values2) {
    ...
    public static ByteBuf copyLong(long ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 8);
        for (long v : values2) {
            buffer.writeLong(v);
        }
        return buffer;
    ...
    public static ByteBuf copyBoolean(boolean ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length);
    ...
    public static ByteBuf copyFloat(float ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 4);
    ...
    public static ByteBuf copyDouble(double ... values2) {
        if (values2 == null || values2.length == 0) {
            return EMPTY_BUFFER;
        }
        ByteBuf buffer = Unpooled.buffer(values2.length * 8);
