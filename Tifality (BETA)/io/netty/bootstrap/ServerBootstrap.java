...
extends AbstractBootstrap<ServerBootstrap, ServerChannel> {
    ...
    private ServerBootstrap(ServerBootstrap bootstrap) {
        ...
        Map<UniqueName, Object> map2 = bootstrap.childOptions;
        synchronized (map2) {
    ...
    void init(Channel channel) throws Exception {
        ...
        Map<ChannelOption<?>, Object> map2 = options = this.options();
        synchronized (map2) {
            channel.config().setOptions(options);
        }
        Map<AttributeKey<?>, Object> map3 = attrs = this.attrs();
        synchronized (map3) {
        ...
        Map<UniqueName, Object> map4 = this.childOptions;
        synchronized (map4) {
    ...
    public String toString() {
        ...
        Map<UniqueName, Object> map2 = this.childOptions;
        synchronized (map2) {
