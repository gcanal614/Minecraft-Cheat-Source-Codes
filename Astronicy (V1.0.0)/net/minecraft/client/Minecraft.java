...
import wtf.astronicy.IMPL.utils.font.FontRendererHook;
import wtf.astronicy.IMPL.utils.font.FontUtils;
import wtf.astronicy.UIs.menu.AstronicyMainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public FontRenderer comfortaaFont;
    public FontRenderer MontserratFont;
    public FontRenderer AdventFont;
    public FontRenderer BungeeFont;
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.comfortaaFont = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/comfortaa.ttf"), 18.0F, 0), true, true);
        this.MontserratFont = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/montserrat.ttf"), 18.0F, 0), true, true);
        this.AdventFont = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/advent.ttf"), 18.0F, 0), true, true);
        this.BungeeFont = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/bungee.ttf"), 14.0F, 0), true, true);
        this.fontRenderer = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/sf_ui_display_regular.ttf"), 18.0F, 0), true, true);
        this.fontRendererSmall = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/sf_ui_display_regular.ttf"), 12.0F, 0), true, true);
        this.fontRendererTiny = new FontRendererHook(FontUtils.getFontFromTTF(new ResourceLocation("Astronicy/sf_ui_display_regular.ttf"), 6.0F, 0), true, true);
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new AstronicyMainMenu(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new AstronicyMainMenu());
        }
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new AstronicyMainMenu();
        }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    Astronicy.EVENT_BUS_REGISTRY.eventBus.post(new KeyPressEvent(k));
        ...
        Astronicy.EVENT_BUS_REGISTRY.eventBus.post(new TickEvent());
        this.mcProfiler.endSection();
