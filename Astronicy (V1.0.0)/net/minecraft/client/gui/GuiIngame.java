...
import wtf.astronicy.API.events.render.RenderCrosshairEvent;
...
import libraries.optifine.TextureAnimations;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        Astronicy.EVENT_BUS_REGISTRY.eventBus.post(new RenderGuiEvent(scaledresolution, partialTicks));
        NotificationManager.doRender(i, j);
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes)
    {
        //if (instance == null || !instance.shouldHideScoreboard()) {
            ...
            for (Score score1 : arraylist1) {
                ...
                servers.add("eu.loyisa.cn");
                servers.add("mc.hypixel.net");
