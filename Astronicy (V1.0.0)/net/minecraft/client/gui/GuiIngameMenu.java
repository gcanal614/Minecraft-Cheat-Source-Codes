    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        switch(button.id) {
            ...
            case 1:
                ...
                if (flag) {
                    this.mc.displayGuiScreen(new AstronicyMainMenu());
                } else if (flag1) {
                    RealmsBridge realmsbridge = new RealmsBridge();
                    realmsbridge.switchToRealms(new AstronicyMainMenu());
                } else {
                    this.mc.displayGuiScreen(new GuiMultiplayer(new AstronicyMainMenu()));
                }
            case 2:
            case 3:
            default:
