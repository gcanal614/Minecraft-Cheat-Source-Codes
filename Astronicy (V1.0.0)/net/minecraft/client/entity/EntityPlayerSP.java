...
import wtf.astronicy.API.events.player.*;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer() {
        ...
        Astronicy.EVENT_BUS_REGISTRY.eventBus.post(actionEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Astronicy.EVENT_BUS_REGISTRY.eventBus.post(pushEvent);
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        Astronicy.EVENT_BUS_REGISTRY.eventBus.post(blockRenderEvent);
