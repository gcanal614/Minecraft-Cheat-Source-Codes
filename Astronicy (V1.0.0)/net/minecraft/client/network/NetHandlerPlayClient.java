...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn)
    {
        ...
        Astronicy.EVENT_BUS_REGISTRY.eventBus.post(event);
    ...
    public void onDisconnect(IChatComponent reason)
    {
        ...
        {
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new AstronicyMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void addToSendQueueNoEvent(Packet poll) {
        Minecraft.getMinecraft().getNetHandler().getNetworkManager().sendPacketNoEvent(poll);
    }
}
