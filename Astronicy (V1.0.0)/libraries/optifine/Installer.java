...
import libraries.optifine.json.JSONArray;
import libraries.optifine.json.JSONObject;
import libraries.optifine.json.JSONParser;
import libraries.optifine.json.JSONWriter;
import libraries.optifine.json.ParseException;
...
public class Installer
{
    ...
    private static void updateJson(File dirMcVers, String mcVerOf, File dirMcLib, String mcVer, String ofEd) throws IOException, ParseException
    {
        ...
        if (!s1.startsWith("net.minecraft.launchwrapper."))
        {
            ...
            s2 = s2 + "  --tweakClass libraries.optifine.OptiFineTweaker";
        ...
        jsonobject2.put("name", "libraries.optifine:OptiFine:" + mcVer + "_" + ofEd);
