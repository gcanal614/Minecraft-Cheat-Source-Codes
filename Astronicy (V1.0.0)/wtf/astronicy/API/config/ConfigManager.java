package wtf.astronicy.API.config;
...
public final class ConfigManager {
   ...
   public static class Config {
      ...
      public void save() {
         ...
         Module module;
         JsonObject jsf;
         for(UnmodifiableIterator var2 = Astronicy.MANAGER_REGISTRY.moduleManager.getModules().iterator(); var2.hasNext(); js.add(module.getLabel(), jsf)) {
         ...
         Astronicy.MANAGER_REGISTRY.fileManager.write(this.getFile(), (new GsonBuilder()).setPrettyPrinting().create().toJson(js));
      }
