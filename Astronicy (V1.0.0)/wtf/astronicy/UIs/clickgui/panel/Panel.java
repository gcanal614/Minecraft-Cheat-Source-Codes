package wtf.astronicy.UIs.clickgui.panel;
...
import wtf.astronicy.UIs.clickgui.panel.component.impl.ModuleComponent;
...
public final class Panel {
   ...
   public Panel(ModuleCategory category, int x, int y) {
      ...
      this.width = 100;
      int componentY = 18;
      List modulesForCategory = Astronicy.MANAGER_REGISTRY.moduleManager.getModulesForCategory(category);
      int i = 0;
   ...
   public final void onDraw(int mouseX, int mouseY) {
      ...
      int categoryColor = (new Color(50, 50, 50)).getRGB();
      Gui.drawRect((double)(x - 2), (double)y + 5, (double)(x + width + 2), (double)(y + 18), categoryColor);
      this.fr.drawStringWithShadow(this.category.toString(), (float)(x + 3), (float)y + 12.0F - 3.0F, ClickGuiScreen.getColor().getRGB());
      GL11.glPushMatrix();
      GL11.glEnable(3089);
