...
import wtf.astronicy.UIs.clickgui.panel.AnimationState;
...
public final class ModuleComponent extends Component {
   ...
   public void onDraw(int mouseX, int mouseY) {
      ...
      int x2 = this.module.isEnabled() ? x1 + 2 : x1 - 2;
      ...
      FONT_RENDERER.drawStringWithShadow(this.module.getLabel(), (float)x1, (float)y + (float)height / 2.0F - 4.0F, color);
