...
import stellar.skid.utils.java.HttpUtils;
...
import static stellar.skid.utils.java.HttpUtils.createConnection;
import static stellar.skid.utils.java.HttpUtils.parseConnectionInput;
...
public final class NameCommand extends NovoCommand {
    ...
    /* constructors */
    public NameCommand(@NonNull StellarWare stellarWare) {
        super(stellarWare, "name", "names");
    }
