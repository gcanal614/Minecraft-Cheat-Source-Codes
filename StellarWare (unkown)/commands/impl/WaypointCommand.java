...
import stellar.skid.modules.visual.Waypoints;
...
public final class WaypointCommand extends NovoCommand {
    ...
    /* constructors */
    public WaypointCommand(@NonNull StellarWare stellarWare) {
        super(stellarWare, "waypoint", "Manages waypoints", Arrays.asList("waypoints", "wp"));
    }
    ...
    public void process(String[] args) {
        final Waypoints module = StellarWare.getInstance().getModuleManager().getModule(Waypoints.class);
        ...
        switch (action.toLowerCase()) {
            case "add":
                ...
                try {
                    ...
                    StellarWare.getInstance().getNotificationManager().pop("Can't save to file", ERROR);
