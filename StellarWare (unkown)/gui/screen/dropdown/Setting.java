...
import stellar.skid.events.events.BindEvent;
...
import static stellar.skid.utils.fonts.impl.Fonts.SF.SF_16.SF_16;
import static stellar.skid.utils.fonts.impl.Fonts.SF.SF_17.SF_17;
import static stellar.skid.utils.fonts.impl.Fonts.SF.SF_18.SF_18;
import static stellar.skid.utils.fonts.impl.Fonts.SF.SF_26.SF_26;

public class Setting {

    public stellar.skid.gui.screen.setting.Setting setting;
    ...
    public Setting(stellar.skid.gui.screen.setting.Setting setting, Module module) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        switch (setting.getSettingType()) {
            case SLIDER:
                ...
                Gui.drawRect(module.tab.getPosX() + 1, y + 15, module.tab.getPosX() + 99, y + 14, new Color(0, 0, 0, 50).getRGB());
                Gui.drawRect(module.tab.getPosX() + 1, y + 15, module.tab.getPosX() + 1 + 98 * percent, y + 14, hud.getHUDColor());
                SF_18.drawString(setting.getDisplayName() + " " + rounded, module.tab.getPosX() + 1, y + 5.5f, 0xffffffff, true);
            ...
            case CHECKBOX:
                ...
                SF_18.drawString(setting.getDisplayName(), module.tab.getPosX() + 1, y + 5.5f,
            ...
            case COLOR_PICKER:
                final int oColor = StellarWare.getInstance().getModuleManager().getModule(ClickGUI.class).getGUIColor();
                ...
                switch (setting.getColorPickerMode()) {
                    case HUE:
                        ...
                        SF_18.drawString(setting.getDisplayName(), module.tab.getPosX() + 1, y + 5.5f, 0xffffffff, true);
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        if (mouseButton == 1 && setting.getSettingType() == SettingType.COLOR_PICKER && isHovered(mouseX, mouseY)) {
            final stellar.skid.gui.screen.setting.Setting.ColorPickerMode[] values = stellar.skid.gui.screen.setting.Setting.ColorPickerMode
                    .values();
            ...
            if (setting.getColorPickedDisabledModes() == null) {
                ...
                stellar.skid.gui.screen.setting.Setting.ColorPickerMode mode;
