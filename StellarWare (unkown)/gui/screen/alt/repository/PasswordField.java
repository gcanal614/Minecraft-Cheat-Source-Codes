    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = Minecraft.getInstance().fontRendererObj.drawStringWithShadow(this.text.replaceAll("(?s).", "*"), var7, var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                Minecraft.getInstance().fontRendererObj.drawStringWithShadow(var4.substring(var2), var9, var8, var1);
            }
            if (var6) {
                if (var10) {
                    ...
                    Minecraft.getInstance().fontRendererObj.drawStringWithShadow("_", var11, var8, var1);
                }
            }
            if (var3 != var2) {
