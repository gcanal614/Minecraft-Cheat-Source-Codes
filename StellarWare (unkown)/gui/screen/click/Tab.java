...
import static stellar.skid.utils.fonts.impl.Fonts.ICONFONT.ICONFONT_24.ICONFONT_24;
...
import static stellar.skid.utils.fonts.impl.Fonts.SFTHIN.SFTHIN_20.SFTHIN_20;
...
public class Tab {
    ...
    public Tab(@NotNull StellarWare stellarWare, @NotNull EnumModuleType category, int y) {
        ...
        for (ModuleHolder<?> holder : this.stellarWare.getModuleManager().getModuleManager().values()) {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        ...
        int guiColor = stellarWare.getModuleManager().getModule(ClickGUI.class).getGUIColor();
    ...
    private double[] getCoords() {
        switch (category.name()) { // @off
            case "COMBAT":
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 21.5D, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 4.5D};
            case "MOVEMENT":
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 22.5, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 5};
            case "PLAYER":
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 22.2D, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 6};
            case "VISUALS":
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 22D, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 5};
            case "EXPLOITS":
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 22.3D, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 5.6};
            case "MISC":
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 22.5D, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 5};
            default:
                return new double[]{StellarWare.getInstance().getDiscordGUI().getXCoordinate() + 22D, StellarWare.getInstance().getDiscordGUI().getYCoordinate() + y - 5};
        } // @on
    }
