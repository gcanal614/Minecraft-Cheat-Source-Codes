...
import static stellar.skid.gui.screen.setting.Manager.getSettingList;
import static stellar.skid.gui.screen.setting.Manager.getSettingsByMod;
import static stellar.skid.utils.fonts.impl.Fonts.SFBOLD.SFBOLD_26.SFBOLD_26;
import static stellar.skid.utils.fonts.impl.Fonts.SFTHIN.SFTHIN_12.SFTHIN_12;
...
public class Module {
    ...
    public void drawScreen(int mouseX, int mouseY) {
        final DiscordGUI discordGUI = StellarWare.getInstance().getDiscordGUI();
        ClickGUI clickGUI = StellarWare.getInstance().getModuleManager().getModule(ClickGUI.class);
        ...
        if (isHovered(mouseX, mouseY) || this.selected) {
            drawRect(xCoordinate + 45, //
                    ...
                    xCoordinate + 45 + 110, //
                    yCoordinate + this.y + SFTHIN_20.getHeight() + 4 > yCoordinate + discordGUI.getHeight() ? clamp_float(yCoordinate + this.y + SFTHIN_20.getHeight() + 4, yCoordinate + this.y - 4, yCoordinate + discordGUI.getHeight()) : yCoordinate + this.y + SFTHIN_20.getHeight() + 4,  0xFF36393E);
        }
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        ...
        if (mouseY >= discordGUI.getYCoordinate() + 20 && mouseY <= discordGUI.getYCoordinate() + discordGUI.getHeight() && isHovered(mouseX, mouseY)) {
            if (mouseButton == 2) {
                final Tab currentTab = StellarWare.getInstance().getDiscordGUI().getSelectedTab();
    ...
    protected void keyTyped(char typedChar, int keyCode) {
        ...
        if (this.listening) {
            if (keyCode != Keyboard.KEY_ESCAPE) {
                ...
                this.data.getStellarWare().getModuleManager().getBindManager().save();
            }
