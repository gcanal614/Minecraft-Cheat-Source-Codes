package stellar.skid.utils.pathfinding;
...
public class AStarCustomPathfinder {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        return Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()).isSolidFullCube() ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockSlab ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockStairs ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockCactus ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockChest ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockEnderChest ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockSkull ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPane ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockFence ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockWall ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockGlass ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonBase ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonExtension ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockPistonMoving ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockStainedGlass ||
                Minecraft.getInstance().world.getBlock(block.getX(), block.getY(), block.getZ()) instanceof BlockTrapDoor;
    }
