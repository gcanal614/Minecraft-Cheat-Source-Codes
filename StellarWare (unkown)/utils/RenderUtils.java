...
import stellar.skid.modules.visual.PlayerESP;
...
public final class RenderUtils {
    ...
    public static int getArrayRainbow(int counter, int alpha) {
        final int width = 110;
        PlayerESP playerESP = StellarWare.getInstance().getModuleManager().getModule(PlayerESP.class);
    ...
    public static void renderTHUD(KillAura aura, @NotNull EntityPlayer e) {
        ...
        float rectLength = 35 + mc.fontRendererCrack.getStringWidth(winner) + 92, health = (float) (Math.round(hp * 100.0) / 100.0);
        ...
        RenderUtils.drawRoundedRect(i2, i1 - 1.5f, 120, 40, 14, new Color(0, 0, 0, 170).getRGB());
        //Gui.drawRect(i2 + 1, i1, i2 + rectLength - 7, i1 + 36, new Color(40, 40, 40, 130).getRGB());
        GL11.glPushMatrix();
        GL11.glColor4f(1, 1, 1, 1);
        final int l6 = 8;
        final int i6 = 8;
        GL11.glScaled(4.42, 4.42, 4.4);
        Gui.drawScaledCustomSizeModalRect((float) ((i2 + 1.5) / 4.4), (float) ((i1 + 0.4) / 4.42), 8.0f, (float) l6, 8, i6, 8, 8, 64.0f, 64.0f);
        GL11.glPopMatrix();
        int hudColor = StellarWare.getInstance().getModuleManager().getModule(HUD.class).getHUDColor();
        //Gui.drawRect(i2 + 40, i1 + 16.5, i2 + 40 + 100 * space, i1 + 27.3, new Color(0, 0, 0, 50).getRGB());
        RenderUtils.drawRoundedRect(i2 + 40F, i1 + 16.5F, percent * space, 10, 5, hudColor);
        ...
        Fonts.SFBOLD.SFBOLD_20.SFBOLD_20.drawString(text, i2 + 40 + 50 * space - mc.fontRendererCrack.getStringWidth(text) / 2,
                i1 + 18.6f, 0xffffffff, true);
        Fonts.SFBOLD.SFBOLD_20.SFBOLD_20.drawString(e.getName(), i2 + 40, i1 + 4, 0xffffffff, true);
        
        if(e.getHealth() < mc.player.getHealth()) {
        	winner = "You Would Win This Fight";
        } else {
        	winner = "You Would Lose This Fight";;
        }
        
        Fonts.SFBOLD.SFBOLD_12.SFBOLD_12.drawString(winner, i2 + 40, i1 + 31, 0xffffffff, true);
