...
import stellar.skid.modules.move.TargetStrafe;
...
public class MoveEvent implements Event {
    ...
    public void setMoveSpeed(double moveSpeed) {
        StellarWare stellarWare = StellarWare.getInstance();
        Minecraft mc = Minecraft.getInstance();
        KillAura killAura = stellarWare.getModuleManager().getModule(KillAura.class);
        TargetStrafe targetStrafe = stellarWare.getModuleManager().getModule(TargetStrafe.class);
