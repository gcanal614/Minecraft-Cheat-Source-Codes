package stellar.skid.modules.configurations.holder;

import static stellar.skid.modules.configurations.property.mapper.PropertyMapper.mapPropertyPath;
...
public final class CreatingModuleHolder<Module extends AbstractModule> extends ModuleHolder<Module> {
    ...
    private void collectField(Map<@NonNull String, @NonNull PropertyFieldData> fields, @NonNull Field field,
        ...
        final stellar.skid.modules.configurations.annotation.Property annotation = field
                .getAnnotation(stellar.skid.modules.configurations.annotation.Property.class);
