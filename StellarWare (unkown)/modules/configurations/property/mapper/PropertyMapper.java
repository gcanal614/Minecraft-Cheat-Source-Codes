package stellar.skid.modules.configurations.property.mapper;
...
public final class PropertyMapper<T> extends ObjectMapper<T> {
    ...
    protected void collectFields(Map<String, FieldData> cachedFields,
        ...
        for (final Field field : clazz.getDeclaredFields()) {
            if (stellar.skid.modules.configurations.property.Property.class.isAssignableFrom(field.getType()) && field
