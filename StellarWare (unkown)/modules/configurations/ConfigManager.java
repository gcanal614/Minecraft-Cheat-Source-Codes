package stellar.skid.modules.configurations;
...
import stellar.skid.modules.configurations.property.Property;
import stellar.skid.modules.configurations.property.mapper.PropertyMapperFactory;
...
import stellar.skid.modules.serializers.ModuleMapSerializer;
import stellar.skid.modules.serializers.PropertySerializer;
...
public final class ConfigManager {
            ...
            if ((destHolder = (CreatingModuleHolder<?>) destModulesMap.get(moduleName)) != null) {
                ...
                for (final Map.Entry<String, CreatingModuleHolder.PropertyFieldData> propertyEntry : destHolder.getFields().entrySet()) {
                    ...
                    try {
                        ...
                        StellarWare.getLogger().warn("An error occurred while updating property: value: " + propertyName + ", module: " + destHolder.getName(), t);
                        error++;
                    }
                }
    ...
    public Path getConfigsFolder() {
        final Path path = this.moduleManager.getStellarWare().getDataFolder();
        ...
        if (isRegularFile(configsFolder)) {
            ...
            for (int i = 1; i < Integer.MAX_VALUE; i++) {
                try {
                    ...
                    StellarWare.getLogger().error("An I/O error occurred while creating configs folder", e);
                }
            }

            if (!b) StellarWare.getLogger().error("User created 2.147.483.648 configs-# files. Cannot create configs folder");
        }
