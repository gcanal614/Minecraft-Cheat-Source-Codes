...
public final class Arrows extends AbstractModule {
    ...
    public void onRender(Render2DEvent event) {
        ...
        for (Entity entity : minecraft.world.getLoadedEntityList().stream().sorted(Comparator.comparingDouble(entity ->
            ...
            if (targetsOnly.get() && !stellarWare.getPlayerManager().hasType(entity.getName(), PlayerManager.EnumPlayerType.TARGET))
                continue;
            ...
            switch (colorType.get()) {
                ...
                case "Team":
                    ...
                    } else if (stellarWare.getPlayerManager().hasType(entity.getName(), PlayerManager.EnumPlayerType.FRIEND)) {
                        temp = new Color(169, 255, 43, 255);
                    } else if (stellarWare.getPlayerManager().hasType(entity.getName(), PlayerManager.EnumPlayerType.TARGET)) {
    ...
    public boolean isValidTarget(Entity target) {
        ...
        if (target.isEntityAlive() && player.getHealth() > 0.0F && !stellarWare.getPlayerManager().hasType(target.getName(), PlayerManager.EnumPlayerType.FRIEND)) {
