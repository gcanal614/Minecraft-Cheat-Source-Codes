...
import stellar.skid.utils.ColorUtils;
...
public final class XRay extends AbstractModule {
    ...
    public static boolean showESP() {
        return StellarWare.getInstance().getModuleManager().getModule(XRay.class).esp.get();
    }

    public static int getDistance() {
        return StellarWare.getInstance().getModuleManager().getModule(XRay.class).distance.get();
    }
}
