package stellar.skid.modules.visual.tabgui;
...
import static stellar.skid.utils.fonts.impl.Fonts.SFTHIN.SFTHIN_18.SFTHIN_18;
...
public final class TabModule {
    ...
    public TabModule(AbstractModule mod, TabType type) {
        ...
        for (Setting setting : Manager.getSettingsByMod(mod)) {
    ...
    public boolean isOpenable(Setting setting) {
    ...
    public int getLongest() {
        ...
        for (AbstractModule module : this.type.getTabGUI().getStellarWare().getModuleManager()
