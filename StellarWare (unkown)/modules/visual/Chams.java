...
import stellar.skid.events.events.RenderEntityEvent;
...
import stellar.skid.utils.minecraft.FakeEntityPlayer;
...
public final class Chams extends AbstractModule {
    ...
    public boolean isValid(EntityLivingBase entity) {
        return !(entity instanceof FakeEntityPlayer) && isValidType(entity) && entity.isEntityAlive() && !entity.isInvisible() && entity != mc.player && (!onlyTargets.get() || stellarWare.getPlayerManager().hasType(entity.getName(), PlayerManager.EnumPlayerType.TARGET));
    }
