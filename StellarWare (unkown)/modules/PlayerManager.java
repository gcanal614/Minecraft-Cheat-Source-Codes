...
import stellar.skid.utils.java.Helpers;
...
public final class PlayerManager {
    ...
    /* constructors */
    public PlayerManager(@NotNull StellarWare stellarWare, @NotNull String s) {
        this.config = Config.fromPath(stellarWare.getDataFolder().resolve(s));
        config.load();
