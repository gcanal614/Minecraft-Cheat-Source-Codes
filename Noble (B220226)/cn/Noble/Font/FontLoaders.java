...
public abstract class FontLoaders {
	...
	public static CFontRenderer click18 = new CFontRenderer(FontLoaders.getIcon(18), true);
	public static CFontRenderer click24 = new CFontRenderer(FontLoaders.getIcon(24), true);
	public static CFontRenderer click40 = new CFontRenderer(FontLoaders.getIcon(40), true);
	...
	public static UnicodeFontRender CN16 = new UnicodeFontRender(FontLoaders.getCN(16), true);
	public static UnicodeFontRender CN17 = new UnicodeFontRender(FontLoaders.getCN(17), true);
	public static UnicodeFontRender CN18 = new UnicodeFontRender(FontLoaders.getCN(18), true);
	public static UnicodeFontRender CN20 = new UnicodeFontRender(FontLoaders.getCN(20), true);
	
	public static UnicodeFontRender ui18 = new UnicodeFontRender(FontLoaders.getgui(18), true);
	...
	private static Font getCNMD(int size) {
		...
		try {
			InputStream is = Minecraft.getMinecraft().getResourceManager()
					.getResource(new ResourceLocation("Melody/Fonts/CNMD.ttf")).getInputStream();
	...
	private static Font getIcon(int size) {
		...
		try {
			InputStream is = Minecraft.getMinecraft().getResourceManager()
					.getResource(new ResourceLocation("Melody/clickgui.ttf")).getInputStream();
			font = Font.createFont(0, is);
			font = font.deriveFont(0, size);
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	private static Font getgui(int size) {
		Font font;
		try {
			InputStream is = Minecraft.getMinecraft().getResourceManager()
					.getResource(new ResourceLocation("Melody/SessionInfo.ttf")).getInputStream();
			font = Font.createFont(0, is);
			font = font.deriveFont(0, size);
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	private static Font getCN(int size) {
		...
		try {
			InputStream is = Minecraft.getMinecraft().getResourceManager()
					.getResource(new ResourceLocation("Melody/Fonts/CN.ttc")).getInputStream();
			font = Font.createFont(0, is);
			font = font.deriveFont(0, size);
		} catch (Exception ex) {
			ex.printStackTrace();
