...
public class ColorUtils {
    ...
    public static Color getArmorColor(float armor, float maxArmor) {
        ...
        Color[] colors = new Color[]{new Color(Colors.DARKGREY.c), new Color(Colors.GREY.c), new Color(Colors.DARKBLUE.c), new Color(Colors.BLUE.c)};
    ...
    public static Color fastrainbow() {
        int rainbowTick = 0;
        return new Color(Color.HSBtoRGB((float) ((double)Minecraft.getMinecraft().player.ticksExisted / 50 + Math.sin((double) rainbowTick / 50.0 * 1.6)) % 1.0f, 0.5f, 1.0f));
    }
    ...
    public static String stripColor(final String input) {
        return ColorUtils.COLOR_PATTERN.matcher(input).replaceAll("");
    }
}
