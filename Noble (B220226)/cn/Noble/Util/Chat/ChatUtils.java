...
public class ChatUtils {
    ...
    public void displayClientSided() {
        Minecraft.getMinecraft().player.addChatMessage(this.message);
    }
    ...
    public static class ChatMessageBuilder {
        ...
        public ChatMessageBuilder(boolean prependDefaultPrefix, boolean useDefaultMessageColor) {
            if (prependDefaultPrefix) {
                ...
                this.theMessage.appendSibling(new ChatMessageBuilder(false, false).appendText(String.valueOf((Object)((Object)EnumChatFormatting.BLUE) + "Noble" + " ")).setColor(EnumChatFormatting.RED).build().getChatComponent());
            }
