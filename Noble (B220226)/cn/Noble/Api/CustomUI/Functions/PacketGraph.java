...
import cn.Noble.Util.BlockObject;
...
public class PacketGraph extends HUDApi {
	...
	public void onRender() {
		...
		if (!serverBlocks.isEmpty()) {
			...
			mc.fontRendererObj.drawString("< avg: " + firstBlock.height, x * 2 + 301,
	...
	private void drawGraph(int mode, int x, int y) {
		...
		mc.fontRendererObj.drawString(secString, (x * 2) + 300 - (mc.fontRendererObj.getStringWidth(secString)),
				y * 2 - 129, -1);
		GL11.glPopMatrix();
