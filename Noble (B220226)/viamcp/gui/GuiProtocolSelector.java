...
public class GuiProtocolSelector extends GuiScreen
{
    ...
    public void drawScreen(int p_drawScreen_1_, int p_drawScreen_2_, float p_drawScreen_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, EnumChatFormatting.BOLD + "Ultimate ViaMCP", this.width / 4, 6, 16777215);
        GL11.glPopMatrix();
        drawString(this.fontRendererObj, "Ultimate ViaMCP For 1.8.9", 5, 5, -1);
