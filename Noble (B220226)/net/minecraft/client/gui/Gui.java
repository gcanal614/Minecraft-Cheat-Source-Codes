...
public class Gui
{
     ...
     */public static void drawFilledCircleq(float xx, float yy, float radius, Color col) {
         int sections = 50;
    ...
    public static void drawModalRectWithCustomSizedTexture(double d, double e, float u, float v, int width, int height, float textureWidth, float textureHeight)
    {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX);
        worldrenderer.pos((double)d, (double)(e + height), 0.0D).tex((double)(u * f), (double)((v + (float)height) * f1)).endVertex();
        worldrenderer.pos((double)(d + width), (double)(e + height), 0.0D).tex((double)((u + (float)width) * f), (double)((v + (float)height) * f1)).endVertex();
        worldrenderer.pos((double)(d + width), (double)e, 0.0D).tex((double)((u + (float)width) * f), (double)(v * f1)).endVertex();
    ...
    public static void drawFilledCirclespl(double x, double y, double r, int c, int id) {
        float f = (float) (c >> 24 & 0xff) / 255F;
        float f1 = (float) (c >> 16 & 0xff) / 255F;
        float f2 = (float) (c >> 8 & 0xff) / 255F;
        float f3 = (float) (c & 0xff) / 255F;
