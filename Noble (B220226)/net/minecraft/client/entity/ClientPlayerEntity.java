...
public class ClientPlayerEntity extends AbstractClientPlayer
{
    ...
    public ClientPlayerEntity(Minecraft mcIn, World worldIn, NetHandlerPlayClient netHandler, StatFileWriter statFile)
    {
    ...
    {
        EventPreUpdate event = new EventPreUpdate(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.mc.player.onGround);
    ...
    public void moveEntity(double x, double y, double z) {
    	EventMove event = EventBus.getInstance().call(new EventMove(x, y, z));
    ...
    {
    	EventBus.getInstance().call(new EventRespawn());
    ...
    public void onLivingUpdate()
    {
		...
		if (this.isUsingItem() && !this.isRiding()
				&& !Client.instance.getModuleManager().getModuleByClass(NoSlowDown.class).isEnabled()) {
