...
public class ItemInWorldManager
{
    ...
    public void updateBlockRemoving()
    {
        ...
        if (this.receivedFinishDiggingPacket)
        {
            ...
            Block block = this.world.getBlockState(this.field_180241_i).getBlock();
            ...
            else
            {
                ...
                {
                    this.world.sendBlockBreakProgress(this.thisPlayerMP.getEntityId(), this.field_180241_i, j);
        ...
        {
            Block block1 = this.world.getBlockState(this.field_180240_f).getBlock();

            if (block1.getMaterial() == Material.air)
            {
                this.world.sendBlockBreakProgress(this.thisPlayerMP.getEntityId(), this.field_180240_f, -1);
            ...
            else
            {
                ...
                {
                    this.world.sendBlockBreakProgress(this.thisPlayerMP.getEntityId(), this.field_180240_f, l);
    ...
    public void onBlockClicked(BlockPos pos, EnumFacing side)
    {
        ...
        else
        {
            ...
            if (block.getMaterial() != Material.air)
            {
                block.onBlockClicked(this.world, pos, this.thisPlayerMP);
            ...
            else
            {
                ...
                int i = (int)(f * 10.0F);
                this.world.sendBlockBreakProgress(this.thisPlayerMP.getEntityId(), pos, i);
    ...
    public void blockRemoving(BlockPos pos)
    {
        if (pos.equals(this.field_180240_f))
        {
            ...
            if (block.getMaterial() != Material.air)
            {
                ...
                {
                    this.isDestroyingBlock = false;
                    this.world.sendBlockBreakProgress(this.thisPlayerMP.getEntityId(), pos, -1);
                    this.tryHarvestBlock(pos);
                }
    ...
    private boolean removeBlock(BlockPos pos)
    {
        ...
        iblockstate.getBlock().onBlockHarvested(this.world, pos, iblockstate, this.thisPlayerMP);
    ...
    public boolean tryHarvestBlock(BlockPos pos)
    {
        ...
        else
        {
            ...
            this.world.playAuxSFXAtEntity(this.thisPlayerMP, 2001, pos, Block.getStateId(iblockstate));
            boolean flag1 = this.removeBlock(pos);

            if (this.isCreative())
            {
                this.thisPlayerMP.playerNetServerHandler.sendPacket(new S23PacketBlockChange(this.world, pos));
            }
            else
            {
                ...
                if (itemstack1 != null)
                {
                    itemstack1.onBlockDestroyed(this.world, iblockstate.getBlock(), pos, this.thisPlayerMP);
                ...
                if (flag1 && flag)
                {
                    iblockstate.getBlock().harvestBlock(this.world, this.thisPlayerMP, pos, iblockstate, tileentity);
                }
            }
