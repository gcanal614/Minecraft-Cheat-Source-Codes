...
public class IntegratedServer extends MinecraftServer
{
    ...
    public IntegratedServer(Minecraft mcIn, String folderName, String worldName, WorldSettings settings)
    {
        ...
        this.mc = mcIn;
        this.worldSettings = this.isDemo() ? DemoWorldServer.demoWorldSettings : settings;
        ...
        else
        {
            for (int l = 0; l < this.worldServers.length; ++l)
            {
                ...
                if (l == 0)
                {
                    ...
                    this.worldServers[l].initialize(this.worldSettings);
                }
                else
                {
    ...
    protected boolean startServer() throws IOException
    {
        ...
        this.loadAllWorlds(this.getFolderName(), this.getWorldName(), this.worldSettings.getSeed(), this.worldSettings.getTerrainType(), this.worldSettings.getWorldName());
    ...
    /**
     * Adds the server info, including from worldServer, to the crash report.
     */
