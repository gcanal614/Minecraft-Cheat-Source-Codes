...
import cn.Noble.Util.BlockUtils;
...
public final class LiquidRender {
    ...
    public static void renderNameTag(final String string, final double x, final double y, final double z) {
        ...
        final int width = (int)FontLoaders.NMSL35.getStringWidth(string) / 2;

        Gui.drawRect(-width - 1, -1, width + 1, FontLoaders.NMSL35.getHeight(), Integer.MIN_VALUE);
        FontLoaders.NMSL35.drawString(string, -width, 1.5F, Color.WHITE.getRGB());
