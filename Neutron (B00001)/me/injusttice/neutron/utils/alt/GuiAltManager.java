...
public class GuiAltManager extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        ResourceLocation background = new ResourceLocation("Desync/nigger_background.jpg");
        mc.getTextureManager().bindTexture(background);
        RenderUtil.drawImage(0, 0, 0, 0, width, height, width, height);
        this.drawString(this.fontRendererObj, "Username: §3" + this.mc.session.getUsername(), 10, 10, -7829368);
        FontRenderer fontRendererObj = this.fontRendererObj;
        StringBuilder sb2 = new StringBuilder("");

        this.drawCenteredString(fontRendererObj, "Account Manager", width / 2, 10, -1);
        this.drawCenteredString(fontRendererObj, "§8(§7" + sb2.append(AltManager.registry.size()).append("").toString() + "§8)", width / 2, 20, -1);
        Gui.drawRect(50.0f, 33.0f, width - 50, height - 50, -16777216);
        GL11.glPushMatrix();
        this.prepareScissorBox(0.0f, 33.0f, width, height - 50);
        GL11.glEnable(3089);
        int y2 = 38;
        AltManager altManager2 = NeutronMain.instance.altManager;
        for (Alt alt2 : AltManager.registry) {
            ...
            String pass = alt2.getPassword().equals("") ? "" : alt2.getPassword().replaceAll(".", "*");
            if (alt2 == this.selectedAlt) {
                ...
                RenderUtil.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -16777216);
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                RenderUtil.drawRect(52.0f, y2 - this.offset - 4, width - 52, y2 - this.offset + 20, -16777216);
            }
    ...
    public void initGui() {
    	...
    	if(this.selectedAlt == null) {
            this.login = new GuiButton(1, width / 2 - 154, height - 48, 100, 20, "§oLogin");
        } else {
