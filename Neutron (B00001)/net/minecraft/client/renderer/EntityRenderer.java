...
import me.injusttice.neutron.api.events.impl.EntityRenderEvent;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    {
        EventHurt hurtEvent = new EventHurt();
        hurtEvent.call();
        if (hurtEvent.isCancelled()) return;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        EntityRenderEvent eventRenderEntity = new EntityRenderEvent(partialTicks);
    ...
    private void updateMainMenu(GuiCustomMainMenu p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = GuiCustomMainMenu.class.getDeclaredFields();
