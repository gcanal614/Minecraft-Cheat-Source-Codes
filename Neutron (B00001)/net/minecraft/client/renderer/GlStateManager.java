...
{
    public static GlStateManager.AlphaState alphaState = new GlStateManager.AlphaState((GlStateManager.GlStateManager1)null);
    ...
    public static GlStateManager.ColorMaterialState colorMaterialState = new GlStateManager.ColorMaterialState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.BlendState blendState = new GlStateManager.BlendState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.DepthState depthState = new GlStateManager.DepthState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.FogState fogState = new GlStateManager.FogState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.CullState cullState = new GlStateManager.CullState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.PolygonOffsetState polygonOffsetState = new GlStateManager.PolygonOffsetState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.ColorLogicState colorLogicState = new GlStateManager.ColorLogicState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.TexGenState texGenState = new GlStateManager.TexGenState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.ClearState clearState = new GlStateManager.ClearState((GlStateManager.GlStateManager1)null);
    public static GlStateManager.StencilState stencilState = new GlStateManager.StencilState((GlStateManager.GlStateManager1)null);
    ...
    public static GlStateManager.ColorMask colorMaskState = new GlStateManager.ColorMask((GlStateManager.GlStateManager1)null);
    ...
    {
        GlStateManager.TexGenCoord glstatemanagertexgencoord = texGenCoord(p_179149_0_);

        if (p_179149_1_ != glstatemanagertexgencoord.field_179066_c)
        {
            glstatemanagertexgencoord.field_179066_c = p_179149_1_;
            GL11.glTexGeni(glstatemanagertexgencoord.field_179065_b, GL11.GL_TEXTURE_GEN_MODE, p_179149_1_);
        }
    }
    ...
    {
        switch (GlStateManager.GlStateManager1.field_179175_a[p_179125_0_.ordinal()])
        {
            case 1:
    ...
    public static void deleteTexture(int texture)
    {
        if (texture != 0)
        {
            ...
            for (GlStateManager.TextureState glstatemanagertexturestate : textureState)
            {
                if (glstatemanagertexturestate.textureName == texture)
                {
                    glstatemanagertexturestate.textureName = 0;
                }
            }
        }
    }
    ...
    static
    {
        ...
        {
            textureState[j] = new GlStateManager.TextureState((GlStateManager.GlStateManager1)null);
        }
    }

    static final class GlStateManager1
    {
    ...
    static class AlphaState
    {
        ...
        AlphaState(GlStateManager.GlStateManager1 p_i46489_1_)
        {
            this();
        }
    }
    ...
    static class BlendState
    {
        ...
        BlendState(GlStateManager.GlStateManager1 p_i46488_1_)
        {
            this();
        }
    }
    ...
    static class ClearState
    {
        ...
        ClearState(GlStateManager.GlStateManager1 p_i46487_1_)
        {
            this();
        }
    }
    ...
    static class ColorLogicState
    {
        ...
        ColorLogicState(GlStateManager.GlStateManager1 p_i46486_1_)
        {
            this();
        }
    }
    ...
    static class ColorMask
    {
        ...
        ColorMask(GlStateManager.GlStateManager1 p_i46485_1_)
        {
            this();
        }
    }
    ...
    static class ColorMaterialState
    {
        ...
        ColorMaterialState(GlStateManager.GlStateManager1 p_i46484_1_)
        {
            this();
        }
    }
    ...
    static class CullState
    {
        ...
        CullState(GlStateManager.GlStateManager1 p_i46483_1_)
        {
            this();
        }
    }
    ...
    static class DepthState
    {
        ...
        DepthState(GlStateManager.GlStateManager1 p_i46482_1_)
        {
            this();
        }
    }
    ...
    static class FogState
    {
        ...
        FogState(GlStateManager.GlStateManager1 p_i46481_1_)
        {
            this();
        }
    }
    ...
    static class PolygonOffsetState
    {
        ...
        PolygonOffsetState(GlStateManager.GlStateManager1 p_i46480_1_)
        {
            this();
        }
    }
    ...
    static class StencilFunc
    {
        ...
        StencilFunc(GlStateManager.GlStateManager1 p_i46479_1_)
        {
            this();
        }
    }
    ...
    static class StencilState
    {
        ...
        public StencilState()
        {
            this.field_179078_a = new GlStateManager.StencilFunc((GlStateManager.GlStateManager1)null);
        ...
        StencilState(GlStateManager.GlStateManager1 p_i46478_1_)
        {
            this();
        }
    }
    ...
    static class TexGenState
    {
        ...
        TexGenState(GlStateManager.GlStateManager1 p_i46477_1_)
        {
            this();
        }
    }
    ...
    public static class TextureState
    {
        ...
        TextureState(GlStateManager.GlStateManager1 p_i46476_1_)
        {
            this();
        }
    }
