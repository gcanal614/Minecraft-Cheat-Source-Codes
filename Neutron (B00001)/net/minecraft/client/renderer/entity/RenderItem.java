    ...
    public void func_180453_a(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                GlStateManager.disableBlend();
                Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(itemDamaged, (float) (xPosition + 19 - 2 - fr.getStringWidth(itemDamaged)), (float) (yPosition + 6 + 3), 16777215);
                GlStateManager.enableLighting();
            ...
            if (itemDamaged1) {
                ...
                if (Reflector.ForgeItem_getDurabilityForDisplay.exists()) {
                    ...
                    i = (int) Math.round(13.0D - var8 * 13.0D);
                    j = (int) Math.round(255.0D - var8 * 255.0D);
                }
