...
public class RenderManager
{
    ...
    public boolean renderEntityWithPosYawWithNoNameTag(Entity entityIn, double x, double y, double z, float entityYaw, float partialTicks)
    {
        return this.doRenderEntity(entityIn, x, y, z, entityYaw, partialTicks, false);
    }

    public boolean doRenderEntityWithNoNameTag(Entity entity, double x, double y, double z, float entityYaw, float partialTicks, boolean p_147939_10_)
    {
        Render render = null;
        ...
        try
        {
            ...
            if (render != null && this.renderEngine != null)
            {
                try
                {
                    ...
                    render.doRenderNoNameTag(entity, x, y, z, entityYaw, partialTicks);
                }
