...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderNameNoNameTag(T entity, double x, double y, double z)
    {
        if (this.canRenderName(entity))
        {
            //this.renderLivingLabelWithNoNameTag(entity, entity.getDisplayName().getFormattedText(), x, y, z, 64);
        }
    }

    public void doRenderNoNameTag(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        this.renderNameNoNameTag(entity, x, y, z);
    }
}
