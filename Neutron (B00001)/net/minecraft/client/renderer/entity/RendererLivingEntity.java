...
import me.injusttice.neutron.impl.modules.impl.visual.Chams;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            boolean flag2 = NeutronMain.instance.moduleManager.getModule(Chams.class).isEnabled() && entitylivingbaseIn instanceof EntityPlayer;

            java.awt.Color chamsColor;
            if (flag2) {
    ...
    protected boolean canRenderName(T entity)
    {
        ...
        if (entity instanceof EntityPlayer && entity != entityplayersp)
        {
            ...
            if (team != null)
            {
                ...
                switch (RendererLivingEntity.RendererLivingEntity1.field_178679_a[team$enumvisible.ordinal()])
                {
                    case 1:
                        return true;
    ...
    static final class RendererLivingEntity1
    {
