...
public class TileEntityBeaconRenderer extends TileEntitySpecialRenderer<TileEntityBeacon>
{
    ...
    public void renderTileEntityAt(TileEntityBeacon te, double x, double y, double z, float partialTicks, int destroyStage)
    {
        ...
        if (f > 0.0F)
        {
            ...
            {
                TileEntityBeacon.BeamSegment tileentitybeaconbeamsegment = (TileEntityBeacon.BeamSegment)list.get(j);
                int k = i + tileentitybeaconbeamsegment.getHeight();
                ...
                float f1 = tileentitybeaconbeamsegment.getColors()[0];
                float f2 = tileentitybeaconbeamsegment.getColors()[1];
                float f3 = tileentitybeaconbeamsegment.getColors()[2];
                ...
                double d13 = 1.0D;
                double d14 = -1.0D + d1;
                double d15 = (double)((float)tileentitybeaconbeamsegment.getHeight() * f) * 2.5D + d14;
                ...
                d11 = 1.0D;
                d12 = -1.0D + d1;
                d13 = (double)((float)tileentitybeaconbeamsegment.getHeight() * f) + d12;
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
