...
import me.injusttice.neutron.impl.modules.impl.visual.Animations;
import me.injusttice.neutron.impl.modules.impl.visual.Camera;
...
public class ItemRenderer
{
    ...
    public void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
        ...
        if(ModuleManager.getModule(Camera.class).isEnabled()) {
            GlStateManager.scale(Camera.scale.getValue(), Camera.scale.getValue(), Camera.scale.getValue());
        } else {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        ...
        if (this.itemToRender != null) {
            Module killAura = NeutronMain.instance.moduleManager.getMod("KillAura");
            ModeSet blockMode = null;
            for (Setting s : NeutronMain.instance.moduleManager.getMod("KillAura").getSettings()) {
                if (s.name.equalsIgnoreCase("AutoBlock"))
                    blockMode = (ModeSet)s;
            }
            boolean isKillAuraAttacking = (KillAura.closestTarget != null);
            boolean holdingSword = (this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof net.minecraft.item.ItemSword);
            boolean fakeBlock = (killAura.isToggled() && (blockMode.is("Fake") || blockMode.is("Verus") || blockMode.is("Watchdog")) && isKillAuraAttacking && holdingSword);
            if (this.itemToRender.getItem() instanceof net.minecraft.item.ItemMap) {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                    ...
                    case 4:
                        ...
                        final float f6 = sin((float)(sqrt_float(f1) * 3.1));
                        ...
                        if (ModuleManager.getModule(Animations.class).isEnabled()) {
                            ModeSet anim = NeutronMain.instance.moduleManager.getModeSetByName("Animations", "Mode");
                            ...
                            if(anim.is("Spin")) {
                                ...
                                var15 = MathHelper.sin(sqrt_float(f1) * 3.0F);
                            ...
                            if(anim.is("Spinny")) {
                                ...
                                GlStateManager.rotate(40, -0.0f, 0.0f, -0.05f);
    ...
    private void nigger() {
        ...
        GlStateManager.rotate(var15, var16, var17, var18);
        GlStateManager.rotate((float)(-var13), var14, var6, 0.0f);
        GlStateManager.rotate(60.0f, 0.0f, 1.0f, 0.0f);
    }
