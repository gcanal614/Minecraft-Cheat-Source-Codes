...
public abstract class GuiContainer extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(2272, 0, 0, 120, 20, "Disable KillAura"));
        this.buttonList.add(new GuiButton(2274, 0, 20, 140, 20, "Disable Inventory Manager"));
        this.buttonList.add(new GuiButton(2273, 0, 40, 120, 20, "Disable Stealer"));
    }
        ...
        if (mouseButton == 0) {
            ...
            while(var4.hasNext()) {
                ...
                if (button.mousePressed(this.mc, mouseX, mouseY)) {
                    ...
                    Module mod;
                    if (button.id == 2272) {
                        mod = NeutronMain.instance.moduleManager.getModuleOrNull(KillAura.class);
                        if (mod.isEnabled()) {
                            mod.toggle();
                        }
                    } else if (button.id == 2273) {
                        mod = NeutronMain.instance.moduleManager.getModuleOrNull(Stealer.class);
                        if (mod.isEnabled()) {
                            mod.toggle();
                        }
                    } else if (button.id == 2274) {
                        mod = NeutronMain.instance.moduleManager.getModuleOrNull(InventoryManager.class);
                        if (mod.isEnabled()) {
                            mod.toggle();
                        }
                    }
