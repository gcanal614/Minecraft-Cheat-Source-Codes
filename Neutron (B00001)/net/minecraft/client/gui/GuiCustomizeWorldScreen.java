        ...
        if (button.enabled)
        {
            switch (button.id)
            {
                ...
                case 301:
                    ...
                    {
                        GuiPageButtonList.GuiEntry guipagebuttonlistguientry = this.field_175349_r.getListEntry(i);
                        Gui gui = guipagebuttonlistguientry.func_178022_a();
                        ...
                        Gui gui1 = guipagebuttonlistguientry.func_178021_b();
