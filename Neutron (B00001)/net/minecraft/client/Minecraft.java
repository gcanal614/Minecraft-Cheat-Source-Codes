...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        else
        {
            ...
            //this.displayGuiScreen(new HWID());
        }
    ...
    {
        Util.EnumOS utilenumos = Util.getOSType();
    ...
    public void refreshResources()
    {
        ...
        for (ResourcePackRepository.Entry resourcepackrepositoryentry : this.mcResourcePackRepository.getRepositoryEntries())
        {
    ...
    private void updateDebugProfilerName(int keyCount)
    {
        ...
        {
            Profiler.Result profilerresult = (Profiler.Result)list.remove(0);
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            {
                Profiler.Result profilerresult1 = (Profiler.Result)list.get(l);
                int i1 = MathHelper.floor_double(profilerresult1.field_76332_a / 4.0D) + 1;
                worldrenderer.begin(6, DefaultVertexFormats.POSITION_COLOR);
                int j1 = profilerresult1.func_76329_a();
                int k1 = j1 >> 16 & 255;
                int l1 = j1 >> 8 & 255;
                int i2 = j1 & 255;
                ...
                {
                    float f = (float)((d0 + profilerresult1.field_76332_a * (double)j2 / (double)i1) * Math.PI * 2.0D / 100.0D);
                ...
                {
                    float f3 = (float)((d0 + profilerresult1.field_76332_a * (double)i3 / (double)i1) * Math.PI * 2.0D / 100.0D);
            ...
            this.fontRendererObj.drawStringWithShadow(s = decimalformat.format(profilerresult.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s)), (float)(k - i / 2 - 16), l2);

            for (int k2 = 0; k2 < list.size(); ++k2)
            {
                Profiler.Result profilerresult2 = (Profiler.Result)list.get(k2);
                String s1 = "";
                ...
                this.fontRendererObj.drawStringWithShadow(s1, (float)(j - i), (float)(k + i / 2 + k2 * 8 + 20), profilerresult2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profilerresult2.field_76332_a) + "%", (float)(j + i - 50 - this.fontRendererObj.getStringWidth(s1)), (float)(k + i / 2 + k2 * 8 + 20), profilerresult2.func_76329_a());
                this.fontRendererObj.drawStringWithShadow(s1 = decimalformat.format(profilerresult2.field_76330_b) + "%", (float)(j + i - this.fontRendererObj.getStringWidth(s1)), (float)(k + i / 2 + k2 * 8 + 20), profilerresult2.func_76329_a());
            }
        }
    }
    ...
    public void runTick() throws IOException{
        ...
        if (isInGame()) {
            EventWorldTick eventWorldTick = new EventWorldTick();
            eventWorldTick.call();
        }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage)
    {
        ...
        EventLoadWorld eventLoadWorld = new EventLoadWorld(worldClientIn);
        eventLoadWorld.call();
