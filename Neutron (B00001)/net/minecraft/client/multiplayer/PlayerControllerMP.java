...
import me.injusttice.neutron.api.events.impl.EventReach;
import me.injusttice.neutron.utils.world.Vec3d;
...
public class PlayerControllerMP
{
    ...
    public float getBlockReachDistance() {
        EventReach reachDistance = new EventReach();
        reachDistance.call();
        if (reachDistance.getReachDistance() != -1.0F)
            return reachDistance.getReachDistance();
    ...
    public boolean onPlayerRightClick3d(EntityPlayerSP player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3d hitVec)
    {
        this.syncCurrentPlayItem();
