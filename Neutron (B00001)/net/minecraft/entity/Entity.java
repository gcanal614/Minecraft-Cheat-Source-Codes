...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            EventStepHeight e = new EventStepHeight(this.stepHeight);
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    EventStepConfirm event = new EventStepConfirm();
                    if (this == (Minecraft.getMinecraft()).thePlayer)
                        event.call();
                }
            }
     ...
     * For EntityLivingBase subclasses, returning false when invisible will render the entity nigga (semitransparent).
     */
