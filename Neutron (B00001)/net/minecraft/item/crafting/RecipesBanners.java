...
public class RecipesBanners
{
    ...
    static class RecipeAddPattern implements IRecipe
    {
        ...
        public ItemStack getCraftingResult(InventoryCrafting inv)
        {
            ...
            TileEntityBanner.EnumBannerPattern tileentitybannerenumbannerpattern = this.func_179533_c(inv);
            ...
            if (tileentitybannerenumbannerpattern != null)
            {
                ...
                nbttagcompound.setString("Pattern", tileentitybannerenumbannerpattern.getPatternID());
        ...
        {
            for (TileEntityBanner.EnumBannerPattern tileentitybannerenumbannerpattern : TileEntityBanner.EnumBannerPattern.values())
            {
                    ...
                    if (tileentitybannerenumbannerpattern.hasCraftingStack())
                    {
                        ...
                        for (int i = 0; i < p_179533_1_.getSizeInventory() && flag; ++i)
                        {
                            ...
                            if (itemstack != null && itemstack.getItem() != Items.banner)
                            {
                                ...
                                {
                                    if (flag1 || !itemstack.isItemEqual(tileentitybannerenumbannerpattern.getCraftingStack()))
                                    {
                                        flag = false;
                                        break;
                                    }
                    ...
                    else if (p_179533_1_.getSizeInventory() == tileentitybannerenumbannerpattern.getCraftingLayers().length * tileentitybannerenumbannerpattern.getCraftingLayers()[0].length())
                    {
                        ...
                        for (int k = 0; k < p_179533_1_.getSizeInventory() && flag; ++k)
                        {
                            ...
                            if (itemstack1 != null && itemstack1.getItem() != Items.banner)
                            {
                                ...
                                if (tileentitybannerenumbannerpattern.getCraftingLayers()[l].charAt(i1) == 32)
                                {
                                    flag = false;
                                    break;
                                }
                            ...
                            else if (tileentitybannerenumbannerpattern.getCraftingLayers()[l].charAt(i1) != 32)
                            {
                                flag = false;
                                break;
                            }
