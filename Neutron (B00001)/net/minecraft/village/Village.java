...
public class Village
{
    ...
    {
        for (Village.VillageAggressor villagevillageaggressor : this.villageAgressors)
        {
            if (villagevillageaggressor.agressor == entitylivingbaseIn)
            {
                villagevillageaggressor.agressionTime = this.tickCounter;
                return;
            }
        }
    ...
    public EntityLivingBase findNearestVillageAggressor(EntityLivingBase entitylivingbaseIn)
    {
        ...
        Village.VillageAggressor villagevillageaggressor = null;

        for (int i = 0; i < this.villageAgressors.size(); ++i)
        {
            Village.VillageAggressor villagevillageaggressor1 = (Village.VillageAggressor)this.villageAgressors.get(i);
            double d1 = villagevillageaggressor1.agressor.getDistanceSqToEntity(entitylivingbaseIn);

            if (d1 <= d0)
            {
                villagevillageaggressor = villagevillageaggressor1;
                d0 = d1;
            }
        }

        return villagevillageaggressor != null ? villagevillageaggressor.agressor : null;
    }
    ...
    public EntityPlayer getNearestTargetPlayer(EntityLivingBase villageDefender)
    {
        ...
        for (String s : this.playerReputation.keySet())
        {
            ...
            {
                EntityPlayer entityplayer1 = this.worldObj.getPlayerEntityByName(s, false);
    ...
    private void removeDeadAndOldAgressors()
    {
        ...
        {
            Village.VillageAggressor villagevillageaggressor = (Village.VillageAggressor)iterator.next();

            if (!villagevillageaggressor.agressor.isEntityAlive() || Math.abs(this.tickCounter - villagevillageaggressor.agressionTime) > 300)
            {
                iterator.remove();
            }
        }
