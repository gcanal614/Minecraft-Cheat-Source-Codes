...
public class MapGenVillage extends MapGenStructure
{
    ...
    public static class Start extends StructureStart
    {
        ...
        public Start(World worldIn, Random rand, int x, int z, int p_i2092_5_)
        {
            ...
            StructureVillagePieces.Start structurevillagepiecesstart = new StructureVillagePieces.Start(worldIn.getWorldChunkManager(), 0, rand, (x << 4) + 2, (z << 4) + 2, list, p_i2092_5_);
            ...
            List<StructureComponent> list1 = structurevillagepiecesstart.field_74930_j;
            List<StructureComponent> list2 = structurevillagepiecesstart.field_74932_i;
