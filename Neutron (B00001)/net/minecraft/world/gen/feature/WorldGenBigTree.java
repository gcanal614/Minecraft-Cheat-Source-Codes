...
public class WorldGenBigTree extends WorldGenAbstractTree
{
    ...
    void func_175937_a(BlockPos p_175937_1_, BlockPos p_175937_2_, Block p_175937_3_)
    {
        ...
        for (int j = 0; j <= i; ++j)
        {
            ...
            BlockLog.EnumAxis blocklogenumaxis = this.func_175938_b(p_175937_1_, blockpos1);
            this.setBlockAndNotifyAdequately(this.world, blockpos1, p_175937_3_.getDefaultState().withProperty(BlockLog.LOG_AXIS, blocklogenumaxis));
        }
    }
    ...
    void generateLeaves()
    {
        for (WorldGenBigTree.FoliageCoordinates worldgenbigtreefoliagecoordinates : this.field_175948_j)
        {
    ...
    void generateLeafNodeBases()
    {
        for (WorldGenBigTree.FoliageCoordinates worldgenbigtreefoliagecoordinates : this.field_175948_j)
        {
            int i = worldgenbigtreefoliagecoordinates.func_177999_q();
