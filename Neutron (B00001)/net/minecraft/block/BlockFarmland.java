...
public class BlockFarmland extends Block
{
    ...
    {
        for (BlockPos.MutableBlockPos blockposmutableblockpos : BlockPos.getAllInBoxMutable(pos.add(-4, 0, -4), pos.add(4, 1, 4)))
        {
            if (worldIn.getBlockState(blockposmutableblockpos).getBlock().getMaterial() == Material.water)
            {
                return true;
            }
        }
