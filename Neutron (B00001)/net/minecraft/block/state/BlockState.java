...
public class BlockState
{
    ...
    public BlockState(Block blockIn, IProperty... properties)
    {
        ...
        for (List<Comparable> list1 : Cartesian.cartesianProduct(this.getAllowedValues()))
        {
            ...
            BlockState.StateImplementation blockstatestateimplementation = new BlockState.StateImplementation(blockIn, ImmutableMap.copyOf(map1));
            map.put(map1, blockstatestateimplementation);
            list.add(blockstatestateimplementation);
        }

        for (BlockState.StateImplementation blockstatestateimplementation1 : list)
        {
            blockstatestateimplementation1.buildPropertyValueTable(map);
        }
