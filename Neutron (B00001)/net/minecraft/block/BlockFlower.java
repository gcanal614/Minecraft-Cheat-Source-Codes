...
public abstract class BlockFlower extends BlockBush
{
    ...
    {
        for (BlockFlower.EnumFlowerType blockflowerenumflowertype : BlockFlower.EnumFlowerType.getTypes(this.getBlockType()))
        {
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        {
            BlockFlower.EnumFlowerType[] ablockflowerenumflowertype = TYPES_FOR_BLOCK[blockType.ordinal()];
        ...
        static {
            for (final BlockFlower.EnumFlowerColor blockflowerenumflowercolor : BlockFlower.EnumFlowerColor.values())
            {
                ...
                TYPES_FOR_BLOCK[blockflowerenumflowercolor.ordinal()] = (BlockFlower.EnumFlowerType[])collection.toArray(new BlockFlower.EnumFlowerType[collection.size()]);
            }
        }
    }
}
