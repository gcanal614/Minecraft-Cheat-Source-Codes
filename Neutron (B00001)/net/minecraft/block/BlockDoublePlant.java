...
public class BlockDoublePlant extends BlockBush implements IGrowable
{
    ...
    public boolean isReplaceable(World worldIn, BlockPos pos)
    {
        ...
        {
            BlockDoublePlant.EnumPlantType blockdoubleplantenumplanttype = (BlockDoublePlant.EnumPlantType)this.getActualState(iblockstate, worldIn, pos).getValue(VARIANT);
            return blockdoubleplantenumplanttype == BlockDoublePlant.EnumPlantType.FERN || blockdoubleplantenumplanttype == BlockDoublePlant.EnumPlantType.GRASS;
        }
    }
