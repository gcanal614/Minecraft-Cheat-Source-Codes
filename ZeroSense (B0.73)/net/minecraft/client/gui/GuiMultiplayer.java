...
import com.zerosense.alts.GuiAltManager;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui()
    {
       // ZeroSense.getInstance().getDiscordRP().update("In", "SelectMultiPlayerWorld");
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(599, this.width / 2 + 4 + 176, this.height - 28, 75, 20, "GuiAltManager"));
        this.buttonList.add(new GuiButton(123, this.width / 2 + 4 + -235, this.height - 28, 75, 20, "SinglePlayer"));
