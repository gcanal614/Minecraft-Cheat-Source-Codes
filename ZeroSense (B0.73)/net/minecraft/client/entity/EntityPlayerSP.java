...
import com.zerosense.Events.EventType;
import com.zerosense.Events.impl.EventCancellable;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void func_175161_p()
    {
        ...
        ModuleManager.onEvent(e);//where is files of skid  and
        ...
        ModuleManager.onEvent(eventMotion);
        ...
        {
            double var3 = eventMotion.getX() - this.field_175172_bI;
            double var5 = eventMotion.getY() - this.field_175166_bJ;
            double var7 = eventMotion.getZ() - this.field_175167_bK;
            double var9 = (double)(eventMotion.getYaw() - this.field_175164_bL);
            double var11 = (double)(eventMotion.getPitch() - this.field_175165_bM);
            ...
            if (var14)
            {
                this.field_175164_bL = eventMotion.getYaw();
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding() && !ModuleManager.noslow.toggled) {
    ...
    public void VAITOMANOCU(){
        if(mc.thePlayer.onGround) {
            if (mc.theWorld.getCollidingBoundingBoxes(mc.thePlayer, mc.thePlayer.getEntityBoundingBox().offset(0, 3.0001, 0)).isEmpty()) {
