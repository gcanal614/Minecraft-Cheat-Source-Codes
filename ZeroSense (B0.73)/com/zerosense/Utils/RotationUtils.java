...
public class RotationUtils {
  ...
  private static float[] getRotations(double v, double v1, double v2) {
    EntityPlayerSP player = mc.thePlayer;
    double x = v - player.posX;
    double y = v1 - (player.posY + (double)player.getEyeHeight());
    double z = v2 - player.posZ;
