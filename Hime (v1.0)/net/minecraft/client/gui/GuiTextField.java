...
public class GuiTextField extends Gui
{
    ...
    public void mouseClicked(int mouseX, int mouseY){
        if(mouseX > xPosition && mouseX < (length > 50 ? xPosition + length : xPosition + Hime.instance.cfrs.getWidth(name)) && mouseY > yPosition && mouseY < yPosition + Hime.instance.cfrs.getHeight("A")){
            this.isFocused = true;
        }else {
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
               ...
               // Hime.instance.cfrs.drawStringWithShadow(s1, (float)l, (float)i1, i);
            }
    ...
    public void draw(){
        ...
        if(Hime.instance.cfrs.getWidth(text) < 50){
            Gui.drawRect(xPosition, yPosition + Hime.instance.cfrs.getHeight("A") + 3, xPosition + 50 + Hime.instance.cfrs.getWidth(name) - 40, yPosition + Hime.instance.cfrs.getHeight("A") + 4, -1);
        }else {
            Gui.drawRect(xPosition, yPosition + Hime.instance.cfrs.getHeight("A") + 3, xPosition + length + 7, yPosition + Hime.instance.cfrs.getHeight("A") + 4, -1);
        }
        if(text.equalsIgnoreCase("") && !isFocused){
            Hime.instance.cfrs.drawString(name, xPosition, yPosition + 1, -1);
        }
        if(!timer.hasTimePassed(1000)) {
            if(timer.hasTimePassed(500) && isFocused) {
            	   Hime.instance.cfrs.drawString(text + "|", xPosition, yPosition + 1, -1);
               // Hime.instance.cfrs.drawString(text, xPosition, yPosition + 1, -1);
            }else {
                Hime.instance.cfrs.drawString(text, xPosition, yPosition + 1, -1);
            }
