...
public class LayerCape implements LayerRenderer<AbstractClientPlayer>
{
    ...
    {
        if (entitylivingbaseIn.hasPlayerInfo() && !entitylivingbaseIn.isInvisible() && entitylivingbaseIn.isWearing(EnumPlayerModelParts.CAPE) && Hime.instance.cape) // && entitylivingbaseIn.getLocationCape() != null
        {
        	if(entitylivingbaseIn.getName().equals(Minecraft.getMinecraft().getSession().getUsername())) {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            if(Hime.instance.cape) {
