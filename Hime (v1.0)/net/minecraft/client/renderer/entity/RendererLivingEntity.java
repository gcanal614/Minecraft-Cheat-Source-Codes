...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            //TODO chams
            if(Hime.instance.moduleManager.getModule("Chams").isToggled() && !Hime.instance.settingsManager.getSettingByName("Colored").getValBoolean()) {
              GL11.glEnable(32823);
            ...
            try
            {
                ...
                //TODO pitch f5
                float f7 = (entity == (Minecraft.getMinecraft()).thePlayer) ? ((EntityLivingBase)entity).rotationPitchHead : (((EntityLivingBase)entity).prevRotationPitch + (((EntityLivingBase)entity).rotationPitch - ((EntityLivingBase)entity).prevRotationPitch) * partialTicks);
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (flag || flag1)
        {
            ...
            boolean allowRender = Hime.instance.settingsManager.getSettingByName("Colored").getValBoolean() && Hime.instance.moduleManager.getModule("Chams").isToggled() && entitylivingbaseIn instanceof EntityPlayer;
            ...
            if(Hime.instance.moduleManager.getModule("ESP").isToggled() && Hime.instance.settingsManager.getSettingByName("ESP Mode").getValString().equalsIgnoreCase("Outline")){
            		/*	GL11.glPushMatrix();
                        {
                        ...
                        GL11.glPopMatrix();*/
            	Render2D.color(java.awt.Color.white);
				OutlineUtil.renderOne((float) Hime.instance.settingsManager.getSettingByName("Outline ESP Width").getValDouble());
				this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
				OutlineUtil.renderTwo();
				this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
				OutlineUtil.renderThree();
				this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
				OutlineUtil.renderFour(java.awt.Color.white);
				this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_, p_77036_7_);
            ...
            if (allowRender) {
                ...
                if(Hime.instance.settingsManager.getSettingByName("Behind Walls").getValBoolean()) {
                 GL11.glColor4f((float)Color.RED.getRed() / 255.0F, (float)Color.RED.getGreen() / 255.0F, (float)Color.RED.getBlue() / 255.0F, (float)Color.RED.getAlpha() / 255.0F);
                }else {
                 GL11.glColor4f((float)Color.PURPLE.getRed() / 255.0F, (float)Color.PURPLE.getGreen() / 255.0F, (float)Color.PURPLE.getBlue() / 255.0F, (float)Color.PURPLE.getAlpha() / 255.0F);
                }
                 GL11.glDisable(2929);
    ...
    protected boolean canRenderName(T entity)
    {
    	  ...
    	  if ((Hime.instance.moduleManager.getModule("Nametags")).isToggled())
    	      return false; 
