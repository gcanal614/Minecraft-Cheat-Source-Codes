    ...
    private void renderEffect(IBakedModel model)
    {
        if (!Config.isCustomItems() || CustomItems.isUseGlint())
        {
            if (!Config.isShaders() || !Shaders.isShadowPass)
            {
                ...
                final float hue = (float) (Hime.instance.settingsManager.getSettingByName("Color").getValDouble() / 255);
          	    //                           colorSaturation  colorBrightness 
                Color color = Color.getHSBColor(hue, (float) Hime.instance.settingsManager.getSettingByName("Saturation2").getValDouble(), (float) Hime.instance.settingsManager.getSettingByName("Brightness2").getValDouble());
                ...
                //color1
                if(Hime.instance.moduleManager.getModule("CustomGlint").isToggled()) {
                 if(Hime.instance.settingsManager.getSettingByName("Rainbow Glint").getValBoolean())	{
                  this.renderModel(model, RainbowUtil.rainbow(300, (float) Hime.instance.settingsManager.getSettingByName("Brightness2").getValDouble(), (float) Hime.instance.settingsManager.getSettingByName("Saturation2").getValDouble()));
                 }else {
                  this.renderModel(model, color2);
                 }
                }else {
