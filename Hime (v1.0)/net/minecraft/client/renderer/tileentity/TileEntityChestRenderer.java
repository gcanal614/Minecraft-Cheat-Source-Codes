...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest>
{
    ...
    public void doCrap(TileEntityChest te, double x, double y, double z, float partialTicks, int destroyStage) {
    ...
    public void renderTileEntityAt(TileEntityChest te, double x, double y, double z, float partialTicks, int destroyStage)
    {
    	...
    	this.doCrap(te, x, y, z, partialTicks, destroyStage);
    	
        if(Hime.instance.moduleManager.getModule("ChestESP").isToggled() && Hime.instance.settingsManager.getSettingByName("Chest Mode").getValString().equalsIgnoreCase("Outline")){
        	GL11.glPushMatrix();
        	{
