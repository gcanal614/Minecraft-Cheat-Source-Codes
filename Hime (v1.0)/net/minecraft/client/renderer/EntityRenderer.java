...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            {
            	if(Hime.instance.moduleManager.getModule("Reach").isToggled() && Hime.instance.settingsManager.getSettingByName("Reach Mode").getValString().equalsIgnoreCase("Combat Reach")) {
            		d0 = Hime.instance.settingsManager.getSettingByName("Reach").getValDouble();
            	}else {
                if (d0 > 3.0D)
                {
                    flag = true;
    ...
    {
    	if (Hime.instance.moduleManager.getModule("NoHurtCam").isToggled())
            return;
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if(!Hime.instance.moduleManager.getModule("CameraNoClip").isToggled()) {
                            if (d7 < d3)
                            {
                                d3 = d7;
                            }
