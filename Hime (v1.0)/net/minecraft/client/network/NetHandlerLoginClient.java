...
public class NetHandlerLoginClient implements INetHandlerLoginClient
{
    ...
    public void handleLoginSuccess(S02PacketLoginSuccess packetIn)
    {
        ...
        if (Hime.instance.moduleManager.getModule("Disabler").isToggled()) {
           if(Hime.instance.settingsManager.getSettingByName("Disabler Mode").getValString().equalsIgnoreCase("PoopdogNew")) {
