...
public class PlayerControllerMP
{
    ...
    {
    	if(Hime.instance.moduleManager.getModule("Reach").isToggled() && Hime.instance.settingsManager.getSettingByName("Reach Mode").getValString().equalsIgnoreCase("Build Reach")) {
    		return (float) Hime.instance.settingsManager.getSettingByName("Reach").getValDouble();
    	}
    ...
    public boolean func_181040_m()
    {
	  ...
	  public void onPlayerRightClick(EntityPlayerSP thePlayer, WorldClient theWorld, ItemStack stack, BlockPos position, EnumFacing face, Vec3d vec3d) {
