...
import me.event.impl.EventStep;
...
public abstract class Entity implements ICommandSender
{
    ...
    protected static UUID entityUniqueID;
        ...
        else
        {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z))
            {
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z)
                {
                	...
                	EventStep event2 = new EventStep();
    ...
    {
    	if(Hime.instance.moduleManager.getModule("Hitbox").isToggled() && Hime.instance.settingsManager.getSettingByName("Hitbox Mode").getValString().equalsIgnoreCase("Normal")) {
    		return (float) Hime.instance.settingsManager.getSettingByName("Hitbox Expand").getValDouble() + 0.1F;
    	}
