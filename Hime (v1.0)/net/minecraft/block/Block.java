...
public class Block
{
    ...
    {
    /*	
     if(Hime.instance.moduleManager.getModule("Opacity").isToggled()) {
  		if(Hime.instance.settingsManager.getSettingByName("XRay").getValBoolean()) {
    	...
    	if(Hime.instance.moduleManager.getModule("Opacity").isToggled()) {
    		...
    		if(Hime.instance.settingsManager.getSettingByName("Opacity").getValBoolean()) {
    			return false;
    		}
    	}
    	*/
