...
public class Slider extends Component {
	...
	public void renderComponentRect() {
		    ...
		    Gui.drawRect(parent.parent.getX() + 2, parent.parent.getY() + offset + 8, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 10,color.getRGB());
     }
	
	@Override
	public void renderComponent() {
		GuiButton.ssss.drawString(this.set.getName() + ": " + this.set.getValDouble() , (parent.parent.getX() + 6), (parent.parent.getY() + offset - 1), -1);
	}
