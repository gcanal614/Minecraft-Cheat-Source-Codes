...
public class HueSlider extends Component {
	...
	public HueSlider(Setting value, Button button, int offset) {
		this.set = value;
		this.parent = button;
	...
	public void renderComponentRect() {
		    ...
		    RenderUtil.instance.draw2DImage(new ResourceLocation("client/hue.png"), parent.parent.getX() + 2,  parent.parent.getY() + offset + 6, 86, 5, Color.WHITE);
			//RenderUtil.instance.draw2DImage(new ResourceLocation("client/hue.png"), parent.parent.getX() + 45,  parent.parent.getY() + offset + 6, 43, 5, Color.WHITE);
