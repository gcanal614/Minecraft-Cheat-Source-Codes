...
public class SaturationSlider extends Component {
	...
	public SaturationSlider(Setting value, Button button, int offset) {
		this.set = value;
		this.parent = button;
	...
	public void renderComponentRect() {
		    ...
		    final float hue = (float) (ColorUtil.getClickGUIColor());
			 ...
			 RenderUtil.instance.drawGradientSideways(parent.parent.getX(), parent.parent.getY() + offset + 6, parent.parent.getX() + 88, parent.parent.getY() + offset + 11, -1, color);
	...
	public void renderComponent() {
			 GuiButton.ssss.drawString(this.set.getName() + ": " + set.getValDouble(), (parent.parent.getX() + 15), (parent.parent.getY() + offset - 2)+ 1, -1);
	}
