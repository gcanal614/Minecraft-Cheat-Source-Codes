...
public class BrightnessSlider extends Component {
	...
	public void renderComponent() {
		...
		RenderUtil.instance.draw2DImage(new ResourceLocation("client/bright.png"), x ,  y + 10, 91, 8, Color.WHITE);
		...
		//Gui.drawRect(x, y + 10, x + 2, y + 10 + 12, 0x80000000);
		 ...
		 GuiButton.appleSmall.drawString(this.set.getName() + ": " +  this.set.getValDouble() , x, y, -1);
