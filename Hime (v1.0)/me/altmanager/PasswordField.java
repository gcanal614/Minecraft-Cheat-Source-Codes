...
public class PasswordField extends Gui
{
    ...
    private void drawCursorVertical(int par1, int par2, int par3, int par4) {
        ...
        GL11.glEnable(3058);
        GL11.glLogicOp(5387);
        var7.func_181668_a(7, var7.getVertexFormat());
        var7.func_181662_b(par1, par4, 0.0);
        var7.func_181662_b(par3, par4, 0.0);
        var7.func_181662_b(par3, par2, 0.0);
        var7.func_181662_b(par1, par2, 0.0);
        var7.finishDrawing();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
