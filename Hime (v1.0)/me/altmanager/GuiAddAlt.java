...
extends GuiScreen {
  ...
  //  public NameGenerator namegen;
    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            case 0: {
            	if (this.password.getText().isEmpty() && this.username.getText().isEmpty() && !this.Passwordusername.getText().isEmpty()) {
                       if(this.Passwordusername.getText().contains(":") && !this.Passwordusername.getText().endsWith(":")) {
            	   this.username.setText(this.Passwordusername.getText().split(":")[0]);
            	   this.password.setText(this.Passwordusername.getText().split(":")[1]);
            	   this.Passwordusername.setText("");
          ...
          //    this.namegen = new NameGenerator(RandomUtils.nextInt(5, 10));
            ...
            //  
              //AddAltThread login = new AddAltThread(name, "");
             // login.start();
    ...
    public void initGui() {
      ...
      //  Passwordusername.maxStringLength = 20;
        ...
        buttonList.add(new GuiButton(3, this.width / 2 - 100, this.height / 4 + 116 + 60, "Generate Cracked"));
    ...
    public static void access$0(GuiAddAlt guiAddAlt, String status) {
