    ...
    public void drawChat(final int p_146230_1_) {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                    ...
                    if (chatline != null) {
                        ...
                        if (j2 < 200 || flag) {
                            ...
                            if (l2 > 3) {
                                ...
                                BozoWare.getInstance().getFontManager().mediumFontRenderer.drawStringWithShadow(s, (float)i3, (float)(j3 - 8), 16777215 + (l2 << 24));
                ...
                if (flag) {
                    final int k2 = BozoWare.getInstance().getFontManager().largeFontRenderer.getHeight() + 4;
