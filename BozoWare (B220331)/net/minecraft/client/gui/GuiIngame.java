...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(final float partialTicks) {
        ...
        BozoWare.getInstance().getEventManager().callEvent(render2DEvent);
        ...
        if (this.recordPlayingUpFor > 0) {
            ...
            if (k2 > 8) {
                ...
                this.getFontRenderer().drawString(this.recordPlaying, (float)(-this.getFontRenderer().getStringWidth(this.recordPlaying) / 2), -4.0f, i3 + (k2 << 24 & 0xFF000000));
                GlStateManager.disableBlend();
    ...
    protected void renderTooltip(final ScaledResolution sr, final float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            RenderUtil.drawSmoothRoundedRect((float)(i - 91), (float)(sr.getScaledHeight() - 22), (float)(i + 91), (float)(sr.getScaledHeight() - 2), 5.0f, 1610612736);
            RenderUtil.drawSmoothRoundedRectWithWidth(i - 91, sr.getScaledHeight() - 2, 182.0, 2.0, 1.0f, -1);
            RenderUtil.drawSmoothRoundedRectWithWidth(i - 91 - 1 + entityplayer.inventory.currentItem * 20, sr.getScaledHeight() - 2, 23.0, 2.0, 0.0f, HUD.getInstance().bozoColor);
            GuiIngame.zLevel = f;
    ...
    public void renderExpBar(final ScaledResolution p_175176_1_, final int p_175176_2_) {
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            this.getFontRenderer().drawString(s, (float)(i2 + 1), (float)l, 0);
            this.getFontRenderer().drawString(s, (float)(i2 - 1), (float)l, 0);
            this.getFontRenderer().drawString(s, (float)i2, (float)(l + 1), 0);
            this.getFontRenderer().drawString(s, (float)i2, (float)(l - 1), 0);
            this.getFontRenderer().drawString(s, (float)i2, (float)l, j2);
            this.mc.mcProfiler.endSection();
        }
    }
    ...
    private void renderScoreboard(final ScoreObjective p_180475_1_, final ScaledResolution p_180475_2_) {
        ...
        for (final Object score2 : arraylist2) {
            ...
            String s2 = ScorePlayerTeam.formatPlayerName(scoreplayerteam2, ((Score)score2).getPlayerName());
            ...
            BlurUtil.blurArea(l - 2, l2, i2, this.getFontRenderer().FONT_HEIGHT);
            if (s2.contains("hypixel")) {
                s2 = "BozoWare";
            }
            BozoWare.getInstance().getFontManager().mediumFontRenderer.drawStringWithShadow(s2.replaceAll("eu.loyisa.cn", "BozoWare"), l, l2, s2.equals("BozoWare") ? HUD.getInstance().bozoColor : -1);
            if (m == arraylist2.size()) {
                String s4 = p_180475_1_.getDisplayName().replaceAll("eu.loyisa.cn", "BozoWare");
                if (s4.contains("hypixel")) {
                    s4 = "BozoWare";
                }
                Gui.drawRect(l - 2, l2 - this.getFontRenderer().FONT_HEIGHT - 1, i2, l2 - 1, 1610612736);
                Gui.drawRect(l - 2, l2 - 1, i2, l2, 1342177280);
                BozoWare.getInstance().getFontManager().mediumFontRenderer.drawStringWithShadow(s4, l + i / 2 - this.getFontRenderer().getStringWidth(s4) / 2, l2 - this.getFontRenderer().FONT_HEIGHT, HUD.getInstance().bozoColor);
            }
        }
    }
