...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 72 + 30, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 72 + 30, 98, 20, I18n.format("menu.quit", new Object[0])));
        this.buttonList.add(new GuiButton(420, this.width / 2 - 100, j + 72 + 6, 98, 20, "Alts"));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 72 + 30));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final int k = 30;
        Gui.drawGradientRect(0.0, 0.0, this.width, this.height, 16777215, Integer.MIN_VALUE);
        Gui.drawGradientRect(0.0, 0.0, this.width, this.height, Integer.MIN_VALUE, 16777215);
        ...
        GlStateManager.popMatrix();
        String s = "BozoWare 1.8.8";
        if (this.mc.isDemo()) {
            s += " Demo";
        }
        this.drawString(this.fontRendererObj, s, 2, this.height - 10, -1);
        final String s2 = "By Kobley, Posk, and Shidder";
