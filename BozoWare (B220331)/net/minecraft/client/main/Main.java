...
public class Main
{
    public static void main(final String[] p_main_0_) {
        ...
        final OptionSpec<String> optionspec10 = (OptionSpec<String>)optionparser.accepts("username").withRequiredArg().defaultsTo((Object)"BozoWareOnTop", (Object[])new String[0]);
