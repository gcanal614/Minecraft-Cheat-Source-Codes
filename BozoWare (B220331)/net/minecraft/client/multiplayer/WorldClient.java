...
public class WorldClient extends World
{
    ...
    public void tick() {
        ...
        if (this.getGameRules().getBoolean("doDaylightCycle")) {
            final WorldTimeChangeEvent worldTimeChangeEvent = new WorldTimeChangeEvent();
            BozoWare.getInstance().getEventManager().callEvent(worldTimeChangeEvent);
            if (!worldTimeChangeEvent.isCancelled()) {
