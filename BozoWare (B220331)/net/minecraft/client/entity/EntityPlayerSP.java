...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            final UpdatePositionEvent event = new UpdatePositionEvent(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            ...
            final boolean onGround = event.isOnGround();
            if (this.ridingEntity == null) {
                ...
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0, this.motionZ, yaw, pitch, onGround));
                flag3 = false;
            }
    ...
    public void moveEntity(final double x, final double y, final double z) {
        final PlayerMoveEvent playerMoveEvent = new PlayerMoveEvent(x, y, z);
        BozoWare.getInstance().getEventManager().callEvent(playerMoveEvent);
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding() && !BozoWare.getInstance().getModuleManager().getModuleByClass.apply(NoSlow.class).isModuleToggled()) {
    ...
    public void SendC04(final double posX, final double posY, final double posZ, final boolean ground) {
        this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(posX, posY, posZ, ground));
    }
    
    public void yC04(final double y, final boolean ground) {
        this.SendC04(this.posX, this.posY + y, this.posZ, ground);
    }
}
