...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(final float partialTicks) {
        ...
        if (entity != null) {
            ...
            boolean flag = false;
            float reach;
            if (BozoWare.getInstance().getModuleManager().getModuleByClass.apply(Reach.class).isModuleToggled()) {
    ...
    private void hurtCameraEffect(final float partialTicks) {
        if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            final HurtShakeEvent HurtCamShakeEvent = new HurtShakeEvent();
            BozoWare.getInstance().getEventManager().callEvent(HurtCamShakeEvent);
            if (HurtCamShakeEvent.isCancelled()) {
                return;
            }
    ...
    private void frameInit() {
        ...
        if (this.mc.currentScreen instanceof BozoMainMenu) {
            this.updateMainMenu((BozoMainMenu)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(final BozoMainMenu p_updateMainMenu_1_) {
        try {
            String s = null;
            ...
            final Field[] afield = BozoMainMenu.class.getDeclaredFields();
