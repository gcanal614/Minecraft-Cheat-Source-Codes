    ...
    public void renderItemOverlayIntoGUI(final FontRenderer fr, final ItemStack stack, final int xPosition, final int yPosition, final String text) {
        if (stack != null) {
            if (stack.stackSize != 1 || text != null) {
                ...
                GlStateManager.disableBlend();
                fr.drawStringWithShadow(s, (float)(xPosition + 19 - 2 - fr.getStringWidth(s)), (float)(yPosition + 6 + 1), 16777215);
                GlStateManager.enableLighting();
    ...
    public void renderItemAboveHead(final ItemStack stack, final int xPosition, final int yPosition) {
        if (stack != null) {
            try {
                ...
                var7.addCrashSectionCallable("Item Type", () -> String.valueOf(stack.getItem()));
                var7.addCrashSectionCallable("Item Aux", () -> String.valueOf(stack.getMetadata()));
                var7.addCrashSectionCallable("Item NBT", () -> String.valueOf(stack.getTagCompound()));
                var7.addCrashSectionCallable("Item Foil", () -> String.valueOf(stack.hasEffect()));
