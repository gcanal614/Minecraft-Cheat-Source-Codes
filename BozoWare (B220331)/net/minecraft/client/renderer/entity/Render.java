...
public abstract class Render<T extends Entity>
{
    ...
    protected void renderLivingLabel(final T entityIn, final String str, final double x, final double y, final double z, final int maxDistance) {
        ...
        if (d0 <= maxDistance * maxDistance) {
            ...
            tessellator.draw();
            GlStateManager.enableTexture2D();
            fontrenderer.drawString(str, (float)(-fontrenderer.getStringWidth(str) / 2), b0, 553648127);
            GlStateManager.enableDepth();
            GlStateManager.depthMask(true);
            fontrenderer.drawString(str, (float)(-fontrenderer.getStringWidth(str) / 2), b0, -1);
            GlStateManager.enableLighting();
            GlStateManager.disableBlend();
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
            GlStateManager.popMatrix();
