...
public class ItemRenderer
{
    ...
    private void func_178098_a(final float p_178098_1_, final AbstractClientPlayer clientPlayer) {
        ...
        GlStateManager.translate(f2 * 0.0f, f2 * 0.0f, f2 * 0.2f);
    ...
    public void renderItemInFirstPerson(final float partialTicks) {
        ...
        final float scalableProg = MathHelper.sin((float)(MathHelper.sqrt_float(f2) * Math.toRadians(180.0)));
        ...
        if (this.itemToRender != null) {
            if (this.itemToRender.getItem() instanceof ItemMap) {
            ...
            else if (entityplayersp.getItemInUseCount() > 0 || (BozoWare.getInstance().getModuleManager().getModuleByClass.apply(Aura.class).isModuleToggled() && Aura.target != null && Aura.isBlocking)) {
                ...
                switch (ItemRenderer$1.field_178094_a[enumaction.ordinal()]) {
                    ...
                    case 4: {
                        if (Animations.getInstance().isModuleToggled()) {
                            final float sizeFactor = Animations.getInstance().Size.getPropertyValue();
                            final float X = Animations.getInstance().Xpos.getPropertyValue();
                            final float Y = Animations.getInstance().Ypos.getPropertyValue();
                            final float Z = Animations.getInstance().Zpos.getPropertyValue();
                            switch (Animations.getInstance().blockMode.getPropertyValue()) {
                                case Swing: {
                                    GL11.glScalef(sizeFactor, sizeFactor, 1.0f);
                                    GL11.glTranslatef(X, Y, Z);
                                    this.transformFirstPersonItem(f - 0.25f, f2);
                                    this.func_178103_d();
                                    break;
                                }
                                case Swong: {
                                    ...
                                    GL11.glRotated((double)(-scalableProg * 35.0f), scalableProg / 2.9, 0.0, 5.0);
                                    GL11.glRotated((double)(-scalableProg * 55.0f), 4.0, scalableProg / 0.7, 0.0);
                                    this.func_178103_d();
                                    break;
                                }
                                case Slide: {
                                    GL11.glScalef(sizeFactor, sizeFactor, 1.0f);
                                    GL11.glTranslatef(X, Y, Z);
                                    this.transformFirstPersonItem(f - 0.15f, 0.0f);
                                    GlStateManager.rotate(scalableProg * -35.0f, 1.0f, -0.0f, 0.0f);
                                    this.func_178103_d();
                                    break;
                                }
                            }
