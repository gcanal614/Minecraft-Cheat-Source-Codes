...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new BozoMainMenu()), "disconnect.lost", reason));
        }
    }
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        ...
        if (Minecraft.getMinecraft().thePlayer != null) {
            BozoWare.getInstance().getEventManager().callEvent(packetSendEvent);
        }
    ...
    @Override
    public void handleResourcePack(S48PacketResourcePackSend p0) {
