...
public class Reflector
{
    ...
    public static ReflectorClass BozoMainMenu;
    public static ReflectorField BozoMainMenu_splashText;
    ...
    static {
        ...
        Reflector.BozoMainMenu = new ReflectorClass(BozoMainMenu.class);
        Reflector.BozoMainMenu_splashText = new ReflectorField(Reflector.BozoMainMenu, String.class);
