        ...
        try {
            if (Config.minecraft.isFullScreen()) {
                ...
                if (Config.minecraft.currentScreen != null) {
                    final ScaledResolution scaledresolution = new ScaledResolution(Config.minecraft, Minecraft.getMinecraft().displayWidth, Minecraft.getMinecraft().displayHeight);
