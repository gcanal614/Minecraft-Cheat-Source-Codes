...
public class MinecraftFontRenderer extends CFont
{
    ...
    public float drawCenteredStringWithShadow(final String text, final double x2, final double y2, final int color) {
        return (float)this.drawStringWithShadow(text, x2 - this.getStringWidth(text) / 2.0, y2, color);
    }
