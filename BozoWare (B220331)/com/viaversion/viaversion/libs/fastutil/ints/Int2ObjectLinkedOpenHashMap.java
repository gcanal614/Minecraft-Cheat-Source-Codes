...
public class Int2ObjectLinkedOpenHashMap<V> extends AbstractInt2ObjectSortedMap<V> implements Serializable, Cloneable, Hash
{
            ...
            this.values = new AbstractObjectCollection<V>() {
                ...
                public void forEach(final Consumer<? super V> consumer) {
                    if (Int2ObjectLinkedOpenHashMap.this.containsNullKey) {
                        consumer.accept((Object)Int2ObjectLinkedOpenHashMap.this.value[Int2ObjectLinkedOpenHashMap.this.n]);
                    }
                    int pos = Int2ObjectLinkedOpenHashMap.this.n;
                    while (pos-- != 0) {
                        if (Int2ObjectLinkedOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((Object)Int2ObjectLinkedOpenHashMap.this.value[pos]);
                        }
                    }
                }
            };
    ...
    private final class KeySet extends AbstractIntSortedSet
    {
        ...
        public void forEach(final IntConsumer consumer) {
            ...
            int pos = Int2ObjectLinkedOpenHashMap.this.n;
            while (pos-- != 0) {
                final int k = Int2ObjectLinkedOpenHashMap.this.key[pos];
                if (k != 0) {
                    consumer.accept(k);
                }
            }
