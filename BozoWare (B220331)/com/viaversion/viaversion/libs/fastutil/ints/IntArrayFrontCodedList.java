        ...
        return new ObjectListIterator<int[]>() {
            ...
            public int[] next() {
                ...
                if (this.i % IntArrayFrontCodedList.this.ratio == 0) {
                    ...
                    BigArrays.copyFromBig(IntArrayFrontCodedList.this.array, this.pos + count(length), this.s, 0, length);
                    ...
                    BigArrays.copyFromBig(IntArrayFrontCodedList.this.array, this.pos + count(length) + count(common), this.s, common, length);
