...
final class StyleSerializer implements JsonDeserializer<Style>, JsonSerializer<Style>
{
    ...
    private Codec.Decoder<Component, String, JsonParseException> decoder(final JsonDeserializationContext ctx) {
        ...
        // Original Bytecode:
        // 
        //     1: invokedynamic   BootstrapMethod #0, decode:(Lcom/viaversion/viaversion/libs/gson/JsonDeserializationContext;)Lcom/viaversion/viaversion/libs/kyori/adventure/util/Codec$Decoder;
        //     6: areturn        
        //    Signature:
