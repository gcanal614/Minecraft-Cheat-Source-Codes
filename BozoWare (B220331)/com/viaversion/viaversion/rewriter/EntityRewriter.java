...
public abstract class EntityRewriter<T extends Protocol> extends RewriterBase<T> implements com.viaversion.viaversion.api.rewriter.EntityRewriter<T>
{
    ...
    public <E extends Enum> void mapTypes(final EntityType[] oldTypes, final Class<E> newTypeClass) {
        if (this.typeMappings == null) {
            (this.typeMappings = new Int2IntOpenHashMap(oldTypes.length, 1.0f)).defaultReturnValue(-1);
        }
    ...
    public void registerTracker(final ClientboundPacketType packetType, final EntityType entityType, final Type<?> intType) {
        this.protocol.registerClientbound(packetType, new PacketRemapper() {
            @Override
            public void registerMap() {
                ...
                final int entityId;
                this.handler(wrapper -> {
                    val$intType = (Type<Integer>)intType;
    ...
    protected PacketHandler worldDataTrackerHandler(final int nbtIndex) {
