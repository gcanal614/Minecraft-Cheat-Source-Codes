...
public class Step extends Module {
    ...
    public void onStep(StepEvent event) {
        if (getMc().theWorld == null || getMc().thePlayer == null || Clarinet.INSTANCE.getModuleManager().getModule("speed").isEnabled() || Clarinet.INSTANCE.getModuleManager().getModule("flight").isEnabled() || Clarinet.INSTANCE.getModuleManager().getModule("longjump").isEnabled())
            return;
