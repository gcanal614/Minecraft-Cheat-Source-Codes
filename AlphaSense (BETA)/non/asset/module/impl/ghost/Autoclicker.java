...
import non.asset.event.bus.*;
import non.asset.event.impl.input.ClickMouseEvent;
import non.asset.event.impl.player.*;
...
import non.asset.utils.value.impl.*;
...
public class Autoclicker extends Module {
    ...
    public Autoclicker() {
        ...
        setDescription("Make mcdonald's mouse a gaming mouse");
    }
    ...
    private int getCPS() {
        ...
        range = chance <= num1Prob ? 1 : chance <= num2Prob ? 2 : chance <= 98 ? 3 : MathUtils.getRandomInRange(4, 6);
        return range;
    }
