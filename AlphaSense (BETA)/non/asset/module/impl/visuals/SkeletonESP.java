...
public class SkeletonESP extends Module {
    ...
    public BooleanValue visibleonly = new BooleanValue("Visible Only",false);
    private NumberValue<Float> width = new NumberValue<>("Scale", 1.0f, 0.5f, 10.0f, 0.1f);
