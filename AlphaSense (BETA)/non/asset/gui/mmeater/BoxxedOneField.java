...
public class BoxxedOneField extends Gui {
   ...
   public static String numbero = "AS" + MathUtils.getRandomInRange(199, 300);


   public BoxxedOneField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
   ...
   public void setStatus(String par1Str) {
	      if(par1Str.length() > this.maxStringLength) {
	         this.text = par1Str.substring(0, this.maxStringLength);
	      } else {
	         this.text = par1Str;
   ...
   public void drawTextBox() {
      if(this.func_73778_q()) {
         ...
         if(var4.length() > 0) {
            ...
            var9 = Minecraft.getMinecraft().fontRendererObj.drawString(this.text.replaceAll("(?s).", "#"), (double)var7, (double)var8, var1);
         ...
         if(var4.length() > 0 && var5 && var2 < var4.length()) {
            Minecraft.getMinecraft().fontRendererObj.drawString(var4.substring(var2), (double)var9, (double)var8, var1);
         }
         ...
         if(var6) {
            if(var10) {
               ...
               Minecraft.getMinecraft().fontRendererObj.drawString("_", (double)var11, (double)var8, var1);
            }
         }
