...
import non.asset.utils.OFC.GLUtil;
...
public class RenderUtil {
    ...
    public static void renderTag(String name, double pX, double pY, double pZ, int color) {
        ...
        mc.fontRendererObj.drawString(name, -(width), -(mc.fontRendererObj.FONT_HEIGHT + 7), color);
    ...
    public static boolean getMinecraftNoVirusUltraHDNoSkidNoSigmaVirusImNotSigmaHatarAndWhyThisNameIsSooBig = false;
