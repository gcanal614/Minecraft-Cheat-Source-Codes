...
import non.asset.event.impl.player.StepEvent;
import non.asset.module.impl.ghost.HitBox;
...
public abstract class Entity implements ICommandSender {
    ...
    public void setPosition(double x, double y, double z) {
		...
		/*if (this instanceof EntityPlayer) {
	        if(Clarinet.INSTANCE.getModuleManager().getModuleClass(HitBox.class).isEnabled()) {
	        	float f = HitBox.hitboxvalue.getValue() / 2;
        		float f1 = HitBox.hitboxvalue.getValue();
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                Clarinet.INSTANCE.getEventBus().dispatch(entityStepEvent);
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    Clarinet.INSTANCE.getEventBus().dispatch( new StepEvent(this));
                }
            }
