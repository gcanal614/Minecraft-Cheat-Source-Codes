...
public class MovementInputFromOptions extends MovementInput {
    ...
    public void updatePlayerMoveState() {
        if (Clarinet.INSTANCE.getModuleManager().getModule("invwalk").isEnabled() && !(Minecraft.getMinecraft().currentScreen instanceof GuiChat)) {
            ...
            final Scaffold scaffold = (Scaffold) Clarinet.INSTANCE.getModuleManager().getModule("scaffold");
