...
public class BlockPos extends Vec3i
{
	...
	public static int getNumXBits() {
		return NUM_X_BITS;
	}

	public static int getNumZBits() {
		return NUM_Z_BITS;
	}

	public static int getNumYBits() {
		return NUM_Y_BITS;
	}
	...
	public static long getxMask() {
		return X_MASK;
	}

	public static long getyMask() {
		return Y_MASK;
	}

	public static long getzMask() {
		return Z_MASK;
	}
