...
import non.asset.event.impl.render.CrosshairEvent;
import non.asset.event.impl.render.Render2DEvent;
import non.asset.module.Module;
import non.asset.module.impl.other.AutoMatchJoin;
...
public class GuiIngame extends Gui {
    ...
    protected boolean showCrosshair() {
        ...
        Clarinet.INSTANCE.getEventBus().dispatch(crosshairEvent);
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        float y1 = 24;
        for (Module mod : Clarinet.INSTANCE.getModuleManager().getModuleMap().values()) {
        ...
        for (Object score1 : arraylist1) {
            ...
            if (k == arraylist1.size()) {
                ...
                String[] confirm = new String[] {"Bed Wars", "bedwars", "BedWars", "Bedwars"};
                
                isInSkywars = s3.toLowerCase().contains("skywars");
                
                for (String fuckYou : confirm) {
                	isInBedwars = s3.toLowerCase().equals(fuckYou);
                }
