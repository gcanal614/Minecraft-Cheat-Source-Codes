...
import non.asset.UpdateMotion;
import non.asset.event.impl.game.ChatEvent;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdate() {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                ...
                Clarinet.INSTANCE.getEventBus().dispatch(updateEvent);
                
                if (updateEvent.isCanceled()) {
                    Clarinet.INSTANCE.getEventBus().dispatch(new UpdateEvent(this.rotationYaw, this.rotationPitch, this.getEntityBoundingBox().minY, this.onGround));
                    return;
                }
    ...
    public void sendChatMessage(String message) {
        ...
        Clarinet.INSTANCE.getEventBus().dispatch(chatEvent);
    ...
    public boolean isEntityInsideOpaqueBlock() {
        ...
        Clarinet.INSTANCE.getEventBus().dispatch(insideBlockRenderEvent);
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        ...
        Clarinet.INSTANCE.getEventBus().dispatch(ep);
        if (this.noClip || ep.isCanceled()) {
            ...
            Clarinet.INSTANCE.getEventBus().dispatch(epo);
            return false;
        }
    }
