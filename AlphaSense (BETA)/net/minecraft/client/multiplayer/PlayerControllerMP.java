...
public class PlayerControllerMP
{
    ...
    public boolean clickBlock(BlockPos loc, EnumFacing face)
    {
        ...
        else
        {
            ...
            else if (!this.isHittingBlock || !this.isHittingPosition(loc))
            {
                ...
                if (flag && this.getBlockDamage() == 0.0F)
                {
                ...
                else
                {
                    ...
                    this.setBlockDamage(0.0F);
                    this.stepSoundTickCounter = 0.0F;
                    this.mc.theWorld.sendBlockBreakProgress(this.mc.thePlayer.getEntityId(), this.currentBlock, (int)(this.getBlockDamage() * 10.0F) - 1);
                }
            }
    ...
    public boolean onPlayerDamageBlock(BlockPos posBlock, EnumFacing directionFacing)
    {
        ...
        else if (this.isHittingPosition(posBlock))
        {
            ...
            {
                this.setBlockDamage(this.getBlockDamage() + block.getPlayerRelativeBlockHardness(this.mc.thePlayer, this.mc.thePlayer.worldObj, posBlock));
	...
	public void setBlockDamage(float curBlockDamageMP) {
