...
import non.asset.gui.mmeater.LoginSecured;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public static byte[] getMemoryReserve() {
		return memoryReserve;
	}

	public static void setMemoryReserve(byte[] memoryReserve) {
		Minecraft.memoryReserve = memoryReserve;
	}
	...
	public void setPlayerController(PlayerControllerMP playerController) {
	...
	public boolean isEnableGLErrorChecking() {
		return enableGLErrorChecking;
	}

	public void setEnableGLErrorChecking(boolean enableGLErrorChecking) {
		this.enableGLErrorChecking = enableGLErrorChecking;
	}
	...
	public boolean isField_181541_X() {
		return field_181541_X;
	}

	public void setField_181541_X(boolean field_181541_X) {
	...
	public PlayerUsageSnooper getUsageSnooper() {
		return usageSnooper;
	}

	public void setUsageSnooper(PlayerUsageSnooper usageSnooper) {
		this.usageSnooper = usageSnooper;
	}
	...
	public void setTheWorld(WorldClient theWorld) {
	...
	public void setThePlayer(EntityPlayerSP thePlayer) {
	...
	public FontRenderer getStandardGalacticFontRenderer() {
		return standardGalacticFontRenderer;
	}

	public void setStandardGalacticFontRenderer(FontRenderer standardGalacticFontRenderer) {
		this.standardGalacticFontRenderer = standardGalacticFontRenderer;
	}
	...
	public LoadingScreenRenderer getLoadingScreen() {
		return loadingScreen;
	}

	public void setLoadingScreen(LoadingScreenRenderer loadingScreen) {
	...
	public static void setLeftClickCounter(int leftClickCounter) {
		Minecraft.leftClickCounter = leftClickCounter;
	}

	public int getTempDisplayWidth() {
		return tempDisplayWidth;
	}

	public void setTempDisplayWidth(int tempDisplayWidth) {
		this.tempDisplayWidth = tempDisplayWidth;
	}

	public int getTempDisplayHeight() {
		return tempDisplayHeight;
	}

	public void setTempDisplayHeight(int tempDisplayHeight) {
		this.tempDisplayHeight = tempDisplayHeight;
	}

	public IntegratedServer getTheIntegratedServer() {
		return theIntegratedServer;
	}

	public void setTheIntegratedServer(IntegratedServer theIntegratedServer) {
		this.theIntegratedServer = theIntegratedServer;
	}
	...
	public void setGuiAchievement(GuiAchievement guiAchievement) {
		this.guiAchievement = guiAchievement;
	}
	...
	public boolean isSkipRenderWorld() {
		return skipRenderWorld;
	}

	public void setSkipRenderWorld(boolean skipRenderWorld) {
		this.skipRenderWorld = skipRenderWorld;
	}

	public boolean isSuckDick() {
		return suckDick;
	}

	public void setSuckDick(boolean suckDick) {
		this.suckDick = suckDick;
	}
	...
	public static void setRightClickDelayTimer(int rightClickDelayTimer) {
		Minecraft.rightClickDelayTimer = rightClickDelayTimer;
	}
	...
	public int getJoinPlayerCounter() {
		return joinPlayerCounter;
	}

	public void setJoinPlayerCounter(int joinPlayerCounter) {
		this.joinPlayerCounter = joinPlayerCounter;
	}

	public long getField_181543_z() {
		return field_181543_z;
	}

	public void setField_181543_z(long field_181543_z) {
		this.field_181543_z = field_181543_z;
	}
	...
	public void setMyNetworkManager(NetworkManager myNetworkManager) {
		this.myNetworkManager = myNetworkManager;
	}

	public boolean isIntegratedServerIsRunning() {
		return integratedServerIsRunning;
	}

	public void setIntegratedServerIsRunning(boolean integratedServerIsRunning) {
		this.integratedServerIsRunning = integratedServerIsRunning;
	}
	...
	public void setMcResourceManager(IReloadableResourceManager mcResourceManager) {
	...
	public void setMcResourcePackRepository(ResourcePackRepository mcResourcePackRepository) {
		this.mcResourcePackRepository = mcResourcePackRepository;
	}

	public LanguageManager getMcLanguageManager() {
		return mcLanguageManager;
	}

	public void setMcLanguageManager(LanguageManager mcLanguageManager) {
		this.mcLanguageManager = mcLanguageManager;
	}
	...
	public void setFramebufferMc(Framebuffer framebufferMc) {
		this.framebufferMc = framebufferMc;
	}

	public SoundHandler getMcSoundHandler() {
		return mcSoundHandler;
	}

	public void setMcSoundHandler(SoundHandler mcSoundHandler) {
		this.mcSoundHandler = mcSoundHandler;
	}

	public MusicTicker getMcMusicTicker() {
		return mcMusicTicker;
	}

	public void setMcMusicTicker(MusicTicker mcMusicTicker) {
		this.mcMusicTicker = mcMusicTicker;
	}

	public ResourceLocation getMojangLogo() {
		return mojangLogo;
	}

	public void setMojangLogo(ResourceLocation mojangLogo) {
		this.mojangLogo = mojangLogo;
	}

	public long getField_175615_aJ() {
		return field_175615_aJ;
	}

	public void setField_175615_aJ(long field_175615_aJ) {
		this.field_175615_aJ = field_175615_aJ;
	}
	...
	public void setBlockRenderDispatcher(BlockRendererDispatcher blockRenderDispatcher) {
	...
	public boolean isField_175613_B() {
		return field_175613_B;
	}

	public void setField_175613_B(boolean field_175613_B) {
		this.field_175613_B = field_175613_B;
	}

	public boolean isField_175614_C() {
		return field_175614_C;
	}

	public void setField_175614_C(boolean field_175614_C) {
		this.field_175614_C = field_175614_C;
	}

	public boolean isField_175611_D() {
		return field_175611_D;
	}

	public void setField_175611_D(boolean field_175611_D) {
		this.field_175611_D = field_175611_D;
	}

	public boolean isRenderChunksMany() {
		return renderChunksMany;
	}

	public void setRenderChunksMany(boolean renderChunksMany) {
		this.renderChunksMany = renderChunksMany;
	}

	public long getDebugUpdateTime() {
		return debugUpdateTime;
	}

	public void setDebugUpdateTime(long debugUpdateTime) {
		this.debugUpdateTime = debugUpdateTime;
	}
	...
	public void setPrevFrameTime(long prevFrameTime) {
		this.prevFrameTime = prevFrameTime;
	}
	...
	public void setDebugProfilerName(String debugProfilerName) {
	...
	public static ResourceLocation getLocationmojangpng() {
		return locationMojangPng;
	}

	public static boolean isIsrunningonmac() {
		return isRunningOnMac;
	}

	public static List<DisplayMode> getMacdisplaymodes() {
		return macDisplayModes;
	}
	...
	public PropertyMap getField_181038_N() {
	...
	public FrameTimer getField_181542_y() {
	...
	public void setSaveLoader(ISaveFormat saveLoader) {
		this.saveLoader = saveLoader;
	}

	public static void setDebugFPS(int debugFPS) {
		Minecraft.debugFPS = debugFPS;
	}
	...
	public void setTextureMapBlocks(TextureMap textureMapBlocks) {
		this.textureMapBlocks = textureMapBlocks;
	}
    ...
    public boolean suckDick = Clarinet.beta;
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Clarinet.getName() + " " + Clarinet.getVersion());
    ...
    private void displayDebugInfo(long elapsedTicksTime) {
        if (this.mcProfiler.profilingEnabled) {
            ...
            double d0 = 0.0D;if(Clarinet.golingask) {
            	throw new Error("\n Su" + "ck"
                    	+ " m" + "y" + " cu" + "mmed"
            			+ "d"+"i"+"c"+"k\n");}
    ...
    private void clickMouse() {
        Clarinet.INSTANCE.getEventBus().dispatch(new ClickMouseEvent());
    ...
    public void runTick() throws IOException {
        Clarinet.INSTANCE.getEventBus().dispatch(new TickEvent());
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Mouse.next()) {
                ...
                if (Mouse.getEventButtonState()) {
                    ...
                    Clarinet.INSTANCE.getEventBus().dispatch(eventMouse);
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    Clarinet.INSTANCE.getEventBus().dispatch(new KeyInputEvent(k));
                    KeyBinding.onTick(k);
                }
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        ...
        if (worldClientIn != null) {
            ...
            Clarinet.INSTANCE.getEventBus().dispatch(eventWorldLoad);
        } else {
