...
import non.asset.module.impl.visuals.ItemPhysics;
import non.asset.utils.ItemPhysic;
...
public class RenderEntityItem extends Render<EntityItem>
{
    ...
    public void doRender(EntityItem entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if(Clarinet.INSTANCE.getModuleManager().getModuleClass(ItemPhysics.class).isEnabled()) {	
