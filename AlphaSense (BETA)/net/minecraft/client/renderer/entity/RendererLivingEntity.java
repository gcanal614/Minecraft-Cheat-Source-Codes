...
import non.asset.module.impl.other.MurderMystery;
import non.asset.module.impl.player.ChestStealer;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, x, y, z)) {
            ...
            try {
                ...
                if (entity == Minecraft.getMinecraft().thePlayer) {
                	...
                	if (Clarinet.INSTANCE.getModuleManager().getModule("killaura").isEnabled() && Aura.target != null || Clarinet.INSTANCE.getModuleManager().getModule("scaffold").isEnabled() || Clarinet.INSTANCE.getModuleManager().getModuleClass(ChestStealer.class).isEnabled()) {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_) {
        ...
        final Color visible = MurderMystery.murderers.contains(entitylivingbaseIn) ? new Color(255,0,0,255) : (new Color((Clarinet.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) || MurderMystery.gudpeople.contains(entitylivingbaseIn)) ? chams.visiblefriend.getValue() :chams.visible.getValue()));
        final Color hidden =MurderMystery.murderers.contains(entitylivingbaseIn) ? new Color(255, 128, 128,255) : (new Color((Clarinet.INSTANCE.getFriendManager().isFriend(entitylivingbaseIn.getName()) || MurderMystery.gudpeople.contains(entitylivingbaseIn)) ? chams.hiddenfriend.getValue() : chams.hidden.getValue()));
        ...
        if (flag || flag1) {
            ...
            if (Clarinet.INSTANCE.getModuleManager().getModuleClass(Chams.class).isEnabled() && chams.isValid(entitylivingbaseIn) && chams.colored.isEnabled()) {
    ...
    public void renderName(T entity, double x, double y, double z) {
        ...
        Clarinet.INSTANCE.getEventBus().dispatch(event);
