...
import non.asset.module.impl.visuals.Animation;
import non.asset.module.impl.visuals.Chams;
...
public class ItemRenderer
{
    ...
    {
        final Chams chams = (Chams) Clarinet.INSTANCE.getModuleManager().getModule("chams");
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.ItemRenderer$1.field_178094_a[enumaction.ordinal()])
                {
                    ...
                    case 4:
                        ...
                        GlStateManager.translate(0, Animation.Y.getValue(), 0);
                        
                        GlStateManager.translate(Animation.X.getValue(), 0, 0);
                    	
                        if (Clarinet.INSTANCE.getModuleManager().getModule("animation").isEnabled()) {
                            final Animation animation = ((Animation)Clarinet.INSTANCE.getModuleManager().getModule("animation"));
                            switch (animation.Mode.getValue()) {
								case ALPHA:
									 ...
									 if (itemToRender.getItem() instanceof ItemSword) {
	                                    	...
	                                    	final float MathHelperA = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
	                                    	GlStateManager.rotate(-MathHelperA * 30.0f / 2.0f, 4f, 0f, 9.0f);
	                                        GlStateManager.rotate(-MathHelperA * 50.0f, -10f, -0.4f, 1f);
	                                        this.func_178103_d();
	                                    }
                                ...
                                case SLIDE:
                                    if (itemToRender.getItem() instanceof ItemSword) {
                                    	...
                                    	final float MathHelperA = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
                                    	GlStateManager.rotate(-MathHelperA * 60.0f / 2.0f, 0f, 0f, 9.0f);
                                        GlStateManager.rotate(-MathHelperA * 30.0f, 10f, -0.4f, 1f);
                                    }
                                    break;
                                case EXHI:
							...
							case ASUNA:
								if (itemToRender.getItem() instanceof ItemSword) {
                                    ...
                                    final float MathHelperB = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
                                	GlStateManager.rotate(-MathHelperB * 20.0f / 2.0f, -9.0f, -18.4f, 7.0f);
                                    GlStateManager.rotate(-MathHelperB * 50.0f, 1f, -10f, 10f);
                                }
								break;
							case XD:
								if (itemToRender.getItem() instanceof ItemSword) {
                                	...
                                	float f62 = MathHelper.sin((float) (MathHelper.sqrt_float(f1) * 3.1));

                                    GlStateManager.rotate(-f62 * 40.0F / 2.0F, f62 / 2.0F, -0.0F, 9.0F);
                                    GlStateManager.rotate(-f62 * 30.0F, 1.0F, f62 / 2.0F, -0.0F);
                                    
                                	final float MathHelperA = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927f);
                                	GlStateManager.rotate(-MathHelperA * 30.0f / 2.0f, 0f, 0f, 9.0f);
                                    GlStateManager.rotate(-MathHelperA * 40.0f, 10f, -0.4f, 1f);
                                }
								break;
							default:
								break;
                        ...
                        GlStateManager.scale(Animation.scale.getValue(), Animation.scale.getValue(), Animation.scale.getValue());
            ...
            if (Clarinet.INSTANCE.getModuleManager().getModuleClass(Chams.class).isEnabled() && chams.hands.isEnabled()&& chams.colored.isEnabled()) {
                GL11.glDisable(3008);
                GL11.glDisable(3553);
                GL11.glDisable(2896);
                GL11.glEnable(3042);
