...
import non.asset.module.impl.other.TimeChanger;
...
public class WorldInfo
{
    ...
    public long getWorldTime()
    {
    	...
    	if(Clarinet.INSTANCE.getModuleManager().getModuleClass(TimeChanger.class).isEnabled()) {
    		return worldTime = TimeChanger.time.getValue();
    	}
