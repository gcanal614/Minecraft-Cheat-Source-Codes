...
extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        FontLoaders2.msFont18.drawCenteredString("Edit Alt", width / 2, 10.0f, -1);
        FontLoaders2.msFont18.drawCenteredString(this.status, width / 2, 20.0f, -1);
        this.nameField.drawTextBox();
        this.pwField.drawTextBox();
        if (this.nameField.getText().isEmpty()) {
            FontLoaders2.msFont18.drawStringWithShadow("New E-Mail", width / 2 - 96, 66.0f, -7829368);
        }
        if (this.pwField.getText().isEmpty()) {
            FontLoaders2.msFont18.drawStringWithShadow("New Password", width / 2 - 96, 106.0f, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.pwField = new GuiTextField(eventButton, this.mc.fontRendererObj, width / 2 - 100, 100, 200, 20);
    }
