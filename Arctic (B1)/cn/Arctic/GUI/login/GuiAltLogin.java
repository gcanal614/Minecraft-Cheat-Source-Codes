...
extends GuiScreen {
    ...
    public void drawScreen(int x, int y, float z) {
        ...
        FontLoaders2.msFont18.drawCenteredString("Alt Login", width / 2, 20.0f, -1);
        FontLoaders2.msFont18.drawCenteredString(this.thread == null ? "\u00a7eWaiting..." : this.thread.getStatus(), width / 2, 29.0f, -1);
        if (this.username.getText().isEmpty()) {
            FontLoaders2.msFont18.drawStringWithShadow("Username / E-Mail", width / 2 - 96, 64.0f, -7829368);
        }
        if (this.password.getText().isEmpty()) {
            FontLoaders2.msFont18.drawStringWithShadow("Password", width / 2 - 96, 104.0f, -7829368);
        }
        if (this.combined.getText().isEmpty()) {
            FontLoaders2.msFont18.drawStringWithShadow("Email:Password", width / 2 - 96, 144.0f, -7829368);
        }
