...
public class RenderUtil123 {
    ...
    public static void drawRoundRect(double xPosition, double yPosition, double endX, double endY, int radius,
        ...
        RenderUtil123.drawRect(xPosition + radius, yPosition + radius, xPosition + width - radius, yPosition + height - radius,
                color);
        RenderUtil123.drawRect(xPosition, yPosition + radius, xPosition + radius, yPosition + height - radius, color);
        RenderUtil123.drawRect(xPosition + width - radius, yPosition + radius, xPosition + width, yPosition + height - radius,
                color);
        RenderUtil123.drawRect(xPosition + radius, yPosition, xPosition + width - radius, yPosition + radius, color);
        RenderUtil123.drawRect(xPosition + radius, yPosition + height - radius, xPosition + width - radius, yPosition + height,
                color);
        RenderUtil123.drawFilledCircle(xPosition + radius, yPosition + radius, radius, color, 1);
        RenderUtil123.drawFilledCircle(xPosition + radius, yPosition + height - radius, radius, color, 2);
        RenderUtil123.drawFilledCircle(xPosition + width - radius, yPosition + radius, radius, color, 3);
        RenderUtil123.drawFilledCircle(xPosition + width - radius, yPosition + height - radius, radius, color, 4);
    }
    ...
    public static void drawBorderedRect(final double x, final double y, final double x2, final double d, final float l1,
        ...
        RenderUtil123.drawRect(x, y, x2, d, col2);
    ...
    public static void rectangleBordered(double x, double y, double x1, double y1, double width, int internalColor,
                                         int borderColor) {
        RenderUtil123.rectangle(x + width, y + width, x1 - width, y1 - width, internalColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RenderUtil123.rectangle(x + width, y, x1 - width, y + width, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RenderUtil123.rectangle(x, y, x + width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RenderUtil123.rectangle(x1 - width, y, x1, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RenderUtil123.rectangle(x + width, y1 - width, x1 - width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
    }
    ...
    public static boolean isInViewFrustrum(Entity entity) {
        return RenderUtil123.isInViewFrustrum(entity.getEntityBoundingBox()) || entity.ignoreFrustumCheck;
    }

    public static void drawHollowBox(float x, float y, float x1, float y1, float thickness, int color) {
        RenderUtil123.drawHorizontalLine(x, y, x1, thickness, color);
        RenderUtil123.drawHorizontalLine(x, y1, x1, thickness, color);
        RenderUtil123.drawVerticalLine(x, y, y1, thickness, color);
        RenderUtil123.drawVerticalLine(x1 - thickness, y, y1, thickness, color);
    }

    public static void drawHorizontalLine(float x, float y, float x1, float thickness, int color) {
        RenderUtil123.drawRect2(x, y, x1, y + thickness, color);
    }

    public static void drawRect2(double x, double y, double x2, double y2, int color) {
        RenderUtil123.drawRect(x, y, x2, y2, color);
    }

    public static void drawVerticalLine(float x, float y, float y1, float thickness, int color) {
        RenderUtil123.drawRect2(x, y, x + thickness, y1, color);
    }
...
//							R2DUtils.drawRect(x2, y2, x1, y1, color);
        ...
        public static void drawGradientRect(float x, float y, float x1, float y1, int topColor, int bottomColor) {
            ...
            GL11.glShadeModel((int) 7425);
            glBegin((int) 7);
            RenderUtil123.glColor(topColor);
            GL11.glVertex2f((float) x, (float) y1);
            GL11.glVertex2f((float) x1, (float) y1);
            RenderUtil123.glColor(bottomColor);
...
//		org.lwjgl.opengl.GL11.glDisable((int) 3042);
    ...
    public static void drawSolidBlockESP(double x, double y, double z, float red, float green, float blue,
        ...
        GL11.glColor4f((float) red, (float) green, (float) blue, (float) alpha);
        RenderUtil123.drawBoundingBox(new AxisAlignedBB(x, y, z, x + 1.0, y + 1.0, z + 1.0));
    ...
    public static void drawOutline(double x, double y, double width, double height, double lineWidth, int color) {
        RenderUtil123.drawRect(x, y, x + width, y + lineWidth, color);
        RenderUtil123.drawRect(x, y, x + lineWidth, y + height, color);
        RenderUtil123.drawRect(x, y + height - lineWidth, x + width, y + height, color);
        RenderUtil123.drawRect(x + width - lineWidth, y, x + width, y + height, color);
    }
    ...
    public static void startGlScissor(int x, int y, int width, int height) {
        ...
        GL11.glPushMatrix();
        glEnable((int) 3089);
        GL11.glScissor((int) (x * scaleFactor), (int) (RenderUtil123.mc.displayHeight - (y + height) * scaleFactor),
