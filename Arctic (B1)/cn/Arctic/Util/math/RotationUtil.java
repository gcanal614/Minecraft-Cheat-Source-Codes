...
import cn.Arctic.Event.events.EventRotation;
import cn.Arctic.Util.RandomUtils;
import cn.Arctic.Util.Chat.Helper;
import cn.Arctic.Util.rotaions.Rotation;
import cn.Arctic.Util.rotaions.VecRotation;
...
public class RotationUtil {
    ...
    public static float[] getRotateForScaffold(float needYaw, float needPitch, float yaw, float pitch, float minturnspeed, float maxturnspeed) {
        ...
        return new float[]{mc.player.rotationYaw + MathHelper.wrapAngleTo180_float(smoothAngle.getYaw() - mc.player.rotationYaw), smoothAngle.getPitch()};
    }
