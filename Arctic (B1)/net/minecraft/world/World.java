...
import cn.Arctic.Module.modules.WORLD.WorldTime;
...
public abstract class World implements IBlockAccess {
	...
	public long getWorldTime() {
		return (long) (Client.instance.getModuleManager().getModuleByClass(WorldTime.class).isEnabled()
				? WorldTime.Time.getValue()
	...
	public void setWorldTime(long time) {
		if (Client.instance.getModuleManager().getModuleByClass(WorldTime.class).isEnabled()) {
			WorldTime.Time.getValue().longValue();
			return;
		}
