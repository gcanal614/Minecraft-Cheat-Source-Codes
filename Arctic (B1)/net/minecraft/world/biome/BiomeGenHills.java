...
{
    private WorldGenerator worldGenerator = new WorldGenMinable(Blocks.monster_egg.getDefaultState().withProperty(BlockSilverfish.VARIANT, BlockSilverfish.EnumType.STONE), 9);
    ...
    public void decorate(World worldIn, Random rand, BlockPos pos)
    {
        ...
        for (i = 0; i < 7; ++i)
        {
            ...
            this.worldGenerator.generate(worldIn, rand, pos.add(j1, k1, l1));
        }
    }
