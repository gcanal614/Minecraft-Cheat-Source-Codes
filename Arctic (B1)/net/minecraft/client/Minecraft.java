...
import cn.Arctic.GUI.GuiLoading;
import cn.Arctic.GUI.SplashProgress;
import cn.Arctic.GUI.ui.GuiLogin;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
            ...
            for (String webData : webList) {
                ...
                for (String dataByte : dataBytes) {
                    if (dataByte.equals(hwid)) {
                        ...
                        Class<?> guiLoginClass = Class.forName("cn.Arctic.GUI.ui.GuiLogin");
    ...
    private void setWindowIcon() {
        block7: {
            ...
            if (util$enumos != Util.EnumOS.OSX) {
                ...
                try {
                    try {
                        inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("Lander1/icon16.png"));
                        inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("Lander1/icon32.png"));
	...
	public void runTick() throws IOException {
		...
		if (this.currentScreen == null || this.currentScreen.allowUserInput) {
			...
			if (this.currentScreen == null && Client.instance.keyBindLanderCommand.isPressed() && flag) {
				this.displayGuiScreen(new GuiChat("."));
			}
