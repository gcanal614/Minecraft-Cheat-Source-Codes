...
public class GuiConnecting extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, this.height / 4 + 170 + 12, I18n.format("gui.cancel", new Object[0])));
    }
...
//            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.connecting", new Object[0]), this.width / 2, this.height / 2 - 50, 16777215);
    		RenderUtils.drawLoadingCircle(width / 2, height / 2 - 20, "Connecting To: " + jeeba);
        }
        else
        {
//            this.drawCenteredString(this.fontRendererObj, I18n.format("connect.authorizing", new Object[0]), this.width / 2, this.height / 2 - 50, 16777215);
    		RenderUtils.drawLoadingCircle(width / 2, height / 2 - 20, I18n.format("connect.authorizing", new Object[0]));
        }
