...
public class PlayerControllerMP
{
    ...
    {
        return this.currentGameType.isCreative() ? 5.0F : 3.5F;
    }
    ...
    public boolean onPlayerRightClick(ClientPlayerEntity player, WorldClient worldIn, ItemStack heldStack, BlockPos hitPos, EnumFacing side, Vec3 hitVec)
    {
        this.syncCurrentPlayItem();
    ...
    public ClientPlayerEntity func_178892_a(World worldIn, StatFileWriter statWriter)
    {
        return new ClientPlayerEntity(this.mc, worldIn, this.netClientHandler, statWriter);
    }
