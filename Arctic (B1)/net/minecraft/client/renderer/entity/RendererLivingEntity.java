...
import cn.Arctic.Module.modules.RENDER.Chams;
import cn.Arctic.Module.modules.RENDER.Nametags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        if (flag || flag1)
        {
            ...
            if (ModuleManager.getModuleByClass(Chams.class).isEnabled() && Chams.mode.getValue() == Chams.ChamsMode.Normal) {
                GL11.glPushMatrix();
                GL11.glPushAttrib((int)1048575);
                RenderUtil.pre();
                GL11.glDisable((int)2896);
                GL11.glPolygonMode((int)1032, (int)6914);
                if (Chams.rainbow.getValue()) {
                    GL11.glColor3d(ColorUtils.rainbow(1,1).getRed() / 255.0f, ColorUtils.rainbow(1,1).getGreen() / 255.0f, ColorUtils.rainbow(1,1).getBlue() / 255.0f);
                } else {
                    GL11.glColor3d((double)(!Helper.mc.player.canEntityBeSeen(entitylivingbaseIn) ? 1.0 : 0.0), (double)(!Helper.mc.player.canEntityBeSeen(entitylivingbaseIn) ? 0.5 : 1.0), (double)(!Helper.mc.player.canEntityBeSeen(entitylivingbaseIn) ? 0.0 : 0.0)); ;
                }
            ...
            if (!ModuleManager.getModuleByClass(Chams.class).isEnabled() || Chams.mode.getValue() != Chams.ChamsMode.Textured) {
            	this.mainModel.render(entitylivingbaseIn, p_77036_2_, p_77036_3_, p_77036_4_, p_77036_5_, p_77036_6_,scaleFactor);
            }
    ...
    public static void SetPitchY(final float y) {
        RendererLivingEntity.pitchy = y;
    }
}
