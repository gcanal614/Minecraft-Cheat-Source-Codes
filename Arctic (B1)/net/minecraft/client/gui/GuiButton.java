...
//			GlStateManager.blendFunc(770, 771);
			int color = (hovered && this.enabled) ? new Color(140, 140, 140, 130).getRGB() : new Color(20, 20, 20, 130).getRGB();
			RenderUtil.drawRect(this.xPosition, this.yPosition, this.xPosition + this.getButtonWidth(),
			...
			FontLoaders2.msFont18.drawCenteredString(this.displayString, this.xPosition + this.width / 2,
					this.yPosition + (this.height - 11) / 2, j);
