    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawStringWithShadow(s1, (float)l, (float)i1 - 2, i);
            }
            ...
            {
                j1 = this.fontRendererInstance.drawStringWithShadow(s.substring(j), (float)j1, (float)i1 - 2, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.fontRendererInstance.drawStringWithShadow("_", (float)k1 + 5, (float)i1 - 2, i);
                }
            }
