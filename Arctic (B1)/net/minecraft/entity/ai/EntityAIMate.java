...
public class EntityAIMate extends EntityAIBase
{
    ...
    {
        float f = 8.0F;
        List<EntityAnimal> list = this.world.<EntityAnimal>getEntitiesWithinAABB(this.theAnimal.getClass(), this.theAnimal.getEntityBoundingBox().expand((double)f, (double)f, (double)f));
    ...
    private void spawnBaby()
    {
        ...
        if (entityageable != null)
        {
            ...
            {
                this.world.spawnEntityInWorld(new EntityXPOrb(this.world, this.theAnimal.posX, this.theAnimal.posY, this.theAnimal.posZ, random.nextInt(7) + 1));
            }
        }
    }
}
