...
import cn.Arctic.Event.events.EventStrafe;
import cn.Arctic.Manager.ModuleManager;
import cn.Arctic.Module.modules.COMBAT.HitBox;
import cn.Arctic.Module.modules.MOVE.SafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && this.isSneaking() && this instanceof EntityPlayer || Client.instance.getModuleManager().getModuleByClass(SafeWalk.class).isEnabled()||ModuleManager.getModuleByClass(Scaffold.class).isEnabled() && this instanceof EntityPlayer;
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
            	  EventBus.call(new EventStep(EventCategory.PRE, this.stepHeight));
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    EventBus.call(new EventStep(EventCategory.POST, this.stepHeight));
                }
            }
