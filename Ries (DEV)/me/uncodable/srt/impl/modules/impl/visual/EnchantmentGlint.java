...
@ModuleInfo(internalName="EnchantmentGlint", name="Enchantment Glint", desc="Allows you to change the color of the enchantment glint.\nNo more generic blue!", category=Module.Category.VISUAL, legit=true)
...
extends Module {
    ...
    public EnchantmentGlint(int key, boolean enabled) {
        super(key, enabled);
        Ries.INSTANCE.getSettingManager().addSlider(this, INTERNAL_RED_VALUE, RED_VALUE_SETTING_NAME, 255.0, 0.0, 255.0, true);
        Ries.INSTANCE.getSettingManager().addSlider(this, INTERNAL_GREEN_VALUE, GREEN_VALUE_SETTING_NAME, 0.0, 0.0, 255.0, true);
        Ries.INSTANCE.getSettingManager().addSlider(this, INTERNAL_BLUE_VALUE, BLUE_VALUE_SETTING_NAME, 0.0, 0.0, 255.0, true);
        Ries.INSTANCE.getSettingManager().addCheckbox(this, INTERNAL_DISABLE_GLINT, DISABLE_GLINT);
    }
}
