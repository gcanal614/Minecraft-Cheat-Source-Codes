...
@Deprecated
@ModuleInfo(internalName="ClickGUI", name="Click GUI", desc="Allows you to view a clickable GUI that you can click on.\nWhat else is there to say?", category=Module.Category.VISUAL, legit=true)
public class ClickGUIDeprecated
extends Module {
    ...
    public void onEnable() {
        MC.displayGuiScreen(new ClickGUIScreen(RandomUtils.nextInt((int)0, (int)100)));
    }
