...
@ModuleInfo(internalName="TimeChecker", name="Time Checker", desc="Allows SRT to send you an update on the time.\nPerfect for looking back at the days that were actually enjoyable.", category=Module.Category.MISCELLANEOUS, legit=true)
