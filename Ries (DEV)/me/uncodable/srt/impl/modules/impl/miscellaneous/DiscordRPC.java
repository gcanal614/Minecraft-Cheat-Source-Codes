...
@ModuleInfo(internalName="DiscordRPC", name="Discord RPC", desc="Allows you to show off SRT to your Discord friends (and pedophiles).", category=Module.Category.MISCELLANEOUS, legit=true)
...
extends Module {
    ...
    @EventTarget(target=EventMinecraftLoop.class)
    public void onLoop(EventMinecraftLoop e) {
        ...
        switch (this.switchCounter) {
            ...
            case 2: {
                if (DiscordRPC.MC.theWorld == null) {
                    this.message = "In Main Menu";
                    break;
                }
                this.message = String.format("Playing On: %s", MC.getCurrentServerData() == null ? "Single Player" : DiscordRPC.MC.getCurrentServerData().serverIP);
                break;
            }
            case 3: {
