...
@ModuleInfo(internalName="NoRotate", name="No Rotate", desc="Prevents the server from setting your rotations.\nCompletely negates server-induced Parkinson's disease.", category=Module.Category.PLAYER)
...
extends Module {
    ...
    public void onPacket(EventPacket e) {
        if (e.getPacket() instanceof S08PacketPlayerPosLook) {
            S08PacketPlayerPosLook packet = (S08PacketPlayerPosLook)PacketUtils.getPacket(e.getPacket());
