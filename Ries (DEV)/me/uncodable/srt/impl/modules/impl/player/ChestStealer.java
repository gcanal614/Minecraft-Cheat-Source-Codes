...
@ModuleInfo(internalName="ChestStealer", name="Chest Stealer", desc="Allows you to steal chests with incredible speed.\nAlso allows for mass amounts of robberies worthy of a felony!", category=Module.Category.PLAYER)
...
extends Module {
    ...
    public void onUpdate(EventUpdate e) {
        if (e.getState() == EventUpdate.State.PRE && ChestStealer.MC.thePlayer.openContainer instanceof ContainerChest) {
            ...
            for (int i = 0; i < container.getLowerChestInventory().getSizeInventory(); ++i) {
                if (container.getLowerChestInventory().getStackInSlot(i) == null || !this.timer.elapsed((long)delay)) continue;
