...
@ModuleInfo(internalName="BlockReach", name="Block Reach", desc="Allows you to break blocks from afar.", category=Module.Category.WORLD)
...
extends Module {
    ...
    public BlockReach(int key, boolean enabled) {
        super(key, enabled);
        Ries.INSTANCE.getSettingManager().addSlider(this, INTERNAL_BLOCK_REACH_VALUE, BLOCK_REACH_VALUE_SETTING_NAME, 10.0, 0.0, 10.0);
    }
}
