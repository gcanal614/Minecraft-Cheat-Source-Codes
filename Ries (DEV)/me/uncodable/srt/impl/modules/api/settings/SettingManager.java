...
public class SettingManager {
    ...
    public void addSlider(Module module, String internalName, String settingName, double defaultValue, double minimumValue, double maximumValue, boolean truncate) {
    ...
    public Setting getSetting(Module module, String internalName, Setting.Type type) {
        for (Setting setting : this.settings) {
            if (setting.getModule() != module || !setting.getInternalName().equals(internalName) || setting.getSettingType() != type) continue;
            return setting;
        }
        return null;
    }
    ...
    public ArrayList<Setting> getAllSettings(Module module) {
        ArrayList<Setting> returnSettings = new ArrayList<Setting>();
        for (Setting setting : this.settings) {
