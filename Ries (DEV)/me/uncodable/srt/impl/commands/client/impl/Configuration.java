...
@CommandInfo(name="Config", desc="Allows you to perform configuration manipulation; allows you to load or save configurations.", usage=".config save <config file> OR .config load <config file> [load binds]")
