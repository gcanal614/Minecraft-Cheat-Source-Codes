...
public enum Ries {
    ...
    public static void intentInitialization() {
        INSTANCE.getModuleManager().addModules(new ClickGUIDeprecated(54, false), new Hud(0, true), new Aura(0, false), new AirJump(0, false), new HighJump(0, false), new BlockReach(0, false), new Reach(0, false), new Ambience(0, false), new AutoArmor(0, false), new AntiCheatDisabler(0, false), new ReverseKnockback(0, false), new QuakeBot(0, false), new EnchantmentGlint(0, false), new Keystrokes(0, false), new Safeguard(0, false), new FullBright(0, false), new Timer(0, false), new Velocity(0, false), new Weather(0, false), new InventoryMove(0, false), new NoFall(0, false), new TriggerBot(0, false), new FastPlace(0, false), new ChestStealer(0, false), new NoSlowdown(0, false), new Regen(0, false), new FastUse(0, false), new Sprint(0, false), new LowFire(0, false), new FastBow(0, false), new Unstuck(0, false), new ClientCommands(0, false), new FastLadder(0, false), new ServerCrasher(0, false), new LongJump(0, false), new Speed(0, false), new Flight(0, false), new InventoryManager(0, false), new AntiInvisibles(0, false), new NoEffectRender(0, false), new NetherPortalFix(0, false), new NoHurtDisplay(0, false), new ClientSpoof(0, false), new MagnetMode(0, false), new Animations(0, false), new Spider(0, false), new TimeChecker(0, false), new PostCoordinates(0, false), new MinemenBoats(0, false), new NoPumpkinOverlay(0, false), new FastRespawn(0, false), new ChatSpammer(0, false), new CraftingCarry(0, false), new ChatBypass(0, false), new Derp(0, false), new AntiVoid(0, false), new Criticals(0, false), new DiscordRPC(0, false), new PluginDisabler(0, false), new ESP(0, false), new Step(0, false), new MetasploitCommands(0, false), new AutoTip(0, false), new InstantPickaxe(0, false), new NoStrike(0, false), new NoRotate(0, false), new NoTeleport(0, false), new AntiBot(0, false), new SpeedFuzzer(0, false), new ClickGUI(0, false));
