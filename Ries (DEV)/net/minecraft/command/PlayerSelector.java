...
public class PlayerSelector {
    ...
    private static List<Predicate<Entity>> func_179647_f(Map<String, String> p_179647_0_) {
        ...
        if (s != null) {
            String s_f = s;
            list.add(p_apply_1_ -> p_apply_1_.getCommandSenderName().equals(s_f) != flag);
        }
        return list;
    }
    ...
    private static <T extends Entity> List<T> filterResults(Map<String, String> params, Class<? extends T> entityClass, List<Predicate<Entity>> inputList, String type, World worldIn, BlockPos position) {
        ...
        if (position != null) {
            ...
            if (!(params.containsKey("dx") || params.containsKey("dy") || params.containsKey("dz"))) {
                ...
                if (flag && flag2 && !flag1) {
                    Predicate predicate2 = p_apply_1_ -> p_apply_1_.posX >= axisalignedbb.minX && p_apply_1_.posY >= axisalignedbb.minY && p_apply_1_.posZ >= axisalignedbb.minZ && p_apply_1_.posX < axisalignedbb.maxX && p_apply_1_.posY < axisalignedbb.maxY && p_apply_1_.posZ < axisalignedbb.maxZ;
    ...
    private static <T extends Entity> List<T> func_179658_a(List<T> p_179658_0_, Map<String, String> p_179658_1_, ICommandSender p_179658_2_, Class<? extends T> p_179658_3_, String p_179658_4_, BlockPos p_179658_5_) {
        ...
        if (!(p_179658_4_.equals("p") || p_179658_4_.equals("a") || p_179658_4_.equals("e"))) {
            ...
            p_179658_0_.sort((p_compare_1_, p_compare_2_) -> ComparisonChain.start().compare(p_compare_1_.getDistanceSq(p_179658_5_), p_compare_2_.getDistanceSq(p_179658_5_)).result());
        }
