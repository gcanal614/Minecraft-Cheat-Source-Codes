...
extends CommandBase {
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        EntityPlayerMP entityplayermp = args.length >= 3 ? CommandAchievement.getPlayer(sender, args[2]) : CommandAchievement.getCommandSenderAsPlayer(sender);
            ...
            if (statbase == null) {
                ...
                if (statbase instanceof Achievement) {
                    ...
                    if (flag) {
                        ...
                        ArrayList list1 = Lists.newArrayList((Iterator)Iterators.filter(AchievementList.achievementList.iterator(), p_apply_1_ -> entityplayermp.getStatFile().hasAchievementUnlocked((Achievement)p_apply_1_) && p_apply_1_ != statbase));
