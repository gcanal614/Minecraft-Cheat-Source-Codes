...
public class Item {
    ...
    public static void registerItems() {
        Item.registerItemBlock(Blocks.stone, new ItemMultiTexture(Blocks.stone, Blocks.stone, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockStone.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("stone"));
        Item.registerItemBlock(Blocks.grass, new ItemColored(Blocks.grass, false));
        Item.registerItemBlock(Blocks.dirt, new ItemMultiTexture(Blocks.dirt, Blocks.dirt, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockDirt.DirtType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("dirt"));
        Item.registerItemBlock(Blocks.cobblestone);
        Item.registerItemBlock(Blocks.planks, new ItemMultiTexture(Blocks.planks, Blocks.planks, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("wood"));
        Item.registerItemBlock(Blocks.sapling, new ItemMultiTexture(Blocks.sapling, Blocks.sapling, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("sapling"));
        Item.registerItemBlock(Blocks.bedrock);
        Item.registerItemBlock(Blocks.sand, new ItemMultiTexture((Block)Blocks.sand, (Block)Blocks.sand, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockSand.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("sand"));
        ...
        Item.registerItemBlock(Blocks.log, new ItemMultiTexture(Blocks.log, Blocks.log, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("log"));
        Item.registerItemBlock(Blocks.log2, new ItemMultiTexture(Blocks.log2, Blocks.log2, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockPlanks.EnumType.byMetadata(p_apply_1_.getMetadata() + 4).getUnlocalizedName())).setUnlocalizedName("log"));
        ...
        Item.registerItemBlock(Blocks.sponge, new ItemMultiTexture(Blocks.sponge, Blocks.sponge, (Function<ItemStack, String>)((Function)p_apply_1_ -> (p_apply_1_.getMetadata() & 1) == 1 ? "wet" : "dry")).setUnlocalizedName("sponge"));
        ...
        Item.registerItemBlock(Blocks.sandstone, new ItemMultiTexture(Blocks.sandstone, Blocks.sandstone, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockSandStone.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("sandStone"));
        ...
        Item.registerItemBlock(Blocks.yellow_flower, new ItemMultiTexture((Block)Blocks.yellow_flower, (Block)Blocks.yellow_flower, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.YELLOW, p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("flower"));
        Item.registerItemBlock(Blocks.red_flower, new ItemMultiTexture((Block)Blocks.red_flower, (Block)Blocks.red_flower, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockFlower.EnumFlowerType.getType(BlockFlower.EnumFlowerColor.RED, p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("rose"));
        ...
        Item.registerItemBlock(Blocks.monster_egg, new ItemMultiTexture(Blocks.monster_egg, Blocks.monster_egg, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockSilverfish.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("monsterStoneEgg"));
        Item.registerItemBlock(Blocks.stonebrick, new ItemMultiTexture(Blocks.stonebrick, Blocks.stonebrick, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockStoneBrick.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("stonebricksmooth"));
        ...
        Item.registerItemBlock(Blocks.cobblestone_wall, new ItemMultiTexture(Blocks.cobblestone_wall, Blocks.cobblestone_wall, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockWall.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("cobbleWall"));
        ...
        Item.registerItemBlock(Blocks.double_plant, new ItemDoublePlant((Block)Blocks.double_plant, (Block)Blocks.double_plant, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockDoublePlant.EnumPlantType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("doublePlant"));
        ...
        Item.registerItemBlock(Blocks.prismarine, new ItemMultiTexture(Blocks.prismarine, Blocks.prismarine, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockPrismarine.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("prismarine"));
        Item.registerItemBlock(Blocks.sea_lantern);
        Item.registerItemBlock(Blocks.red_sandstone, new ItemMultiTexture(Blocks.red_sandstone, Blocks.red_sandstone, (Function<ItemStack, String>)((Function)p_apply_1_ -> BlockRedSandstone.EnumType.byMetadata(p_apply_1_.getMetadata()).getUnlocalizedName())).setUnlocalizedName("redSandStone"));
        ...
        Item.registerItem(349, "fish", new ItemFishFood(false).setUnlocalizedName("fish").setHasSubtypes());
        Item.registerItem(350, "cooked_fish", new ItemFishFood(true).setUnlocalizedName("fish").setHasSubtypes());
