...
public class PlayerProfileCache {
    ...
    private List<ProfileEntry> getEntriesWithLimit() {
        ArrayList arraylist = Lists.newArrayList();
        for (GameProfile gameprofile : Lists.newArrayList((Iterator)Iterators.limit(this.gameProfiles.iterator(), (int)1000))) {
