...
public abstract class ServerConfigurationManager {
    ...
    public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn) {
        ...
        if (this.clientSpoofMod.isEnabled() && Ries.INSTANCE.getSettingManager().getSetting(this.clientSpoofMod, "INTERNAL_GENERAL_COMBO_BOX", Setting.Type.COMBO_BOX).getCurrentCombo().equals("Lunar Client")) {
            nethandlerplayserver.sendPacket(new S3FPacketCustomPayload("REGISTER", new PacketBuffer(Unpooled.wrappedBuffer((byte[])"Lunar".getBytes()))));
        } else {
