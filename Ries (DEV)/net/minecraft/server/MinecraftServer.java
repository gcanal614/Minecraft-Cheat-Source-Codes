            ...
            if (this.startServer()) {
                ...
                while (this.serverRunning) {
                    ...
                    if (j > 2000L && this.currentTime - this.timeOfLastWarning >= 15000L) {
                        logger.warn("Can't keep up! Did the system time change, or is the server overloaded? Running {}ms behind, skipping {} tick(s)", (Object)j, (Object)(j / 50L));
                        j = 2000L;
    ...
    public List<String> getTabCompletions(ICommandSender sender, String input, BlockPos pos) {
        ...
        block4: {
            block3: {
                ...
                if (!input.startsWith("/")) break block3;
