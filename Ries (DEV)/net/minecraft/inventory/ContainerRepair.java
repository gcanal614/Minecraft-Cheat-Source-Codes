...
extends Container {
            ...
            if (itemstack2 != null) {
                ...
                if (itemstack1.isItemStackDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
                    ...
                    for (int i5 : map1.keySet()) {
                        ...
                        int i6 = k5 == (l3 = map1.get(i5).intValue()) ? ++l3 : Math.max(l3, k5);
                        l3 = i6;
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (index != 0 && index != 1 ? index < 39 && this.mergeItemStack(itemstack1, 0, 2, false) : this.mergeItemStack(itemstack1, 3, 39, false)) {
                return null;
            }
