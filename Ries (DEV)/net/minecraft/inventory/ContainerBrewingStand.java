...
extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index > 2 && index != 3) {
                if (!this.theSlot.getHasStack() && this.theSlot.isItemValid(itemstack1) ? this.mergeItemStack(itemstack1, 3, 4, false) : (Potion.canHoldPotion(itemstack) ? this.mergeItemStack(itemstack1, 0, 3, false) : (index < 31 ? this.mergeItemStack(itemstack1, 31, 40, false) : (index < 40 ? this.mergeItemStack(itemstack1, 4, 31, false) : this.mergeItemStack(itemstack1, 4, 40, false))))) {
                    return null;
                }
            } else {
