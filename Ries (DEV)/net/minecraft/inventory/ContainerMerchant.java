...
extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (index != 0 && index != 1 ? (index < 30 ? this.mergeItemStack(itemstack1, 30, 39, false) : index < 39 && this.mergeItemStack(itemstack1, 3, 30, false)) : this.mergeItemStack(itemstack1, 3, 39, false)) {
                return null;
            }
