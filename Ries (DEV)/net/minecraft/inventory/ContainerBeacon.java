...
extends Container {
    ...
    public void onContainerClosed(EntityPlayer playerIn) {
        ...
        if (!playerIn.worldObj.isRemote && (itemstack = this.beaconSlot.decrStackSize(this.beaconSlot.getSlotStackLimit())) != null) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (!this.beaconSlot.getHasStack() && this.beaconSlot.isItemValid(itemstack1) && itemstack1.stackSize == 1 ? this.mergeItemStack(itemstack1, 0, 1, false) : (index < 28 ? this.mergeItemStack(itemstack1, 28, 37, false) : (index < 37 ? this.mergeItemStack(itemstack1, 1, 28, false) : this.mergeItemStack(itemstack1, 1, 37, false)))) {
                return null;
            }
