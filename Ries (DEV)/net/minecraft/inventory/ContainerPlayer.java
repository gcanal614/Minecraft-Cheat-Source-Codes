...
extends Container {
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            } else if (index < 5 ? this.mergeItemStack(itemstack1, 9, 45, false) : (index < 9 ? this.mergeItemStack(itemstack1, 9, 45, false) : (itemstack.getItem() instanceof ItemArmor && !((Slot)this.inventorySlots.get(5 + ((ItemArmor)itemstack.getItem()).armorType)).getHasStack() ? this.mergeItemStack(itemstack1, i = 5 + ((ItemArmor)itemstack.getItem()).armorType, i + 1, false) : (index < 36 ? this.mergeItemStack(itemstack1, 36, 45, false) : (index < 45 ? this.mergeItemStack(itemstack1, 9, 36, false) : this.mergeItemStack(itemstack1, 9, 45, false)))))) {
                return null;
            }
