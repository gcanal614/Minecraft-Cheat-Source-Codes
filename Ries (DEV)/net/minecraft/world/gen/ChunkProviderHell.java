...
implements IChunkProvider {
    ...
    private double[] initializeNoiseField(double[] p_73164_1_, int p_73164_2_, int p_73164_4_, int p_73164_5_, int p_73164_6_, int p_73164_7_) {
        ...
        this.noiseData1 = this.netherNoiseGen3.generateNoiseOctaves(this.noiseData1, p_73164_2_, 0, p_73164_4_, p_73164_5_, p_73164_6_, p_73164_7_, d0 / 80.0, d1 / 60.0, d0 / 80.0);
        ...
        for (int l = 0; l < p_73164_5_; ++l) {
            for (int i1 = 0; i1 < p_73164_7_; ++i1) {
                ...
                for (int k = 0; k < p_73164_6_; ++k) {
                    ...
                    double d4 = d8 < 0.0 ? d6 : (d8 > 1.0 ? d7 : d6 + (d7 - d6) * d8);
                    d4 -= d5;
                    if (k > p_73164_6_ - 4) {
