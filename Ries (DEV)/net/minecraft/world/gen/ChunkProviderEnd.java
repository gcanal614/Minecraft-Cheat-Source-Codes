...
implements IChunkProvider {
    ...
    private double[] initializeNoiseField(double[] p_73187_1_, int p_73187_2_, int p_73187_4_, int p_73187_5_, int p_73187_6_, int p_73187_7_) {
        ...
        this.noiseData1 = this.noiseGen3.generateNoiseOctaves(this.noiseData1, p_73187_2_, 0, p_73187_4_, p_73187_5_, p_73187_6_, p_73187_7_, (d0 *= 2.0) / 80.0, d1 / 160.0, d0 / 80.0);
        ...
        for (int j = 0; j < p_73187_5_; ++j) {
            for (int k = 0; k < p_73187_7_; ++k) {
                ...
                for (int l = 0; l < p_73187_6_; ++l) {
                    ...
                    double d2 = d5 < 0.0 ? d3 : (d5 > 1.0 ? d4 : d3 + (d4 - d3) * d5);
                    d2 -= 8.0;
                    d2 += (double)f2;
                    int i1 = 2;
