...
extends WorldGenAbstractTree {
    ...
    void generateLeafNodeList() {
        ...
        if ((i = (int)(1.382 + Math.pow((double)this.trunkSize * (double)this.heightLimit / 13.0, 2.0))) < 1) {
            i = 1;
        }
        ...
        for (k = this.heightLimit - this.leafDistanceLimit; k >= 0; --k) {
            ...
            for (int l = 0; l < i; ++l) {
                ...
                double d3;
                double d1;
                double d0 = (double)this.trunkSize * (double)f * ((double)this.rand.nextFloat() + 0.328);
    ...
    private BlockLog.EnumAxis func_175938_b(BlockPos p_175938_1_, BlockPos p_175938_2_) {
        ...
        if (k > 0) {
            blocklog$enumaxis = i == k ? BlockLog.EnumAxis.X : BlockLog.EnumAxis.Z;
        }
