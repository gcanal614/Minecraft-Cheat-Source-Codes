...
implements ISaveFormat {
    ...
    public void deleteWorldDirectory(String p_75802_1_) {
        ...
        if (file1.exists()) {
            ...
            for (int i = 1; i <= 5; ++i) {
                ...
                if (SaveFormatOld.deleteFiles(Objects.requireNonNull(file1.listFiles()))) break;
    ...
    protected static boolean deleteFiles(File[] files) {
        for (File file1 : files) {
            ...
            if (file1.isDirectory() && !SaveFormatOld.deleteFiles(Objects.requireNonNull(file1.listFiles()))) {
