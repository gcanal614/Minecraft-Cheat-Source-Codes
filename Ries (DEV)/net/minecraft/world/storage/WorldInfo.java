...
public class WorldInfo {
    ...
    public void addToCrashReport(CrashReportCategory category) {
        ...
        category.addCrashSectionCallable("Level game mode", () -> String.format("Game mode: %s (ID %d). Hardcore: %b. Cheats: %b", this.theGameType.getName(), this.theGameType.getID(), this.hardcore, this.allowCommands));
    }
}
