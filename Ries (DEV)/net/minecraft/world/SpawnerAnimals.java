                ...
                block6: for (ChunkCoordIntPair chunkcoordintpair1 : collection) {
                    ...
                    block7: for (int k2 = 0; k2 < 3; ++k2) {
                        ...
                        for (int l3 = 0; l3 < 4; ++l3) {
                            ...
                            BlockPos blockpos1 = new BlockPos(l2 += p_77192_1_.rand.nextInt(k3) - p_77192_1_.rand.nextInt(k3), i3 += 0, j3 += p_77192_1_.rand.nextInt(k3) - p_77192_1_.rand.nextInt(k3));
