...
extends SaveFormatOld {
    ...
    public void convertMapFormat(String filename, IProgressUpdate progressCallback) {
        ...
        WorldChunkManager worldchunkmanager = worldinfo.getTerrainType() == WorldType.FLAT ? new WorldChunkManagerHell(BiomeGenBase.plains, 0.5f) : new WorldChunkManager(worldinfo.getSeed(), worldinfo.getTerrainType(), worldinfo.getGeneratorOptions());
