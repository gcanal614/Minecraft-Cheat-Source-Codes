...
extends Chunk {
    ...
    public Random getRandomWithSeed(long seed) {
        return new Random(this.getWorld().getSeed() + (long)this.xPosition * (long)this.xPosition * 4987142L + (long)this.xPosition * 5947611L + (long)this.zPosition * (long)this.zPosition * 4392871L + (long)this.zPosition * 389711L ^ seed);
    }
