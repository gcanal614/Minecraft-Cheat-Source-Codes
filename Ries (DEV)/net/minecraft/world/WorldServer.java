...
implements IThreadListener {
    ...
    protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
        ...
        List<EntityLivingBase> list = this.getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb, p_apply_1_ -> p_apply_1_ != null && p_apply_1_.isEntityAlive() && this.canSeeSky(p_apply_1_.getPosition()));
