...
extends EntityLivingBase {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isSprinting()) {
            double d = this.jumpMovementFactor;
            this.getClass();
            this.jumpMovementFactor = (float)(d + (double)0.02f * 0.3);
        }
        ...
        if (this.getHealth() > 0.0f && !this.isSpectator()) {
            AxisAlignedBB axisalignedbb = this.ridingEntity != null && !this.ridingEntity.isDead ? this.getEntityBoundingBox().union(this.ridingEntity.getEntityBoundingBox()).expand(1.0, 0.0, 1.0) : this.getEntityBoundingBox().expand(1.0, 0.5, 1.0);
    ...
    public void attackTargetEntityWithCurrentItem(Entity targetEntity) {
        if (targetEntity.canAttackWithItem() && !targetEntity.hitByEntity(this)) {
            ...
            int i = 0;
            float f1 = targetEntity instanceof EntityLivingBase ? EnchantmentHelper.func_152377_a(this.getHeldItem(), ((EntityLivingBase)targetEntity).getCreatureAttribute()) : EnchantmentHelper.func_152377_a(this.getHeldItem(), EnumCreatureAttribute.UNDEFINED);
    ...
    public void jump() {
        ...
        EventBus.processEvent(eventJump);
