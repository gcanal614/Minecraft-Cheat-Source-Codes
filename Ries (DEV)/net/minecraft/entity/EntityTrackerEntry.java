...
public class EntityTrackerEntry {
    ...
    private Packet func_151260_c() {
        ...
        if (this.trackedEntity instanceof EntityFireball) {
            ...
            S0EPacketSpawnObject s0epacketspawnobject2 = entityfireball.shootingEntity != null ? new S0EPacketSpawnObject(this.trackedEntity, i, ((EntityFireball)this.trackedEntity).shootingEntity.getEntityId()) : new S0EPacketSpawnObject(this.trackedEntity, i, 0);
