...
extends Entity {
    ...
    protected void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        this.fallTile = tagCompund.hasKey("Block", 8) ? Objects.requireNonNull(Block.getBlockFromName(tagCompund.getString("Block"))).getStateFromMeta(i) : (tagCompund.hasKey("TileID", 99) ? Block.getBlockById(tagCompund.getInteger("TileID")).getStateFromMeta(i) : Block.getBlockById(tagCompund.getByte("Tile") & 0xFF).getStateFromMeta(i));
