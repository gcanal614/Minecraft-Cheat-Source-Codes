...
extends EntityMob {
    ...
    public EntityEnderman(World worldIn) {
        ...
        this.targetTasks.addTask(3, new EntityAINearestAttackableTarget<EntityEndermite>(this, EntityEndermite.class, 10, true, false, EntityEndermite::isSpawnedByPlayer));
    }
    ...
    public void readEntityFromNBT(NBTTagCompound tagCompund) {
        ...
        IBlockState iblockstate = tagCompund.hasKey("carried", 8) ? Objects.requireNonNull(Block.getBlockFromName(tagCompund.getString("carried"))).getStateFromMeta(tagCompund.getShort("carriedData") & 0xFFFF) : Block.getBlockById(tagCompund.getShort("carried")).getStateFromMeta(tagCompund.getShort("carriedData") & 0xFFFF);
