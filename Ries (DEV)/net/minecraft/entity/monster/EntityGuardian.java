    ...
    protected void updateAITasks() {
        ...
        if (this.isElder()) {
            ...
            if ((this.ticksExisted + this.getEntityId()) % 1200 == 0) {
                ...
                for (EntityPlayerMP entityplayermp : this.worldObj.getPlayers(EntityPlayerMP.class, p_apply_1_ -> this.getDistanceSqToEntity((Entity)p_apply_1_) < 2500.0 && p_apply_1_.theItemInWorldManager.survivalOrAdventure())) {
    ...
    extends EntityMoveHelper {
        ...
        public void onUpdateMoveHelper() {
            if (this.update && !this.entityGuardian.getNavigator().noPath()) {
                ...
                this.entityGuardian.renderYawOffset = this.entityGuardian.rotationYaw = this.limitAngle(this.entityGuardian.rotationYaw, f);
