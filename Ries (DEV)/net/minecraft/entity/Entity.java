...
implements ICommandSender {
    ...
    public boolean isInvisible() {
        return (!this.antiInvisMod.isEnabled() || !Ries.INSTANCE.getSettingManager().getSetting(this.antiInvisMod, "INTERNAL_INVISIBLES", Setting.Type.CHECKBOX).isTicked()) && this.getFlag(5);
    }
