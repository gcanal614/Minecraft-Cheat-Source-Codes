...
public abstract class Enchantment {
    ...
    static {
        ...
        knockback = new EnchantmentKnockback(new ResourceLocation("knockback"));
        fireAspect = new EnchantmentFireAspect(new ResourceLocation("fire_aspect"));
        looting = new EnchantmentLootBonus(21, new ResourceLocation("looting"), EnumEnchantmentType.WEAPON);
        efficiency = new EnchantmentDigging(new ResourceLocation("efficiency"));
        silkTouch = new EnchantmentUntouching(new ResourceLocation("silk_touch"));
        unbreaking = new EnchantmentDurability(new ResourceLocation("unbreaking"));
        fortune = new EnchantmentLootBonus(35, new ResourceLocation("fortune"), EnumEnchantmentType.DIGGER);
        ...
        luckOfTheSea = new EnchantmentLootBonus(61, new ResourceLocation("luck_of_the_sea"), EnumEnchantmentType.FISHING_ROD);
        lure = new EnchantmentFishingSpeed(new ResourceLocation("lure"));
