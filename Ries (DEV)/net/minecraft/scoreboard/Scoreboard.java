...
public class Scoreboard {
    ...
    public ScoreObjective addScoreObjective(String name, IScoreObjectiveCriteria criteria) {
        ...
        List list = this.scoreObjectiveCriterias.computeIfAbsent(criteria, k -> Lists.newArrayList());
    ...
    public Score getValueFromObjective(String name, ScoreObjective objective) {
        ...
        Map map = this.entitiesScoreObjectives.computeIfAbsent(name, k -> Maps.newHashMap());
