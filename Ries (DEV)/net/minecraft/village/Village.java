...
public class Village {
    ...
    public void tick(int p_75560_1_) {
        ...
        if (this.numIronGolems < (i = this.numVillagers / 10) && this.villageDoorInfoList.size() > 20 && this.worldObj.rand.nextInt(7000) == 0 && (vec3 = this.func_179862_a(this.center)) != null) {
    ...
    private Vec3 func_179862_a(BlockPos p_179862_1_) {
        for (int i = 0; i < 10; ++i) {
            ...
            if (!this.func_179866_a(blockpos) || !this.func_179861_a(new BlockPos(2, 4, 2), blockpos)) continue;
