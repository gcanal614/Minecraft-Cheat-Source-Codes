...
extends MessageToByteEncoder<Packet> {
    ...
    protected void encode(ChannelHandlerContext p_encode_1_, Packet p_encode_2_, ByteBuf p_encode_3_) throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(RECEIVED_PACKET_MARKER, "OUT: [{}:{}] {}", p_encode_1_.channel().attr(NetworkManager.attrKeyConnectionState).get(), (Object)integer, (Object)p_encode_2_.getClass().getName());
        }
        if (integer == null) {
