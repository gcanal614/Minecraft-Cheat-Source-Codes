...
implements IChatComponent {
    ...
    public static Iterator<IChatComponent> createDeepCopyIterator(Iterable<IChatComponent> components) {
        Iterator iterator = Iterators.concat((Iterator)Iterators.transform(components.iterator(), Iterable::iterator));
        iterator = Iterators.transform((Iterator)iterator, p_apply_1_ -> {
