...
public class AxisAlignedBB {
    ...
    public MovingObjectPosition calculateIntercept(Vec3 vecA, Vec3 vecB) {
        ...
        EnumFacing enumfacing = vec36 == vec3 ? EnumFacing.WEST : (vec36 == vec31 ? EnumFacing.EAST : (vec36 == vec32 ? EnumFacing.DOWN : (vec36 == vec33 ? EnumFacing.UP : (vec36 == vec34 ? EnumFacing.NORTH : EnumFacing.SOUTH))));
