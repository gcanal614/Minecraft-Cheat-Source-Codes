...
extends EntityFX {
    ...
    public void onUpdate() {
        ...
        if (material.isLiquid() || material.isSolid()) {
            double d0 = iblockstate.getBlock() instanceof BlockLiquid ? (double)(1.0f - BlockLiquid.getLiquidHeightPercent(iblockstate.getValue(BlockLiquid.LEVEL))) : block.getBlockBoundsMaxY();
