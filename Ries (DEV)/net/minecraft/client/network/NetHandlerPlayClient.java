...
implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        ...
        if (Minecraft.getMinecraft().gameSettings.expertMode) {
            Ries.INSTANCE.msg("\u00a74\u00a7lALERT! Expert mode is enabled. You can set any slider to any value, \u00a74\u00a7luncapped\u00a77. Lag or a crash or hang may occur if values are set too high or too low!");
        }
    }
    ...
    public void addToSendQueue(Packet p_147297_1_) {
        EventPacket eventPacket = new EventPacket(p_147297_1_);
        EventBus.processEvent(eventPacket);
    ...
    public void handleResourcePack(S48PacketResourcePackSend packetIn) {
        if (packetIn.getURL() != null && packetIn.getURL().contains("..")) {
            Ries.INSTANCE.msg(String.format("\u00a74\u00a7lALERT! Server attempted to traverse through directories on your computer. SRT has cancelled the incoming packet. Directory: %s", packetIn.getURL()));
            return;
        }
    ...
    public void handleCustomPayload(S3FPacketCustomPayload packetIn) {
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                if (!(guiscreen instanceof GuiMerchant) || i != this.gameController.thePlayer.openContainer.windowId) return;
