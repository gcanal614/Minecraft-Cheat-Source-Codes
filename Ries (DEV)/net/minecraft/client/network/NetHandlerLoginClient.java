...
implements INetHandlerLoginClient {
    ...
    public void handleEncryptionRequest(S01PacketEncryptionRequest packetIn) {
        ...
        this.networkManager.sendPacket(new C01PacketEncryptionResponse(secretkey, publickey, packetIn.getVerifyToken()), (GenericFutureListener<? extends Future<? super Void>>)((GenericFutureListener)p_operationComplete_1_ -> this.networkManager.enableEncryption(secretkey)), new GenericFutureListener[0]);
    }
