...
public class ResourcePackRepository {
    ...
    private List<File> getResourcePackFiles() {
        return this.dirResourcepacks.isDirectory() ? Arrays.asList((Object[])Objects.requireNonNull(this.dirResourcepacks.listFiles(resourcePackFilter))) : Collections.emptyList();
    }
        ...
        try {
            ...
            if (file1.exists() && hash.length() == 40) {
                ...
                block8: {
                    ...
                    ListenableFuture<Object> listenableFuture = this.setResourcePackInstance(file1);
