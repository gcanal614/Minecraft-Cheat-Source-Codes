...
public class ModelBakery {
    ...
    public void loadItemModel(String p_loadItemModel_1_, ResourceLocation p_loadItemModel_2_, ResourceLocation p_loadItemModel_3_) {
        ...
        if (this.models.get(p_loadItemModel_2_) == null) {
            try {
                ...
                LOGGER.warn("Unable to load item model: '{}' for item: '{}'", (Object)p_loadItemModel_2_, (Object)p_loadItemModel_3_);
    ...
    public static ResourceLocation fixModelLocation(ResourceLocation p_fixModelLocation_0_, String p_fixModelLocation_1_) {
        String s;
        String s1;
        if (p_fixModelLocation_0_ != null && p_fixModelLocation_1_ != null && p_fixModelLocation_0_.getResourceDomain().equals("minecraft") && !(s1 = ModelBakery.fixResourcePath(s = p_fixModelLocation_0_.getResourcePath(), p_fixModelLocation_1_)).equals(s)) {
