...
public class PlayerControllerMP {
    ...
    public void onPlayerDestroyBlock(BlockPos pos) {
        ...
        if (!(this.currentGameType.isCreative() && this.mc.thePlayer.getHeldItem() != null && this.mc.thePlayer.getHeldItem().getItem() instanceof ItemSword || (block1 = (iblockstate = (world = this.mc.theWorld).getBlockState(pos)).getBlock()).getMaterial() == Material.air)) {
    ...
    public float getBlockReachDistance() {
        return this.blockReachMod.isEnabled() ? (float)Ries.INSTANCE.getSettingManager().getSetting(this.blockReachMod, "INTERNAL_BLOCK_REACH_VALUE", Setting.Type.SLIDER).getCurrentValue() : (this.currentGameType.isCreative() ? 5.0f : 4.5f);
    }
