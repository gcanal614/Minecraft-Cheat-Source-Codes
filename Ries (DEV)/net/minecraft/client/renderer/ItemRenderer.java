...
public class ItemRenderer {
    ...
    public void doBlockAnimation(float partialTicks) {
        ...
        GL11.glTranslated((double)0.2, (double)0.0, (double)0.0);
        this.func_178103_d();
    }
    ...
    private void func_178108_a(TextureAtlasSprite p_178108_2_) {
        ...
        worldrenderer.func_181662_b(1.0, -1.0, -0.5).func_181673_a(f6, f9).func_181675_d();
        worldrenderer.func_181662_b(1.0, 1.0, -0.5).func_181673_a(f6, f8).func_181675_d();
        worldrenderer.func_181662_b(-1.0, 1.0, -0.5).func_181673_a(f7, f8).func_181675_d();
        tessellator.draw();
        GlStateManager.popMatrix();
    ...
    private void renderWaterOverlayTexture(float p_78448_1_) {
        if (!Config.isShaders() || Shaders.isUnderwaterOverlay()) {
            ...
            worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
            worldrenderer.func_181662_b(-1.0, -1.0, -0.5).func_181673_a(4.0f + f7, 4.0f + f8).func_181675_d();
            worldrenderer.func_181662_b(1.0, -1.0, -0.5).func_181673_a(0.0f + f7, 4.0f + f8).func_181675_d();
            worldrenderer.func_181662_b(1.0, 1.0, -0.5).func_181673_a(0.0f + f7, 0.0f + f8).func_181675_d();
            worldrenderer.func_181662_b(-1.0, 1.0, -0.5).func_181673_a(4.0f + f7, 0.0f + f8).func_181675_d();
            tessellator.draw();
            GlStateManager.popMatrix();
            GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
