...
public class RenderChunk {
    ...
    public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
        ...
        if (!this.isChunkRegionEmpty(blockpos)) {
            ...
            for (Object e : BlockPosM.getAllInBoxMutable(blockpos, blockpos1)) {
                ...
                EnumWorldBlockLayer[] enumWorldBlockLayerArray = aenumworldblocklayer;
                int n = enumWorldBlockLayerArray.length;
                for (int j = 0; j < n; ++j) {
                    boolean flag2;
                    EnumWorldBlockLayer enumWorldBlockLayer;
                    EnumWorldBlockLayer enumworldblocklayer = enumWorldBlockLayer = enumWorldBlockLayerArray[j];
    ...
    private ChunkCacheOF makeChunkCacheOF(BlockPos p_makeChunkCacheOF_1_) {
        ...
        RegionRenderCache chunkcache = this.createRegionRenderCache(this.world, blockpos, blockpos1);
