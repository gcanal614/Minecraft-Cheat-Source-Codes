...
public class OpenGlHelper {
    ...
    public static void initializeTextures() {
        ...
        logText = arbMultitexture ? logText + "Using ARB_multitexture.\n" : logText + "Using GL 1.3 multitexturing.\n";
        defaultTexUnit = 33984;
        lightmapTexUnit = 33985;
        GL_TEXTURE2 = 33986;
        logText = arbTextureEnvCombine ? logText + "Using ARB_texture_env_combine.\n" : logText + "Using GL 1.3 texture combiners.\n";
        GL_COMBINE = 34160;
        ...
        if (vboSupported) {
            logText = arbVbo ? logText + "ARB_vertex_buffer_object is supported.\n" : logText + "OpenGL 1.5 is supported.\n";
