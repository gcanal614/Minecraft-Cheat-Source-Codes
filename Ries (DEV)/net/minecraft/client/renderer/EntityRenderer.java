...
implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            if (this.mc.objectMouseOver != null) {
                d1 = this.reachMod.isEnabled() ? Ries.INSTANCE.getSettingManager().getSetting(this.reachMod, "INTERNAL_REACH_VALUE", Setting.Type.SLIDER).getCurrentValue() : this.mc.objectMouseOver.hitVec.distanceTo(vec3);
            }
            ...
            Vec3 vec33 = null;
            float f = 1.0f;
            List<Entity> list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand(f, f, f), (Predicate<? super Entity>)Predicates.and(EntitySelectors.NOT_SPECTATING, Entity::canBeCollidedWith));
            double d2 = d1;
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    if (Reflector.ForgeHooksClient_drawScreen.exists()) {
                        Reflector.callVoid(Reflector.ForgeHooksClient_drawScreen, this.mc.currentScreen, k1, l1, Float.valueOf(eventGameRender.getPartialTicks()));
                    } else {
    ...
    private void setupFog(int p_78468_1_, float partialTicks) {
        ...
        Entity entity = this.mc.getRenderViewEntity();
        GL11.glFog((int)2918, (FloatBuffer)this.setFogColorBuffer(this.fogColorRed, this.fogColorGreen, this.fogColorBlue));
        GL11.glNormal3f((float)0.0f, (float)-1.0f, (float)0.0f);
        GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
        Block block = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, entity, partialTicks);
        float f = -1.0f;
    ...
    private void frameFinish() {
        int i;
        if (this.mc.theWorld != null && Config.isShowGlErrors() && TimedEvent.isActive("CheckGlErrorFrameFinish", 10000L) && (i = GlStateManager.glGetError()) != 0 && GlErrors.isEnabled()) {
