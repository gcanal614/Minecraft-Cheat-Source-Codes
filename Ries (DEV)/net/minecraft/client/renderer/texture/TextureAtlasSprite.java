...
public class TextureAtlasSprite {
    ...
    public void loadSprite(BufferedImage[] images, AnimationMetadataSection meta) {
        ...
        for (int k = 0; k < images.length; ++k) {
            ...
            if (this.width >> k != ((BufferedImage)bufferedimage).getWidth()) {
                bufferedimage = TextureUtils.scaleImage((BufferedImage)bufferedimage, this.width >> k);
            }
        ...
        if (meta == null) {
            ...
            if (meta.getFrameCount() > 0) {
                bufferedimage = meta.getFrameIndexSet().iterator();
    ...
    public List<int[][]> getFramesTextureData() {
        return new ArrayList<int[][]>(this.framesTextureData);
    }
