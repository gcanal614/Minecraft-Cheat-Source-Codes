...
implements ITickableTextureObject {
    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
        ...
        for (Map.Entry<String, TextureAtlasSprite> entry : this.mapRegisteredSprites.entrySet()) {
                ...
                if ((texturemetadatasection = (TextureMetadataSection)iresource.getMetadata("texture")) != null) {
                    ...
                    for (int j4 : list1) {
                        ...
                        try {
                            ...
                            logger.error("Unable to load miplevel {} from: {}", (Object)j4, (Object)resourcelocation, (Object)ioexception);
                        }
                    }
                }
            ...
            if (j3 < k) {
                logger.warn("Texture {} with size {}x{} limits mip level from {} to {}", (Object)resourceLocation, (Object)textureatlassprite3.getIconWidth(), (Object)textureatlassprite3.getIconHeight(), (Object)MathHelper.calculateLogBaseTwo(k), (Object)MathHelper.calculateLogBaseTwo(j3));
                k = j3;
            }
            stitcher.addSprite(textureatlassprite3);
        }
        ...
        if (k2 < this.mipmapLevels) {
            logger.warn("{}: dropping miplevel from {} to {}, because of minimum power of two: {}", (Object)this.basePath, (Object)this.mipmapLevels, (Object)k2, (Object)j2);
        ...
        for (TextureAtlasSprite textureAtlasSprite : this.mapRegisteredSprites.values()) {
            ...
            try {
                ...
                crashreportcategory.addCrashSectionCallable("Sprite name", textureAtlasSprite::getIconName);
                ...
                crashreportcategory.addCrashSectionCallable("Sprite frames", () -> textureAtlasSprite.getFrameCount() + " frames");
