...
extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (this.mc.gameSettings.thirdPersonView == 0 && itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin) && !this.noPumpkinOverlayMod.isEnabled()) {
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        ArrayList list = Lists.newArrayList((Iterable)Iterables.filter(collection, p_apply_1_ -> p_apply_1_.getPlayerName() != null && !p_apply_1_.getPlayerName().startsWith("#")));
