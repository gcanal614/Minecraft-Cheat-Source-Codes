...
implements IProgressMeter {
    ...
    private void drawSprite(int p_146527_1_, int p_146527_2_, int p_146527_3_, int p_146527_4_) {
        ...
        worldrenderer.func_181662_b(p_146527_1_, p_146527_2_ + 18, this.zLevel).func_181673_a((float)p_146527_3_ * 0.0078125f, (float)(p_146527_4_ + 18) * 0.0078125f).func_181675_d();
        ...
        worldrenderer.func_181662_b(p_146527_1_ + 18, p_146527_2_, this.zLevel).func_181673_a((float)(p_146527_3_ + 18) * 0.0078125f, (float)p_146527_4_ * 0.0078125f).func_181675_d();
        worldrenderer.func_181662_b(p_146527_1_, p_146527_2_, this.zLevel).func_181673_a((float)p_146527_3_ * 0.0078125f, (float)p_146527_4_ * 0.0078125f).func_181675_d();
        tessellator.draw();
    }
