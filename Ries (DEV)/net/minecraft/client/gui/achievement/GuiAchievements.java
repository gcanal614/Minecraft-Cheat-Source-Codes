...
implements IProgressMeter {
    ...
    public GuiAchievements(GuiScreen parentScreenIn, StatFileWriter statFileWriterIn) {
        ...
        int i = 141;
        int j = 141;
        this.field_146567_u = this.field_146565_w = (double)((float)(AchievementList.openInventory.displayColumn * 24) - (float)i / 2.0f - 12.0f);
        this.field_146569_s = this.field_146565_w;
        this.field_146566_v = this.field_146573_x = (double)((float)(AchievementList.openInventory.displayRow * 24) - (float)j / 2.0f);
