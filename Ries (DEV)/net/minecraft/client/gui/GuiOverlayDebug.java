...
extends Gui {
    ...
    protected List<String> call() {
        ...
        if (!this.mc.debug.equals(this.debugOF)) {
            ...
            this.debugOF = this.mc.debug = builder.toString();
        }
    ...
    protected List<String> getDebugInfoRight() {
        ...
        if (Reflector.FMLCommonHandler_getBrandings.exists()) {
            ...
            list.add("");
            list.addAll((Collection)Objects.requireNonNull(Reflector.call(object, Reflector.FMLCommonHandler_getBrandings, Boolean.FALSE)));
        }
        if (this.isReducedDebug()) {
            return list;
        }
