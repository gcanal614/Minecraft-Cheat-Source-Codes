...
public class MapItemRenderer {
    ...
    class Instance {
        ...
        private void render(boolean noOverlayRendering) {
            ...
            worldrenderer.func_181662_b((float)i + f, (float)(j + 128) - f, -0.01f).func_181673_a(0.0, 1.0).func_181675_d();
            worldrenderer.func_181662_b((float)(i + 128) - f, (float)(j + 128) - f, -0.01f).func_181673_a(1.0, 1.0).func_181675_d();
            worldrenderer.func_181662_b((float)(i + 128) - f, (float)j + f, -0.01f).func_181673_a(1.0, 0.0).func_181675_d();
            worldrenderer.func_181662_b((float)i + f, (float)j + f, -0.01f).func_181673_a(0.0, 0.0).func_181675_d();
            tessellator.draw();
