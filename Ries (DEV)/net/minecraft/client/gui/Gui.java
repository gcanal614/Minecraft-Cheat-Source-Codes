...
public class Gui {
    ...
    public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
        ...
        worldrenderer.func_181662_b(x, y + height, this.zLevel).func_181673_a((float)textureX * f, (float)(textureY + height) * f1).func_181675_d();
        ...
        worldrenderer.func_181662_b(x + width, y, this.zLevel).func_181673_a((float)(textureX + width) * f, (float)textureY * f1).func_181675_d();
        worldrenderer.func_181662_b(x, y, this.zLevel).func_181673_a((float)textureX * f, (float)textureY * f1).func_181675_d();
        tessellator.draw();
    }
    ...
    public void drawTexturedModalRect(float xCoord, float yCoord, int minU, int minV, int maxU, int maxV) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.func_181662_b(xCoord + 0.0f, yCoord + (float)maxV, this.zLevel).func_181673_a((float)minU * f, (float)(minV + maxV) * f1).func_181675_d();
        ...
        worldrenderer.func_181662_b(xCoord + (float)maxU, yCoord + 0.0f, this.zLevel).func_181673_a((float)(minU + maxU) * f, (float)minV * f1).func_181675_d();
        worldrenderer.func_181662_b(xCoord + 0.0f, yCoord + 0.0f, this.zLevel).func_181673_a((float)minU * f, (float)minV * f1).func_181675_d();
        tessellator.draw();
    }
    ...
    public void drawTexturedModalRect(int xCoord, int yCoord, TextureAtlasSprite textureSprite, int widthIn, int heightIn) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181707_g);
        worldrenderer.func_181662_b(xCoord, yCoord + heightIn, this.zLevel).func_181673_a(textureSprite.getMinU(), textureSprite.getMaxV()).func_181675_d();
        ...
        worldrenderer.func_181662_b(xCoord + widthIn, yCoord, this.zLevel).func_181673_a(textureSprite.getMaxU(), textureSprite.getMinV()).func_181675_d();
        worldrenderer.func_181662_b(xCoord, yCoord, this.zLevel).func_181673_a(textureSprite.getMinU(), textureSprite.getMinV()).func_181675_d();
        tessellator.draw();
    }
