...
extends GuiScreen {
    ...
    private static void func_146425_a(FlatLayerInfo ... p_146425_3_) {
        GuiFlatPresets.func_175354_a("Redstone Ready", Items.redstone, 0, BiomeGenBase.desert, null, p_146425_3_);
    }
    ...
    static {
        GuiFlatPresets.func_146421_a("Classic Flat", Item.getItemFromBlock(Blocks.grass), BiomeGenBase.plains, Collections.singletonList("village"), new FlatLayerInfo(1, Blocks.grass), new FlatLayerInfo(2, Blocks.dirt), new FlatLayerInfo(1, Blocks.bedrock));
        ...
        GuiFlatPresets.func_146425_a(new FlatLayerInfo(52, Blocks.sandstone), new FlatLayerInfo(3, Blocks.stone), new FlatLayerInfo(1, Blocks.bedrock));
    }
    ...
    extends GuiSlot {
        ...
        private void func_148171_c(int p_148171_1_, int p_148171_2_) {
            ...
            worldrenderer.func_181662_b(p_148171_1_, p_148171_2_ + 18, GuiFlatPresets.this.zLevel).func_181673_a(0.0, 0.140625).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 18, p_148171_2_ + 18, GuiFlatPresets.this.zLevel).func_181673_a(0.140625, 0.140625).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_ + 18, p_148171_2_, GuiFlatPresets.this.zLevel).func_181673_a(0.140625, 0.0).func_181675_d();
            worldrenderer.func_181662_b(p_148171_1_, p_148171_2_, GuiFlatPresets.this.zLevel).func_181673_a(0.0, 0.0).func_181675_d();
            tessellator.draw();
        }
