...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        private void func_148224_c(int p_148224_1_, int p_148224_2_) {
            ...
            worldrenderer.func_181662_b(p_148224_1_, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel).func_181673_a(0.0, 0.140625).func_181675_d();
            worldrenderer.func_181662_b(p_148224_1_ + 18, p_148224_2_ + 18, GuiCreateFlatWorld.this.zLevel).func_181673_a(0.140625, 0.140625).func_181675_d();
            worldrenderer.func_181662_b(p_148224_1_ + 18, p_148224_2_, GuiCreateFlatWorld.this.zLevel).func_181673_a(0.140625, 0.0).func_181675_d();
            worldrenderer.func_181662_b(p_148224_1_, p_148224_2_, GuiCreateFlatWorld.this.zLevel).func_181673_a(0.0, 0.0).func_181675_d();
            tessellator.draw();
        }
