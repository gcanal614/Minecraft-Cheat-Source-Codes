...
public abstract class GuiSlot {
    ...
    protected void overlayBackground(int startY, int endY) {
        ...
        float f = 32.0f;
        worldrenderer.func_181668_a(7, DefaultVertexFormats.field_181709_i);
        worldrenderer.func_181662_b(this.left, endY, 0.0).func_181673_a(0.0, (float)endY / 32.0f).func_181669_b(64, 64, 64, 255).func_181675_d();
        worldrenderer.func_181662_b(this.left + this.width, endY, 0.0).func_181673_a((float)this.width / 32.0f, (float)endY / 32.0f).func_181669_b(64, 64, 64, 255).func_181675_d();
        worldrenderer.func_181662_b(this.left + this.width, startY, 0.0).func_181673_a((float)this.width / 32.0f, (float)startY / 32.0f).func_181669_b(64, 64, 64, 255).func_181675_d();
        worldrenderer.func_181662_b(this.left, startY, 0.0).func_181673_a(0.0, (float)startY / 32.0f).func_181669_b(64, 64, 64, 255).func_181675_d();
        tessellator.draw();
    }
