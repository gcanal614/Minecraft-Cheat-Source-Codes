...
extends Block {
            ...
            if (enumfacing1 == EnumFacing.UP && pos.getY() < 255 && worldIn.isAirBlock(blockpos1)) {
                if (!flag) {
                    ...
                    for (EnumFacing enumfacing3 : EnumFacing.Plane.HORIZONTAL) {
                        ...
                        iblockstate2 = iblockstate2.withProperty(BlockVine.getPropertyFor(enumfacing3), Boolean.FALSE);
                    }
                ...
                if (!flag) {
                    ...
                    if (block1.blockMaterial == Material.air) {
                        ...
                        if (flag1 && this.canPlaceOn(worldIn.getBlockState(blockpos4).getBlock())) {
                            worldIn.setBlockState(blockpos3, this.getDefaultState().withProperty(BlockVine.getPropertyFor(enumfacing2), Boolean.TRUE), 2);
                        } else if (flag2 && this.canPlaceOn(worldIn.getBlockState(blockpos).getBlock())) {
                            worldIn.setBlockState(blockpos3, this.getDefaultState().withProperty(BlockVine.getPropertyFor(enumfacing4), Boolean.TRUE), 2);
                        } else if (flag1 && worldIn.isAirBlock(blockpos4) && this.canPlaceOn(worldIn.getBlockState(pos.offset(enumfacing2)).getBlock())) {
                            worldIn.setBlockState(blockpos4, this.getDefaultState().withProperty(BlockVine.getPropertyFor(enumfacing1.getOpposite()), Boolean.TRUE), 2);
                        } else if (flag2 && worldIn.isAirBlock(blockpos) && this.canPlaceOn(worldIn.getBlockState(pos.offset(enumfacing4)).getBlock())) {
                            worldIn.setBlockState(blockpos, this.getDefaultState().withProperty(BlockVine.getPropertyFor(enumfacing1.getOpposite()), Boolean.TRUE), 2);
                        ...
                        worldIn.setBlockState(pos, state.withProperty(BlockVine.getPropertyFor(enumfacing1), Boolean.TRUE), 2);
                    }
                }
            } else if (pos.getY() > 1) {
                ...
                if (block.blockMaterial == Material.air) {
                    ...
                    for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
                        ...
                        iblockstate1 = iblockstate1.withProperty(BlockVine.getPropertyFor(enumfacing), Boolean.FALSE);
                    }
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        ...
        return facing.getAxis().isHorizontal() ? iblockstate.withProperty(BlockVine.getPropertyFor(facing.getOpposite()), Boolean.TRUE) : iblockstate;
    }
