...
extends BlockBush {
    ...
    public IProperty<EnumFlowerType> getTypeProperty() {
        if (this.type == null) {
            this.type = PropertyEnum.create("type", EnumFlowerType.class, p_apply_1_ -> p_apply_1_.getBlockType() == this.getBlockType());
        }
        return this.type;
    }
    ...
    public static enum EnumFlowerType implements IStringSerializable
    {
        ...
        static {
            ...
            for (EnumFlowerColor blockflower$enumflowercolor : EnumFlowerColor.values()) {
                Collection collection = Collections2.filter((Collection)Lists.newArrayList((Object[])EnumFlowerType.values()), p_apply_1_ -> p_apply_1_.getBlockType() == blockflower$enumflowercolor);
