    ...
    public int func_176307_f(IBlockAccess blockAccess, BlockPos pos) {
        ...
        switch (enumfacing) {
            case EAST: {
                ...
                if (!BlockStairs.isBlockStairs(block) || blockstairs$enumhalf != iblockstate1.getValue(HALF)) break;
                ...
                if (enumfacing1 != EnumFacing.SOUTH || !BlockStairs.isSameStair(blockAccess, pos.north(), iblockstate)) break;
                return flag ? 2 : 1;
            }
            case WEST: {
                IBlockState iblockstate2 = blockAccess.getBlockState(pos.west());
                Block block1 = iblockstate2.getBlock();
                if (!BlockStairs.isBlockStairs(block1) || blockstairs$enumhalf != iblockstate2.getValue(HALF)) break;
                ...
                if (enumfacing2 != EnumFacing.SOUTH || !BlockStairs.isSameStair(blockAccess, pos.north(), iblockstate)) break;
                return flag ? 1 : 2;
            }
            case SOUTH: {
                IBlockState iblockstate3 = blockAccess.getBlockState(pos.south());
                Block block2 = iblockstate3.getBlock();
                if (!BlockStairs.isBlockStairs(block2) || blockstairs$enumhalf != iblockstate3.getValue(HALF)) break;
                ...
                if (enumfacing3 != EnumFacing.EAST || !BlockStairs.isSameStair(blockAccess, pos.west(), iblockstate)) break;
                return flag ? 1 : 2;
            }
            case NORTH: {
                IBlockState iblockstate4 = blockAccess.getBlockState(pos.north());
                Block block3 = iblockstate4.getBlock();
                if (!BlockStairs.isBlockStairs(block3) || blockstairs$enumhalf != iblockstate4.getValue(HALF)) break;
                ...
                if (enumfacing4 != EnumFacing.EAST || !BlockStairs.isSameStair(blockAccess, pos.west(), iblockstate)) break;
                return flag ? 2 : 1;
            }
        }
        return 0;
    ...
    public int func_176305_g(IBlockAccess blockAccess, BlockPos pos) {
        ...
        switch (enumfacing) {
            case EAST: {
                ...
                if (enumfacing1 != EnumFacing.SOUTH || !BlockStairs.isSameStair(blockAccess, pos.south(), iblockstate)) break;
                return flag ? 2 : 1;
            }
            case WEST: {
                ...
                if (enumfacing2 != EnumFacing.SOUTH || !BlockStairs.isSameStair(blockAccess, pos.south(), iblockstate)) break;
                return flag ? 1 : 2;
            }
            case SOUTH: {
                ...
                if (enumfacing3 != EnumFacing.EAST || !BlockStairs.isSameStair(blockAccess, pos.east(), iblockstate)) break;
                return flag ? 1 : 2;
            }
            case NORTH: {
                ...
                if (enumfacing4 != EnumFacing.EAST || !BlockStairs.isSameStair(blockAccess, pos.east(), iblockstate)) break;
                return flag ? 2 : 1;
            }
        }
        return 0;
