...
implements ITileEntityProvider {
    ...
    private EntityItemFrame findItemFrame(World worldIn, EnumFacing facing, BlockPos pos) {
        List<EntityItemFrame> list = worldIn.getEntitiesWithinAABB(EntityItemFrame.class, new AxisAlignedBB(pos.getX(), pos.getY(), pos.getZ(), pos.getX() + 1, pos.getY() + 1, pos.getZ() + 1), p_apply_1_ -> p_apply_1_ != null && p_apply_1_.getHorizontalFacing() == facing);
