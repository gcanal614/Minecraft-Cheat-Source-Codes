...
public class Block {
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List<AxisAlignedBB> list, Entity collidingEntity) {
        ...
        if ((axisalignedbb = eventAddCollision.getBoundingBox()) != null && mask.intersectsWith(axisalignedbb)) {
    ...
    public static void registerBlocks() {
        ...
        Block.registerBlock(119, "end_portal", new BlockEndPortal().setHardness(-1.0f).setResistance(6000000.0f));
        ...
        Block.registerBlock(147, "light_weighted_pressure_plate", new BlockPressurePlateWeighted(15, MapColor.goldColor).setHardness(0.5f).setStepSound(soundTypeWood).setUnlocalizedName("weightedPlate_light"));
        Block.registerBlock(148, "heavy_weighted_pressure_plate", new BlockPressurePlateWeighted().setHardness(0.5f).setStepSound(soundTypeWood).setUnlocalizedName("weightedPlate_heavy"));
