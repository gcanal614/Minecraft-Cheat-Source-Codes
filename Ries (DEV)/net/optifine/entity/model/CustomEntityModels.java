...
public class CustomEntityModels {
    ...
    public static void update() {
        ...
        if (map == null) {
            ...
            if (Config.isCustomEntityModels()) {
                ...
                for (ResourceLocation resourcelocation : aresourcelocation = CustomEntityModels.getModelLocations()) {
                    Class oclass;
    ...
    private static ResourceLocation[] getModelLocations() {
        ...
        for (String s2 : astring = CustomModelRegistry.getModelNames()) {
            String s3 = s + s2 + s1;
    ...
    private static IEntityRenderer parseEntityRender(ResourceLocation location) {
        try {
            ...
            return CustomEntityModels.parseEntityRender(jsonobject, location.getResourcePath());
        }
