    ...
    public static void drawArrays(int drawMode, int first, int count, WorldRenderer wrr) {
        if (count != 0) {
            ...
            if (i == 56) {
                ...
                GL20.glVertexAttribPointer((int)11, (int)2, (int)5126, (boolean)false, (int)i, (ByteBuffer)bytebuffer);
                bytebuffer.position(40);
                GL20.glVertexAttribPointer((int)12, (int)4, (int)5122, (boolean)false, (int)i, (ByteBuffer)bytebuffer);
                bytebuffer.position(48);
                GL20.glVertexAttribPointer((int)10, (int)3, (int)5122, (boolean)false, (int)i, (ByteBuffer)bytebuffer);
