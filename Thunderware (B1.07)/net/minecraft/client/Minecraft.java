...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        try {
			this.customFont = new CFontRenderer(Font.createFont(Font.TRUETYPE_FONT, CFont.class.getResourceAsStream("font.otf")).deriveFont(Font.PLAIN, 22), true, true);
		} catch (Exception e) {
			e.printStackTrace();
        	shutdown();
		}
        ...
        Thunderware.instance.setupClient();
    ...
    public void shutdownMinecraftApplet()
    {
        try
        {
            ...
            Thunderware.instance.onClientClose();
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                    	...
                    	Thunderware.instance.moduleManager.onEvent(keyEvent);
