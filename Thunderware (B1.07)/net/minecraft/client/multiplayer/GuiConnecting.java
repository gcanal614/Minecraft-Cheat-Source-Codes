            ...
            public void run()
            {
                ...
                try
                {
                    ...
                    if (discordIp.contains("hypixel.net")) {
                        Thunderware.instance.richPresence.update("In-Game", "Playing on Hypixel", "hypixel", "");
                    } else if (discordIp.contains("blocksmc.com")) {
                        Thunderware.instance.richPresence.update("In-Game", "Playing on BlocksMC", "blocksmc", "");
                    } else {
                        Thunderware.instance.richPresence.update("In-Game", "Playing on " + discordIp + (port != 25565 ? ":" + port : ""), "", "");
                    }
                }
